 ...
 * @subpackage Drafts
 */
class FacturasAliadosListForm extends FacturasListFormBase {
...
//		protected function Form_Load() {}
	...
	protected function Form_Create() {
		...
		$this->lblTituForm->Text = 'Facturas Aliados';
    ...
    {
        QApplication::Redirect("emitir_factura_aliado.php");
    }
...
FacturasAliadosListForm::Run('FacturasAliadosListForm');
?>
