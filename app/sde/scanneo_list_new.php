 ...
 * @subpackage Drafts
 */
class ScanneoListNewForm extends ScanneoListFormBase {
...
//		protected function Form_Load() {}
	...
	protected function Form_Create() {
		...
		$objClauWher[] = QQ::Equal(QQN::Scanneo()->EstaCerrado, true);
	...
	public function dtgScanneosRow_Click($strFormId, $strControlId, $strParameter) {
        ...
        QApplication::Redirect("scanneo_edit_new.php/$intId");
	}		
...
ScanneoListNewForm::Run('ScanneoListNewForm');
?>
