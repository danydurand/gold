<?php
	// This is the HTML template include file (.tpl.php) for the guia_transportista_edit.php
	// form DRAFT page.  Remember that this is a DRAFT.  It is MEANT to be altered/modified.

	// Be sure to move this out of the generated/ subdirectory before modifying to ensure that subsequent
	// code re-generations do not overwrite your changes.

	$strPageTitle = 'GuiaTransportista' . ' - ' . $this->mctGuiaTransportista->TitleVerb;
    ...
    <div class="container-fluid">
        ...
        <div class="row" style="margin-top: 1em;">
            ...
            <?php $this->lblId->RenderWithName(); ?>
				<?php $this->lstTransportista->RenderWithName(); ?>
				<?php $this->lstGuiaPieza->RenderWithName(); ?>
				<?php $this->txtGuia->RenderWithName(); ?>
				<?php $this->txtProcesoId->RenderWithName(); ?>
