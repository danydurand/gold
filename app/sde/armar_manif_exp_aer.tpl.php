            ...
            <div class="row" style="margin-top: 1em;">
                <div class="col-md-4">
                    <div class="row">
                        ...
                        <div class="col-md-6 title">Línea Aérea</div>
                    </div>
                    <div class="row">
                        <div class="col-md-6"><?php $this->lstDestMani->Render(); ?></div>
                        <div class="col-md-6"><?php $this->lstLineAere->Render(); ?></div>
                    </div>
                    <div class="row">
                        <div class="col-md-6 title">Master Awb</div>
                        <div class="col-md-6 title">Nro Vuelo</div>
                    </div>
                    <div class="row">
                        <div class="col-md-6"><?php $this->lstMastAwbx->Render(); ?></div>
                        <div class="col-md-6"><?php $this->txtNumeVuel->Render(); ?></div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 title">Cant Kilos</div>
                    </div>
                    <div class="row">
                        <div class="col-md-6"><?php $this->txtCantPiez->Render(); ?></div>
                        <div class="col-md-6"><?php $this->txtCantKilo->Render(); ?></div>
                    </div>
                    <div class="row">
