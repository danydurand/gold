<?php
	...
	$strPageTitle = 'Scanneo' . ' - ' . $this->mctScanneo->TitleVerb;
    ...
    <div class="container-fluid">
        ...
        <div class="row" style="margin-top: 1em;">
            <div class="col-md-4">
                ...
                <div class="titulo" style="margin-top: 1em">Sobrantes</div>
                <?php $this->dtgPiezSobr->Render(); ?>
	        </div>
            <div class="col-md-4">
                <div class="titulo">Scanneadas en Origen</div>
                <?php $this->dtgPiezOrig->Render(); ?>
            </div>
            <div class="col-md-4">
                <div class="titulo">Recibidas en el Almacén</div>
                <?php $this->dtgPiezReci->Render(); ?>
            </div>
        </div>
    </div>
</div>
