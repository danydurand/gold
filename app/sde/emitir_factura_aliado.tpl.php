<?php
$strPageTitle = QApplication::Translate('Emitir Factura Aliado');
    ...
    <div class="container-fluid" data-aos="fade-in">
        ...
        <div class="row" style="margin-top: 2em">
            ...
            <div class="col-xs-12 col-md-7">
                <div class="titulo" style="margin-bottom: .2em">Guias aptas p/Facturar</div>
                <?php $this->dtgGuiaApta->Render(); ?>
            </div>
        </div>
    </div>
</div>
