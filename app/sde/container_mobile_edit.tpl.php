<?php
	// This is the HTML template include file (.tpl.php) for the container_mobile_edit.php
	// form DRAFT page.  Remember that this is a DRAFT.  It is MEANT to be altered/modified.

	// Be sure to move this out of the generated/ subdirectory before modifying to ensure that subsequent
	// code re-generations do not overwrite your changes.

	$strPageTitle = 'ContainerMobile' . ' - ' . $this->mctContainerMobile->TitleVerb;
...
<div class="titulo-formulario">
    ...
    <div class="hidden-xs hidden-sm col-md-7 col-lg-5" style="text-align: center; margin-top: -0.25em;">
        ...
        <?php $this->btnSyncCont->Render(); ?>
        <?php $this->btnActiMobi->Render(); ?>
    ...
    <div class="container-fluid">
        ...
        <div class="row" style="margin-top: 1em;">
            <div class="col-md-4">
				...
				<?php $this->lstChofer->RenderWithName(); ?>
				<?php $this->lstContainer->RenderWithName(); ?>
				<?php $this->chkAbierto->RenderWithName(); ?>
                <div class="row">
                    <div class="col-md-3"></div>
                    <div class="col-md-4">
                        <?php $this->txtCantPiezas->RenderWithName(); ?>
                    </div>
                    <div class="col-md-4">
                        <?php $this->txtPendientes->RenderWithName(); ?>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-3"></div>
                    <div class="col-md-4">
                        <?php $this->txtEntregadas->RenderWithName(); ?>
                    </div>
                    <div class="col-md-4">
                        <?php $this->txtDevueltas->RenderWithName(); ?>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-3"></div>
                    <div class="col-md-4">
                        <?php $this->txtSinGestionar->RenderWithName(); ?>
                    </div>
                    <div class="col-md-4">
                        <?php $this->txtPorxSync->RenderWithName(); ?>
                    </div>
                </div>
