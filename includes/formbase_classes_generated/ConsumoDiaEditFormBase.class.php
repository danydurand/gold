 ...
 * of the ConsumoDia class.  It uses the code-generated
 * ConsumoDiaMetaControl class, which has meta-methods to help with
 * easily creating/defining controls to modify the fields of a ConsumoDia columns.
 *
 * Any display customizations and presentation-tier logic can be implemented
 * here by overriding existing or implementing new methods, properties and variables.
 * 
 * NOTE: This file is overwritten on any code regenerations.  If you want to make
 * permanent changes, it is STRONGLY RECOMMENDED to move both consumo_dia_edit.php AND
 * consumo_dia_edit.tpl.php out of this Form Drafts directory.
 *
 * @package My QCubed Application
 * @subpackage FormBaseObjects
 */
abstract class ConsumoDiaEditFormBase extends QForm {
	// Local instance of the ConsumoDiaMetaControl
	/**
	 * @var ConsumoDiaMetaControlGen mctConsumoDia
	 */
	protected $mctConsumoDia;
	...
	// Controls for ConsumoDia's Data Fields
	protected $lblId;
	...
	protected function Form_Create() {
        ...
        // Use the CreateFromPathInfo shortcut (this can also be done manually using the ConsumoDiaMetaControl constructor)
        // MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
        $this->mctConsumoDia = ConsumoDiaMetaControl::CreateFromPathInfo($this);
		...
		// Call MetaControl's methods to create qcontrols based on ConsumoDia's data fields
		$this->lblId = $this->mctConsumoDia->lblId_Create();
		$this->lstCliente = $this->mctConsumoDia->lstCliente_Create();
		$this->calFecha = $this->mctConsumoDia->calFecha_Create();
		$this->txtCantidadGuias = $this->mctConsumoDia->txtCantidadGuias_Create();
		$this->txtCantidadKilos = $this->mctConsumoDia->txtCantidadKilos_Create();
		$this->txtTotalFacturado = $this->mctConsumoDia->txtTotalFacturado_Create();
		$this->calCreatedAt = $this->mctConsumoDia->calCreatedAt_Create();
		$this->calUpdatedAt = $this->mctConsumoDia->calUpdatedAt_Create();
    ...
    protected function determinarPosicion() {
        if ($this->mctConsumoDia->ConsumoDia && !isset($_SESSION['DataConsumoDia'])) {
            $_SESSION['DataConsumoDia'] = serialize(array($this->mctConsumoDia->ConsumoDia));
        }
        $this->arrDataTabl = unserialize($_SESSION['DataConsumoDia']);
        ...
        foreach ($this->arrDataTabl as $objTable) {
            if ($objTable->Id == $this->mctConsumoDia->ConsumoDia->Id) {
	...
	protected function lblTituForm_Create() {
        ...
        $this->lblTituForm->Text = 'ConsumoDia';
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctConsumoDia->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('ConsumoDia'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctConsumoDia->EditMode;
	}
    ...
    protected function btnLogxCamb_Create() {
        ...
        $this->btnLogxCamb->Visible = Log::CountByTablaRef('ConsumoDia',$this->mctConsumoDia->ConsumoDia->Id);
    }
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctConsumoDia->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctConsumoDia->EditMode;
    }
...
/**
	...
	protected function Form_Validate() {
		...
		// Check for records that may violate Unique Clauses
			if (($objConsumoDia = ConsumoDia::LoadByClienteIdFecha($this->lstCliente->SelectedValue,$this->calFecha->DateTime)) && ($objConsumoDia->Id != $this->mctConsumoDia->ConsumoDia->Id )){
				$blnToReturn = false;
    ...
    protected function btnProxRegi_Click() {
        ...
        QApplication::Redirect(__SIST__.'/consumo_dia_edit.php/'.$objRegiTabl->Id);
    }
    ...
    protected function verificarNavegacion() {
        if ($this->mctConsumoDia->EditMode) {
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the ConsumoDiaMetaControl
		$this->mctConsumoDia->SaveConsumoDia();
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		//----------------------------------------
		$blnTodoOkey = true;
		$arrTablRela = $this->mctConsumoDia->TablasRelacionadasConsumoDia();
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the ConsumoDiaMetaControl
			$this->mctConsumoDia->DeleteConsumoDia();
			$this->RedirectToListPage();
		}
	}

    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctConsumoDia->ConsumoDia->Id;
        $_SESSION['TablRefe'] = 'ConsumoDia';
        $_SESSION['RegiReto'] = 'consumo_dia_edit.php/'.$this->mctConsumoDia->ConsumoDia->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/consumo_dia_list.php');
    }

    protected function btnNuevRegi_Click() {
        QApplication::Redirect(__SIST__.'/consumo_dia_edit.php');
    }
