<?php
	 ...
	 */
	abstract class ClientesRetailListFormBase extends QForm {
		...
		// Local instance of the Meta DataGrid to list ClientesRetails
		/**
		 * @var ClientesRetailDataGrid dtgClientesRetails
		 */
		protected $dtgClientesRetails;
		...
		protected function lblTituForm_Create() {
			...
			$this->lblTituForm->Text = 'ClientesRetails';
		}
        ...
        protected function btnExpoExce_Create() {
            $this->btnExpoExce = new QDataGridExporterButton($this, $this->dtgClientesRetails);
        ...
        protected function btnFiltAvan_Click() {
            $this->dtgClientesRetails->ShowFilter = !$this->dtgClientesRetails->ShowFilter;
        }
