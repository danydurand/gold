 ...
 * of the GuiaConceptosOpcionales class.  It uses the code-generated
 * GuiaConceptosOpcionalesMetaControl class, which has meta-methods to help with
 * easily creating/defining controls to modify the fields of a GuiaConceptosOpcionales columns.
 *
 * Any display customizations and presentation-tier logic can be implemented
 * here by overriding existing or implementing new methods, properties and variables.
 * 
 * NOTE: This file is overwritten on any code regenerations.  If you want to make
 * permanent changes, it is STRONGLY RECOMMENDED to move both guia_conceptos_opcionales_edit.php AND
 * guia_conceptos_opcionales_edit.tpl.php out of this Form Drafts directory.
 *
 * @package My QCubed Application
 * @subpackage FormBaseObjects
 */
abstract class GuiaConceptosOpcionalesEditFormBase extends QForm {
	// Local instance of the GuiaConceptosOpcionalesMetaControl
	/**
	 * @var GuiaConceptosOpcionalesMetaControlGen mctGuiaConceptosOpcionales
	 */
	protected $mctGuiaConceptosOpcionales;
	...
	// Controls for GuiaConceptosOpcionales's Data Fields
	protected $lblId;
	protected $lstGuia;
	...
	protected function Form_Create() {
        ...
        // Use the CreateFromPathInfo shortcut (this can also be done manually using the GuiaConceptosOpcionalesMetaControl constructor)
        // MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
        $this->mctGuiaConceptosOpcionales = GuiaConceptosOpcionalesMetaControl::CreateFromPathInfo($this);
		...
		// Call MetaControl's methods to create qcontrols based on GuiaConceptosOpcionales's data fields
		$this->lblId = $this->mctGuiaConceptosOpcionales->lblId_Create();
		$this->lstGuia = $this->mctGuiaConceptosOpcionales->lstGuia_Create();
		$this->lstConcepto = $this->mctGuiaConceptosOpcionales->lstConcepto_Create();
		$this->calCreatedAt = $this->mctGuiaConceptosOpcionales->calCreatedAt_Create();
		$this->calUpdatedAt = $this->mctGuiaConceptosOpcionales->calUpdatedAt_Create();
		$this->lstCreatedByObject = $this->mctGuiaConceptosOpcionales->lstCreatedByObject_Create();
		$this->lstUpdatedByObject = $this->mctGuiaConceptosOpcionales->lstUpdatedByObject_Create();
    ...
    protected function determinarPosicion() {
        if ($this->mctGuiaConceptosOpcionales->GuiaConceptosOpcionales && !isset($_SESSION['DataGuiaConceptosOpcionales'])) {
            $_SESSION['DataGuiaConceptosOpcionales'] = serialize(array($this->mctGuiaConceptosOpcionales->GuiaConceptosOpcionales));
        }
        $this->arrDataTabl = unserialize($_SESSION['DataGuiaConceptosOpcionales']);
        ...
        foreach ($this->arrDataTabl as $objTable) {
            if ($objTable->Id == $this->mctGuiaConceptosOpcionales->GuiaConceptosOpcionales->Id) {
	...
	protected function lblTituForm_Create() {
        ...
        $this->lblTituForm->Text = 'GuiaConceptosOpcionales';
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctGuiaConceptosOpcionales->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('GuiaConceptosOpcionales'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctGuiaConceptosOpcionales->EditMode;
	}
    ...
    protected function btnLogxCamb_Create() {
        ...
        $this->btnLogxCamb->Visible = Log::CountByTablaRef('GuiaConceptosOpcionales',$this->mctGuiaConceptosOpcionales->GuiaConceptosOpcionales->Id);
    }
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctGuiaConceptosOpcionales->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctGuiaConceptosOpcionales->EditMode;
    }
...
/**
	...
	protected function Form_Validate() {
		...
		// Check for records that may violate Unique Clauses
			if (($objGuiaConceptosOpcionales = GuiaConceptosOpcionales::LoadByGuiaIdConceptoId($this->lstGuia->SelectedValue,$this->lstConcepto->SelectedValue)) && ($objGuiaConceptosOpcionales->Id != $this->mctGuiaConceptosOpcionales->GuiaConceptosOpcionales->Id )){
				$blnToReturn = false;
				$this->lstGuia->Warning = QApplication::Translate("Already in Use");
				$this->lstConcepto->Warning = QApplication::Translate("Already in Use");
			}
    ...
    protected function btnProxRegi_Click() {
        ...
        QApplication::Redirect(__SIST__.'/guia_conceptos_opcionales_edit.php/'.$objRegiTabl->Id);
    }
    ...
    protected function verificarNavegacion() {
        if ($this->mctGuiaConceptosOpcionales->EditMode) {
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the GuiaConceptosOpcionalesMetaControl
		$this->mctGuiaConceptosOpcionales->SaveGuiaConceptosOpcionales();
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		//----------------------------------------
		$blnTodoOkey = true;
		$arrTablRela = $this->mctGuiaConceptosOpcionales->TablasRelacionadasGuiaConceptosOpcionales();
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the GuiaConceptosOpcionalesMetaControl
			$this->mctGuiaConceptosOpcionales->DeleteGuiaConceptosOpcionales();
			$this->RedirectToListPage();
		}
	}

    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctGuiaConceptosOpcionales->GuiaConceptosOpcionales->Id;
        $_SESSION['TablRefe'] = 'GuiaConceptosOpcionales';
        $_SESSION['RegiReto'] = 'guia_conceptos_opcionales_edit.php/'.$this->mctGuiaConceptosOpcionales->GuiaConceptosOpcionales->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/guia_conceptos_opcionales_list.php');
    }

    protected function btnNuevRegi_Click() {
        QApplication::Redirect(__SIST__.'/guia_conceptos_opcionales_edit.php');
    }
