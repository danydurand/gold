 ...
 * of the NotiConsecutivo class.  It uses the code-generated
 * NotiConsecutivoMetaControl class, which has meta-methods to help with
 * easily creating/defining controls to modify the fields of a NotiConsecutivo columns.
 *
 * Any display customizations and presentation-tier logic can be implemented
 * here by overriding existing or implementing new methods, properties and variables.
 * 
 * NOTE: This file is overwritten on any code regenerations.  If you want to make
 * permanent changes, it is STRONGLY RECOMMENDED to move both noti_consecutivo_edit.php AND
 * noti_consecutivo_edit.tpl.php out of this Form Drafts directory.
 *
 * @package My QCubed Application
 * @subpackage FormBaseObjects
 */
abstract class NotiConsecutivoEditFormBase extends QForm {
	// Local instance of the NotiConsecutivoMetaControl
	/**
	 * @var NotiConsecutivoMetaControlGen mctNotiConsecutivo
	 */
	protected $mctNotiConsecutivo;
	...
	// Controls for NotiConsecutivo's Data Fields
	protected $lblId;
	protected $txtNada;
	...
	protected function Form_Create() {
        ...
        // Use the CreateFromPathInfo shortcut (this can also be done manually using the NotiConsecutivoMetaControl constructor)
        // MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
        $this->mctNotiConsecutivo = NotiConsecutivoMetaControl::CreateFromPathInfo($this);
		...
		// Call MetaControl's methods to create qcontrols based on NotiConsecutivo's data fields
		$this->lblId = $this->mctNotiConsecutivo->lblId_Create();
		$this->txtNada = $this->mctNotiConsecutivo->txtNada_Create();
    ...
    protected function determinarPosicion() {
        if ($this->mctNotiConsecutivo->NotiConsecutivo && !isset($_SESSION['DataNotiConsecutivo'])) {
            $_SESSION['DataNotiConsecutivo'] = serialize(array($this->mctNotiConsecutivo->NotiConsecutivo));
        }
        $this->arrDataTabl = unserialize($_SESSION['DataNotiConsecutivo']);
        ...
        foreach ($this->arrDataTabl as $objTable) {
            if ($objTable->Id == $this->mctNotiConsecutivo->NotiConsecutivo->Id) {
	...
	protected function lblTituForm_Create() {
        ...
        $this->lblTituForm->Text = 'NotiConsecutivo';
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctNotiConsecutivo->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('NotiConsecutivo'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctNotiConsecutivo->EditMode;
	}
    ...
    protected function btnLogxCamb_Create() {
        ...
        $this->btnLogxCamb->Visible = Log::CountByTablaRef('NotiConsecutivo',$this->mctNotiConsecutivo->NotiConsecutivo->Id);
    }
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctNotiConsecutivo->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctNotiConsecutivo->EditMode;
    }
...
/**
    ...
    protected function btnProxRegi_Click() {
        ...
        QApplication::Redirect(__SIST__.'/noti_consecutivo_edit.php/'.$objRegiTabl->Id);
    }
    ...
    protected function verificarNavegacion() {
        if ($this->mctNotiConsecutivo->EditMode) {
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the NotiConsecutivoMetaControl
		$this->mctNotiConsecutivo->SaveNotiConsecutivo();
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		//----------------------------------------
		$blnTodoOkey = true;
		$arrTablRela = $this->mctNotiConsecutivo->TablasRelacionadasNotiConsecutivo();
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the NotiConsecutivoMetaControl
			$this->mctNotiConsecutivo->DeleteNotiConsecutivo();
			$this->RedirectToListPage();
		}
	}

    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctNotiConsecutivo->NotiConsecutivo->Id;
        $_SESSION['TablRefe'] = 'NotiConsecutivo';
        $_SESSION['RegiReto'] = 'noti_consecutivo_edit.php/'.$this->mctNotiConsecutivo->NotiConsecutivo->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/noti_consecutivo_list.php');
    }

    protected function btnNuevRegi_Click() {
        QApplication::Redirect(__SIST__.'/noti_consecutivo_edit.php');
    }
