 ...
 * of the FacturaConsecutivo class.  It uses the code-generated
 * FacturaConsecutivoMetaControl class, which has meta-methods to help with
 * easily creating/defining controls to modify the fields of a FacturaConsecutivo columns.
 *
 * Any display customizations and presentation-tier logic can be implemented
 * here by overriding existing or implementing new methods, properties and variables.
 * 
 * NOTE: This file is overwritten on any code regenerations.  If you want to make
 * permanent changes, it is STRONGLY RECOMMENDED to move both factura_consecutivo_edit.php AND
 * factura_consecutivo_edit.tpl.php out of this Form Drafts directory.
 *
 * @package My QCubed Application
 * @subpackage FormBaseObjects
 */
abstract class FacturaConsecutivoEditFormBase extends QForm {
	// Local instance of the FacturaConsecutivoMetaControl
	/**
	 * @var FacturaConsecutivoMetaControlGen mctFacturaConsecutivo
	 */
	protected $mctFacturaConsecutivo;
	...
	// Controls for FacturaConsecutivo's Data Fields
	protected $lblId;
	protected $txtNada;
	...
	protected function Form_Create() {
        ...
        // Use the CreateFromPathInfo shortcut (this can also be done manually using the FacturaConsecutivoMetaControl constructor)
        // MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
        $this->mctFacturaConsecutivo = FacturaConsecutivoMetaControl::CreateFromPathInfo($this);
		...
		// Call MetaControl's methods to create qcontrols based on FacturaConsecutivo's data fields
		$this->lblId = $this->mctFacturaConsecutivo->lblId_Create();
		$this->txtNada = $this->mctFacturaConsecutivo->txtNada_Create();
    ...
    protected function determinarPosicion() {
        if ($this->mctFacturaConsecutivo->FacturaConsecutivo && !isset($_SESSION['DataFacturaConsecutivo'])) {
            $_SESSION['DataFacturaConsecutivo'] = serialize(array($this->mctFacturaConsecutivo->FacturaConsecutivo));
        }
        $this->arrDataTabl = unserialize($_SESSION['DataFacturaConsecutivo']);
        ...
        foreach ($this->arrDataTabl as $objTable) {
            if ($objTable->Id == $this->mctFacturaConsecutivo->FacturaConsecutivo->Id) {
	...
	protected function lblTituForm_Create() {
        ...
        $this->lblTituForm->Text = 'FacturaConsecutivo';
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctFacturaConsecutivo->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('FacturaConsecutivo'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctFacturaConsecutivo->EditMode;
	}
    ...
    protected function btnLogxCamb_Create() {
        ...
        $this->btnLogxCamb->Visible = Log::CountByTablaRef('FacturaConsecutivo',$this->mctFacturaConsecutivo->FacturaConsecutivo->Id);
    }
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctFacturaConsecutivo->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctFacturaConsecutivo->EditMode;
    }
...
/**
    ...
    protected function btnProxRegi_Click() {
        ...
        QApplication::Redirect(__SIST__.'/factura_consecutivo_edit.php/'.$objRegiTabl->Id);
    }
    ...
    protected function verificarNavegacion() {
        if ($this->mctFacturaConsecutivo->EditMode) {
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the FacturaConsecutivoMetaControl
		$this->mctFacturaConsecutivo->SaveFacturaConsecutivo();
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		//----------------------------------------
		$blnTodoOkey = true;
		$arrTablRela = $this->mctFacturaConsecutivo->TablasRelacionadasFacturaConsecutivo();
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the FacturaConsecutivoMetaControl
			$this->mctFacturaConsecutivo->DeleteFacturaConsecutivo();
			$this->RedirectToListPage();
		}
	}

    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctFacturaConsecutivo->FacturaConsecutivo->Id;
        $_SESSION['TablRefe'] = 'FacturaConsecutivo';
        $_SESSION['RegiReto'] = 'factura_consecutivo_edit.php/'.$this->mctFacturaConsecutivo->FacturaConsecutivo->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/factura_consecutivo_list.php');
    }

    protected function btnNuevRegi_Click() {
        QApplication::Redirect(__SIST__.'/factura_consecutivo_edit.php');
    }
