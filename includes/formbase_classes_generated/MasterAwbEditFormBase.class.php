 ...
 */
abstract class MasterAwbEditFormBase extends QForm {
	// Local instance of the MasterAwbMetaControl
	/**
	 * @var MasterAwbMetaControlGen mctMasterAwb
	 */
	protected $mctMasterAwb;
	...
	// Controls for MasterAwb's Data Fields
	protected $lblId;
	...
	protected function lblTituForm_Create() {
        ...
        $this->lblTituForm->Text = 'MasterAwb';
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctMasterAwb->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('MasterAwb'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctMasterAwb->EditMode;
	}
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctMasterAwb->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctMasterAwb->EditMode;
    }
...
/**
	...
	protected function Form_Validate() {
		...
		// Check for records that may violate Unique Clauses
			if (($objMasterAwb = MasterAwb::LoadByNumero($this->txtNumero->Text)) && ($objMasterAwb->Id != $this->mctMasterAwb->MasterAwb->Id )){
				$blnToReturn = false;
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the MasterAwbMetaControl
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the MasterAwbMetaControl
    ...
    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctMasterAwb->MasterAwb->Id;
        $_SESSION['TablRefe'] = 'MasterAwb';
        $_SESSION['RegiReto'] = 'master_awb_edit.php/'.$this->mctMasterAwb->MasterAwb->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/master_awb_list.php');
    }

    protected function btnNuevRegi_Click() {
        QApplication::Redirect(__SIST__.'/master_awb_edit.php');
    }
