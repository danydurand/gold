 ...
 * of the GuiaImprimir class.  It uses the code-generated
 * GuiaImprimirMetaControl class, which has meta-methods to help with
 * easily creating/defining controls to modify the fields of a GuiaImprimir columns.
 *
 * Any display customizations and presentation-tier logic can be implemented
 * here by overriding existing or implementing new methods, properties and variables.
 * 
 * NOTE: This file is overwritten on any code regenerations.  If you want to make
 * permanent changes, it is STRONGLY RECOMMENDED to move both guia_imprimir_edit.php AND
 * guia_imprimir_edit.tpl.php out of this Form Drafts directory.
 *
 * @package My QCubed Application
 * @subpackage FormBaseObjects
 */
abstract class GuiaImprimirEditFormBase extends QForm {
	// Local instance of the GuiaImprimirMetaControl
	/**
	 * @var GuiaImprimirMetaControlGen mctGuiaImprimir
	 */
	protected $mctGuiaImprimir;
	...
	// Controls for GuiaImprimir's Data Fields
	protected $lblId;
	protected $lstGuia;
	protected $txtIsImpresa;
	...
	protected function Form_Create() {
        ...
        // Use the CreateFromPathInfo shortcut (this can also be done manually using the GuiaImprimirMetaControl constructor)
        // MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
        $this->mctGuiaImprimir = GuiaImprimirMetaControl::CreateFromPathInfo($this);
		...
		// Call MetaControl's methods to create qcontrols based on GuiaImprimir's data fields
		$this->lblId = $this->mctGuiaImprimir->lblId_Create();
		$this->lstGuia = $this->mctGuiaImprimir->lstGuia_Create();
		$this->txtIsImpresa = $this->mctGuiaImprimir->txtIsImpresa_Create();
		$this->calCreatedAt = $this->mctGuiaImprimir->calCreatedAt_Create();
		$this->calUpdatedAt = $this->mctGuiaImprimir->calUpdatedAt_Create();
    ...
    protected function determinarPosicion() {
        if ($this->mctGuiaImprimir->GuiaImprimir && !isset($_SESSION['DataGuiaImprimir'])) {
            $_SESSION['DataGuiaImprimir'] = serialize(array($this->mctGuiaImprimir->GuiaImprimir));
        }
        $this->arrDataTabl = unserialize($_SESSION['DataGuiaImprimir']);
        ...
        foreach ($this->arrDataTabl as $objTable) {
            if ($objTable->Id == $this->mctGuiaImprimir->GuiaImprimir->Id) {
	...
	protected function lblTituForm_Create() {
        ...
        $this->lblTituForm->Text = 'GuiaImprimir';
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctGuiaImprimir->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('GuiaImprimir'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctGuiaImprimir->EditMode;
	}
    ...
    protected function btnLogxCamb_Create() {
        ...
        $this->btnLogxCamb->Visible = Log::CountByTablaRef('GuiaImprimir',$this->mctGuiaImprimir->GuiaImprimir->Id);
    }
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctGuiaImprimir->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctGuiaImprimir->EditMode;
    }
...
/**
	...
	protected function Form_Validate() {
		...
		// Check for records that may violate Unique Clauses
			if (($objGuiaImprimir = GuiaImprimir::LoadByGuiaId($this->lstGuia->SelectedValue)) && ($objGuiaImprimir->Id != $this->mctGuiaImprimir->GuiaImprimir->Id )){
				$blnToReturn = false;
    ...
    protected function btnProxRegi_Click() {
        ...
        QApplication::Redirect(__SIST__.'/guia_imprimir_edit.php/'.$objRegiTabl->Id);
    }
    ...
    protected function verificarNavegacion() {
        if ($this->mctGuiaImprimir->EditMode) {
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the GuiaImprimirMetaControl
		$this->mctGuiaImprimir->SaveGuiaImprimir();
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		//----------------------------------------
		$blnTodoOkey = true;
		$arrTablRela = $this->mctGuiaImprimir->TablasRelacionadasGuiaImprimir();
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the GuiaImprimirMetaControl
			$this->mctGuiaImprimir->DeleteGuiaImprimir();
			$this->RedirectToListPage();
		}
	}

    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctGuiaImprimir->GuiaImprimir->Id;
        $_SESSION['TablRefe'] = 'GuiaImprimir';
        $_SESSION['RegiReto'] = 'guia_imprimir_edit.php/'.$this->mctGuiaImprimir->GuiaImprimir->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/guia_imprimir_list.php');
    }

    protected function btnNuevRegi_Click() {
        QApplication::Redirect(__SIST__.'/guia_imprimir_edit.php');
    }
