 ...
 */
abstract class ConceptoRangosEditFormBase extends QForm {
	// Local instance of the ConceptoRangosMetaControl
	/**
	 * @var ConceptoRangosMetaControlGen mctConceptoRangos
	 */
	protected $mctConceptoRangos;
	...
	// Controls for ConceptoRangos's Data Fields
	protected $lblId;
	protected $lstConcepto;
	protected $txtRangoInicial;
	protected $txtRangoFinal;
	protected $txtValor;
	...
	protected function lblTituForm_Create() {
        ...
        $this->lblTituForm->Text = 'ConceptoRangos';
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctConceptoRangos->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('ConceptoRangos'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctConceptoRangos->EditMode;
	}
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctConceptoRangos->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctConceptoRangos->EditMode;
    }
...
/**
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the ConceptoRangosMetaControl
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the ConceptoRangosMetaControl
    ...
    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctConceptoRangos->ConceptoRangos->Id;
        $_SESSION['TablRefe'] = 'ConceptoRangos';
        $_SESSION['RegiReto'] = 'concepto_rangos_edit.php/'.$this->mctConceptoRangos->ConceptoRangos->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/concepto_rangos_list.php');
    }

    protected function btnNuevRegi_Click() {
        QApplication::Redirect(__SIST__.'/concepto_rangos_edit.php');
    }
