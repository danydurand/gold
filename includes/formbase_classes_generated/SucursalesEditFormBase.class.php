 ...
 */
abstract class SucursalesEditFormBase extends QForm {
	// Local instance of the SucursalesMetaControl
	/**
	 * @var SucursalesMetaControlGen mctSucursales
	 */
	protected $mctSucursales;
	...
	// Controls for Sucursales's Data Fields
	protected $lblId;
	protected $txtNombre;
	protected $txtIata;
	...
	protected $chkEsTienda;
	protected $txtEmailPrincipal;
	protected $txtEmailAlmacen;
	protected $txtZonaNc;
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctSucursales->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('Sucursales'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctSucursales->EditMode;
	}
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctSucursales->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctSucursales->EditMode;
    }
...
/**
	...
	protected function Form_Validate() {
		...
		// Check for records that may violate Unique Clauses
			if (($objSucursales = Sucursales::LoadByNombre($this->txtNombre->Text)) && ($objSucursales->Id != $this->mctSucursales->Sucursales->Id )){
				$blnToReturn = false;
				$this->txtNombre->Warning = QApplication::Translate("Already in Use");
			}
			if (($objSucursales = Sucursales::LoadByIata($this->txtIata->Text)) && ($objSucursales->Id != $this->mctSucursales->Sucursales->Id )){
				$blnToReturn = false;
				$this->txtIata->Warning = QApplication::Translate("Already in Use");
			}
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the SucursalesMetaControl
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the SucursalesMetaControl
    ...
    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctSucursales->Sucursales->Id;
        $_SESSION['TablRefe'] = 'Sucursales';
        $_SESSION['RegiReto'] = 'sucursales_edit.php/'.$this->mctSucursales->Sucursales->Id;
    ...
    protected function btnNuevRegi_Click() {
        QApplication::Redirect(__SIST__.'/sucursales_edit.php');
    }
