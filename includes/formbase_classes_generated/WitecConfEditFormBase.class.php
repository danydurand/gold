 ...
 * of the WitecConf class.  It uses the code-generated
 * WitecConfMetaControl class, which has meta-methods to help with
 * easily creating/defining controls to modify the fields of a WitecConf columns.
 *
 * Any display customizations and presentation-tier logic can be implemented
 * here by overriding existing or implementing new methods, properties and variables.
 * 
 * NOTE: This file is overwritten on any code regenerations.  If you want to make
 * permanent changes, it is STRONGLY RECOMMENDED to move both witec_conf_edit.php AND
 * witec_conf_edit.tpl.php out of this Form Drafts directory.
 *
 * @package My QCubed Application
 * @subpackage FormBaseObjects
 */
abstract class WitecConfEditFormBase extends QForm {
	// Local instance of the WitecConfMetaControl
	/**
	 * @var WitecConfMetaControlGen mctWitecConf
	 */
	protected $mctWitecConf;
	...
	protected function Form_Create() {
        ...
        // Use the CreateFromPathInfo shortcut (this can also be done manually using the WitecConfMetaControl constructor)
        // MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
        $this->mctWitecConf = WitecConfMetaControl::CreateFromPathInfo($this);
		...
		// Call MetaControl's methods to create qcontrols based on WitecConf's data fields
		$this->lblId = $this->mctWitecConf->lblId_Create();
		$this->lstGuia = $this->mctWitecConf->lstGuia_Create();
		$this->txtEntregadoA = $this->mctWitecConf->txtEntregadoA_Create();
		$this->calFechaEntrega = $this->mctWitecConf->calFechaEntrega_Create();
		$this->txtHoraEntrega = $this->mctWitecConf->txtHoraEntrega_Create();
		$this->txtConfirmado = $this->mctWitecConf->txtConfirmado_Create();
		$this->calCreatedAt = $this->mctWitecConf->calCreatedAt_Create();
		$this->calUpdatedAt = $this->mctWitecConf->calUpdatedAt_Create();
    ...
    protected function determinarPosicion() {
        if ($this->mctWitecConf->WitecConf && !isset($_SESSION['DataWitecConf'])) {
            $_SESSION['DataWitecConf'] = serialize(array($this->mctWitecConf->WitecConf));
        }
        $this->arrDataTabl = unserialize($_SESSION['DataWitecConf']);
        ...
        foreach ($this->arrDataTabl as $objTable) {
            if ($objTable->Id == $this->mctWitecConf->WitecConf->Id) {
	...
	protected function lblTituForm_Create() {
        ...
        $this->lblTituForm->Text = 'WitecConf';
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctWitecConf->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('WitecConf'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctWitecConf->EditMode;
	}
    ...
    protected function btnLogxCamb_Create() {
        ...
        $this->btnLogxCamb->Visible = Log::CountByTablaRef('WitecConf',$this->mctWitecConf->WitecConf->Id);
    }
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctWitecConf->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctWitecConf->EditMode;
    }
...
/**
	...
	protected function Form_Validate() {
		...
		// Check for records that may violate Unique Clauses
			if (($objWitecConf = WitecConf::LoadByGuiaId($this->lstGuia->SelectedValue)) && ($objWitecConf->Id != $this->mctWitecConf->WitecConf->Id )){
				$blnToReturn = false;
    ...
    protected function btnProxRegi_Click() {
        ...
        QApplication::Redirect(__SIST__.'/witec_conf_edit.php/'.$objRegiTabl->Id);
    }
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the WitecConfMetaControl
		$this->mctWitecConf->SaveWitecConf();
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		//----------------------------------------
		$blnTodoOkey = true;
		$arrTablRela = $this->mctWitecConf->TablasRelacionadasWitecConf();
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the WitecConfMetaControl
			$this->mctWitecConf->DeleteWitecConf();
			$this->RedirectToListPage();
		}
	}

    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctWitecConf->WitecConf->Id;
        $_SESSION['TablRefe'] = 'WitecConf';
        $_SESSION['RegiReto'] = 'witec_conf_edit.php/'.$this->mctWitecConf->WitecConf->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/witec_conf_list.php');
    }

    protected function btnNuevRegi_Click() {
        QApplication::Redirect(__SIST__.'/witec_conf_edit.php');
    }
