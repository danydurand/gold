 ...
 */
abstract class TarifaAgentesEditFormBase extends QForm {
	// Local instance of the TarifaAgentesMetaControl
	/**
	 * @var TarifaAgentesMetaControlGen mctTarifaAgentes
	 */
	protected $mctTarifaAgentes;
	...
	protected function lblTituForm_Create() {
        ...
        $this->lblTituForm->Text = 'TarifaAgentes';
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctTarifaAgentes->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('TarifaAgentes'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctTarifaAgentes->EditMode;
	}
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctTarifaAgentes->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctTarifaAgentes->EditMode;
    }
...
/**
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the TarifaAgentesMetaControl
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the TarifaAgentesMetaControl
    ...
    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctTarifaAgentes->TarifaAgentes->Id;
        $_SESSION['TablRefe'] = 'TarifaAgentes';
        $_SESSION['RegiReto'] = 'tarifa_agentes_edit.php/'.$this->mctTarifaAgentes->TarifaAgentes->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/tarifa_agentes_list.php');
    }
