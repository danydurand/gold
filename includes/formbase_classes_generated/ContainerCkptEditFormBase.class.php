 ...
 * ContainerCkptMetaControl class, which has meta-methods to help with
 * easily creating/defining controls to modify the fields of a ContainerCkpt columns.
 *
 * Any display customizations and presentation-tier logic can be implemented
 * here by overriding existing or implementing new methods, properties and variables.
 * 
 * NOTE: This file is overwritten on any code regenerations.  If you want to make
 * permanent changes, it is STRONGLY RECOMMENDED to move both container_ckpt_edit.php AND
 * container_ckpt_edit.tpl.php out of this Form Drafts directory.
 *
 * @package My QCubed Application
 * @subpackage FormBaseObjects
 */
abstract class ContainerCkptEditFormBase extends QForm {
	// Local instance of the ContainerCkptMetaControl
	/**
	 * @var ContainerCkptMetaControlGen mctContainerCkpt
	 */
	protected $mctContainerCkpt;
	...
	// Controls for ContainerCkpt's Data Fields
	protected $lblId;
	...
	protected function Form_Create() {
        ...
        // Use the CreateFromPathInfo shortcut (this can also be done manually using the ContainerCkptMetaControl constructor)
        // MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
        $this->mctContainerCkpt = ContainerCkptMetaControl::CreateFromPathInfo($this);
		...
		// Call MetaControl's methods to create qcontrols based on ContainerCkpt's data fields
		$this->lblId = $this->mctContainerCkpt->lblId_Create();
		$this->lstContainer = $this->mctContainerCkpt->lstContainer_Create();
		$this->lstCheckpoint = $this->mctContainerCkpt->lstCheckpoint_Create();
		$this->lstSucursal = $this->mctContainerCkpt->lstSucursal_Create();
		$this->calFecha = $this->mctContainerCkpt->calFecha_Create();
    ...
    protected function determinarPosicion() {
        if ($this->mctContainerCkpt->ContainerCkpt && !isset($_SESSION['DataContainerCkpt'])) {
            $_SESSION['DataContainerCkpt'] = serialize(array($this->mctContainerCkpt->ContainerCkpt));
        }
        $this->arrDataTabl = unserialize($_SESSION['DataContainerCkpt']);
        ...
        foreach ($this->arrDataTabl as $objTable) {
            if ($objTable->Id == $this->mctContainerCkpt->ContainerCkpt->Id) {
	...
	protected function lblTituForm_Create() {
        ...
        $this->lblTituForm->Text = 'ContainerCkpt';
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctContainerCkpt->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('ContainerCkpt'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctContainerCkpt->EditMode;
	}
    ...
    protected function btnLogxCamb_Create() {
        ...
        $this->btnLogxCamb->Visible = Log::CountByTablaRef('ContainerCkpt',$this->mctContainerCkpt->ContainerCkpt->Id);
    }
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctContainerCkpt->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctContainerCkpt->EditMode;
    }
...
/**
    ...
    protected function btnProxRegi_Click() {
        ...
        QApplication::Redirect(__SIST__.'/container_ckpt_edit.php/'.$objRegiTabl->Id);
    }
    ...
    protected function verificarNavegacion() {
        if ($this->mctContainerCkpt->EditMode) {
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the ContainerCkptMetaControl
		$this->mctContainerCkpt->SaveContainerCkpt();
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		//----------------------------------------
		$blnTodoOkey = true;
		$arrTablRela = $this->mctContainerCkpt->TablasRelacionadasContainerCkpt();
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the ContainerCkptMetaControl
			$this->mctContainerCkpt->DeleteContainerCkpt();
			$this->RedirectToListPage();
		}
	}

    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctContainerCkpt->ContainerCkpt->Id;
        $_SESSION['TablRefe'] = 'ContainerCkpt';
        $_SESSION['RegiReto'] = 'container_ckpt_edit.php/'.$this->mctContainerCkpt->ContainerCkpt->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/container_ckpt_list.php');
    }
