 ...
 * of the ManifiestoExpCkpt class.  It uses the code-generated
 * ManifiestoExpCkptMetaControl class, which has meta-methods to help with
 * easily creating/defining controls to modify the fields of a ManifiestoExpCkpt columns.
 *
 * Any display customizations and presentation-tier logic can be implemented
 * here by overriding existing or implementing new methods, properties and variables.
 * 
 * NOTE: This file is overwritten on any code regenerations.  If you want to make
 * permanent changes, it is STRONGLY RECOMMENDED to move both manifiesto_exp_ckpt_edit.php AND
 * manifiesto_exp_ckpt_edit.tpl.php out of this Form Drafts directory.
 *
 * @package My QCubed Application
 * @subpackage FormBaseObjects
 */
abstract class ManifiestoExpCkptEditFormBase extends QForm {
	// Local instance of the ManifiestoExpCkptMetaControl
	/**
	 * @var ManifiestoExpCkptMetaControlGen mctManifiestoExpCkpt
	 */
	protected $mctManifiestoExpCkpt;
	...
	// Controls for ManifiestoExpCkpt's Data Fields
	protected $lblId;
	protected $lstManifiestoExp;
	...
	protected function Form_Create() {
        ...
        // Use the CreateFromPathInfo shortcut (this can also be done manually using the ManifiestoExpCkptMetaControl constructor)
        // MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
        $this->mctManifiestoExpCkpt = ManifiestoExpCkptMetaControl::CreateFromPathInfo($this);
		...
		// Call MetaControl's methods to create qcontrols based on ManifiestoExpCkpt's data fields
		$this->lblId = $this->mctManifiestoExpCkpt->lblId_Create();
		$this->lstManifiestoExp = $this->mctManifiestoExpCkpt->lstManifiestoExp_Create();
		$this->lstCheckpoint = $this->mctManifiestoExpCkpt->lstCheckpoint_Create();
		$this->lstSucursal = $this->mctManifiestoExpCkpt->lstSucursal_Create();
		$this->calFecha = $this->mctManifiestoExpCkpt->calFecha_Create();
		$this->txtHora = $this->mctManifiestoExpCkpt->txtHora_Create();
		$this->calCreatedAt = $this->mctManifiestoExpCkpt->calCreatedAt_Create();
		$this->lstCreatedByObject = $this->mctManifiestoExpCkpt->lstCreatedByObject_Create();
		$this->txtObservacion = $this->mctManifiestoExpCkpt->txtObservacion_Create();
    ...
    protected function determinarPosicion() {
        if ($this->mctManifiestoExpCkpt->ManifiestoExpCkpt && !isset($_SESSION['DataManifiestoExpCkpt'])) {
            $_SESSION['DataManifiestoExpCkpt'] = serialize(array($this->mctManifiestoExpCkpt->ManifiestoExpCkpt));
        }
        $this->arrDataTabl = unserialize($_SESSION['DataManifiestoExpCkpt']);
        ...
        foreach ($this->arrDataTabl as $objTable) {
            if ($objTable->Id == $this->mctManifiestoExpCkpt->ManifiestoExpCkpt->Id) {
	...
	protected function lblTituForm_Create() {
        ...
        $this->lblTituForm->Text = 'ManifiestoExpCkpt';
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctManifiestoExpCkpt->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('ManifiestoExpCkpt'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctManifiestoExpCkpt->EditMode;
	}
    ...
    protected function btnLogxCamb_Create() {
        ...
        $this->btnLogxCamb->Visible = Log::CountByTablaRef('ManifiestoExpCkpt',$this->mctManifiestoExpCkpt->ManifiestoExpCkpt->Id);
    }
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctManifiestoExpCkpt->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctManifiestoExpCkpt->EditMode;
    }
...
/**
    ...
    protected function btnProxRegi_Click() {
        ...
        QApplication::Redirect(__SIST__.'/manifiesto_exp_ckpt_edit.php/'.$objRegiTabl->Id);
    }
    ...
    protected function verificarNavegacion() {
        if ($this->mctManifiestoExpCkpt->EditMode) {
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the ManifiestoExpCkptMetaControl
		$this->mctManifiestoExpCkpt->SaveManifiestoExpCkpt();
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		//----------------------------------------
		$blnTodoOkey = true;
		$arrTablRela = $this->mctManifiestoExpCkpt->TablasRelacionadasManifiestoExpCkpt();
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the ManifiestoExpCkptMetaControl
			$this->mctManifiestoExpCkpt->DeleteManifiestoExpCkpt();
			$this->RedirectToListPage();
		}
	}

    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctManifiestoExpCkpt->ManifiestoExpCkpt->Id;
        $_SESSION['TablRefe'] = 'ManifiestoExpCkpt';
        $_SESSION['RegiReto'] = 'manifiesto_exp_ckpt_edit.php/'.$this->mctManifiestoExpCkpt->ManifiestoExpCkpt->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/manifiesto_exp_ckpt_list.php');
    }

    protected function btnNuevRegi_Click() {
        QApplication::Redirect(__SIST__.'/manifiesto_exp_ckpt_edit.php');
    }
