 ...
 */
abstract class PagosCorpEditFormBase extends QForm {
	// Local instance of the PagosCorpMetaControl
	/**
	 * @var PagosCorpMetaControlGen mctPagosCorp
	 */
	protected $mctPagosCorp;
	...
	// Controls for PagosCorp's Data Fields
	protected $lblId;
	...
	protected $dtgFacturasesAsFacturaPagoCorp;
	...
	protected function lblTituForm_Create() {
        ...
        $this->lblTituForm->Text = 'PagosCorp';
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctPagosCorp->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('PagosCorp'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctPagosCorp->EditMode;
	}
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctPagosCorp->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctPagosCorp->EditMode;
    }
...
/**
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the PagosCorpMetaControl
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the PagosCorpMetaControl
    ...
    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctPagosCorp->PagosCorp->Id;
        $_SESSION['TablRefe'] = 'PagosCorp';
        $_SESSION['RegiReto'] = 'pagos_corp_edit.php/'.$this->mctPagosCorp->PagosCorp->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/pagos_corp_list.php');
    }
