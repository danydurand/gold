 ...
 * of the PiezaCheckpoints class.  It uses the code-generated
 * PiezaCheckpointsMetaControl class, which has meta-methods to help with
 * easily creating/defining controls to modify the fields of a PiezaCheckpoints columns.
 *
 * Any display customizations and presentation-tier logic can be implemented
 * here by overriding existing or implementing new methods, properties and variables.
 * 
 * NOTE: This file is overwritten on any code regenerations.  If you want to make
 * permanent changes, it is STRONGLY RECOMMENDED to move both pieza_checkpoints_edit.php AND
 * pieza_checkpoints_edit.tpl.php out of this Form Drafts directory.
 *
 * @package My QCubed Application
 * @subpackage FormBaseObjects
 */
abstract class PiezaCheckpointsEditFormBase extends QForm {
	// Local instance of the PiezaCheckpointsMetaControl
	/**
	 * @var PiezaCheckpointsMetaControlGen mctPiezaCheckpoints
	 */
	protected $mctPiezaCheckpoints;
	...
	// Controls for PiezaCheckpoints's Data Fields
	protected $lblId;
	protected $lstPieza;
	...
	protected function Form_Create() {
        ...
        // Use the CreateFromPathInfo shortcut (this can also be done manually using the PiezaCheckpointsMetaControl constructor)
        // MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
        $this->mctPiezaCheckpoints = PiezaCheckpointsMetaControl::CreateFromPathInfo($this);
		...
		// Call MetaControl's methods to create qcontrols based on PiezaCheckpoints's data fields
		$this->lblId = $this->mctPiezaCheckpoints->lblId_Create();
		$this->lstPieza = $this->mctPiezaCheckpoints->lstPieza_Create();
		$this->lstCheckpoint = $this->mctPiezaCheckpoints->lstCheckpoint_Create();
		$this->lstSucursal = $this->mctPiezaCheckpoints->lstSucursal_Create();
		$this->calFecha = $this->mctPiezaCheckpoints->calFecha_Create();
    ...
    protected function determinarPosicion() {
        if ($this->mctPiezaCheckpoints->PiezaCheckpoints && !isset($_SESSION['DataPiezaCheckpoints'])) {
            $_SESSION['DataPiezaCheckpoints'] = serialize(array($this->mctPiezaCheckpoints->PiezaCheckpoints));
        }
        $this->arrDataTabl = unserialize($_SESSION['DataPiezaCheckpoints']);
        ...
        foreach ($this->arrDataTabl as $objTable) {
            if ($objTable->Id == $this->mctPiezaCheckpoints->PiezaCheckpoints->Id) {
	...
	protected function lblTituForm_Create() {
        ...
        $this->lblTituForm->Text = 'PiezaCheckpoints';
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctPiezaCheckpoints->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('PiezaCheckpoints'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctPiezaCheckpoints->EditMode;
	}
    ...
    protected function btnLogxCamb_Create() {
        ...
        $this->btnLogxCamb->Visible = Log::CountByTablaRef('PiezaCheckpoints',$this->mctPiezaCheckpoints->PiezaCheckpoints->Id);
    }
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctPiezaCheckpoints->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctPiezaCheckpoints->EditMode;
    }
...
/**
    ...
    protected function btnProxRegi_Click() {
        ...
        QApplication::Redirect(__SIST__.'/pieza_checkpoints_edit.php/'.$objRegiTabl->Id);
    }
    ...
    protected function verificarNavegacion() {
        if ($this->mctPiezaCheckpoints->EditMode) {
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the PiezaCheckpointsMetaControl
		$this->mctPiezaCheckpoints->SavePiezaCheckpoints();
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		//----------------------------------------
		$blnTodoOkey = true;
		$arrTablRela = $this->mctPiezaCheckpoints->TablasRelacionadasPiezaCheckpoints();
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the PiezaCheckpointsMetaControl
			$this->mctPiezaCheckpoints->DeletePiezaCheckpoints();
			$this->RedirectToListPage();
		}
	}

    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctPiezaCheckpoints->PiezaCheckpoints->Id;
        $_SESSION['TablRefe'] = 'PiezaCheckpoints';
        $_SESSION['RegiReto'] = 'pieza_checkpoints_edit.php/'.$this->mctPiezaCheckpoints->PiezaCheckpoints->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/pieza_checkpoints_list.php');
    }

    protected function btnNuevRegi_Click() {
        QApplication::Redirect(__SIST__.'/pieza_checkpoints_edit.php');
    }
