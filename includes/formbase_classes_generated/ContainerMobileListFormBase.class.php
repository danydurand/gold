 ...
 */
abstract class ContainerMobileListFormBase extends QForm {
    ...
    // Local instance of the Meta DataGrid to list ContainerMobiles
    /**
     * @var ContainerMobileDataGrid dtgContainerMobiles
     */
    protected $dtgContainerMobiles;
    ...
    protected function Form_Create() {
        ...
        $this->dtgContainerMobiles->MetaAddColumn(QQN::ContainerMobile()->Container);
        $this->dtgContainerMobiles->MetaAddColumn('Abierto');
        $this->dtgContainerMobiles->MetaAddColumn('CantPiezas');
        $this->dtgContainerMobiles->MetaAddColumn('Pendientes');
        $this->dtgContainerMobiles->MetaAddColumn('Entregadas');
        $this->dtgContainerMobiles->MetaAddColumn('Devueltas');
        $this->dtgContainerMobiles->MetaAddColumn('SinGestionar');
        $this->dtgContainerMobiles->MetaAddColumn('CreatedAt');
        $this->dtgContainerMobiles->MetaAddColumn('UpdatedAt');
        $this->dtgContainerMobiles->MetaAddColumn(QQN::ContainerMobile()->CreatedByObject);
        $this->dtgContainerMobiles->MetaAddColumn(QQN::ContainerMobile()->UpdatedByObject);
    ...
    protected function lblTituForm_Create() {
        ...
        $this->lblTituForm->Text = 'ContainerMobiles';
    }
    ...
    protected function btnExpoExce_Create() {
        $this->btnExpoExce = new QDataGridExporterButton($this, $this->dtgContainerMobiles);
    ...
    protected function btnFiltAvan_Click() {
        $this->dtgContainerMobiles->ShowFilter = !$this->dtgContainerMobiles->ShowFilter;
    }
