 ...
 * ScanneoPiezasMetaControl class, which has meta-methods to help with
 * easily creating/defining controls to modify the fields of a ScanneoPiezas columns.
 *
 * Any display customizations and presentation-tier logic can be implemented
 * here by overriding existing or implementing new methods, properties and variables.
 * 
 * NOTE: This file is overwritten on any code regenerations.  If you want to make
 * permanent changes, it is STRONGLY RECOMMENDED to move both scanneo_piezas_edit.php AND
 * scanneo_piezas_edit.tpl.php out of this Form Drafts directory.
 *
 * @package My QCubed Application
 * @subpackage FormBaseObjects
 */
abstract class ScanneoPiezasEditFormBase extends QForm {
	// Local instance of the ScanneoPiezasMetaControl
	/**
	 * @var ScanneoPiezasMetaControlGen mctScanneoPiezas
	 */
	protected $mctScanneoPiezas;
	...
	// Controls for ScanneoPiezas's Data Fields
	protected $lblId;
	protected $lstScanneo;
	...
	protected function Form_Create() {
        ...
        // Use the CreateFromPathInfo shortcut (this can also be done manually using the ScanneoPiezasMetaControl constructor)
        // MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
        $this->mctScanneoPiezas = ScanneoPiezasMetaControl::CreateFromPathInfo($this);
		...
		// Call MetaControl's methods to create qcontrols based on ScanneoPiezas's data fields
		$this->lblId = $this->mctScanneoPiezas->lblId_Create();
		$this->lstScanneo = $this->mctScanneoPiezas->lstScanneo_Create();
		...
		$this->lstUpdatedByObject = $this->mctScanneoPiezas->lstUpdatedByObject_Create();
    ...
    protected function determinarPosicion() {
        if ($this->mctScanneoPiezas->ScanneoPiezas && !isset($_SESSION['DataScanneoPiezas'])) {
            $_SESSION['DataScanneoPiezas'] = serialize(array($this->mctScanneoPiezas->ScanneoPiezas));
        }
        $this->arrDataTabl = unserialize($_SESSION['DataScanneoPiezas']);
        ...
        foreach ($this->arrDataTabl as $objTable) {
            if ($objTable->Id == $this->mctScanneoPiezas->ScanneoPiezas->Id) {
	...
	protected function lblTituForm_Create() {
        ...
        $this->lblTituForm->Text = 'ScanneoPiezas';
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctScanneoPiezas->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('ScanneoPiezas'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctScanneoPiezas->EditMode;
	}
    ...
    protected function btnLogxCamb_Create() {
        ...
        $this->btnLogxCamb->Visible = Log::CountByTablaRef('ScanneoPiezas',$this->mctScanneoPiezas->ScanneoPiezas->Id);
    }
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctScanneoPiezas->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctScanneoPiezas->EditMode;
    }
...
/**
	...
	protected function Form_Validate() {
		...
		// Check for records that may violate Unique Clauses
			if (($objScanneoPiezas = ScanneoPiezas::LoadByScanneoIdIdPieza($this->lstScanneo->SelectedValue,$this->txtIdPieza->Text)) && ($objScanneoPiezas->Id != $this->mctScanneoPiezas->ScanneoPiezas->Id )){
				$blnToReturn = false;
				$this->lstScanneo->Warning = QApplication::Translate("Already in Use");
    ...
    protected function btnProxRegi_Click() {
        ...
        QApplication::Redirect(__SIST__.'/scanneo_piezas_edit.php/'.$objRegiTabl->Id);
    }
    ...
    protected function verificarNavegacion() {
        if ($this->mctScanneoPiezas->EditMode) {
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the ScanneoPiezasMetaControl
		$this->mctScanneoPiezas->SaveScanneoPiezas();
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		//----------------------------------------
		$blnTodoOkey = true;
		$arrTablRela = $this->mctScanneoPiezas->TablasRelacionadasScanneoPiezas();
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the ScanneoPiezasMetaControl
			$this->mctScanneoPiezas->DeleteScanneoPiezas();
			$this->RedirectToListPage();
		}
	}

    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctScanneoPiezas->ScanneoPiezas->Id;
        $_SESSION['TablRefe'] = 'ScanneoPiezas';
        $_SESSION['RegiReto'] = 'scanneo_piezas_edit.php/'.$this->mctScanneoPiezas->ScanneoPiezas->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/scanneo_piezas_list.php');
    }
