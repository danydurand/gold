<?php
	 ...
	 */
	abstract class CheckpointsListFormBase extends QForm {
		...
		// Local instance of the Meta DataGrid to list Checkpointses
		/**
		 * @var CheckpointsDataGrid dtgCheckpointses
		 */
		protected $dtgCheckpointses;
		...
		protected function lblTituForm_Create() {
			...
			$this->lblTituForm->Text = 'Checkpointses';
		}
        ...
        protected function btnExpoExce_Create() {
            $this->btnExpoExce = new QDataGridExporterButton($this, $this->dtgCheckpointses);
        ...
        protected function btnFiltAvan_Click() {
            $this->dtgCheckpointses->ShowFilter = !$this->dtgCheckpointses->ShowFilter;
        }
