 ...
 */
abstract class DivisasEditFormBase extends QForm {
	// Local instance of the DivisasMetaControl
	/**
	 * @var DivisasMetaControlGen mctDivisas
	 */
	protected $mctDivisas;
	...
	// Controls for Divisas's Data Fields
	protected $lblId;
	protected $txtCodigo;
	protected $txtNombre;
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctDivisas->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('Divisas'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctDivisas->EditMode;
	}
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctDivisas->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctDivisas->EditMode;
    }
...
/**
	...
	protected function Form_Validate() {
		...
		// Check for records that may violate Unique Clauses
			if (($objDivisas = Divisas::LoadByCodigo($this->txtCodigo->Text)) && ($objDivisas->Id != $this->mctDivisas->Divisas->Id )){
				$blnToReturn = false;
				$this->txtCodigo->Warning = QApplication::Translate("Already in Use");
			}
			if (($objDivisas = Divisas::LoadByNombre($this->txtNombre->Text)) && ($objDivisas->Id != $this->mctDivisas->Divisas->Id )){
				$blnToReturn = false;
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the DivisasMetaControl
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the DivisasMetaControl
    ...
    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctDivisas->Divisas->Id;
        $_SESSION['TablRefe'] = 'Divisas';
        $_SESSION['RegiReto'] = 'divisas_edit.php/'.$this->mctDivisas->Divisas->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/divisas_list.php');
    }

    protected function btnNuevRegi_Click() {
        QApplication::Redirect(__SIST__.'/divisas_edit.php');
    }
