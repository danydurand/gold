 ...
 * of the NotaCreditoItems class.  It uses the code-generated
 * NotaCreditoItemsMetaControl class, which has meta-methods to help with
 * easily creating/defining controls to modify the fields of a NotaCreditoItems columns.
 *
 * Any display customizations and presentation-tier logic can be implemented
 * here by overriding existing or implementing new methods, properties and variables.
 * 
 * NOTE: This file is overwritten on any code regenerations.  If you want to make
 * permanent changes, it is STRONGLY RECOMMENDED to move both nota_credito_items_edit.php AND
 * nota_credito_items_edit.tpl.php out of this Form Drafts directory.
 *
 * @package My QCubed Application
 * @subpackage FormBaseObjects
 */
abstract class NotaCreditoItemsEditFormBase extends QForm {
	// Local instance of the NotaCreditoItemsMetaControl
	/**
	 * @var NotaCreditoItemsMetaControlGen mctNotaCreditoItems
	 */
	protected $mctNotaCreditoItems;
	...
	// Controls for NotaCreditoItems's Data Fields
	protected $lblId;
	...
	protected function Form_Create() {
        ...
        // Use the CreateFromPathInfo shortcut (this can also be done manually using the NotaCreditoItemsMetaControl constructor)
        // MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
        $this->mctNotaCreditoItems = NotaCreditoItemsMetaControl::CreateFromPathInfo($this);
		...
		// Call MetaControl's methods to create qcontrols based on NotaCreditoItems's data fields
		$this->lblId = $this->mctNotaCreditoItems->lblId_Create();
		$this->lstNotaCredito = $this->mctNotaCreditoItems->lstNotaCredito_Create();
    ...
    protected function determinarPosicion() {
        if ($this->mctNotaCreditoItems->NotaCreditoItems && !isset($_SESSION['DataNotaCreditoItems'])) {
            $_SESSION['DataNotaCreditoItems'] = serialize(array($this->mctNotaCreditoItems->NotaCreditoItems));
        }
        $this->arrDataTabl = unserialize($_SESSION['DataNotaCreditoItems']);
        ...
        foreach ($this->arrDataTabl as $objTable) {
            if ($objTable->Id == $this->mctNotaCreditoItems->NotaCreditoItems->Id) {
	...
	protected function lblTituForm_Create() {
        ...
        $this->lblTituForm->Text = 'NotaCreditoItems';
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctNotaCreditoItems->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('NotaCreditoItems'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctNotaCreditoItems->EditMode;
	}
    ...
    protected function btnLogxCamb_Create() {
        ...
        $this->btnLogxCamb->Visible = Log::CountByTablaRef('NotaCreditoItems',$this->mctNotaCreditoItems->NotaCreditoItems->Id);
    }
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctNotaCreditoItems->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctNotaCreditoItems->EditMode;
    }
...
/**
	...
	protected function Form_Validate() {
		...
		// Check for records that may violate Unique Clauses
			if (($objNotaCreditoItems = NotaCreditoItems::LoadByNotaCreditoIdConceptoId($this->lstNotaCredito->SelectedValue,$this->lstConcepto->SelectedValue)) && ($objNotaCreditoItems->Id != $this->mctNotaCreditoItems->NotaCreditoItems->Id )){
				$blnToReturn = false;
				$this->lstNotaCredito->Warning = QApplication::Translate("Already in Use");
    ...
    protected function btnProxRegi_Click() {
        ...
        QApplication::Redirect(__SIST__.'/nota_credito_items_edit.php/'.$objRegiTabl->Id);
    }
    ...
    protected function verificarNavegacion() {
        if ($this->mctNotaCreditoItems->EditMode) {
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the NotaCreditoItemsMetaControl
		$this->mctNotaCreditoItems->SaveNotaCreditoItems();
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		//----------------------------------------
		$blnTodoOkey = true;
		$arrTablRela = $this->mctNotaCreditoItems->TablasRelacionadasNotaCreditoItems();
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the NotaCreditoItemsMetaControl
			$this->mctNotaCreditoItems->DeleteNotaCreditoItems();
			$this->RedirectToListPage();
		}
	}

    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctNotaCreditoItems->NotaCreditoItems->Id;
        $_SESSION['TablRefe'] = 'NotaCreditoItems';
        $_SESSION['RegiReto'] = 'nota_credito_items_edit.php/'.$this->mctNotaCreditoItems->NotaCreditoItems->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/nota_credito_items_list.php');
    }

    protected function btnNuevRegi_Click() {
        QApplication::Redirect(__SIST__.'/nota_credito_items_edit.php');
    }
