 ...
 */
abstract class TarifaAgentesZonasEditFormBase extends QForm {
	// Local instance of the TarifaAgentesZonasMetaControl
	/**
	 * @var TarifaAgentesZonasMetaControlGen mctTarifaAgentesZonas
	 */
	protected $mctTarifaAgentesZonas;
	...
	protected function lblTituForm_Create() {
        ...
        $this->lblTituForm->Text = 'TarifaAgentesZonas';
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctTarifaAgentesZonas->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('TarifaAgentesZonas'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctTarifaAgentesZonas->EditMode;
	}
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctTarifaAgentesZonas->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctTarifaAgentesZonas->EditMode;
    }
...
/**
	...
	protected function Form_Validate() {
		...
		// Check for records that may violate Unique Clauses
			if (($objTarifaAgentesZonas = TarifaAgentesZonas::LoadByTarifaIdZonaServicio($this->lstTarifa->SelectedValue,$this->txtZona->Text,$this->txtServicio->Text)) && ($objTarifaAgentesZonas->Id != $this->mctTarifaAgentesZonas->TarifaAgentesZonas->Id )){
				$blnToReturn = false;
				$this->lstTarifa->Warning = QApplication::Translate("Already in Use");
				$this->txtZona->Warning = QApplication::Translate("Already in Use");
				$this->txtServicio->Warning = QApplication::Translate("Already in Use");
			}
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the TarifaAgentesZonasMetaControl
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the TarifaAgentesZonasMetaControl
    ...
    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctTarifaAgentesZonas->TarifaAgentesZonas->Id;
        $_SESSION['TablRefe'] = 'TarifaAgentesZonas';
        $_SESSION['RegiReto'] = 'tarifa_agentes_zonas_edit.php/'.$this->mctTarifaAgentesZonas->TarifaAgentesZonas->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/tarifa_agentes_zonas_list.php');
    }

    protected function btnNuevRegi_Click() {
        QApplication::Redirect(__SIST__.'/tarifa_agentes_zonas_edit.php');
    }
