 ...
 */
abstract class FacturasListFormBase extends QForm {
    ...
    // Local instance of the Meta DataGrid to list Facturases
    /**
     * @var FacturasDataGrid dtgFacturases
     */
    protected $dtgFacturases;
    ...
    protected function lblTituForm_Create() {
        ...
        $this->lblTituForm->Text = 'Facturases';
    }
    ...
    protected function btnExpoExce_Create() {
        $this->btnExpoExce = new QDataGridExporterButton($this, $this->dtgFacturases);
    ...
    protected function btnFiltAvan_Click() {
        $this->dtgFacturases->ShowFilter = !$this->dtgFacturases->ShowFilter;
    }
