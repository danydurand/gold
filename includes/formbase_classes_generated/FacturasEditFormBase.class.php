 ...
 */
abstract class FacturasEditFormBase extends QForm {
	// Local instance of the FacturasMetaControl
	/**
	 * @var FacturasMetaControlGen mctFacturas
	 */
	protected $mctFacturas;
	...
	// Controls for Facturas's Data Fields
	protected $lblId;
	...
	protected $calFechaHoraAnulacion;
	...
	protected $dtgPagosCorpsAsFacturaPagoCorp;
	...
	protected function Form_Create() {
		...
		$this->lstAnuladaPorObject = $this->mctFacturas->lstAnuladaPorObject_Create();
		$this->txtMotivoAnulacion = $this->mctFacturas->txtMotivoAnulacion_Create();
		$this->calFechaHoraAnulacion = $this->mctFacturas->calFechaHoraAnulacion_Create();
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctFacturas->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('Facturas'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctFacturas->EditMode;
	}
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctFacturas->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctFacturas->EditMode;
    }
...
/**
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the FacturasMetaControl
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the FacturasMetaControl
    ...
    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctFacturas->Facturas->Id;
        $_SESSION['TablRefe'] = 'Facturas';
        $_SESSION['RegiReto'] = 'facturas_edit.php/'.$this->mctFacturas->Facturas->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/facturas_list.php');
    }

    protected function btnNuevRegi_Click() {
        QApplication::Redirect(__SIST__.'/facturas_edit.php');
    }
