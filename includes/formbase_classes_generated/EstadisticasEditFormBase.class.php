 ...
 * of the Estadisticas class.  It uses the code-generated
 * EstadisticasMetaControl class, which has meta-methods to help with
 * easily creating/defining controls to modify the fields of a Estadisticas columns.
 *
 * Any display customizations and presentation-tier logic can be implemented
 * here by overriding existing or implementing new methods, properties and variables.
 * 
 * NOTE: This file is overwritten on any code regenerations.  If you want to make
 * permanent changes, it is STRONGLY RECOMMENDED to move both estadisticas_edit.php AND
 * estadisticas_edit.tpl.php out of this Form Drafts directory.
 *
 * @package My QCubed Application
 * @subpackage FormBaseObjects
 */
abstract class EstadisticasEditFormBase extends QForm {
	// Local instance of the EstadisticasMetaControl
	/**
	 * @var EstadisticasMetaControlGen mctEstadisticas
	 */
	protected $mctEstadisticas;
	...
	// Controls for Estadisticas's Data Fields
	protected $lblId;
	...
	protected function Form_Create() {
        ...
        // Use the CreateFromPathInfo shortcut (this can also be done manually using the EstadisticasMetaControl constructor)
        // MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
        $this->mctEstadisticas = EstadisticasMetaControl::CreateFromPathInfo($this);
		...
		// Call MetaControl's methods to create qcontrols based on Estadisticas's data fields
		$this->lblId = $this->mctEstadisticas->lblId_Create();
		$this->lstSucursal = $this->mctEstadisticas->lstSucursal_Create();
		$this->calFecha = $this->mctEstadisticas->calFecha_Create();
		$this->txtMedicion = $this->mctEstadisticas->txtMedicion_Create();
		$this->txtCifra = $this->mctEstadisticas->txtCifra_Create();
		$this->calCreatedAt = $this->mctEstadisticas->calCreatedAt_Create();
		$this->calUpdatedAt = $this->mctEstadisticas->calUpdatedAt_Create();
    ...
    protected function determinarPosicion() {
        if ($this->mctEstadisticas->Estadisticas && !isset($_SESSION['DataEstadisticas'])) {
            $_SESSION['DataEstadisticas'] = serialize(array($this->mctEstadisticas->Estadisticas));
        }
        $this->arrDataTabl = unserialize($_SESSION['DataEstadisticas']);
        ...
        foreach ($this->arrDataTabl as $objTable) {
            if ($objTable->Id == $this->mctEstadisticas->Estadisticas->Id) {
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctEstadisticas->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('Estadisticas'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctEstadisticas->EditMode;
	}
    ...
    protected function btnLogxCamb_Create() {
        ...
        $this->btnLogxCamb->Visible = Log::CountByTablaRef('Estadisticas',$this->mctEstadisticas->Estadisticas->Id);
    }
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctEstadisticas->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctEstadisticas->EditMode;
    }
...
/**
	...
	protected function Form_Validate() {
		...
		// Check for records that may violate Unique Clauses
			if (($objEstadisticas = Estadisticas::LoadBySucursalIdFechaMedicion($this->lstSucursal->SelectedValue,$this->calFecha->DateTime,$this->txtMedicion->Text)) && ($objEstadisticas->Id != $this->mctEstadisticas->Estadisticas->Id )){
				$blnToReturn = false;
				$this->lstSucursal->Warning = QApplication::Translate("Already in Use");
				$this->calFecha->Warning = QApplication::Translate("Already in Use");
				$this->txtMedicion->Warning = QApplication::Translate("Already in Use");
			}
    ...
    protected function btnProxRegi_Click() {
        ...
        QApplication::Redirect(__SIST__.'/estadisticas_edit.php/'.$objRegiTabl->Id);
    }
    ...
    protected function verificarNavegacion() {
        if ($this->mctEstadisticas->EditMode) {
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the EstadisticasMetaControl
		$this->mctEstadisticas->SaveEstadisticas();
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		//----------------------------------------
		$blnTodoOkey = true;
		$arrTablRela = $this->mctEstadisticas->TablasRelacionadasEstadisticas();
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the EstadisticasMetaControl
			$this->mctEstadisticas->DeleteEstadisticas();
			$this->RedirectToListPage();
		}
	}

    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctEstadisticas->Estadisticas->Id;
        $_SESSION['TablRefe'] = 'Estadisticas';
        $_SESSION['RegiReto'] = 'estadisticas_edit.php/'.$this->mctEstadisticas->Estadisticas->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/estadisticas_list.php');
    }

    protected function btnNuevRegi_Click() {
        QApplication::Redirect(__SIST__.'/estadisticas_edit.php');
    }
