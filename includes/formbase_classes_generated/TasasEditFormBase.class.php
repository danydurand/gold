 ...
 * of the Tasas class.  It uses the code-generated
 * TasasMetaControl class, which has meta-methods to help with
 * easily creating/defining controls to modify the fields of a Tasas columns.
 *
 * Any display customizations and presentation-tier logic can be implemented
 * here by overriding existing or implementing new methods, properties and variables.
 * 
 * NOTE: This file is overwritten on any code regenerations.  If you want to make
 * permanent changes, it is STRONGLY RECOMMENDED to move both tasas_edit.php AND
 * tasas_edit.tpl.php out of this Form Drafts directory.
 *
 * @package My QCubed Application
 * @subpackage FormBaseObjects
 */
abstract class TasasEditFormBase extends QForm {
	// Local instance of the TasasMetaControl
	/**
	 * @var TasasMetaControlGen mctTasas
	 */
	protected $mctTasas;
	...
	// Controls for Tasas's Data Fields
	protected $lblId;
	protected $lstDivisa;
	protected $txtTasa;
	...
	protected function Form_Create() {
        ...
        // Use the CreateFromPathInfo shortcut (this can also be done manually using the TasasMetaControl constructor)
        // MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
        $this->mctTasas = TasasMetaControl::CreateFromPathInfo($this);
		...
		// Call MetaControl's methods to create qcontrols based on Tasas's data fields
		...
		$this->txtDeletedBy = $this->mctTasas->txtDeletedBy_Create();
    ...
    protected function determinarPosicion() {
        if ($this->mctTasas->Tasas && !isset($_SESSION['DataTasas'])) {
            $_SESSION['DataTasas'] = serialize(array($this->mctTasas->Tasas));
        }
        $this->arrDataTabl = unserialize($_SESSION['DataTasas']);
        ...
        foreach ($this->arrDataTabl as $objTable) {
            if ($objTable->Id == $this->mctTasas->Tasas->Id) {
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctTasas->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('Tasas'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctTasas->EditMode;
	}
    ...
    protected function btnLogxCamb_Create() {
        ...
        $this->btnLogxCamb->Visible = Log::CountByTablaRef('Tasas',$this->mctTasas->Tasas->Id);
    }
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctTasas->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctTasas->EditMode;
    }
...
/**
    ...
    protected function btnProxRegi_Click() {
        ...
        QApplication::Redirect(__SIST__.'/tasas_edit.php/'.$objRegiTabl->Id);
    }
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the TasasMetaControl
		$this->mctTasas->SaveTasas();
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		//----------------------------------------
		$blnTodoOkey = true;
		$arrTablRela = $this->mctTasas->TablasRelacionadasTasas();
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the TasasMetaControl
			$this->mctTasas->DeleteTasas();
			$this->RedirectToListPage();
		}
	}

    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctTasas->Tasas->Id;
        $_SESSION['TablRefe'] = 'Tasas';
        $_SESSION['RegiReto'] = 'tasas_edit.php/'.$this->mctTasas->Tasas->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/tasas_list.php');
    }

    protected function btnNuevRegi_Click() {
        QApplication::Redirect(__SIST__.'/tasas_edit.php');
    }
