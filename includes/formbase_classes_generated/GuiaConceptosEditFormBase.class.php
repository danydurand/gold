 ...
 * of the GuiaConceptos class.  It uses the code-generated
 * GuiaConceptosMetaControl class, which has meta-methods to help with
 * easily creating/defining controls to modify the fields of a GuiaConceptos columns.
 *
 * Any display customizations and presentation-tier logic can be implemented
 * here by overriding existing or implementing new methods, properties and variables.
 * 
 * NOTE: This file is overwritten on any code regenerations.  If you want to make
 * permanent changes, it is STRONGLY RECOMMENDED to move both guia_conceptos_edit.php AND
 * guia_conceptos_edit.tpl.php out of this Form Drafts directory.
 *
 * @package My QCubed Application
 * @subpackage FormBaseObjects
 */
abstract class GuiaConceptosEditFormBase extends QForm {
	// Local instance of the GuiaConceptosMetaControl
	/**
	 * @var GuiaConceptosMetaControlGen mctGuiaConceptos
	 */
	protected $mctGuiaConceptos;
	...
	// Controls for GuiaConceptos's Data Fields
	protected $lblId;
	protected $lstGuia;
	...
	protected function Form_Create() {
        ...
        // Use the CreateFromPathInfo shortcut (this can also be done manually using the GuiaConceptosMetaControl constructor)
        // MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
        $this->mctGuiaConceptos = GuiaConceptosMetaControl::CreateFromPathInfo($this);
		...
		// Call MetaControl's methods to create qcontrols based on GuiaConceptos's data fields
		$this->lblId = $this->mctGuiaConceptos->lblId_Create();
		$this->lstGuia = $this->mctGuiaConceptos->lstGuia_Create();
		$this->lstConcepto = $this->mctGuiaConceptos->lstConcepto_Create();
		$this->txtTipo = $this->mctGuiaConceptos->txtTipo_Create();
		$this->txtValor = $this->mctGuiaConceptos->txtValor_Create();
		...
		$this->txtDeletedBy = $this->mctGuiaConceptos->txtDeletedBy_Create();
    ...
    protected function determinarPosicion() {
        if ($this->mctGuiaConceptos->GuiaConceptos && !isset($_SESSION['DataGuiaConceptos'])) {
            $_SESSION['DataGuiaConceptos'] = serialize(array($this->mctGuiaConceptos->GuiaConceptos));
        }
        $this->arrDataTabl = unserialize($_SESSION['DataGuiaConceptos']);
        ...
        foreach ($this->arrDataTabl as $objTable) {
            if ($objTable->Id == $this->mctGuiaConceptos->GuiaConceptos->Id) {
	...
	protected function lblTituForm_Create() {
        ...
        $this->lblTituForm->Text = 'GuiaConceptos';
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctGuiaConceptos->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('GuiaConceptos'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctGuiaConceptos->EditMode;
	}
    ...
    protected function btnLogxCamb_Create() {
        ...
        $this->btnLogxCamb->Visible = Log::CountByTablaRef('GuiaConceptos',$this->mctGuiaConceptos->GuiaConceptos->Id);
    }
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctGuiaConceptos->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctGuiaConceptos->EditMode;
    }
...
/**
	...
	protected function Form_Validate() {
		...
		// Check for records that may violate Unique Clauses
			if (($objGuiaConceptos = GuiaConceptos::LoadByGuiaIdConceptoId($this->lstGuia->SelectedValue,$this->lstConcepto->SelectedValue)) && ($objGuiaConceptos->Id != $this->mctGuiaConceptos->GuiaConceptos->Id )){
				$blnToReturn = false;
    ...
    protected function btnProxRegi_Click() {
        ...
        QApplication::Redirect(__SIST__.'/guia_conceptos_edit.php/'.$objRegiTabl->Id);
    }
    ...
    protected function verificarNavegacion() {
        if ($this->mctGuiaConceptos->EditMode) {
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the GuiaConceptosMetaControl
		$this->mctGuiaConceptos->SaveGuiaConceptos();
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		//----------------------------------------
		$blnTodoOkey = true;
		$arrTablRela = $this->mctGuiaConceptos->TablasRelacionadasGuiaConceptos();
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the GuiaConceptosMetaControl
			$this->mctGuiaConceptos->DeleteGuiaConceptos();
			$this->RedirectToListPage();
		}
	}

    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctGuiaConceptos->GuiaConceptos->Id;
        $_SESSION['TablRefe'] = 'GuiaConceptos';
        $_SESSION['RegiReto'] = 'guia_conceptos_edit.php/'.$this->mctGuiaConceptos->GuiaConceptos->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/guia_conceptos_list.php');
    }

    protected function btnNuevRegi_Click() {
        QApplication::Redirect(__SIST__.'/guia_conceptos_edit.php');
    }
