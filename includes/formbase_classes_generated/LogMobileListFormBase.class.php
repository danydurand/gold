 ...
 */
abstract class LogMobileListFormBase extends QForm {
    ...
    // Local instance of the Meta DataGrid to list LogMobiles
    /**
     * @var LogMobileDataGrid dtgLogMobiles
     */
    protected $dtgLogMobiles;
    ...
    protected function lblTituForm_Create() {
        ...
        $this->lblTituForm->Text = 'LogMobiles';
    }
    ...
    protected function btnExpoExce_Create() {
        $this->btnExpoExce = new QDataGridExporterButton($this, $this->dtgLogMobiles);
    ...
    protected function btnFiltAvan_Click() {
        $this->dtgLogMobiles->ShowFilter = !$this->dtgLogMobiles->ShowFilter;
    }
