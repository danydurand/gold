 ...
 * GuiaPiezasMetaControl class, which has meta-methods to help with
 * easily creating/defining controls to modify the fields of a GuiaPiezas columns.
 *
 * Any display customizations and presentation-tier logic can be implemented
 * here by overriding existing or implementing new methods, properties and variables.
 * 
 * NOTE: This file is overwritten on any code regenerations.  If you want to make
 * permanent changes, it is STRONGLY RECOMMENDED to move both guia_piezas_edit.php AND
 * guia_piezas_edit.tpl.php out of this Form Drafts directory.
 *
 * @package My QCubed Application
 * @subpackage FormBaseObjects
 */
abstract class GuiaPiezasEditFormBase extends QForm {
	// Local instance of the GuiaPiezasMetaControl
	/**
	 * @var GuiaPiezasMetaControlGen mctGuiaPiezas
	 */
	protected $mctGuiaPiezas;
	...
	protected function Form_Create() {
        ...
        // Use the CreateFromPathInfo shortcut (this can also be done manually using the GuiaPiezasMetaControl constructor)
        // MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
        $this->mctGuiaPiezas = GuiaPiezasMetaControl::CreateFromPathInfo($this);
		...
		$this->txtLastCkptUserId = $this->mctGuiaPiezas->txtLastCkptUserId_Create();
		...
		$this->txtHojaEntrega = $this->mctGuiaPiezas->txtHojaEntrega_Create();
		$this->txtUbicacion = $this->mctGuiaPiezas->txtUbicacion_Create();
		$this->calCreatedAt = $this->mctGuiaPiezas->calCreatedAt_Create();
		$this->calUpdatedAt = $this->mctGuiaPiezas->calUpdatedAt_Create();
    ...
    protected function determinarPosicion() {
        if ($this->mctGuiaPiezas->GuiaPiezas && !isset($_SESSION['DataGuiaPiezas'])) {
            $_SESSION['DataGuiaPiezas'] = serialize(array($this->mctGuiaPiezas->GuiaPiezas));
        }
        $this->arrDataTabl = unserialize($_SESSION['DataGuiaPiezas']);
        ...
        foreach ($this->arrDataTabl as $objTable) {
            if ($objTable->Id == $this->mctGuiaPiezas->GuiaPiezas->Id) {
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctGuiaPiezas->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('GuiaPiezas'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctGuiaPiezas->EditMode;
	}
    ...
    protected function btnLogxCamb_Create() {
        ...
        $this->btnLogxCamb->Visible = Log::CountByTablaRef('GuiaPiezas',$this->mctGuiaPiezas->GuiaPiezas->Id);
    }
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctGuiaPiezas->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctGuiaPiezas->EditMode;
    }
...
/**
	...
	protected function Form_Validate() {
		...
		// Check for records that may violate Unique Clauses
			if (($objGuiaPiezas = GuiaPiezas::LoadByIdPieza($this->txtIdPieza->Text)) && ($objGuiaPiezas->Id != $this->mctGuiaPiezas->GuiaPiezas->Id )){
				$blnToReturn = false;
    ...
    protected function btnProxRegi_Click() {
        ...
        QApplication::Redirect(__SIST__.'/guia_piezas_edit.php/'.$objRegiTabl->Id);
    }
    ...
    protected function verificarNavegacion() {
        if ($this->mctGuiaPiezas->EditMode) {
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the GuiaPiezasMetaControl
		$this->mctGuiaPiezas->SaveGuiaPiezas();
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		//----------------------------------------
		$blnTodoOkey = true;
		$arrTablRela = $this->mctGuiaPiezas->TablasRelacionadasGuiaPiezas();
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the GuiaPiezasMetaControl
			$this->mctGuiaPiezas->DeleteGuiaPiezas();
			$this->RedirectToListPage();
		}
	}

    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctGuiaPiezas->GuiaPiezas->Id;
        $_SESSION['TablRefe'] = 'GuiaPiezas';
        $_SESSION['RegiReto'] = 'guia_piezas_edit.php/'.$this->mctGuiaPiezas->GuiaPiezas->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/guia_piezas_list.php');
    }
