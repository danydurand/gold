 ...
 * of the ConsumoMes class.  It uses the code-generated
 * ConsumoMesMetaControl class, which has meta-methods to help with
 * easily creating/defining controls to modify the fields of a ConsumoMes columns.
 *
 * Any display customizations and presentation-tier logic can be implemented
 * here by overriding existing or implementing new methods, properties and variables.
 * 
 * NOTE: This file is overwritten on any code regenerations.  If you want to make
 * permanent changes, it is STRONGLY RECOMMENDED to move both consumo_mes_edit.php AND
 * consumo_mes_edit.tpl.php out of this Form Drafts directory.
 *
 * @package My QCubed Application
 * @subpackage FormBaseObjects
 */
abstract class ConsumoMesEditFormBase extends QForm {
	// Local instance of the ConsumoMesMetaControl
	/**
	 * @var ConsumoMesMetaControlGen mctConsumoMes
	 */
	protected $mctConsumoMes;
	...
	// Controls for ConsumoMes's Data Fields
	protected $lblId;
	protected $lstCliente;
	protected $txtAnio;
	protected $txtMes;
	protected $txtCantidadGuias;
	protected $txtCantidadKilos;
	protected $txtTotalFacturado;
	...
	protected function Form_Create() {
        ...
        // Use the CreateFromPathInfo shortcut (this can also be done manually using the ConsumoMesMetaControl constructor)
        // MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
        $this->mctConsumoMes = ConsumoMesMetaControl::CreateFromPathInfo($this);
		...
		// Call MetaControl's methods to create qcontrols based on ConsumoMes's data fields
		$this->lblId = $this->mctConsumoMes->lblId_Create();
		$this->lstCliente = $this->mctConsumoMes->lstCliente_Create();
		$this->txtAnio = $this->mctConsumoMes->txtAnio_Create();
		$this->txtMes = $this->mctConsumoMes->txtMes_Create();
		$this->txtCantidadGuias = $this->mctConsumoMes->txtCantidadGuias_Create();
		$this->txtCantidadKilos = $this->mctConsumoMes->txtCantidadKilos_Create();
		$this->txtTotalFacturado = $this->mctConsumoMes->txtTotalFacturado_Create();
		$this->calCreatedAt = $this->mctConsumoMes->calCreatedAt_Create();
		$this->calUpdatedAt = $this->mctConsumoMes->calUpdatedAt_Create();
    ...
    protected function determinarPosicion() {
        if ($this->mctConsumoMes->ConsumoMes && !isset($_SESSION['DataConsumoMes'])) {
            $_SESSION['DataConsumoMes'] = serialize(array($this->mctConsumoMes->ConsumoMes));
        }
        $this->arrDataTabl = unserialize($_SESSION['DataConsumoMes']);
        ...
        foreach ($this->arrDataTabl as $objTable) {
            if ($objTable->Id == $this->mctConsumoMes->ConsumoMes->Id) {
	...
	protected function lblTituForm_Create() {
        ...
        $this->lblTituForm->Text = 'ConsumoMes';
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctConsumoMes->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('ConsumoMes'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctConsumoMes->EditMode;
	}
    ...
    protected function btnLogxCamb_Create() {
        ...
        $this->btnLogxCamb->Visible = Log::CountByTablaRef('ConsumoMes',$this->mctConsumoMes->ConsumoMes->Id);
    }
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctConsumoMes->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctConsumoMes->EditMode;
    }
...
/**
	...
	protected function Form_Validate() {
		...
		// Check for records that may violate Unique Clauses
			if (($objConsumoMes = ConsumoMes::LoadByClienteIdAnioMes($this->lstCliente->SelectedValue,$this->txtAnio->Text,$this->txtMes->Text)) && ($objConsumoMes->Id != $this->mctConsumoMes->ConsumoMes->Id )){
				$blnToReturn = false;
    ...
    protected function btnProxRegi_Click() {
        ...
        QApplication::Redirect(__SIST__.'/consumo_mes_edit.php/'.$objRegiTabl->Id);
    }
    ...
    protected function verificarNavegacion() {
        if ($this->mctConsumoMes->EditMode) {
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the ConsumoMesMetaControl
		$this->mctConsumoMes->SaveConsumoMes();
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		//----------------------------------------
		$blnTodoOkey = true;
		$arrTablRela = $this->mctConsumoMes->TablasRelacionadasConsumoMes();
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the ConsumoMesMetaControl
			$this->mctConsumoMes->DeleteConsumoMes();
			$this->RedirectToListPage();
		}
	}

    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctConsumoMes->ConsumoMes->Id;
        $_SESSION['TablRefe'] = 'ConsumoMes';
        $_SESSION['RegiReto'] = 'consumo_mes_edit.php/'.$this->mctConsumoMes->ConsumoMes->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/consumo_mes_list.php');
    }

    protected function btnNuevRegi_Click() {
        QApplication::Redirect(__SIST__.'/consumo_mes_edit.php');
    }
