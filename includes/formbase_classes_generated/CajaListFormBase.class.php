<?php
	...
	abstract class CajaListFormBase extends QForm {
		...
		protected function Form_Create() {
			...
			$this->dtgCajas->MetaAddColumn('CreatedAt');
			$this->dtgCajas->MetaAddColumn('UpdatedAt');
			$this->dtgCajas->MetaAddColumn('DeletedAt');
			$this->dtgCajas->MetaAddColumn('CreatedBy');
			$this->dtgCajas->MetaAddColumn('UpdatedBy');
			$this->dtgCajas->MetaAddColumn('DeletedBy');
