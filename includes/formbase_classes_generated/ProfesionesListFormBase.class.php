<?php
	 ...
	 */
	abstract class ProfesionesListFormBase extends QForm {
		...
		// Local instance of the Meta DataGrid to list Profesioneses
		/**
		 * @var ProfesionesDataGrid dtgProfesioneses
		 */
		protected $dtgProfesioneses;
		...
		protected function lblTituForm_Create() {
			...
			$this->lblTituForm->Text = 'Profesioneses';
		}
        ...
        protected function btnExpoExce_Create() {
            $this->btnExpoExce = new QDataGridExporterButton($this, $this->dtgProfesioneses);
        ...
        protected function btnFiltAvan_Click() {
            $this->dtgProfesioneses->ShowFilter = !$this->dtgProfesioneses->ShowFilter;
        }
