 ...
 */
abstract class RutasEditFormBase extends QForm {
	// Local instance of the RutasMetaControl
	/**
	 * @var RutasMetaControlGen mctRutas
	 */
	protected $mctRutas;
	...
	// Controls for Rutas's Data Fields
	protected $lblId;
	protected $txtCodigo;
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctRutas->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('Rutas'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctRutas->EditMode;
	}
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctRutas->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctRutas->EditMode;
    }
...
/**
	...
	protected function Form_Validate() {
		...
		// Check for records that may violate Unique Clauses
			if (($objRutas = Rutas::LoadByCodigo($this->txtCodigo->Text)) && ($objRutas->Id != $this->mctRutas->Rutas->Id )){
				$blnToReturn = false;
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the RutasMetaControl
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the RutasMetaControl
    ...
    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctRutas->Rutas->Id;
        $_SESSION['TablRefe'] = 'Rutas';
        $_SESSION['RegiReto'] = 'rutas_edit.php/'.$this->mctRutas->Rutas->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/rutas_list.php');
    }
