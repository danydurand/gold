 ...
 * of the Audits class.  It uses the code-generated
 * AuditsMetaControl class, which has meta-methods to help with
 * easily creating/defining controls to modify the fields of a Audits columns.
 *
 * Any display customizations and presentation-tier logic can be implemented
 * here by overriding existing or implementing new methods, properties and variables.
 * 
 * NOTE: This file is overwritten on any code regenerations.  If you want to make
 * permanent changes, it is STRONGLY RECOMMENDED to move both audits_edit.php AND
 * audits_edit.tpl.php out of this Form Drafts directory.
 *
 * @package My QCubed Application
 * @subpackage FormBaseObjects
 */
abstract class AuditsEditFormBase extends QForm {
	// Local instance of the AuditsMetaControl
	/**
	 * @var AuditsMetaControlGen mctAudits
	 */
	protected $mctAudits;
	...
	// Controls for Audits's Data Fields
	protected $lblId;
	protected $txtUserType;
	protected $txtUserId;
	protected $txtEvent;
	protected $txtAuditableType;
	protected $txtAuditableId;
	protected $txtOldValues;
	protected $txtNewValues;
	protected $txtUrl;
	...
	protected function Form_Create() {
        ...
        // Use the CreateFromPathInfo shortcut (this can also be done manually using the AuditsMetaControl constructor)
        // MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
        $this->mctAudits = AuditsMetaControl::CreateFromPathInfo($this);
		...
		// Call MetaControl's methods to create qcontrols based on Audits's data fields
		$this->lblId = $this->mctAudits->lblId_Create();
		$this->txtUserType = $this->mctAudits->txtUserType_Create();
		$this->txtUserId = $this->mctAudits->txtUserId_Create();
		$this->txtEvent = $this->mctAudits->txtEvent_Create();
		$this->txtAuditableType = $this->mctAudits->txtAuditableType_Create();
		$this->txtAuditableId = $this->mctAudits->txtAuditableId_Create();
		$this->txtOldValues = $this->mctAudits->txtOldValues_Create();
		$this->txtNewValues = $this->mctAudits->txtNewValues_Create();
		$this->txtUrl = $this->mctAudits->txtUrl_Create();
		$this->txtIpAddress = $this->mctAudits->txtIpAddress_Create();
		$this->txtUserAgent = $this->mctAudits->txtUserAgent_Create();
		$this->txtTags = $this->mctAudits->txtTags_Create();
		$this->lblCreatedAt = $this->mctAudits->lblCreatedAt_Create();
		$this->lblUpdatedAt = $this->mctAudits->lblUpdatedAt_Create();
    ...
    protected function determinarPosicion() {
        if ($this->mctAudits->Audits && !isset($_SESSION['DataAudits'])) {
            $_SESSION['DataAudits'] = serialize(array($this->mctAudits->Audits));
        }
        $this->arrDataTabl = unserialize($_SESSION['DataAudits']);
        ...
        foreach ($this->arrDataTabl as $objTable) {
            if ($objTable->Id == $this->mctAudits->Audits->Id) {
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctAudits->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('Audits'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctAudits->EditMode;
	}
    ...
    protected function btnLogxCamb_Create() {
        ...
        $this->btnLogxCamb->Visible = Log::CountByTablaRef('Audits',$this->mctAudits->Audits->Id);
    }
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctAudits->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctAudits->EditMode;
    }
...
/**
    ...
    protected function btnProxRegi_Click() {
        ...
        QApplication::Redirect(__SIST__.'/audits_edit.php/'.$objRegiTabl->Id);
    }
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the AuditsMetaControl
		$this->mctAudits->SaveAudits();
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		//----------------------------------------
		$blnTodoOkey = true;
		$arrTablRela = $this->mctAudits->TablasRelacionadasAudits();
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the AuditsMetaControl
			$this->mctAudits->DeleteAudits();
			$this->RedirectToListPage();
		}
	}

    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctAudits->Audits->Id;
        $_SESSION['TablRefe'] = 'Audits';
        $_SESSION['RegiReto'] = 'audits_edit.php/'.$this->mctAudits->Audits->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/audits_list.php');
    }

    protected function btnNuevRegi_Click() {
        QApplication::Redirect(__SIST__.'/audits_edit.php');
    }
