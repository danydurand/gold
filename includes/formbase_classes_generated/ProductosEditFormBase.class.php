 ...
 * of the Productos class.  It uses the code-generated
 * ProductosMetaControl class, which has meta-methods to help with
 * easily creating/defining controls to modify the fields of a Productos columns.
 *
 * Any display customizations and presentation-tier logic can be implemented
 * here by overriding existing or implementing new methods, properties and variables.
 * 
 * NOTE: This file is overwritten on any code regenerations.  If you want to make
 * permanent changes, it is STRONGLY RECOMMENDED to move both productos_edit.php AND
 * productos_edit.tpl.php out of this Form Drafts directory.
 *
 * @package My QCubed Application
 * @subpackage FormBaseObjects
 */
abstract class ProductosEditFormBase extends QForm {
	// Local instance of the ProductosMetaControl
	/**
	 * @var ProductosMetaControlGen mctProductos
	 */
	protected $mctProductos;
	...
	// Controls for Productos's Data Fields
	protected $lblId;
	protected $txtCodigo;
	protected $txtNombre;
	...
	protected function Form_Create() {
        ...
        // Use the CreateFromPathInfo shortcut (this can also be done manually using the ProductosMetaControl constructor)
        // MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
        $this->mctProductos = ProductosMetaControl::CreateFromPathInfo($this);
		...
		// Call MetaControl's methods to create qcontrols based on Productos's data fields
		$this->lblId = $this->mctProductos->lblId_Create();
		$this->txtCodigo = $this->mctProductos->txtCodigo_Create();
		...
		$this->txtDeletedBy = $this->mctProductos->txtDeletedBy_Create();
    ...
    protected function determinarPosicion() {
        if ($this->mctProductos->Productos && !isset($_SESSION['DataProductos'])) {
            $_SESSION['DataProductos'] = serialize(array($this->mctProductos->Productos));
        }
        $this->arrDataTabl = unserialize($_SESSION['DataProductos']);
        ...
        foreach ($this->arrDataTabl as $objTable) {
            if ($objTable->Id == $this->mctProductos->Productos->Id) {
	...
	protected function lblTituForm_Create() {
        ...
        $this->lblTituForm->Text = 'Productos';
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctProductos->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('Productos'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctProductos->EditMode;
	}
    ...
    protected function btnLogxCamb_Create() {
        ...
        $this->btnLogxCamb->Visible = Log::CountByTablaRef('Productos',$this->mctProductos->Productos->Id);
    }
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctProductos->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctProductos->EditMode;
    }
...
/**
	...
	protected function Form_Validate() {
		...
		// Check for records that may violate Unique Clauses
			if (($objProductos = Productos::LoadByCodigo($this->txtCodigo->Text)) && ($objProductos->Id != $this->mctProductos->Productos->Id )){
				$blnToReturn = false;
				$this->txtCodigo->Warning = QApplication::Translate("Already in Use");
			}
			if (($objProductos = Productos::LoadByNombre($this->txtNombre->Text)) && ($objProductos->Id != $this->mctProductos->Productos->Id )){
				$blnToReturn = false;
    ...
    protected function btnProxRegi_Click() {
        ...
        QApplication::Redirect(__SIST__.'/productos_edit.php/'.$objRegiTabl->Id);
    }
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the ProductosMetaControl
		$this->mctProductos->SaveProductos();
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		//----------------------------------------
		$blnTodoOkey = true;
		$arrTablRela = $this->mctProductos->TablasRelacionadasProductos();
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the ProductosMetaControl
			$this->mctProductos->DeleteProductos();
			$this->RedirectToListPage();
		}
	}

    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctProductos->Productos->Id;
        $_SESSION['TablRefe'] = 'Productos';
        $_SESSION['RegiReto'] = 'productos_edit.php/'.$this->mctProductos->Productos->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/productos_list.php');
    }

    protected function btnNuevRegi_Click() {
        QApplication::Redirect(__SIST__.'/productos_edit.php');
    }
