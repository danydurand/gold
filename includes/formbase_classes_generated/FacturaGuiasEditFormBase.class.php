 ...
 * FacturaGuiasMetaControl class, which has meta-methods to help with
 * easily creating/defining controls to modify the fields of a FacturaGuias columns.
 *
 * Any display customizations and presentation-tier logic can be implemented
 * here by overriding existing or implementing new methods, properties and variables.
 * 
 * NOTE: This file is overwritten on any code regenerations.  If you want to make
 * permanent changes, it is STRONGLY RECOMMENDED to move both factura_guias_edit.php AND
 * factura_guias_edit.tpl.php out of this Form Drafts directory.
 *
 * @package My QCubed Application
 * @subpackage FormBaseObjects
 */
abstract class FacturaGuiasEditFormBase extends QForm {
	// Local instance of the FacturaGuiasMetaControl
	/**
	 * @var FacturaGuiasMetaControlGen mctFacturaGuias
	 */
	protected $mctFacturaGuias;
	...
	// Controls for FacturaGuias's Data Fields
	protected $lblId;
	...
	protected function Form_Create() {
        ...
        // Use the CreateFromPathInfo shortcut (this can also be done manually using the FacturaGuiasMetaControl constructor)
        // MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
        $this->mctFacturaGuias = FacturaGuiasMetaControl::CreateFromPathInfo($this);
		...
		// Call MetaControl's methods to create qcontrols based on FacturaGuias's data fields
		$this->lblId = $this->mctFacturaGuias->lblId_Create();
		$this->lstFactura = $this->mctFacturaGuias->lstFactura_Create();
		$this->lstGuia = $this->mctFacturaGuias->lstGuia_Create();
		$this->txtTotal = $this->mctFacturaGuias->txtTotal_Create();
		$this->calCreatedAt = $this->mctFacturaGuias->calCreatedAt_Create();
		$this->calUpdatedAt = $this->mctFacturaGuias->calUpdatedAt_Create();
    ...
    protected function determinarPosicion() {
        if ($this->mctFacturaGuias->FacturaGuias && !isset($_SESSION['DataFacturaGuias'])) {
            $_SESSION['DataFacturaGuias'] = serialize(array($this->mctFacturaGuias->FacturaGuias));
        }
        $this->arrDataTabl = unserialize($_SESSION['DataFacturaGuias']);
        ...
        foreach ($this->arrDataTabl as $objTable) {
            if ($objTable->Id == $this->mctFacturaGuias->FacturaGuias->Id) {
	...
	protected function lblTituForm_Create() {
        ...
        $this->lblTituForm->Text = 'FacturaGuias';
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctFacturaGuias->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('FacturaGuias'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctFacturaGuias->EditMode;
	}
    ...
    protected function btnLogxCamb_Create() {
        ...
        $this->btnLogxCamb->Visible = Log::CountByTablaRef('FacturaGuias',$this->mctFacturaGuias->FacturaGuias->Id);
    }
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctFacturaGuias->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctFacturaGuias->EditMode;
    }
...
/**
    ...
    protected function btnProxRegi_Click() {
        ...
        QApplication::Redirect(__SIST__.'/factura_guias_edit.php/'.$objRegiTabl->Id);
    }
    ...
    protected function verificarNavegacion() {
        if ($this->mctFacturaGuias->EditMode) {
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the FacturaGuiasMetaControl
		$this->mctFacturaGuias->SaveFacturaGuias();
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		//----------------------------------------
		$blnTodoOkey = true;
		$arrTablRela = $this->mctFacturaGuias->TablasRelacionadasFacturaGuias();
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the FacturaGuiasMetaControl
			$this->mctFacturaGuias->DeleteFacturaGuias();
			$this->RedirectToListPage();
		}
	}

    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctFacturaGuias->FacturaGuias->Id;
        $_SESSION['TablRefe'] = 'FacturaGuias';
        $_SESSION['RegiReto'] = 'factura_guias_edit.php/'.$this->mctFacturaGuias->FacturaGuias->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/factura_guias_list.php');
    }
