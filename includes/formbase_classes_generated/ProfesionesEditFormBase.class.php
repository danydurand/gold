 ...
 */
abstract class ProfesionesEditFormBase extends QForm {
	// Local instance of the ProfesionesMetaControl
	/**
	 * @var ProfesionesMetaControlGen mctProfesiones
	 */
	protected $mctProfesiones;
	...
	protected function lblTituForm_Create() {
        ...
        $this->lblTituForm->Text = 'Profesiones';
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctProfesiones->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('Profesiones'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctProfesiones->EditMode;
	}
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctProfesiones->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctProfesiones->EditMode;
    }
...
/**
	...
	protected function Form_Validate() {
		...
		// Check for records that may violate Unique Clauses
			if (($objProfesiones = Profesiones::LoadByNombre($this->txtNombre->Text)) && ($objProfesiones->Id != $this->mctProfesiones->Profesiones->Id )){
				$blnToReturn = false;
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the ProfesionesMetaControl
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the ProfesionesMetaControl
    ...
    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctProfesiones->Profesiones->Id;
        $_SESSION['TablRefe'] = 'Profesiones';
        $_SESSION['RegiReto'] = 'profesiones_edit.php/'.$this->mctProfesiones->Profesiones->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/profesiones_list.php');
    }

    protected function btnNuevRegi_Click() {
        QApplication::Redirect(__SIST__.'/profesiones_edit.php');
    }
