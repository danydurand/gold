 ...
 * of the PagosCorpDetail class.  It uses the code-generated
 * PagosCorpDetailMetaControl class, which has meta-methods to help with
 * easily creating/defining controls to modify the fields of a PagosCorpDetail columns.
 *
 * Any display customizations and presentation-tier logic can be implemented
 * here by overriding existing or implementing new methods, properties and variables.
 * 
 * NOTE: This file is overwritten on any code regenerations.  If you want to make
 * permanent changes, it is STRONGLY RECOMMENDED to move both pagos_corp_detail_edit.php AND
 * pagos_corp_detail_edit.tpl.php out of this Form Drafts directory.
 *
 * @package My QCubed Application
 * @subpackage FormBaseObjects
 */
abstract class PagosCorpDetailEditFormBase extends QForm {
	// Local instance of the PagosCorpDetailMetaControl
	/**
	 * @var PagosCorpDetailMetaControlGen mctPagosCorpDetail
	 */
	protected $mctPagosCorpDetail;
	...
	// Controls for PagosCorpDetail's Data Fields
	protected $lblId;
	protected $lstPagoCorp;
	protected $lstFactura;
	protected $txtMontoAbonado;
	...
	protected function Form_Create() {
        ...
        // Use the CreateFromPathInfo shortcut (this can also be done manually using the PagosCorpDetailMetaControl constructor)
        // MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
        $this->mctPagosCorpDetail = PagosCorpDetailMetaControl::CreateFromPathInfo($this);
		...
		// Call MetaControl's methods to create qcontrols based on PagosCorpDetail's data fields
		$this->lblId = $this->mctPagosCorpDetail->lblId_Create();
		$this->lstPagoCorp = $this->mctPagosCorpDetail->lstPagoCorp_Create();
		$this->lstFactura = $this->mctPagosCorpDetail->lstFactura_Create();
		$this->txtMontoAbonado = $this->mctPagosCorpDetail->txtMontoAbonado_Create();
    ...
    protected function determinarPosicion() {
        if ($this->mctPagosCorpDetail->PagosCorpDetail && !isset($_SESSION['DataPagosCorpDetail'])) {
            $_SESSION['DataPagosCorpDetail'] = serialize(array($this->mctPagosCorpDetail->PagosCorpDetail));
        }
        $this->arrDataTabl = unserialize($_SESSION['DataPagosCorpDetail']);
        ...
        foreach ($this->arrDataTabl as $objTable) {
            if ($objTable->Id == $this->mctPagosCorpDetail->PagosCorpDetail->Id) {
	...
	protected function lblTituForm_Create() {
        ...
        $this->lblTituForm->Text = 'PagosCorpDetail';
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctPagosCorpDetail->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('PagosCorpDetail'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctPagosCorpDetail->EditMode;
	}
    ...
    protected function btnLogxCamb_Create() {
        ...
        $this->btnLogxCamb->Visible = Log::CountByTablaRef('PagosCorpDetail',$this->mctPagosCorpDetail->PagosCorpDetail->Id);
    }
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctPagosCorpDetail->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctPagosCorpDetail->EditMode;
    }
...
/**
	...
	protected function Form_Validate() {
		...
		// Check for records that may violate Unique Clauses
			if (($objPagosCorpDetail = PagosCorpDetail::LoadByPagoCorpIdFacturaId($this->lstPagoCorp->SelectedValue,$this->lstFactura->SelectedValue)) && ($objPagosCorpDetail->Id != $this->mctPagosCorpDetail->PagosCorpDetail->Id )){
				$blnToReturn = false;
				$this->lstPagoCorp->Warning = QApplication::Translate("Already in Use");
    ...
    protected function btnProxRegi_Click() {
        ...
        QApplication::Redirect(__SIST__.'/pagos_corp_detail_edit.php/'.$objRegiTabl->Id);
    }
    ...
    protected function verificarNavegacion() {
        if ($this->mctPagosCorpDetail->EditMode) {
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the PagosCorpDetailMetaControl
		$this->mctPagosCorpDetail->SavePagosCorpDetail();
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		//----------------------------------------
		$blnTodoOkey = true;
		$arrTablRela = $this->mctPagosCorpDetail->TablasRelacionadasPagosCorpDetail();
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the PagosCorpDetailMetaControl
			$this->mctPagosCorpDetail->DeletePagosCorpDetail();
			$this->RedirectToListPage();
		}
	}

    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctPagosCorpDetail->PagosCorpDetail->Id;
        $_SESSION['TablRefe'] = 'PagosCorpDetail';
        $_SESSION['RegiReto'] = 'pagos_corp_detail_edit.php/'.$this->mctPagosCorpDetail->PagosCorpDetail->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/pagos_corp_detail_list.php');
    }

    protected function btnNuevRegi_Click() {
        QApplication::Redirect(__SIST__.'/pagos_corp_detail_edit.php');
    }
