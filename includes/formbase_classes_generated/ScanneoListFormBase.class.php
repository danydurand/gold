 ...
 */
abstract class ScanneoListFormBase extends QForm {
    ...
    // Local instance of the Meta DataGrid to list Scanneos
    /**
     * @var ScanneoDataGrid dtgScanneos
     */
    protected $dtgScanneos;
    ...
    protected function Form_Create() {
        ...
        $this->dtgScanneos->MetaAddColumn(QQN::Scanneo()->UpdatedByObject);
    ...
    protected function lblTituForm_Create() {
        ...
        $this->lblTituForm->Text = 'Scanneos';
    }
    ...
    protected function btnExpoExce_Create() {
        $this->btnExpoExce = new QDataGridExporterButton($this, $this->dtgScanneos);
    ...
    protected function btnFiltAvan_Click() {
        $this->dtgScanneos->ShowFilter = !$this->dtgScanneos->ShowFilter;
    }
