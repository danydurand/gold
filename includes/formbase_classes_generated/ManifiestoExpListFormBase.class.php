 ...
 */
abstract class ManifiestoExpListFormBase extends QForm {
    ...
    // Local instance of the Meta DataGrid to list ManifiestoExps
    /**
     * @var ManifiestoExpDataGrid dtgManifiestoExps
     */
    ...
    protected function lblTituForm_Create() {
        ...
        $this->lblTituForm->Text = 'ManifiestoExps';
    }
    ...
    protected function btnExpoExce_Create() {
        $this->btnExpoExce = new QDataGridExporterButton($this, $this->dtgManifiestoExps);
    ...
    protected function btnFiltAvan_Click() {
        $this->dtgManifiestoExps->ShowFilter = !$this->dtgManifiestoExps->ShowFilter;
    }
