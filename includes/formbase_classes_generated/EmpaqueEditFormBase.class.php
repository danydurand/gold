 ...
 * EmpaqueMetaControl class, which has meta-methods to help with
 * easily creating/defining controls to modify the fields of a Empaque columns.
 *
 * Any display customizations and presentation-tier logic can be implemented
 * here by overriding existing or implementing new methods, properties and variables.
 * 
 * NOTE: This file is overwritten on any code regenerations.  If you want to make
 * permanent changes, it is STRONGLY RECOMMENDED to move both empaque_edit.php AND
 * empaque_edit.tpl.php out of this Form Drafts directory.
 *
 * @package My QCubed Application
 * @subpackage FormBaseObjects
 */
abstract class EmpaqueEditFormBase extends QForm {
	// Local instance of the EmpaqueMetaControl
	/**
	 * @var EmpaqueMetaControlGen mctEmpaque
	 */
	protected $mctEmpaque;
	...
	// Controls for Empaque's Data Fields
	protected $lblId;
	protected $txtNombre;
	protected $txtSiglas;
	...
	protected function Form_Create() {
        ...
        // Use the CreateFromPathInfo shortcut (this can also be done manually using the EmpaqueMetaControl constructor)
        // MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
        $this->mctEmpaque = EmpaqueMetaControl::CreateFromPathInfo($this);
		...
		// Call MetaControl's methods to create qcontrols based on Empaque's data fields
		...
		$this->calUpdatedAt = $this->mctEmpaque->calUpdatedAt_Create();
		$this->lstCreatedByObject = $this->mctEmpaque->lstCreatedByObject_Create();
		$this->lstUpdatedByObject = $this->mctEmpaque->lstUpdatedByObject_Create();
    ...
    protected function determinarPosicion() {
        if ($this->mctEmpaque->Empaque && !isset($_SESSION['DataEmpaque'])) {
            $_SESSION['DataEmpaque'] = serialize(array($this->mctEmpaque->Empaque));
        }
        $this->arrDataTabl = unserialize($_SESSION['DataEmpaque']);
        ...
        foreach ($this->arrDataTabl as $objTable) {
            if ($objTable->Id == $this->mctEmpaque->Empaque->Id) {
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctEmpaque->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('Empaque'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctEmpaque->EditMode;
	}
    ...
    protected function btnLogxCamb_Create() {
        ...
        $this->btnLogxCamb->Visible = Log::CountByTablaRef('Empaque',$this->mctEmpaque->Empaque->Id);
    }
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctEmpaque->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctEmpaque->EditMode;
    }
...
/**
	...
	protected function Form_Validate() {
		...
		// Check for records that may violate Unique Clauses
			if (($objEmpaque = Empaque::LoadByNombre($this->txtNombre->Text)) && ($objEmpaque->Id != $this->mctEmpaque->Empaque->Id )){
				$blnToReturn = false;
				$this->txtNombre->Warning = QApplication::Translate("Already in Use");
			}
			if (($objEmpaque = Empaque::LoadBySiglas($this->txtSiglas->Text)) && ($objEmpaque->Id != $this->mctEmpaque->Empaque->Id )){
				$blnToReturn = false;
    ...
    protected function btnProxRegi_Click() {
        ...
        QApplication::Redirect(__SIST__.'/empaque_edit.php/'.$objRegiTabl->Id);
    }
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the EmpaqueMetaControl
		$this->mctEmpaque->SaveEmpaque();
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		//----------------------------------------
		$blnTodoOkey = true;
		$arrTablRela = $this->mctEmpaque->TablasRelacionadasEmpaque();
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the EmpaqueMetaControl
			$this->mctEmpaque->DeleteEmpaque();
			$this->RedirectToListPage();
		}
	}

    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctEmpaque->Empaque->Id;
        $_SESSION['TablRefe'] = 'Empaque';
        $_SESSION['RegiReto'] = 'empaque_edit.php/'.$this->mctEmpaque->Empaque->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/empaque_list.php');
    }

    protected function btnNuevRegi_Click() {
        QApplication::Redirect(__SIST__.'/empaque_edit.php');
    }
