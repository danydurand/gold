 ...
 */
abstract class ContainerMobileEditFormBase extends QForm {
	// Local instance of the ContainerMobileMetaControl
	/**
	 * @var ContainerMobileMetaControlGen mctContainerMobile
	 */
	protected $mctContainerMobile;
	...
	// Controls for ContainerMobile's Data Fields
	protected $lblId;
	protected $lstChofer;
	protected $lstContainer;
	protected $chkAbierto;
	protected $txtCantPiezas;
	protected $txtPendientes;
	protected $txtEntregadas;
	...
	protected function lblTituForm_Create() {
        ...
        $this->lblTituForm->Text = 'ContainerMobile';
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctContainerMobile->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('ContainerMobile'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctContainerMobile->EditMode;
	}
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctContainerMobile->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctContainerMobile->EditMode;
    }
...
/**
	...
	protected function Form_Validate() {
		...
		// Check for records that may violate Unique Clauses
			if (($objContainerMobile = ContainerMobile::LoadByContainerId($this->lstContainer->SelectedValue)) && ($objContainerMobile->Id != $this->mctContainerMobile->ContainerMobile->Id )){
				$blnToReturn = false;
				$this->lstContainer->Warning = QApplication::Translate("Already in Use");
			}
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the ContainerMobileMetaControl
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		//----------------------------------------
		$blnTodoOkey = true;
		$arrTablRela = $this->mctContainerMobile->TablasRelacionadasContainerMobile();
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the ContainerMobileMetaControl
    ...
    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctContainerMobile->ContainerMobile->Id;
        $_SESSION['TablRefe'] = 'ContainerMobile';
        $_SESSION['RegiReto'] = 'container_mobile_edit.php/'.$this->mctContainerMobile->ContainerMobile->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/container_mobile_list.php');
    }

    protected function btnNuevRegi_Click() {
        QApplication::Redirect(__SIST__.'/container_mobile_edit.php');
    }
