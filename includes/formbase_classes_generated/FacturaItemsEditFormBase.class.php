 ...
 * of the FacturaItems class.  It uses the code-generated
 * FacturaItemsMetaControl class, which has meta-methods to help with
 * easily creating/defining controls to modify the fields of a FacturaItems columns.
 *
 * Any display customizations and presentation-tier logic can be implemented
 * here by overriding existing or implementing new methods, properties and variables.
 * 
 * NOTE: This file is overwritten on any code regenerations.  If you want to make
 * permanent changes, it is STRONGLY RECOMMENDED to move both factura_items_edit.php AND
 * factura_items_edit.tpl.php out of this Form Drafts directory.
 *
 * @package My QCubed Application
 * @subpackage FormBaseObjects
 */
abstract class FacturaItemsEditFormBase extends QForm {
	// Local instance of the FacturaItemsMetaControl
	/**
	 * @var FacturaItemsMetaControlGen mctFacturaItems
	 */
	protected $mctFacturaItems;
	...
	// Controls for FacturaItems's Data Fields
	protected $lblId;
	...
	protected function Form_Create() {
        ...
        // Use the CreateFromPathInfo shortcut (this can also be done manually using the FacturaItemsMetaControl constructor)
        // MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
        $this->mctFacturaItems = FacturaItemsMetaControl::CreateFromPathInfo($this);
		...
		// Call MetaControl's methods to create qcontrols based on FacturaItems's data fields
		$this->lblId = $this->mctFacturaItems->lblId_Create();
		$this->lstFactura = $this->mctFacturaItems->lstFactura_Create();
		$this->lstConcepto = $this->mctFacturaItems->lstConcepto_Create();
		$this->txtMostrarComo = $this->mctFacturaItems->txtMostrarComo_Create();
		$this->txtMonto = $this->mctFacturaItems->txtMonto_Create();
		$this->lblCreatedAt = $this->mctFacturaItems->lblCreatedAt_Create();
		$this->lblUpdatedAt = $this->mctFacturaItems->lblUpdatedAt_Create();
    ...
    protected function determinarPosicion() {
        if ($this->mctFacturaItems->FacturaItems && !isset($_SESSION['DataFacturaItems'])) {
            $_SESSION['DataFacturaItems'] = serialize(array($this->mctFacturaItems->FacturaItems));
        }
        $this->arrDataTabl = unserialize($_SESSION['DataFacturaItems']);
        ...
        foreach ($this->arrDataTabl as $objTable) {
            if ($objTable->Id == $this->mctFacturaItems->FacturaItems->Id) {
	...
	protected function lblTituForm_Create() {
        ...
        $this->lblTituForm->Text = 'FacturaItems';
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctFacturaItems->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('FacturaItems'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctFacturaItems->EditMode;
	}
    ...
    protected function btnLogxCamb_Create() {
        ...
        $this->btnLogxCamb->Visible = Log::CountByTablaRef('FacturaItems',$this->mctFacturaItems->FacturaItems->Id);
    }
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctFacturaItems->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctFacturaItems->EditMode;
    }
...
/**
	...
	protected function Form_Validate() {
		...
		// Check for records that may violate Unique Clauses
			if (($objFacturaItems = FacturaItems::LoadByFacturaIdConceptoId($this->lstFactura->SelectedValue,$this->lstConcepto->SelectedValue)) && ($objFacturaItems->Id != $this->mctFacturaItems->FacturaItems->Id )){
				$blnToReturn = false;
    ...
    protected function btnProxRegi_Click() {
        ...
        QApplication::Redirect(__SIST__.'/factura_items_edit.php/'.$objRegiTabl->Id);
    }
    ...
    protected function verificarNavegacion() {
        if ($this->mctFacturaItems->EditMode) {
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the FacturaItemsMetaControl
		$this->mctFacturaItems->SaveFacturaItems();
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		//----------------------------------------
		$blnTodoOkey = true;
		$arrTablRela = $this->mctFacturaItems->TablasRelacionadasFacturaItems();
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the FacturaItemsMetaControl
			$this->mctFacturaItems->DeleteFacturaItems();
			$this->RedirectToListPage();
		}
	}

    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctFacturaItems->FacturaItems->Id;
        $_SESSION['TablRefe'] = 'FacturaItems';
        $_SESSION['RegiReto'] = 'factura_items_edit.php/'.$this->mctFacturaItems->FacturaItems->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/factura_items_list.php');
    }

    protected function btnNuevRegi_Click() {
        QApplication::Redirect(__SIST__.'/factura_items_edit.php');
    }
