 ...
 */
abstract class BagListFormBase extends QForm {
    ...
    // Local instance of the Meta DataGrid to list Bags
    /**
     * @var BagDataGrid dtgBags
     */
    protected $dtgBags;
    ...
    protected function btnExpoExce_Create() {
        $this->btnExpoExce = new QDataGridExporterButton($this, $this->dtgBags);
    ...
    protected function btnFiltAvan_Click() {
        $this->dtgBags->ShowFilter = !$this->dtgBags->ShowFilter;
    }
