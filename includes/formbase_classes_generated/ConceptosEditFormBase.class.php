 ...
 */
abstract class ConceptosEditFormBase extends QForm {
	// Local instance of the ConceptosMetaControl
	/**
	 * @var ConceptosMetaControlGen mctConceptos
	 */
	protected $mctConceptos;
	...
	// Controls for Conceptos's Data Fields
	protected $lblId;
	protected $txtNombre;
	protected $txtOrden;
	protected $txtProductos;
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctConceptos->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('Conceptos'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctConceptos->EditMode;
	}
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctConceptos->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctConceptos->EditMode;
    }
...
/**
	...
	protected function Form_Validate() {
		...
		// Check for records that may violate Unique Clauses
			if (($objConceptos = Conceptos::LoadByNombreActivoProductos($this->txtNombre->Text,$this->chkActivo->Checked,$this->txtProductos->Text)) && ($objConceptos->Id != $this->mctConceptos->Conceptos->Id )){
				$blnToReturn = false;
				$this->txtNombre->Warning = QApplication::Translate("Already in Use");
				$this->chkActivo->Warning = QApplication::Translate("Already in Use");
				$this->txtProductos->Warning = QApplication::Translate("Already in Use");
			}
			if (($objConceptos = Conceptos::LoadByNombre($this->txtNombre->Text)) && ($objConceptos->Id != $this->mctConceptos->Conceptos->Id )){
				$blnToReturn = false;
				$this->txtNombre->Warning = QApplication::Translate("Already in Use");
			}
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the ConceptosMetaControl
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the ConceptosMetaControl
    ...
    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctConceptos->Conceptos->Id;
        $_SESSION['TablRefe'] = 'Conceptos';
        $_SESSION['RegiReto'] = 'conceptos_edit.php/'.$this->mctConceptos->Conceptos->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/conceptos_list.php');
    }

    protected function btnNuevRegi_Click() {
        QApplication::Redirect(__SIST__.'/conceptos_edit.php');
    }
