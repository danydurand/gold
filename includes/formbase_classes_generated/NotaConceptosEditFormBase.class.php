 ...
 * of the NotaConceptos class.  It uses the code-generated
 * NotaConceptosMetaControl class, which has meta-methods to help with
 * easily creating/defining controls to modify the fields of a NotaConceptos columns.
 *
 * Any display customizations and presentation-tier logic can be implemented
 * here by overriding existing or implementing new methods, properties and variables.
 * 
 * NOTE: This file is overwritten on any code regenerations.  If you want to make
 * permanent changes, it is STRONGLY RECOMMENDED to move both nota_conceptos_edit.php AND
 * nota_conceptos_edit.tpl.php out of this Form Drafts directory.
 *
 * @package My QCubed Application
 * @subpackage FormBaseObjects
 */
abstract class NotaConceptosEditFormBase extends QForm {
	// Local instance of the NotaConceptosMetaControl
	/**
	 * @var NotaConceptosMetaControlGen mctNotaConceptos
	 */
	protected $mctNotaConceptos;
	...
	// Controls for NotaConceptos's Data Fields
	protected $lblId;
	...
	protected function Form_Create() {
        ...
        // Use the CreateFromPathInfo shortcut (this can also be done manually using the NotaConceptosMetaControl constructor)
        // MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
        $this->mctNotaConceptos = NotaConceptosMetaControl::CreateFromPathInfo($this);
		...
		// Call MetaControl's methods to create qcontrols based on NotaConceptos's data fields
		$this->lblId = $this->mctNotaConceptos->lblId_Create();
		$this->lstNotaEntrega = $this->mctNotaConceptos->lstNotaEntrega_Create();
		$this->lstConcepto = $this->mctNotaConceptos->lstConcepto_Create();
		$this->txtTipo = $this->mctNotaConceptos->txtTipo_Create();
		$this->txtValor = $this->mctNotaConceptos->txtValor_Create();
		...
		$this->txtDeletedBy = $this->mctNotaConceptos->txtDeletedBy_Create();
    ...
    protected function determinarPosicion() {
        if ($this->mctNotaConceptos->NotaConceptos && !isset($_SESSION['DataNotaConceptos'])) {
            $_SESSION['DataNotaConceptos'] = serialize(array($this->mctNotaConceptos->NotaConceptos));
        }
        $this->arrDataTabl = unserialize($_SESSION['DataNotaConceptos']);
        ...
        foreach ($this->arrDataTabl as $objTable) {
            if ($objTable->Id == $this->mctNotaConceptos->NotaConceptos->Id) {
	...
	protected function lblTituForm_Create() {
        ...
        $this->lblTituForm->Text = 'NotaConceptos';
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctNotaConceptos->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('NotaConceptos'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctNotaConceptos->EditMode;
	}
    ...
    protected function btnLogxCamb_Create() {
        ...
        $this->btnLogxCamb->Visible = Log::CountByTablaRef('NotaConceptos',$this->mctNotaConceptos->NotaConceptos->Id);
    }
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctNotaConceptos->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctNotaConceptos->EditMode;
    }
...
/**
	...
	protected function Form_Validate() {
		...
		// Check for records that may violate Unique Clauses
			if (($objNotaConceptos = NotaConceptos::LoadByNotaEntregaIdConceptoId($this->lstNotaEntrega->SelectedValue,$this->lstConcepto->SelectedValue)) && ($objNotaConceptos->Id != $this->mctNotaConceptos->NotaConceptos->Id )){
				$blnToReturn = false;
				$this->lstNotaEntrega->Warning = QApplication::Translate("Already in Use");
    ...
    protected function btnProxRegi_Click() {
        ...
        QApplication::Redirect(__SIST__.'/nota_conceptos_edit.php/'.$objRegiTabl->Id);
    }
    ...
    protected function verificarNavegacion() {
        if ($this->mctNotaConceptos->EditMode) {
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the NotaConceptosMetaControl
		$this->mctNotaConceptos->SaveNotaConceptos();
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		//----------------------------------------
		$blnTodoOkey = true;
		$arrTablRela = $this->mctNotaConceptos->TablasRelacionadasNotaConceptos();
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the NotaConceptosMetaControl
			$this->mctNotaConceptos->DeleteNotaConceptos();
			$this->RedirectToListPage();
		}
	}

    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctNotaConceptos->NotaConceptos->Id;
        $_SESSION['TablRefe'] = 'NotaConceptos';
        $_SESSION['RegiReto'] = 'nota_conceptos_edit.php/'.$this->mctNotaConceptos->NotaConceptos->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/nota_conceptos_list.php');
    }

    protected function btnNuevRegi_Click() {
        QApplication::Redirect(__SIST__.'/nota_conceptos_edit.php');
    }
