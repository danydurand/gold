 ...
 */
abstract class GuiaTransportistaEditFormBase extends QForm {
	// Local instance of the GuiaTransportistaMetaControl
	/**
	 * @var GuiaTransportistaMetaControlGen mctGuiaTransportista
	 */
	protected $mctGuiaTransportista;
	...
	// Controls for GuiaTransportista's Data Fields
	protected $lblId;
	...
	protected function lblTituForm_Create() {
        ...
        $this->lblTituForm->Text = 'GuiaTransportista';
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctGuiaTransportista->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('GuiaTransportista'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctGuiaTransportista->EditMode;
	}
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctGuiaTransportista->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctGuiaTransportista->EditMode;
    }
...
/**
	...
	protected function Form_Validate() {
		...
		// Check for records that may violate Unique Clauses
			if (($objGuiaTransportista = GuiaTransportista::LoadByTransportistaIdGuiaPiezaIdGuia($this->lstTransportista->SelectedValue,$this->lstGuiaPieza->SelectedValue,$this->txtGuia->Text)) && ($objGuiaTransportista->Id != $this->mctGuiaTransportista->GuiaTransportista->Id )){
				$blnToReturn = false;
				$this->lstTransportista->Warning = QApplication::Translate("Already in Use");
				$this->lstGuiaPieza->Warning = QApplication::Translate("Already in Use");
				$this->txtGuia->Warning = QApplication::Translate("Already in Use");
			}
			if (($objGuiaTransportista = GuiaTransportista::LoadByGuiaPiezaId($this->lstGuiaPieza->SelectedValue)) && ($objGuiaTransportista->Id != $this->mctGuiaTransportista->GuiaTransportista->Id )){
				$blnToReturn = false;
				$this->lstGuiaPieza->Warning = QApplication::Translate("Already in Use");
			}
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the GuiaTransportistaMetaControl
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the GuiaTransportistaMetaControl
    ...
    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctGuiaTransportista->GuiaTransportista->Id;
        $_SESSION['TablRefe'] = 'GuiaTransportista';
        $_SESSION['RegiReto'] = 'guia_transportista_edit.php/'.$this->mctGuiaTransportista->GuiaTransportista->Id;
    ...
    protected function btnNuevRegi_Click() {
        QApplication::Redirect(__SIST__.'/guia_transportista_edit.php');
    }
