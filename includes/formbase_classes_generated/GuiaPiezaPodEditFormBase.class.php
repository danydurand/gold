 ...
 * of the GuiaPiezaPod class.  It uses the code-generated
 * GuiaPiezaPodMetaControl class, which has meta-methods to help with
 * easily creating/defining controls to modify the fields of a GuiaPiezaPod columns.
 *
 * Any display customizations and presentation-tier logic can be implemented
 * here by overriding existing or implementing new methods, properties and variables.
 * 
 * NOTE: This file is overwritten on any code regenerations.  If you want to make
 * permanent changes, it is STRONGLY RECOMMENDED to move both guia_pieza_pod_edit.php AND
 * guia_pieza_pod_edit.tpl.php out of this Form Drafts directory.
 *
 * @package My QCubed Application
 * @subpackage FormBaseObjects
 */
abstract class GuiaPiezaPodEditFormBase extends QForm {
	// Local instance of the GuiaPiezaPodMetaControl
	/**
	 * @var GuiaPiezaPodMetaControlGen mctGuiaPiezaPod
	 */
	protected $mctGuiaPiezaPod;
	...
	// Controls for GuiaPiezaPod's Data Fields
	protected $lblId;
	protected $lstGuiaPieza;
	protected $txtEntregadoA;
	protected $txtFechaEntrega;
	...
	protected function Form_Create() {
        ...
        // Use the CreateFromPathInfo shortcut (this can also be done manually using the GuiaPiezaPodMetaControl constructor)
        // MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
        $this->mctGuiaPiezaPod = GuiaPiezaPodMetaControl::CreateFromPathInfo($this);
		...
		// Call MetaControl's methods to create qcontrols based on GuiaPiezaPod's data fields
		$this->lblId = $this->mctGuiaPiezaPod->lblId_Create();
		$this->lstGuiaPieza = $this->mctGuiaPiezaPod->lstGuiaPieza_Create();
		$this->txtEntregadoA = $this->mctGuiaPiezaPod->txtEntregadoA_Create();
		$this->txtFechaEntrega = $this->mctGuiaPiezaPod->txtFechaEntrega_Create();
		$this->txtHoraEntrega = $this->mctGuiaPiezaPod->txtHoraEntrega_Create();
		$this->lblCreatedAt = $this->mctGuiaPiezaPod->lblCreatedAt_Create();
		$this->lblUpdatedAt = $this->mctGuiaPiezaPod->lblUpdatedAt_Create();
		$this->lblDeletedAt = $this->mctGuiaPiezaPod->lblDeletedAt_Create();
		$this->txtCreatedBy = $this->mctGuiaPiezaPod->txtCreatedBy_Create();
		$this->txtUpdatedBy = $this->mctGuiaPiezaPod->txtUpdatedBy_Create();
		$this->txtDeletedBy = $this->mctGuiaPiezaPod->txtDeletedBy_Create();
    ...
    protected function determinarPosicion() {
        if ($this->mctGuiaPiezaPod->GuiaPiezaPod && !isset($_SESSION['DataGuiaPiezaPod'])) {
            $_SESSION['DataGuiaPiezaPod'] = serialize(array($this->mctGuiaPiezaPod->GuiaPiezaPod));
        }
        $this->arrDataTabl = unserialize($_SESSION['DataGuiaPiezaPod']);
        ...
        foreach ($this->arrDataTabl as $objTable) {
            if ($objTable->Id == $this->mctGuiaPiezaPod->GuiaPiezaPod->Id) {
	...
	protected function lblTituForm_Create() {
        ...
        $this->lblTituForm->Text = 'GuiaPiezaPod';
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctGuiaPiezaPod->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('GuiaPiezaPod'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctGuiaPiezaPod->EditMode;
	}
    ...
    protected function btnLogxCamb_Create() {
        ...
        $this->btnLogxCamb->Visible = Log::CountByTablaRef('GuiaPiezaPod',$this->mctGuiaPiezaPod->GuiaPiezaPod->Id);
    }
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctGuiaPiezaPod->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctGuiaPiezaPod->EditMode;
    }
...
/**
	...
	protected function Form_Validate() {
		...
		// Check for records that may violate Unique Clauses
			if (($objGuiaPiezaPod = GuiaPiezaPod::LoadByGuiaPiezaId($this->lstGuiaPieza->SelectedValue)) && ($objGuiaPiezaPod->Id != $this->mctGuiaPiezaPod->GuiaPiezaPod->Id )){
				$blnToReturn = false;
				$this->lstGuiaPieza->Warning = QApplication::Translate("Already in Use");
			}
    ...
    protected function btnProxRegi_Click() {
        ...
        QApplication::Redirect(__SIST__.'/guia_pieza_pod_edit.php/'.$objRegiTabl->Id);
    }
    ...
    protected function verificarNavegacion() {
        if ($this->mctGuiaPiezaPod->EditMode) {
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the GuiaPiezaPodMetaControl
		$this->mctGuiaPiezaPod->SaveGuiaPiezaPod();
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		//----------------------------------------
		$blnTodoOkey = true;
		$arrTablRela = $this->mctGuiaPiezaPod->TablasRelacionadasGuiaPiezaPod();
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the GuiaPiezaPodMetaControl
			$this->mctGuiaPiezaPod->DeleteGuiaPiezaPod();
			$this->RedirectToListPage();
		}
	}

    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctGuiaPiezaPod->GuiaPiezaPod->Id;
        $_SESSION['TablRefe'] = 'GuiaPiezaPod';
        $_SESSION['RegiReto'] = 'guia_pieza_pod_edit.php/'.$this->mctGuiaPiezaPod->GuiaPiezaPod->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/guia_pieza_pod_list.php');
    }

    protected function btnNuevRegi_Click() {
        QApplication::Redirect(__SIST__.'/guia_pieza_pod_edit.php');
    }
