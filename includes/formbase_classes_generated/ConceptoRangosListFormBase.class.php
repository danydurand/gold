<?php
	 ...
	 */
	abstract class ConceptoRangosListFormBase extends QForm {
		...
		// Local instance of the Meta DataGrid to list ConceptoRangoses
		/**
		 * @var ConceptoRangosDataGrid dtgConceptoRangoses
		 */
		protected $dtgConceptoRangoses;
		...
		protected function lblTituForm_Create() {
			...
			$this->lblTituForm->Text = 'ConceptoRangoses';
		}
        ...
        protected function btnExpoExce_Create() {
            $this->btnExpoExce = new QDataGridExporterButton($this, $this->dtgConceptoRangoses);
        ...
        protected function btnFiltAvan_Click() {
            $this->dtgConceptoRangoses->ShowFilter = !$this->dtgConceptoRangoses->ShowFilter;
        }
