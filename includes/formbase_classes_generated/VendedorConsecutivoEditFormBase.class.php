 ...
 * of the VendedorConsecutivo class.  It uses the code-generated
 * VendedorConsecutivoMetaControl class, which has meta-methods to help with
 * easily creating/defining controls to modify the fields of a VendedorConsecutivo columns.
 *
 * Any display customizations and presentation-tier logic can be implemented
 * here by overriding existing or implementing new methods, properties and variables.
 * 
 * NOTE: This file is overwritten on any code regenerations.  If you want to make
 * permanent changes, it is STRONGLY RECOMMENDED to move both vendedor_consecutivo_edit.php AND
 * vendedor_consecutivo_edit.tpl.php out of this Form Drafts directory.
 *
 * @package My QCubed Application
 * @subpackage FormBaseObjects
 */
abstract class VendedorConsecutivoEditFormBase extends QForm {
	// Local instance of the VendedorConsecutivoMetaControl
	/**
	 * @var VendedorConsecutivoMetaControlGen mctVendedorConsecutivo
	 */
	protected $mctVendedorConsecutivo;
	...
	// Controls for VendedorConsecutivo's Data Fields
	protected $lblId;
	protected $txtNada;
	...
	protected function Form_Create() {
        ...
        // Use the CreateFromPathInfo shortcut (this can also be done manually using the VendedorConsecutivoMetaControl constructor)
        // MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
        $this->mctVendedorConsecutivo = VendedorConsecutivoMetaControl::CreateFromPathInfo($this);
		...
		// Call MetaControl's methods to create qcontrols based on VendedorConsecutivo's data fields
		$this->lblId = $this->mctVendedorConsecutivo->lblId_Create();
		$this->txtNada = $this->mctVendedorConsecutivo->txtNada_Create();
    ...
    protected function determinarPosicion() {
        if ($this->mctVendedorConsecutivo->VendedorConsecutivo && !isset($_SESSION['DataVendedorConsecutivo'])) {
            $_SESSION['DataVendedorConsecutivo'] = serialize(array($this->mctVendedorConsecutivo->VendedorConsecutivo));
        }
        $this->arrDataTabl = unserialize($_SESSION['DataVendedorConsecutivo']);
        ...
        foreach ($this->arrDataTabl as $objTable) {
            if ($objTable->Id == $this->mctVendedorConsecutivo->VendedorConsecutivo->Id) {
	...
	protected function lblTituForm_Create() {
        ...
        $this->lblTituForm->Text = 'VendedorConsecutivo';
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctVendedorConsecutivo->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('VendedorConsecutivo'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctVendedorConsecutivo->EditMode;
	}
    ...
    protected function btnLogxCamb_Create() {
        ...
        $this->btnLogxCamb->Visible = Log::CountByTablaRef('VendedorConsecutivo',$this->mctVendedorConsecutivo->VendedorConsecutivo->Id);
    }
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctVendedorConsecutivo->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctVendedorConsecutivo->EditMode;
    }
...
/**
    ...
    protected function btnProxRegi_Click() {
        ...
        QApplication::Redirect(__SIST__.'/vendedor_consecutivo_edit.php/'.$objRegiTabl->Id);
    }
    ...
    protected function verificarNavegacion() {
        if ($this->mctVendedorConsecutivo->EditMode) {
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the VendedorConsecutivoMetaControl
		$this->mctVendedorConsecutivo->SaveVendedorConsecutivo();
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		//----------------------------------------
		$blnTodoOkey = true;
		$arrTablRela = $this->mctVendedorConsecutivo->TablasRelacionadasVendedorConsecutivo();
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the VendedorConsecutivoMetaControl
			$this->mctVendedorConsecutivo->DeleteVendedorConsecutivo();
			$this->RedirectToListPage();
		}
	}

    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctVendedorConsecutivo->VendedorConsecutivo->Id;
        $_SESSION['TablRefe'] = 'VendedorConsecutivo';
        $_SESSION['RegiReto'] = 'vendedor_consecutivo_edit.php/'.$this->mctVendedorConsecutivo->VendedorConsecutivo->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/vendedor_consecutivo_list.php');
    }

    protected function btnNuevRegi_Click() {
        QApplication::Redirect(__SIST__.'/vendedor_consecutivo_edit.php');
    }
