 ...
 * of the PiezaRecibida class.  It uses the code-generated
 * PiezaRecibidaMetaControl class, which has meta-methods to help with
 * easily creating/defining controls to modify the fields of a PiezaRecibida columns.
 *
 * Any display customizations and presentation-tier logic can be implemented
 * here by overriding existing or implementing new methods, properties and variables.
 * 
 * NOTE: This file is overwritten on any code regenerations.  If you want to make
 * permanent changes, it is STRONGLY RECOMMENDED to move both pieza_recibida_edit.php AND
 * pieza_recibida_edit.tpl.php out of this Form Drafts directory.
 *
 * @package My QCubed Application
 * @subpackage FormBaseObjects
 */
abstract class PiezaRecibidaEditFormBase extends QForm {
	// Local instance of the PiezaRecibidaMetaControl
	/**
	 * @var PiezaRecibidaMetaControlGen mctPiezaRecibida
	 */
	protected $mctPiezaRecibida;
	...
	// Controls for PiezaRecibida's Data Fields
	protected $lblId;
	...
	protected function Form_Create() {
        ...
        // Use the CreateFromPathInfo shortcut (this can also be done manually using the PiezaRecibidaMetaControl constructor)
        // MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
        $this->mctPiezaRecibida = PiezaRecibidaMetaControl::CreateFromPathInfo($this);
		...
		// Call MetaControl's methods to create qcontrols based on PiezaRecibida's data fields
		$this->lblId = $this->mctPiezaRecibida->lblId_Create();
		$this->lstProcesoError = $this->mctPiezaRecibida->lstProcesoError_Create();
		$this->txtIdPieza = $this->mctPiezaRecibida->txtIdPieza_Create();
		$this->chkIsRecibida = $this->mctPiezaRecibida->chkIsRecibida_Create();
		$this->calCreatedAt = $this->mctPiezaRecibida->calCreatedAt_Create();
		$this->calUpdatedAt = $this->mctPiezaRecibida->calUpdatedAt_Create();
		$this->lstCreatedByObject = $this->mctPiezaRecibida->lstCreatedByObject_Create();
		$this->lstUpdatedByObject = $this->mctPiezaRecibida->lstUpdatedByObject_Create();
    ...
    protected function determinarPosicion() {
        if ($this->mctPiezaRecibida->PiezaRecibida && !isset($_SESSION['DataPiezaRecibida'])) {
            $_SESSION['DataPiezaRecibida'] = serialize(array($this->mctPiezaRecibida->PiezaRecibida));
        }
        $this->arrDataTabl = unserialize($_SESSION['DataPiezaRecibida']);
        ...
        foreach ($this->arrDataTabl as $objTable) {
            if ($objTable->Id == $this->mctPiezaRecibida->PiezaRecibida->Id) {
	...
	protected function lblTituForm_Create() {
        ...
        $this->lblTituForm->Text = 'PiezaRecibida';
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctPiezaRecibida->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('PiezaRecibida'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctPiezaRecibida->EditMode;
	}
    ...
    protected function btnLogxCamb_Create() {
        ...
        $this->btnLogxCamb->Visible = Log::CountByTablaRef('PiezaRecibida',$this->mctPiezaRecibida->PiezaRecibida->Id);
    }
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctPiezaRecibida->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctPiezaRecibida->EditMode;
    }
...
/**
	...
	protected function Form_Validate() {
		...
		// Check for records that may violate Unique Clauses
			if (($objPiezaRecibida = PiezaRecibida::LoadByIdPieza($this->txtIdPieza->Text)) && ($objPiezaRecibida->Id != $this->mctPiezaRecibida->PiezaRecibida->Id )){
				$blnToReturn = false;
    ...
    protected function btnProxRegi_Click() {
        ...
        QApplication::Redirect(__SIST__.'/pieza_recibida_edit.php/'.$objRegiTabl->Id);
    }
    ...
    protected function verificarNavegacion() {
        if ($this->mctPiezaRecibida->EditMode) {
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the PiezaRecibidaMetaControl
		$this->mctPiezaRecibida->SavePiezaRecibida();
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		//----------------------------------------
		$blnTodoOkey = true;
		$arrTablRela = $this->mctPiezaRecibida->TablasRelacionadasPiezaRecibida();
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the PiezaRecibidaMetaControl
			$this->mctPiezaRecibida->DeletePiezaRecibida();
			$this->RedirectToListPage();
		}
	}

    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctPiezaRecibida->PiezaRecibida->Id;
        $_SESSION['TablRefe'] = 'PiezaRecibida';
        $_SESSION['RegiReto'] = 'pieza_recibida_edit.php/'.$this->mctPiezaRecibida->PiezaRecibida->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/pieza_recibida_list.php');
    }

    protected function btnNuevRegi_Click() {
        QApplication::Redirect(__SIST__.'/pieza_recibida_edit.php');
    }
