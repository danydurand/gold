<?php
	 ...
	 */
	abstract class LineaAereaListFormBase extends QForm {
		...
		// Local instance of the Meta DataGrid to list LineaAereas
		/**
		 * @var LineaAereaDataGrid dtgLineaAereas
		 */
		protected $dtgLineaAereas;
		...
		protected function lblTituForm_Create() {
			...
			$this->lblTituForm->Text = 'LineaAereas';
		}
        ...
        protected function btnExpoExce_Create() {
            $this->btnExpoExce = new QDataGridExporterButton($this, $this->dtgLineaAereas);
        ...
        protected function btnFiltAvan_Click() {
            $this->dtgLineaAereas->ShowFilter = !$this->dtgLineaAereas->ShowFilter;
        }
