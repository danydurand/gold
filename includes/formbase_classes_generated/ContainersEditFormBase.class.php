 ...
 */
abstract class ContainersEditFormBase extends QForm {
	// Local instance of the ContainersMetaControl
	/**
	 * @var ContainersMetaControlGen mctContainers
	 */
	protected $mctContainers;
	...
	// Controls for Containers's Data Fields
	protected $lblId;
	protected $txtNumero;
	...
	protected function lblTituForm_Create() {
        ...
        $this->lblTituForm->Text = 'Containers';
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctContainers->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('Containers'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctContainers->EditMode;
	}
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctContainers->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctContainers->EditMode;
    }
...
/**
	...
	protected function Form_Validate() {
		...
		// Check for records that may violate Unique Clauses
			if (($objContainers = Containers::LoadByNumero($this->txtNumero->Text)) && ($objContainers->Id != $this->mctContainers->Containers->Id )){
				$blnToReturn = false;
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the ContainersMetaControl
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the ContainersMetaControl
    ...
    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctContainers->Containers->Id;
        $_SESSION['TablRefe'] = 'Containers';
        $_SESSION['RegiReto'] = 'containers_edit.php/'.$this->mctContainers->Containers->Id;
