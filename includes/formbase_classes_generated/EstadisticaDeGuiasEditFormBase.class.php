 ...
 * EstadisticaDeGuiasMetaControl class, which has meta-methods to help with
 * easily creating/defining controls to modify the fields of a EstadisticaDeGuias columns.
 *
 * Any display customizations and presentation-tier logic can be implemented
 * here by overriding existing or implementing new methods, properties and variables.
 * 
 * NOTE: This file is overwritten on any code regenerations.  If you want to make
 * permanent changes, it is STRONGLY RECOMMENDED to move both estadistica_de_guias_edit.php AND
 * estadistica_de_guias_edit.tpl.php out of this Form Drafts directory.
 *
 * @package My QCubed Application
 * @subpackage FormBaseObjects
 */
abstract class EstadisticaDeGuiasEditFormBase extends QForm {
	// Local instance of the EstadisticaDeGuiasMetaControl
	/**
	 * @var EstadisticaDeGuiasMetaControlGen mctEstadisticaDeGuias
	 */
	protected $mctEstadisticaDeGuias;
	...
	// Controls for EstadisticaDeGuias's Data Fields
	protected $lstGuia;
	protected $calFechaGuia;
	protected $calFechaPickup;
	protected $txtDiasPickup;
	protected $calFechaTraslado;
	protected $txtDiasTraslado;
	protected $txtAcumuladoTraslado;
	protected $calFechaArribo;
	protected $txtDiasArribo;
	protected $txtAcumuladoArribo;
	protected $calFechaRuta;
	protected $txtDiasRuta;
	protected $txtAcumuladoRuta;
	protected $calFechaEntrega;
	protected $txtDiasEntrega;
	protected $txtAcumuladoEntrega;
	protected $txtAcumuladoSinEntrega;
	protected $txtDiasSinActualizar;
	...
	protected function Form_Create() {
        ...
        // Use the CreateFromPathInfo shortcut (this can also be done manually using the EstadisticaDeGuiasMetaControl constructor)
        // MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
        $this->mctEstadisticaDeGuias = EstadisticaDeGuiasMetaControl::CreateFromPathInfo($this);
		...
		// Call MetaControl's methods to create qcontrols based on EstadisticaDeGuias's data fields
		$this->lstGuia = $this->mctEstadisticaDeGuias->lstGuia_Create();
		$this->calFechaGuia = $this->mctEstadisticaDeGuias->calFechaGuia_Create();
		$this->calFechaPickup = $this->mctEstadisticaDeGuias->calFechaPickup_Create();
		$this->txtDiasPickup = $this->mctEstadisticaDeGuias->txtDiasPickup_Create();
		$this->calFechaTraslado = $this->mctEstadisticaDeGuias->calFechaTraslado_Create();
		$this->txtDiasTraslado = $this->mctEstadisticaDeGuias->txtDiasTraslado_Create();
		$this->txtAcumuladoTraslado = $this->mctEstadisticaDeGuias->txtAcumuladoTraslado_Create();
		$this->calFechaArribo = $this->mctEstadisticaDeGuias->calFechaArribo_Create();
		$this->txtDiasArribo = $this->mctEstadisticaDeGuias->txtDiasArribo_Create();
		$this->txtAcumuladoArribo = $this->mctEstadisticaDeGuias->txtAcumuladoArribo_Create();
		$this->calFechaRuta = $this->mctEstadisticaDeGuias->calFechaRuta_Create();
		$this->txtDiasRuta = $this->mctEstadisticaDeGuias->txtDiasRuta_Create();
		$this->txtAcumuladoRuta = $this->mctEstadisticaDeGuias->txtAcumuladoRuta_Create();
		$this->calFechaEntrega = $this->mctEstadisticaDeGuias->calFechaEntrega_Create();
		$this->txtDiasEntrega = $this->mctEstadisticaDeGuias->txtDiasEntrega_Create();
		$this->txtAcumuladoEntrega = $this->mctEstadisticaDeGuias->txtAcumuladoEntrega_Create();
		$this->txtAcumuladoSinEntrega = $this->mctEstadisticaDeGuias->txtAcumuladoSinEntrega_Create();
		$this->txtDiasSinActualizar = $this->mctEstadisticaDeGuias->txtDiasSinActualizar_Create();
    ...
    protected function determinarPosicion() {
        if ($this->mctEstadisticaDeGuias->EstadisticaDeGuias && !isset($_SESSION['DataEstadisticaDeGuias'])) {
            $_SESSION['DataEstadisticaDeGuias'] = serialize(array($this->mctEstadisticaDeGuias->EstadisticaDeGuias));
        }
        $this->arrDataTabl = unserialize($_SESSION['DataEstadisticaDeGuias']);
        ...
        foreach ($this->arrDataTabl as $objTable) {
            if ($objTable->Id == $this->mctEstadisticaDeGuias->EstadisticaDeGuias->Id) {
	...
	protected function lblTituForm_Create() {
        ...
        $this->lblTituForm->Text = 'EstadisticaDeGuias';
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctEstadisticaDeGuias->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('EstadisticaDeGuias'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctEstadisticaDeGuias->EditMode;
	}
    ...
    protected function btnLogxCamb_Create() {
        ...
        $this->btnLogxCamb->Visible = Log::CountByTablaRef('EstadisticaDeGuias',$this->mctEstadisticaDeGuias->EstadisticaDeGuias->Id);
    }
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctEstadisticaDeGuias->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctEstadisticaDeGuias->EditMode;
    }
...
/**
    ...
    protected function btnProxRegi_Click() {
        ...
        QApplication::Redirect(__SIST__.'/estadistica_de_guias_edit.php/'.$objRegiTabl->Id);
    }
    ...
    protected function verificarNavegacion() {
        if ($this->mctEstadisticaDeGuias->EditMode) {
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the EstadisticaDeGuiasMetaControl
		$this->mctEstadisticaDeGuias->SaveEstadisticaDeGuias();
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		//----------------------------------------
		$blnTodoOkey = true;
		$arrTablRela = $this->mctEstadisticaDeGuias->TablasRelacionadasEstadisticaDeGuias();
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the EstadisticaDeGuiasMetaControl
			$this->mctEstadisticaDeGuias->DeleteEstadisticaDeGuias();
			$this->RedirectToListPage();
		}
	}

    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctEstadisticaDeGuias->EstadisticaDeGuias->Id;
        $_SESSION['TablRefe'] = 'EstadisticaDeGuias';
        $_SESSION['RegiReto'] = 'estadistica_de_guias_edit.php/'.$this->mctEstadisticaDeGuias->EstadisticaDeGuias->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/estadistica_de_guias_list.php');
    }
