 ...
 * of the MatchPieces class.  It uses the code-generated
 * MatchPiecesMetaControl class, which has meta-methods to help with
 * easily creating/defining controls to modify the fields of a MatchPieces columns.
 *
 * Any display customizations and presentation-tier logic can be implemented
 * here by overriding existing or implementing new methods, properties and variables.
 * 
 * NOTE: This file is overwritten on any code regenerations.  If you want to make
 * permanent changes, it is STRONGLY RECOMMENDED to move both match_pieces_edit.php AND
 * match_pieces_edit.tpl.php out of this Form Drafts directory.
 *
 * @package My QCubed Application
 * @subpackage FormBaseObjects
 */
abstract class MatchPiecesEditFormBase extends QForm {
	// Local instance of the MatchPiecesMetaControl
	/**
	 * @var MatchPiecesMetaControlGen mctMatchPieces
	 */
	protected $mctMatchPieces;
	...
	// Controls for MatchPieces's Data Fields
	protected $lblId;
	protected $lstProcesoError;
	protected $txtIdPieza;
	protected $chkIsLeftover;
	...
	protected function Form_Create() {
        ...
        // Use the CreateFromPathInfo shortcut (this can also be done manually using the MatchPiecesMetaControl constructor)
        // MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
        $this->mctMatchPieces = MatchPiecesMetaControl::CreateFromPathInfo($this);
		...
		// Call MetaControl's methods to create qcontrols based on MatchPieces's data fields
		$this->lblId = $this->mctMatchPieces->lblId_Create();
		$this->lstProcesoError = $this->mctMatchPieces->lstProcesoError_Create();
		$this->txtIdPieza = $this->mctMatchPieces->txtIdPieza_Create();
		$this->chkIsLeftover = $this->mctMatchPieces->chkIsLeftover_Create();
		$this->chkIsCycleCompleted = $this->mctMatchPieces->chkIsCycleCompleted_Create();
		$this->lstPieza = $this->mctMatchPieces->lstPieza_Create();
		$this->calCreatedAt = $this->mctMatchPieces->calCreatedAt_Create();
		$this->lstCreatedByObject = $this->mctMatchPieces->lstCreatedByObject_Create();
    ...
    protected function determinarPosicion() {
        if ($this->mctMatchPieces->MatchPieces && !isset($_SESSION['DataMatchPieces'])) {
            $_SESSION['DataMatchPieces'] = serialize(array($this->mctMatchPieces->MatchPieces));
        }
        $this->arrDataTabl = unserialize($_SESSION['DataMatchPieces']);
        ...
        foreach ($this->arrDataTabl as $objTable) {
            if ($objTable->Id == $this->mctMatchPieces->MatchPieces->Id) {
	...
	protected function lblTituForm_Create() {
        ...
        $this->lblTituForm->Text = 'MatchPieces';
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctMatchPieces->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('MatchPieces'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctMatchPieces->EditMode;
	}
    ...
    protected function btnLogxCamb_Create() {
        ...
        $this->btnLogxCamb->Visible = Log::CountByTablaRef('MatchPieces',$this->mctMatchPieces->MatchPieces->Id);
    }
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctMatchPieces->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctMatchPieces->EditMode;
    }
...
/**
    ...
    protected function btnProxRegi_Click() {
        ...
        QApplication::Redirect(__SIST__.'/match_pieces_edit.php/'.$objRegiTabl->Id);
    }
    ...
    protected function verificarNavegacion() {
        if ($this->mctMatchPieces->EditMode) {
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the MatchPiecesMetaControl
		$this->mctMatchPieces->SaveMatchPieces();
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		//----------------------------------------
		$blnTodoOkey = true;
		$arrTablRela = $this->mctMatchPieces->TablasRelacionadasMatchPieces();
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the MatchPiecesMetaControl
			$this->mctMatchPieces->DeleteMatchPieces();
			$this->RedirectToListPage();
		}
	}

    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctMatchPieces->MatchPieces->Id;
        $_SESSION['TablRefe'] = 'MatchPieces';
        $_SESSION['RegiReto'] = 'match_pieces_edit.php/'.$this->mctMatchPieces->MatchPieces->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/match_pieces_list.php');
    }

    protected function btnNuevRegi_Click() {
        QApplication::Redirect(__SIST__.'/match_pieces_edit.php');
    }
