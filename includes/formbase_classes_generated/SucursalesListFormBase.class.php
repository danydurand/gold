 ...
 */
abstract class SucursalesListFormBase extends QForm {
    ...
    // Local instance of the Meta DataGrid to list Sucursaleses
    /**
     * @var SucursalesDataGrid dtgSucursaleses
     */
    protected $dtgSucursaleses;
    ...
    protected function lblTituForm_Create() {
        ...
        $this->lblTituForm->Text = 'Sucursaleses';
    }
    ...
    protected function btnExpoExce_Create() {
        $this->btnExpoExce = new QDataGridExporterButton($this, $this->dtgSucursaleses);
    ...
    protected function btnFiltAvan_Click() {
        $this->dtgSucursaleses->ShowFilter = !$this->dtgSucursaleses->ShowFilter;
    }
