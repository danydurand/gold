 ...
 */
abstract class LineaAereaEditFormBase extends QForm {
	// Local instance of the LineaAereaMetaControl
	/**
	 * @var LineaAereaMetaControlGen mctLineaAerea
	 */
	protected $mctLineaAerea;
	...
	// Controls for LineaAerea's Data Fields
	protected $lblId;
	protected $txtNombre;
	protected $chkActiva;
	...
	protected function lblTituForm_Create() {
        ...
        $this->lblTituForm->Text = 'LineaAerea';
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctLineaAerea->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('LineaAerea'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctLineaAerea->EditMode;
	}
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctLineaAerea->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctLineaAerea->EditMode;
    }
...
/**
	...
	protected function Form_Validate() {
		...
		// Check for records that may violate Unique Clauses
			if (($objLineaAerea = LineaAerea::LoadByNombre($this->txtNombre->Text)) && ($objLineaAerea->Id != $this->mctLineaAerea->LineaAerea->Id )){
				$blnToReturn = false;
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the LineaAereaMetaControl
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the LineaAereaMetaControl
    ...
    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctLineaAerea->LineaAerea->Id;
        $_SESSION['TablRefe'] = 'LineaAerea';
        $_SESSION['RegiReto'] = 'linea_aerea_edit.php/'.$this->mctLineaAerea->LineaAerea->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/linea_aerea_list.php');
    }

    protected function btnNuevRegi_Click() {
        QApplication::Redirect(__SIST__.'/linea_aerea_edit.php');
    }
