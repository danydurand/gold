 ...
 * LogMobileMetaControl class, which has meta-methods to help with
 * easily creating/defining controls to modify the fields of a LogMobile columns.
 *
 * Any display customizations and presentation-tier logic can be implemented
 * here by overriding existing or implementing new methods, properties and variables.
 * 
 * NOTE: This file is overwritten on any code regenerations.  If you want to make
 * permanent changes, it is STRONGLY RECOMMENDED to move both log_mobile_edit.php AND
 * log_mobile_edit.tpl.php out of this Form Drafts directory.
 *
 * @package My QCubed Application
 * @subpackage FormBaseObjects
 */
abstract class LogMobileEditFormBase extends QForm {
	// Local instance of the LogMobileMetaControl
	/**
	 * @var LogMobileMetaControlGen mctLogMobile
	 */
	protected $mctLogMobile;
	...
	// Controls for LogMobile's Data Fields
	protected $lblId;
	protected $txtChofer;
	protected $calFecha;
	...
	protected function Form_Create() {
        ...
        // Use the CreateFromPathInfo shortcut (this can also be done manually using the LogMobileMetaControl constructor)
        // MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
        $this->mctLogMobile = LogMobileMetaControl::CreateFromPathInfo($this);
		...
		// Call MetaControl's methods to create qcontrols based on LogMobile's data fields
		$this->lblId = $this->mctLogMobile->lblId_Create();
		$this->txtChofer = $this->mctLogMobile->txtChofer_Create();
		$this->calFecha = $this->mctLogMobile->calFecha_Create();
		$this->txtDescripcion = $this->mctLogMobile->txtDescripcion_Create();
    ...
    protected function determinarPosicion() {
        if ($this->mctLogMobile->LogMobile && !isset($_SESSION['DataLogMobile'])) {
            $_SESSION['DataLogMobile'] = serialize(array($this->mctLogMobile->LogMobile));
        }
        $this->arrDataTabl = unserialize($_SESSION['DataLogMobile']);
        ...
        foreach ($this->arrDataTabl as $objTable) {
            if ($objTable->Id == $this->mctLogMobile->LogMobile->Id) {
	...
	protected function lblTituForm_Create() {
        ...
        $this->lblTituForm->Text = 'LogMobile';
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctLogMobile->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('LogMobile'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctLogMobile->EditMode;
	}
    ...
    protected function btnLogxCamb_Create() {
        ...
        $this->btnLogxCamb->Visible = Log::CountByTablaRef('LogMobile',$this->mctLogMobile->LogMobile->Id);
    }
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctLogMobile->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctLogMobile->EditMode;
    }
...
/**
    ...
    protected function btnProxRegi_Click() {
        ...
        QApplication::Redirect(__SIST__.'/log_mobile_edit.php/'.$objRegiTabl->Id);
    }
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the LogMobileMetaControl
		$this->mctLogMobile->SaveLogMobile();
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		//----------------------------------------
		$blnTodoOkey = true;
		$arrTablRela = $this->mctLogMobile->TablasRelacionadasLogMobile();
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the LogMobileMetaControl
			$this->mctLogMobile->DeleteLogMobile();
			$this->RedirectToListPage();
		}
	}

    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctLogMobile->LogMobile->Id;
        $_SESSION['TablRefe'] = 'LogMobile';
        $_SESSION['RegiReto'] = 'log_mobile_edit.php/'.$this->mctLogMobile->LogMobile->Id;
    ...
    protected function btnNuevRegi_Click() {
        QApplication::Redirect(__SIST__.'/log_mobile_edit.php');
    }
