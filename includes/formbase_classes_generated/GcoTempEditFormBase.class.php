 ...
 * of the GcoTemp class.  It uses the code-generated
 * GcoTempMetaControl class, which has meta-methods to help with
 * easily creating/defining controls to modify the fields of a GcoTemp columns.
 *
 * Any display customizations and presentation-tier logic can be implemented
 * here by overriding existing or implementing new methods, properties and variables.
 * 
 * NOTE: This file is overwritten on any code regenerations.  If you want to make
 * permanent changes, it is STRONGLY RECOMMENDED to move both gco_temp_edit.php AND
 * gco_temp_edit.tpl.php out of this Form Drafts directory.
 *
 * @package My QCubed Application
 * @subpackage FormBaseObjects
 */
abstract class GcoTempEditFormBase extends QForm {
	// Local instance of the GcoTempMetaControl
	/**
	 * @var GcoTempMetaControlGen mctGcoTemp
	 */
	protected $mctGcoTemp;
	...
	// Controls for GcoTemp's Data Fields
	protected $lblId;
	...
	protected function Form_Create() {
        ...
        // Use the CreateFromPathInfo shortcut (this can also be done manually using the GcoTempMetaControl constructor)
        // MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
        $this->mctGcoTemp = GcoTempMetaControl::CreateFromPathInfo($this);
		...
		// Call MetaControl's methods to create qcontrols based on GcoTemp's data fields
		$this->lblId = $this->mctGcoTemp->lblId_Create();
		$this->lstProcesoError = $this->mctGcoTemp->lstProcesoError_Create();
		$this->lstConcepto = $this->mctGcoTemp->lstConcepto_Create();
		$this->calCreatedAt = $this->mctGcoTemp->calCreatedAt_Create();
		$this->calUpdatedAt = $this->mctGcoTemp->calUpdatedAt_Create();
		$this->lstCreatedByObject = $this->mctGcoTemp->lstCreatedByObject_Create();
		$this->lstUpdatedByObject = $this->mctGcoTemp->lstUpdatedByObject_Create();
    ...
    protected function determinarPosicion() {
        if ($this->mctGcoTemp->GcoTemp && !isset($_SESSION['DataGcoTemp'])) {
            $_SESSION['DataGcoTemp'] = serialize(array($this->mctGcoTemp->GcoTemp));
        }
        $this->arrDataTabl = unserialize($_SESSION['DataGcoTemp']);
        ...
        foreach ($this->arrDataTabl as $objTable) {
            if ($objTable->Id == $this->mctGcoTemp->GcoTemp->Id) {
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctGcoTemp->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('GcoTemp'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctGcoTemp->EditMode;
	}
    ...
    protected function btnLogxCamb_Create() {
        ...
        $this->btnLogxCamb->Visible = Log::CountByTablaRef('GcoTemp',$this->mctGcoTemp->GcoTemp->Id);
    }
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctGcoTemp->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctGcoTemp->EditMode;
    }
...
/**
	...
	protected function Form_Validate() {
		...
		// Check for records that may violate Unique Clauses
			if (($objGcoTemp = GcoTemp::LoadByProcesoErrorIdConceptoId($this->lstProcesoError->SelectedValue,$this->lstConcepto->SelectedValue)) && ($objGcoTemp->Id != $this->mctGcoTemp->GcoTemp->Id )){
				$blnToReturn = false;
				$this->lstProcesoError->Warning = QApplication::Translate("Already in Use");
    ...
    protected function btnProxRegi_Click() {
        ...
        QApplication::Redirect(__SIST__.'/gco_temp_edit.php/'.$objRegiTabl->Id);
    }
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the GcoTempMetaControl
		$this->mctGcoTemp->SaveGcoTemp();
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		//----------------------------------------
		$blnTodoOkey = true;
		$arrTablRela = $this->mctGcoTemp->TablasRelacionadasGcoTemp();
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the GcoTempMetaControl
			$this->mctGcoTemp->DeleteGcoTemp();
			$this->RedirectToListPage();
		}
	}

    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctGcoTemp->GcoTemp->Id;
        $_SESSION['TablRefe'] = 'GcoTemp';
        $_SESSION['RegiReto'] = 'gco_temp_edit.php/'.$this->mctGcoTemp->GcoTemp->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/gco_temp_list.php');
    }

    protected function btnNuevRegi_Click() {
        QApplication::Redirect(__SIST__.'/gco_temp_edit.php');
    }
