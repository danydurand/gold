 ...
 */
abstract class UsersEditFormBase extends QForm {
	// Local instance of the UsersMetaControl
	/**
	 * @var UsersMetaControlGen mctUsers
	 */
	protected $mctUsers;
	...
	protected function Form_Create() {
        ...
        // Use the CreateFromPathInfo shortcut (this can also be done manually using the UsersMetaControl constructor)
		...
		$this->txtRememberToken = $this->mctUsers->txtRememberToken_Create();
		$this->lblCreatedAt = $this->mctUsers->lblCreatedAt_Create();
		$this->lblUpdatedAt = $this->mctUsers->lblUpdatedAt_Create();
    ...
    protected function determinarPosicion() {
        if ($this->mctUsers->Users && !isset($_SESSION['DataUsers'])) {
            $_SESSION['DataUsers'] = serialize(array($this->mctUsers->Users));
        }
        $this->arrDataTabl = unserialize($_SESSION['DataUsers']);
        ...
        foreach ($this->arrDataTabl as $objTable) {
            if ($objTable->Id == $this->mctUsers->Users->Id) {
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctUsers->EditMode;
    }
    ...
    protected function btnLogxCamb_Create() {
        ...
        $this->btnLogxCamb->Visible = Log::CountByTablaRef('Users',$this->mctUsers->Users->Id);
    }
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctUsers->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctUsers->EditMode;
    }
...
/**
	...
	protected function Form_Validate() {
		...
		// Check for records that may violate Unique Clauses
			if (($objUsers = Users::LoadByEmail($this->txtEmail->Text)) && ($objUsers->Id != $this->mctUsers->Users->Id )){
				$blnToReturn = false;
    ...
    protected function btnProxRegi_Click() {
        ...
        QApplication::Redirect(__SIST__.'/users_edit.php/'.$objRegiTabl->Id);
    }
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		//----------------------------------------
		$blnTodoOkey = true;
		$arrTablRela = $this->mctUsers->TablasRelacionadasUsers();
    ...
    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctUsers->Users->Id;
        $_SESSION['TablRefe'] = 'Users';
        $_SESSION['RegiReto'] = 'users_edit.php/'.$this->mctUsers->Users->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/users_list.php');
    }
