 ...
 */
abstract class CheckpointsEditFormBase extends QForm {
	// Local instance of the CheckpointsMetaControl
	/**
	 * @var CheckpointsMetaControlGen mctCheckpoints
	 */
	protected $mctCheckpoints;
	...
	// Controls for Checkpoints's Data Fields
	protected $lblId;
	protected $txtCodigo;
	protected $txtDescripcion;
	protected $txtDescripcionRastreo;
	protected $chkTerminal;
	protected $txtVisibilidad;
	protected $txtTipo;
	protected $chkNotificar;
	protected $txtImagen;
	protected $txtColor;
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctCheckpoints->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('Checkpoints'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctCheckpoints->EditMode;
	}
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctCheckpoints->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctCheckpoints->EditMode;
    }
...
/**
	...
	protected function Form_Validate() {
		...
		// Check for records that may violate Unique Clauses
			if (($objCheckpoints = Checkpoints::LoadByCodigo($this->txtCodigo->Text)) && ($objCheckpoints->Id != $this->mctCheckpoints->Checkpoints->Id )){
				$blnToReturn = false;
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the CheckpointsMetaControl
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the CheckpointsMetaControl
    ...
    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctCheckpoints->Checkpoints->Id;
        $_SESSION['TablRefe'] = 'Checkpoints';
        $_SESSION['RegiReto'] = 'checkpoints_edit.php/'.$this->mctCheckpoints->Checkpoints->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/checkpoints_list.php');
    }

    protected function btnNuevRegi_Click() {
        QApplication::Redirect(__SIST__.'/checkpoints_edit.php');
    }
