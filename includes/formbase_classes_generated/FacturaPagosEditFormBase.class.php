 ...
 * of the FacturaPagos class.  It uses the code-generated
 * FacturaPagosMetaControl class, which has meta-methods to help with
 * easily creating/defining controls to modify the fields of a FacturaPagos columns.
 *
 * Any display customizations and presentation-tier logic can be implemented
 * here by overriding existing or implementing new methods, properties and variables.
 * 
 * NOTE: This file is overwritten on any code regenerations.  If you want to make
 * permanent changes, it is STRONGLY RECOMMENDED to move both factura_pagos_edit.php AND
 * factura_pagos_edit.tpl.php out of this Form Drafts directory.
 *
 * @package My QCubed Application
 * @subpackage FormBaseObjects
 */
abstract class FacturaPagosEditFormBase extends QForm {
	// Local instance of the FacturaPagosMetaControl
	/**
	 * @var FacturaPagosMetaControlGen mctFacturaPagos
	 */
	protected $mctFacturaPagos;
	...
	// Controls for FacturaPagos's Data Fields
	protected $lblId;
	...
	protected function Form_Create() {
        ...
        // Use the CreateFromPathInfo shortcut (this can also be done manually using the FacturaPagosMetaControl constructor)
        // MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
        $this->mctFacturaPagos = FacturaPagosMetaControl::CreateFromPathInfo($this);
		...
		// Call MetaControl's methods to create qcontrols based on FacturaPagos's data fields
		$this->lblId = $this->mctFacturaPagos->lblId_Create();
		$this->lstFactura = $this->mctFacturaPagos->lstFactura_Create();
		$this->lstFormaPago = $this->mctFacturaPagos->lstFormaPago_Create();
		$this->lstDivisa = $this->mctFacturaPagos->lstDivisa_Create();
		$this->txtReferencia = $this->mctFacturaPagos->txtReferencia_Create();
		$this->lstBanco = $this->mctFacturaPagos->lstBanco_Create();
		$this->txtMontoDivisa = $this->mctFacturaPagos->txtMontoDivisa_Create();
		...
		$this->lstCajero = $this->mctFacturaPagos->lstCajero_Create();
		...
		$this->txtDeletedBy = $this->mctFacturaPagos->txtDeletedBy_Create();
    ...
    protected function determinarPosicion() {
        if ($this->mctFacturaPagos->FacturaPagos && !isset($_SESSION['DataFacturaPagos'])) {
            $_SESSION['DataFacturaPagos'] = serialize(array($this->mctFacturaPagos->FacturaPagos));
        }
        $this->arrDataTabl = unserialize($_SESSION['DataFacturaPagos']);
        ...
        foreach ($this->arrDataTabl as $objTable) {
            if ($objTable->Id == $this->mctFacturaPagos->FacturaPagos->Id) {
	...
	protected function lblTituForm_Create() {
        ...
        $this->lblTituForm->Text = 'FacturaPagos';
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctFacturaPagos->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('FacturaPagos'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctFacturaPagos->EditMode;
	}
    ...
    protected function btnLogxCamb_Create() {
        ...
        $this->btnLogxCamb->Visible = Log::CountByTablaRef('FacturaPagos',$this->mctFacturaPagos->FacturaPagos->Id);
    }
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctFacturaPagos->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctFacturaPagos->EditMode;
    }
...
/**
    ...
    protected function btnProxRegi_Click() {
        ...
        QApplication::Redirect(__SIST__.'/factura_pagos_edit.php/'.$objRegiTabl->Id);
    }
    ...
    protected function verificarNavegacion() {
        if ($this->mctFacturaPagos->EditMode) {
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the FacturaPagosMetaControl
		$this->mctFacturaPagos->SaveFacturaPagos();
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		//----------------------------------------
		$blnTodoOkey = true;
		$arrTablRela = $this->mctFacturaPagos->TablasRelacionadasFacturaPagos();
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the FacturaPagosMetaControl
			$this->mctFacturaPagos->DeleteFacturaPagos();
			$this->RedirectToListPage();
		}
	}

    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctFacturaPagos->FacturaPagos->Id;
        $_SESSION['TablRefe'] = 'FacturaPagos';
        $_SESSION['RegiReto'] = 'factura_pagos_edit.php/'.$this->mctFacturaPagos->FacturaPagos->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/factura_pagos_list.php');
    }

    protected function btnNuevRegi_Click() {
        QApplication::Redirect(__SIST__.'/factura_pagos_edit.php');
    }
