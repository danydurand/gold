 ...
 */
abstract class DivisasListFormBase extends QForm {
    ...
    // Local instance of the Meta DataGrid to list Divisases
    /**
     * @var DivisasDataGrid dtgDivisases
     */
    protected $dtgDivisases;
    ...
    protected function lblTituForm_Create() {
        ...
        $this->lblTituForm->Text = 'Divisases';
    }
    ...
    protected function btnExpoExce_Create() {
        $this->btnExpoExce = new QDataGridExporterButton($this, $this->dtgDivisases);
    ...
    protected function btnFiltAvan_Click() {
        $this->dtgDivisases->ShowFilter = !$this->dtgDivisases->ShowFilter;
    }
