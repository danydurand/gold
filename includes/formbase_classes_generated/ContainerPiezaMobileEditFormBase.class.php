 ...
 * of the ContainerPiezaMobile class.  It uses the code-generated
 * ContainerPiezaMobileMetaControl class, which has meta-methods to help with
 * easily creating/defining controls to modify the fields of a ContainerPiezaMobile columns.
 *
 * Any display customizations and presentation-tier logic can be implemented
 * here by overriding existing or implementing new methods, properties and variables.
 * 
 * NOTE: This file is overwritten on any code regenerations.  If you want to make
 * permanent changes, it is STRONGLY RECOMMENDED to move both container_pieza_mobile_edit.php AND
 * container_pieza_mobile_edit.tpl.php out of this Form Drafts directory.
 *
 * @package My QCubed Application
 * @subpackage FormBaseObjects
 */
abstract class ContainerPiezaMobileEditFormBase extends QForm {
	// Local instance of the ContainerPiezaMobileMetaControl
	/**
	 * @var ContainerPiezaMobileMetaControlGen mctContainerPiezaMobile
	 */
	protected $mctContainerPiezaMobile;
	...
	// Controls for ContainerPiezaMobile's Data Fields
	protected $lblId;
	protected $lstContainerMobile;
	protected $txtIdPieza;
	protected $txtCheckpoint;
	protected $calFecha;
	protected $txtHora;
	...
	protected function Form_Create() {
        ...
        // Use the CreateFromPathInfo shortcut (this can also be done manually using the ContainerPiezaMobileMetaControl constructor)
        // MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
        $this->mctContainerPiezaMobile = ContainerPiezaMobileMetaControl::CreateFromPathInfo($this);
		...
		// Call MetaControl's methods to create qcontrols based on ContainerPiezaMobile's data fields
		$this->lblId = $this->mctContainerPiezaMobile->lblId_Create();
		$this->lstContainerMobile = $this->mctContainerPiezaMobile->lstContainerMobile_Create();
		$this->txtIdPieza = $this->mctContainerPiezaMobile->txtIdPieza_Create();
		$this->txtCheckpoint = $this->mctContainerPiezaMobile->txtCheckpoint_Create();
		$this->calFecha = $this->mctContainerPiezaMobile->calFecha_Create();
		$this->txtHora = $this->mctContainerPiezaMobile->txtHora_Create();
		$this->txtComentario = $this->mctContainerPiezaMobile->txtComentario_Create();
		$this->txtEntregadoA = $this->mctContainerPiezaMobile->txtEntregadoA_Create();
		$this->txtCedula = $this->mctContainerPiezaMobile->txtCedula_Create();
		$this->calFechaPod = $this->mctContainerPiezaMobile->calFechaPod_Create();
		$this->txtHoraPod = $this->mctContainerPiezaMobile->txtHoraPod_Create();
		$this->calCreatedAt = $this->mctContainerPiezaMobile->calCreatedAt_Create();
		$this->calUpdatedAt = $this->mctContainerPiezaMobile->calUpdatedAt_Create();
		$this->chkIsSync = $this->mctContainerPiezaMobile->chkIsSync_Create();
    ...
    protected function determinarPosicion() {
        if ($this->mctContainerPiezaMobile->ContainerPiezaMobile && !isset($_SESSION['DataContainerPiezaMobile'])) {
            $_SESSION['DataContainerPiezaMobile'] = serialize(array($this->mctContainerPiezaMobile->ContainerPiezaMobile));
        }
        $this->arrDataTabl = unserialize($_SESSION['DataContainerPiezaMobile']);
        ...
        foreach ($this->arrDataTabl as $objTable) {
            if ($objTable->Id == $this->mctContainerPiezaMobile->ContainerPiezaMobile->Id) {
	...
	protected function lblTituForm_Create() {
        ...
        $this->lblTituForm->Text = 'ContainerPiezaMobile';
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctContainerPiezaMobile->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('ContainerPiezaMobile'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctContainerPiezaMobile->EditMode;
	}
    ...
    protected function btnLogxCamb_Create() {
        ...
        $this->btnLogxCamb->Visible = Log::CountByTablaRef('ContainerPiezaMobile',$this->mctContainerPiezaMobile->ContainerPiezaMobile->Id);
    }
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctContainerPiezaMobile->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctContainerPiezaMobile->EditMode;
    }
...
/**
	...
	protected function Form_Validate() {
		...
		// Check for records that may violate Unique Clauses
			if (($objContainerPiezaMobile = ContainerPiezaMobile::LoadByContainerMobileIdIdPieza($this->lstContainerMobile->SelectedValue,$this->txtIdPieza->Text)) && ($objContainerPiezaMobile->Id != $this->mctContainerPiezaMobile->ContainerPiezaMobile->Id )){
				$blnToReturn = false;
				$this->lstContainerMobile->Warning = QApplication::Translate("Already in Use");
				$this->txtIdPieza->Warning = QApplication::Translate("Already in Use");
			}
    ...
    protected function btnProxRegi_Click() {
        ...
        QApplication::Redirect(__SIST__.'/container_pieza_mobile_edit.php/'.$objRegiTabl->Id);
    }
    ...
    protected function verificarNavegacion() {
        if ($this->mctContainerPiezaMobile->EditMode) {
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the ContainerPiezaMobileMetaControl
		$this->mctContainerPiezaMobile->SaveContainerPiezaMobile();
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		//----------------------------------------
		$blnTodoOkey = true;
		$arrTablRela = $this->mctContainerPiezaMobile->TablasRelacionadasContainerPiezaMobile();
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the ContainerPiezaMobileMetaControl
			$this->mctContainerPiezaMobile->DeleteContainerPiezaMobile();
			$this->RedirectToListPage();
		}
	}

    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctContainerPiezaMobile->ContainerPiezaMobile->Id;
        $_SESSION['TablRefe'] = 'ContainerPiezaMobile';
        $_SESSION['RegiReto'] = 'container_pieza_mobile_edit.php/'.$this->mctContainerPiezaMobile->ContainerPiezaMobile->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/container_pieza_mobile_list.php');
    }

    protected function btnNuevRegi_Click() {
        QApplication::Redirect(__SIST__.'/container_pieza_mobile_edit.php');
    }
