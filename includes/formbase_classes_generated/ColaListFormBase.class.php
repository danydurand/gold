 ...
 */
abstract class ColaListFormBase extends QForm {
    ...
    // Local instance of the Meta DataGrid to list Colas
    /**
     * @var ColaDataGrid dtgColas
     */
    protected $dtgColas;
    ...
    protected function Form_Create() {
        ...
        $this->dtgColas->MetaAddColumn(QQN::Cola()->CreatedByObject);
        $this->dtgColas->MetaAddColumn(QQN::Cola()->UpdatedByObject);
    ...
    protected function btnExpoExce_Create() {
        $this->btnExpoExce = new QDataGridExporterButton($this, $this->dtgColas);
    ...
    protected function btnFiltAvan_Click() {
        $this->dtgColas->ShowFilter = !$this->dtgColas->ShowFilter;
    }
