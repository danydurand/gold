 ...
 * of the FactPagoTemp class.  It uses the code-generated
 * FactPagoTempMetaControl class, which has meta-methods to help with
 * easily creating/defining controls to modify the fields of a FactPagoTemp columns.
 *
 * Any display customizations and presentation-tier logic can be implemented
 * here by overriding existing or implementing new methods, properties and variables.
 * 
 * NOTE: This file is overwritten on any code regenerations.  If you want to make
 * permanent changes, it is STRONGLY RECOMMENDED to move both fact_pago_temp_edit.php AND
 * fact_pago_temp_edit.tpl.php out of this Form Drafts directory.
 *
 * @package My QCubed Application
 * @subpackage FormBaseObjects
 */
abstract class FactPagoTempEditFormBase extends QForm {
	// Local instance of the FactPagoTempMetaControl
	/**
	 * @var FactPagoTempMetaControlGen mctFactPagoTemp
	 */
	protected $mctFactPagoTemp;
	...
	// Controls for FactPagoTemp's Data Fields
	protected $lblId;
	...
	protected function Form_Create() {
        ...
        // Use the CreateFromPathInfo shortcut (this can also be done manually using the FactPagoTempMetaControl constructor)
        // MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
        $this->mctFactPagoTemp = FactPagoTempMetaControl::CreateFromPathInfo($this);
		...
		// Call MetaControl's methods to create qcontrols based on FactPagoTemp's data fields
		$this->lblId = $this->mctFactPagoTemp->lblId_Create();
		$this->txtProcesoId = $this->mctFactPagoTemp->txtProcesoId_Create();
		$this->lstFactura = $this->mctFactPagoTemp->lstFactura_Create();
    ...
    protected function determinarPosicion() {
        if ($this->mctFactPagoTemp->FactPagoTemp && !isset($_SESSION['DataFactPagoTemp'])) {
            $_SESSION['DataFactPagoTemp'] = serialize(array($this->mctFactPagoTemp->FactPagoTemp));
        }
        $this->arrDataTabl = unserialize($_SESSION['DataFactPagoTemp']);
        ...
        foreach ($this->arrDataTabl as $objTable) {
            if ($objTable->Id == $this->mctFactPagoTemp->FactPagoTemp->Id) {
	...
	protected function lblTituForm_Create() {
        ...
        $this->lblTituForm->Text = 'FactPagoTemp';
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctFactPagoTemp->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('FactPagoTemp'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctFactPagoTemp->EditMode;
	}
    ...
    protected function btnLogxCamb_Create() {
        ...
        $this->btnLogxCamb->Visible = Log::CountByTablaRef('FactPagoTemp',$this->mctFactPagoTemp->FactPagoTemp->Id);
    }
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctFactPagoTemp->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctFactPagoTemp->EditMode;
    }
...
/**
	...
	protected function Form_Validate() {
		...
		// Check for records that may violate Unique Clauses
			if (($objFactPagoTemp = FactPagoTemp::LoadByProcesoIdFacturaId($this->txtProcesoId->Text,$this->lstFactura->SelectedValue)) && ($objFactPagoTemp->Id != $this->mctFactPagoTemp->FactPagoTemp->Id )){
				$blnToReturn = false;
				$this->txtProcesoId->Warning = QApplication::Translate("Already in Use");
    ...
    protected function btnProxRegi_Click() {
        ...
        QApplication::Redirect(__SIST__.'/fact_pago_temp_edit.php/'.$objRegiTabl->Id);
    }
    ...
    protected function verificarNavegacion() {
        if ($this->mctFactPagoTemp->EditMode) {
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the FactPagoTempMetaControl
		$this->mctFactPagoTemp->SaveFactPagoTemp();
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		//----------------------------------------
		$blnTodoOkey = true;
		$arrTablRela = $this->mctFactPagoTemp->TablasRelacionadasFactPagoTemp();
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the FactPagoTempMetaControl
			$this->mctFactPagoTemp->DeleteFactPagoTemp();
			$this->RedirectToListPage();
		}
	}

    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctFactPagoTemp->FactPagoTemp->Id;
        $_SESSION['TablRefe'] = 'FactPagoTemp';
        $_SESSION['RegiReto'] = 'fact_pago_temp_edit.php/'.$this->mctFactPagoTemp->FactPagoTemp->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/fact_pago_temp_list.php');
    }

    protected function btnNuevRegi_Click() {
        QApplication::Redirect(__SIST__.'/fact_pago_temp_edit.php');
    }
