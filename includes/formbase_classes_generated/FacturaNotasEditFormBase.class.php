 ...
 * of the FacturaNotas class.  It uses the code-generated
 * FacturaNotasMetaControl class, which has meta-methods to help with
 * easily creating/defining controls to modify the fields of a FacturaNotas columns.
 *
 * Any display customizations and presentation-tier logic can be implemented
 * here by overriding existing or implementing new methods, properties and variables.
 * 
 * NOTE: This file is overwritten on any code regenerations.  If you want to make
 * permanent changes, it is STRONGLY RECOMMENDED to move both factura_notas_edit.php AND
 * factura_notas_edit.tpl.php out of this Form Drafts directory.
 *
 * @package My QCubed Application
 * @subpackage FormBaseObjects
 */
abstract class FacturaNotasEditFormBase extends QForm {
	// Local instance of the FacturaNotasMetaControl
	/**
	 * @var FacturaNotasMetaControlGen mctFacturaNotas
	 */
	protected $mctFacturaNotas;
	...
	// Controls for FacturaNotas's Data Fields
	protected $lblId;
	...
	protected function Form_Create() {
        ...
        // Use the CreateFromPathInfo shortcut (this can also be done manually using the FacturaNotasMetaControl constructor)
        // MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
        $this->mctFacturaNotas = FacturaNotasMetaControl::CreateFromPathInfo($this);
		...
		// Call MetaControl's methods to create qcontrols based on FacturaNotas's data fields
		$this->lblId = $this->mctFacturaNotas->lblId_Create();
    ...
    protected function determinarPosicion() {
        if ($this->mctFacturaNotas->FacturaNotas && !isset($_SESSION['DataFacturaNotas'])) {
            $_SESSION['DataFacturaNotas'] = serialize(array($this->mctFacturaNotas->FacturaNotas));
        }
        $this->arrDataTabl = unserialize($_SESSION['DataFacturaNotas']);
        ...
        foreach ($this->arrDataTabl as $objTable) {
            if ($objTable->Id == $this->mctFacturaNotas->FacturaNotas->Id) {
	...
	protected function lblTituForm_Create() {
        ...
        $this->lblTituForm->Text = 'FacturaNotas';
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctFacturaNotas->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('FacturaNotas'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctFacturaNotas->EditMode;
	}
    ...
    protected function btnLogxCamb_Create() {
        ...
        $this->btnLogxCamb->Visible = Log::CountByTablaRef('FacturaNotas',$this->mctFacturaNotas->FacturaNotas->Id);
    }
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctFacturaNotas->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctFacturaNotas->EditMode;
    }
...
/**
    ...
    protected function btnProxRegi_Click() {
        ...
        QApplication::Redirect(__SIST__.'/factura_notas_edit.php/'.$objRegiTabl->Id);
    }
    ...
    protected function verificarNavegacion() {
        if ($this->mctFacturaNotas->EditMode) {
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the FacturaNotasMetaControl
		$this->mctFacturaNotas->SaveFacturaNotas();
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		//----------------------------------------
		$blnTodoOkey = true;
		$arrTablRela = $this->mctFacturaNotas->TablasRelacionadasFacturaNotas();
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the FacturaNotasMetaControl
			$this->mctFacturaNotas->DeleteFacturaNotas();
			$this->RedirectToListPage();
		}
	}

    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctFacturaNotas->FacturaNotas->Id;
        $_SESSION['TablRefe'] = 'FacturaNotas';
        $_SESSION['RegiReto'] = 'factura_notas_edit.php/'.$this->mctFacturaNotas->FacturaNotas->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/factura_notas_list.php');
    }

    protected function btnNuevRegi_Click() {
        QApplication::Redirect(__SIST__.'/factura_notas_edit.php');
    }
