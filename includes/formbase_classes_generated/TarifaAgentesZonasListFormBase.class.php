<?php
	 ...
	 */
	abstract class TarifaAgentesZonasListFormBase extends QForm {
		...
		// Local instance of the Meta DataGrid to list TarifaAgentesZonases
		/**
		 * @var TarifaAgentesZonasDataGrid dtgTarifaAgentesZonases
		 */
		protected $dtgTarifaAgentesZonases;
		...
		protected function lblTituForm_Create() {
			...
			$this->lblTituForm->Text = 'TarifaAgentesZonases';
		}
        ...
        protected function btnExpoExce_Create() {
            $this->btnExpoExce = new QDataGridExporterButton($this, $this->dtgTarifaAgentesZonases);
        ...
        protected function btnFiltAvan_Click() {
            $this->dtgTarifaAgentesZonases->ShowFilter = !$this->dtgTarifaAgentesZonases->ShowFilter;
        }
