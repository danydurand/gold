 ...
 */
abstract class GuiaTransportistaListFormBase extends QForm {
    ...
    // Local instance of the Meta DataGrid to list GuiaTransportistas
    /**
     * @var GuiaTransportistaDataGrid dtgGuiaTransportistas
     */
    protected $dtgGuiaTransportistas;
    ...
    protected function Form_Create() {
        ...
        $this->dtgGuiaTransportistas->MetaAddColumn('Guia');
    ...
    protected function lblTituForm_Create() {
        ...
        $this->lblTituForm->Text = 'GuiaTransportistas';
    }
    ...
    protected function btnExpoExce_Create() {
        $this->btnExpoExce = new QDataGridExporterButton($this, $this->dtgGuiaTransportistas);
    ...
    protected function btnFiltAvan_Click() {
        $this->dtgGuiaTransportistas->ShowFilter = !$this->dtgGuiaTransportistas->ShowFilter;
    }
