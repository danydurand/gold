 ...
 */
abstract class ClientesRetailEditFormBase extends QForm {
	// Local instance of the ClientesRetailMetaControl
	/**
	 * @var ClientesRetailMetaControlGen mctClientesRetail
	 */
	protected $mctClientesRetail;
	...
	// Controls for ClientesRetail's Data Fields
	protected $lblId;
	...
	protected function lblTituForm_Create() {
        ...
        $this->lblTituForm->Text = 'ClientesRetail';
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctClientesRetail->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('ClientesRetail'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctClientesRetail->EditMode;
	}
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctClientesRetail->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctClientesRetail->EditMode;
    }
...
/**
	...
	protected function Form_Validate() {
		...
		// Check for records that may violate Unique Clauses
			if (($objClientesRetail = ClientesRetail::LoadByCedulaRif($this->txtCedulaRif->Text)) && ($objClientesRetail->Id != $this->mctClientesRetail->ClientesRetail->Id )){
				$blnToReturn = false;
				$this->txtCedulaRif->Warning = QApplication::Translate("Already in Use");
			}
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the ClientesRetailMetaControl
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the ClientesRetailMetaControl
    ...
    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctClientesRetail->ClientesRetail->Id;
        $_SESSION['TablRefe'] = 'ClientesRetail';
        $_SESSION['RegiReto'] = 'clientes_retail_edit.php/'.$this->mctClientesRetail->ClientesRetail->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/clientes_retail_list.php');
    }

    protected function btnNuevRegi_Click() {
        QApplication::Redirect(__SIST__.'/clientes_retail_edit.php');
    }
