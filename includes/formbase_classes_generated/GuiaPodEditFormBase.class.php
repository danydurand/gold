 ...
 * of the GuiaPod class.  It uses the code-generated
 * GuiaPodMetaControl class, which has meta-methods to help with
 * easily creating/defining controls to modify the fields of a GuiaPod columns.
 *
 * Any display customizations and presentation-tier logic can be implemented
 * here by overriding existing or implementing new methods, properties and variables.
 * 
 * NOTE: This file is overwritten on any code regenerations.  If you want to make
 * permanent changes, it is STRONGLY RECOMMENDED to move both guia_pod_edit.php AND
 * guia_pod_edit.tpl.php out of this Form Drafts directory.
 *
 * @package My QCubed Application
 * @subpackage FormBaseObjects
 */
abstract class GuiaPodEditFormBase extends QForm {
	// Local instance of the GuiaPodMetaControl
	/**
	 * @var GuiaPodMetaControlGen mctGuiaPod
	 */
	protected $mctGuiaPod;
	...
	// Controls for GuiaPod's Data Fields
	protected $lblId;
	protected $txtGuiaId;
	...
	protected function Form_Create() {
        ...
        // Use the CreateFromPathInfo shortcut (this can also be done manually using the GuiaPodMetaControl constructor)
        // MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
        $this->mctGuiaPod = GuiaPodMetaControl::CreateFromPathInfo($this);
		...
		// Call MetaControl's methods to create qcontrols based on GuiaPod's data fields
		$this->lblId = $this->mctGuiaPod->lblId_Create();
		$this->txtGuiaId = $this->mctGuiaPod->txtGuiaId_Create();
		$this->txtEntregadoA = $this->mctGuiaPod->txtEntregadoA_Create();
		$this->calFechaEntrega = $this->mctGuiaPod->calFechaEntrega_Create();
		$this->txtHoraEntrega = $this->mctGuiaPod->txtHoraEntrega_Create();
		$this->lblCreatedAt = $this->mctGuiaPod->lblCreatedAt_Create();
		$this->lblUpdatedAt = $this->mctGuiaPod->lblUpdatedAt_Create();
		$this->lblDeletedAt = $this->mctGuiaPod->lblDeletedAt_Create();
		$this->txtCreatedBy = $this->mctGuiaPod->txtCreatedBy_Create();
		$this->txtUpdatedBy = $this->mctGuiaPod->txtUpdatedBy_Create();
		$this->txtDeletedBy = $this->mctGuiaPod->txtDeletedBy_Create();
    ...
    protected function determinarPosicion() {
        if ($this->mctGuiaPod->GuiaPod && !isset($_SESSION['DataGuiaPod'])) {
            $_SESSION['DataGuiaPod'] = serialize(array($this->mctGuiaPod->GuiaPod));
        }
        $this->arrDataTabl = unserialize($_SESSION['DataGuiaPod']);
        ...
        foreach ($this->arrDataTabl as $objTable) {
            if ($objTable->Id == $this->mctGuiaPod->GuiaPod->Id) {
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctGuiaPod->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('GuiaPod'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctGuiaPod->EditMode;
	}
    ...
    protected function btnLogxCamb_Create() {
        ...
        $this->btnLogxCamb->Visible = Log::CountByTablaRef('GuiaPod',$this->mctGuiaPod->GuiaPod->Id);
    }
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctGuiaPod->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctGuiaPod->EditMode;
    }
...
/**
	...
	protected function Form_Validate() {
		...
		// Check for records that may violate Unique Clauses
			if (($objGuiaPod = GuiaPod::LoadByGuiaId($this->txtGuiaId->Text)) && ($objGuiaPod->Id != $this->mctGuiaPod->GuiaPod->Id )){
				$blnToReturn = false;
    ...
    protected function btnProxRegi_Click() {
        ...
        QApplication::Redirect(__SIST__.'/guia_pod_edit.php/'.$objRegiTabl->Id);
    }
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the GuiaPodMetaControl
		$this->mctGuiaPod->SaveGuiaPod();
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		//----------------------------------------
		$blnTodoOkey = true;
		$arrTablRela = $this->mctGuiaPod->TablasRelacionadasGuiaPod();
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the GuiaPodMetaControl
			$this->mctGuiaPod->DeleteGuiaPod();
			$this->RedirectToListPage();
		}
	}

    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctGuiaPod->GuiaPod->Id;
        $_SESSION['TablRefe'] = 'GuiaPod';
        $_SESSION['RegiReto'] = 'guia_pod_edit.php/'.$this->mctGuiaPod->GuiaPod->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/guia_pod_list.php');
    }

    protected function btnNuevRegi_Click() {
        QApplication::Redirect(__SIST__.'/guia_pod_edit.php');
    }
