 ...
 * of the GuiaCalculos class.  It uses the code-generated
 * GuiaCalculosMetaControl class, which has meta-methods to help with
 * easily creating/defining controls to modify the fields of a GuiaCalculos columns.
 *
 * Any display customizations and presentation-tier logic can be implemented
 * here by overriding existing or implementing new methods, properties and variables.
 * 
 * NOTE: This file is overwritten on any code regenerations.  If you want to make
 * permanent changes, it is STRONGLY RECOMMENDED to move both guia_calculos_edit.php AND
 * guia_calculos_edit.tpl.php out of this Form Drafts directory.
 *
 * @package My QCubed Application
 * @subpackage FormBaseObjects
 */
abstract class GuiaCalculosEditFormBase extends QForm {
	// Local instance of the GuiaCalculosMetaControl
	/**
	 * @var GuiaCalculosMetaControlGen mctGuiaCalculos
	 */
	protected $mctGuiaCalculos;
	...
	// Controls for GuiaCalculos's Data Fields
	protected $txtId;
	protected $lstGuia;
	protected $calFecha;
	protected $calHora;
	protected $txtCalculos;
	...
	protected function Form_Create() {
        ...
        // Use the CreateFromPathInfo shortcut (this can also be done manually using the GuiaCalculosMetaControl constructor)
        // MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
        $this->mctGuiaCalculos = GuiaCalculosMetaControl::CreateFromPathInfo($this);
		...
		// Call MetaControl's methods to create qcontrols based on GuiaCalculos's data fields
		$this->txtId = $this->mctGuiaCalculos->txtId_Create();
		$this->lstGuia = $this->mctGuiaCalculos->lstGuia_Create();
		$this->calFecha = $this->mctGuiaCalculos->calFecha_Create();
		$this->calHora = $this->mctGuiaCalculos->calHora_Create();
		$this->txtCalculos = $this->mctGuiaCalculos->txtCalculos_Create();
    ...
    protected function determinarPosicion() {
        if ($this->mctGuiaCalculos->GuiaCalculos && !isset($_SESSION['DataGuiaCalculos'])) {
            $_SESSION['DataGuiaCalculos'] = serialize(array($this->mctGuiaCalculos->GuiaCalculos));
        }
        $this->arrDataTabl = unserialize($_SESSION['DataGuiaCalculos']);
        ...
        foreach ($this->arrDataTabl as $objTable) {
            if ($objTable->Id == $this->mctGuiaCalculos->GuiaCalculos->Id) {
	...
	protected function lblTituForm_Create() {
        ...
        $this->lblTituForm->Text = 'GuiaCalculos';
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctGuiaCalculos->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('GuiaCalculos'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctGuiaCalculos->EditMode;
	}
    ...
    protected function btnLogxCamb_Create() {
        ...
        $this->btnLogxCamb->Visible = Log::CountByTablaRef('GuiaCalculos',$this->mctGuiaCalculos->GuiaCalculos->Id);
    }
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctGuiaCalculos->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctGuiaCalculos->EditMode;
    }
...
/**
	...
	protected function Form_Validate() {
		...
		// Check for records that may violate Unique Clauses
			if (($objGuiaCalculos = GuiaCalculos::LoadByGuiaId($this->lstGuia->SelectedValue)) && ($objGuiaCalculos->Id != $this->mctGuiaCalculos->GuiaCalculos->Id )){
				$blnToReturn = false;
    ...
    protected function btnProxRegi_Click() {
        ...
        QApplication::Redirect(__SIST__.'/guia_calculos_edit.php/'.$objRegiTabl->Id);
    }
    ...
    protected function verificarNavegacion() {
        if ($this->mctGuiaCalculos->EditMode) {
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the GuiaCalculosMetaControl
		$this->mctGuiaCalculos->SaveGuiaCalculos();
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		//----------------------------------------
		$blnTodoOkey = true;
		$arrTablRela = $this->mctGuiaCalculos->TablasRelacionadasGuiaCalculos();
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the GuiaCalculosMetaControl
			$this->mctGuiaCalculos->DeleteGuiaCalculos();
			$this->RedirectToListPage();
		}
	}

    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctGuiaCalculos->GuiaCalculos->Id;
        $_SESSION['TablRefe'] = 'GuiaCalculos';
        $_SESSION['RegiReto'] = 'guia_calculos_edit.php/'.$this->mctGuiaCalculos->GuiaCalculos->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/guia_calculos_list.php');
    }

    protected function btnNuevRegi_Click() {
        QApplication::Redirect(__SIST__.'/guia_calculos_edit.php');
    }
