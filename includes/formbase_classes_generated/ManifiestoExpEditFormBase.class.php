 ...
 */
abstract class ManifiestoExpEditFormBase extends QForm {
	// Local instance of the ManifiestoExpMetaControl
	/**
	 * @var ManifiestoExpMetaControlGen mctManifiestoExp
	 */
	protected $mctManifiestoExp;
	...
	protected function lblTituForm_Create() {
        ...
        $this->lblTituForm->Text = 'ManifiestoExp';
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctManifiestoExp->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('ManifiestoExp'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctManifiestoExp->EditMode;
	}
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctManifiestoExp->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctManifiestoExp->EditMode;
    }
...
/**
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the ManifiestoExpMetaControl
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the ManifiestoExpMetaControl
    ...
    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctManifiestoExp->ManifiestoExp->Id;
        $_SESSION['TablRefe'] = 'ManifiestoExp';
        $_SESSION['RegiReto'] = 'manifiesto_exp_edit.php/'.$this->mctManifiestoExp->ManifiestoExp->Id;
    ...
    protected function btnNuevRegi_Click() {
        QApplication::Redirect(__SIST__.'/manifiesto_exp_edit.php');
    }
