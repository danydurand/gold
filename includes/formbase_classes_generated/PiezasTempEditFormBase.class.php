 ...
 * of the PiezasTemp class.  It uses the code-generated
 * PiezasTempMetaControl class, which has meta-methods to help with
 * easily creating/defining controls to modify the fields of a PiezasTemp columns.
 *
 * Any display customizations and presentation-tier logic can be implemented
 * here by overriding existing or implementing new methods, properties and variables.
 * 
 * NOTE: This file is overwritten on any code regenerations.  If you want to make
 * permanent changes, it is STRONGLY RECOMMENDED to move both piezas_temp_edit.php AND
 * piezas_temp_edit.tpl.php out of this Form Drafts directory.
 *
 * @package My QCubed Application
 * @subpackage FormBaseObjects
 */
abstract class PiezasTempEditFormBase extends QForm {
	// Local instance of the PiezasTempMetaControl
	/**
	 * @var PiezasTempMetaControlGen mctPiezasTemp
	 */
	protected $mctPiezasTemp;
	...
	protected function Form_Create() {
        ...
        // Use the CreateFromPathInfo shortcut (this can also be done manually using the PiezasTempMetaControl constructor)
        // MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
        $this->mctPiezasTemp = PiezasTempMetaControl::CreateFromPathInfo($this);
		...
		$this->txtCreatedBy = $this->mctPiezasTemp->txtCreatedBy_Create();
		$this->txtUpdatedBy = $this->mctPiezasTemp->txtUpdatedBy_Create();
    ...
    protected function determinarPosicion() {
        if ($this->mctPiezasTemp->PiezasTemp && !isset($_SESSION['DataPiezasTemp'])) {
            $_SESSION['DataPiezasTemp'] = serialize(array($this->mctPiezasTemp->PiezasTemp));
        }
        $this->arrDataTabl = unserialize($_SESSION['DataPiezasTemp']);
        ...
        foreach ($this->arrDataTabl as $objTable) {
            if ($objTable->Id == $this->mctPiezasTemp->PiezasTemp->Id) {
	...
	protected function lblTituForm_Create() {
        ...
        $this->lblTituForm->Text = 'PiezasTemp';
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctPiezasTemp->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('PiezasTemp'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctPiezasTemp->EditMode;
	}
    ...
    protected function btnLogxCamb_Create() {
        ...
        $this->btnLogxCamb->Visible = Log::CountByTablaRef('PiezasTemp',$this->mctPiezasTemp->PiezasTemp->Id);
    }
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctPiezasTemp->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctPiezasTemp->EditMode;
    }
...
/**
    ...
    protected function btnProxRegi_Click() {
        ...
        QApplication::Redirect(__SIST__.'/piezas_temp_edit.php/'.$objRegiTabl->Id);
    }
    ...
    protected function verificarNavegacion() {
        if ($this->mctPiezasTemp->EditMode) {
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the PiezasTempMetaControl
		$this->mctPiezasTemp->SavePiezasTemp();
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		//----------------------------------------
		$blnTodoOkey = true;
		$arrTablRela = $this->mctPiezasTemp->TablasRelacionadasPiezasTemp();
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the PiezasTempMetaControl
			$this->mctPiezasTemp->DeletePiezasTemp();
			$this->RedirectToListPage();
		}
	}

    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctPiezasTemp->PiezasTemp->Id;
        $_SESSION['TablRefe'] = 'PiezasTemp';
        $_SESSION['RegiReto'] = 'piezas_temp_edit.php/'.$this->mctPiezasTemp->PiezasTemp->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/piezas_temp_list.php');
    }

    protected function btnNuevRegi_Click() {
        QApplication::Redirect(__SIST__.'/piezas_temp_edit.php');
    }
