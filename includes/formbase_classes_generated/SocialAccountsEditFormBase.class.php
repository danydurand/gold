 ...
 * of the SocialAccounts class.  It uses the code-generated
 * SocialAccountsMetaControl class, which has meta-methods to help with
 * easily creating/defining controls to modify the fields of a SocialAccounts columns.
 *
 * Any display customizations and presentation-tier logic can be implemented
 * here by overriding existing or implementing new methods, properties and variables.
 * 
 * NOTE: This file is overwritten on any code regenerations.  If you want to make
 * permanent changes, it is STRONGLY RECOMMENDED to move both social_accounts_edit.php AND
 * social_accounts_edit.tpl.php out of this Form Drafts directory.
 *
 * @package My QCubed Application
 * @subpackage FormBaseObjects
 */
abstract class SocialAccountsEditFormBase extends QForm {
	// Local instance of the SocialAccountsMetaControl
	/**
	 * @var SocialAccountsMetaControlGen mctSocialAccounts
	 */
	protected $mctSocialAccounts;
	...
	// Controls for SocialAccounts's Data Fields
	protected $lblId;
	protected $txtUserId;
	protected $txtProvider;
	protected $txtProviderId;
	protected $txtToken;
	protected $txtAvatar;
	...
	protected function Form_Create() {
        ...
        // Use the CreateFromPathInfo shortcut (this can also be done manually using the SocialAccountsMetaControl constructor)
        // MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
        $this->mctSocialAccounts = SocialAccountsMetaControl::CreateFromPathInfo($this);
		...
		// Call MetaControl's methods to create qcontrols based on SocialAccounts's data fields
		$this->lblId = $this->mctSocialAccounts->lblId_Create();
		$this->txtUserId = $this->mctSocialAccounts->txtUserId_Create();
		$this->txtProvider = $this->mctSocialAccounts->txtProvider_Create();
		$this->txtProviderId = $this->mctSocialAccounts->txtProviderId_Create();
		$this->txtToken = $this->mctSocialAccounts->txtToken_Create();
		$this->txtAvatar = $this->mctSocialAccounts->txtAvatar_Create();
		$this->lblCreatedAt = $this->mctSocialAccounts->lblCreatedAt_Create();
		$this->lblUpdatedAt = $this->mctSocialAccounts->lblUpdatedAt_Create();
    ...
    protected function determinarPosicion() {
        if ($this->mctSocialAccounts->SocialAccounts && !isset($_SESSION['DataSocialAccounts'])) {
            $_SESSION['DataSocialAccounts'] = serialize(array($this->mctSocialAccounts->SocialAccounts));
        }
        $this->arrDataTabl = unserialize($_SESSION['DataSocialAccounts']);
        ...
        foreach ($this->arrDataTabl as $objTable) {
            if ($objTable->Id == $this->mctSocialAccounts->SocialAccounts->Id) {
	...
	protected function lblTituForm_Create() {
        ...
        $this->lblTituForm->Text = 'SocialAccounts';
    ...
    protected function btnNuevRegi_Create() {
        ...
        $this->btnNuevRegi->Visible = $this->mctSocialAccounts->EditMode;
    }
	...
	protected function btnDelete_Create() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('SocialAccounts'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->mctSocialAccounts->EditMode;
	}
    ...
    protected function btnLogxCamb_Create() {
        ...
        $this->btnLogxCamb->Visible = Log::CountByTablaRef('SocialAccounts',$this->mctSocialAccounts->SocialAccounts->Id);
    }
    ...
    protected function btnNuevSmal_Create() {
        ...
        $this->btnNuevSmal->Visible = $this->mctSocialAccounts->EditMode;
    }
    ...
    protected function btnBorrSmal_Create() {
        ...
        $this->btnBorrSmal->Visible = $this->mctSocialAccounts->EditMode;
    }
...
/**
    ...
    protected function btnProxRegi_Click() {
        ...
        QApplication::Redirect(__SIST__.'/social_accounts_edit.php/'.$objRegiTabl->Id);
    }
    ...
    protected function verificarNavegacion() {
        if ($this->mctSocialAccounts->EditMode) {
	...
	protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
		// Delegate "Save" processing to the SocialAccountsMetaControl
		$this->mctSocialAccounts->SaveSocialAccounts();
	...
	protected function btnDelete_Click($strFormId, $strControlId, $strParameter) {
		...
		//----------------------------------------
		$blnTodoOkey = true;
		$arrTablRela = $this->mctSocialAccounts->TablasRelacionadasSocialAccounts();
		...
		if ($blnTodoOkey) {
			// Delegate "Delete" processing to the SocialAccountsMetaControl
			$this->mctSocialAccounts->DeleteSocialAccounts();
			$this->RedirectToListPage();
		}
	}

    protected function btnLogxCamb_Click() {
        $_SESSION['RegiRefe'] = $this->mctSocialAccounts->SocialAccounts->Id;
        $_SESSION['TablRefe'] = 'SocialAccounts';
        $_SESSION['RegiReto'] = 'social_accounts_edit.php/'.$this->mctSocialAccounts->SocialAccounts->Id;
        QApplication::Redirect(__SIST__.'/log_list.php');
    }

    protected function btnVolvList_Click() {
        QApplication::Redirect(__SIST__.'/social_accounts_list.php');
    }

    protected function btnNuevRegi_Click() {
        QApplication::Redirect(__SIST__.'/social_accounts_edit.php');
    }
