<?php
	/**
	 * The abstract ClientesInternacionalGen class defined here is
	 * code-generated and contains all the basic CRUD-type functionality as well as
	 * basic methods to handle relationships and index-based loading.
	 *
	 * To use, you should use the ClientesInternacional subclass which
	 * extends this ClientesInternacionalGen class.
	 *
	 * Because subsequent re-code generations will overwrite any changes to this
	 * file, you should leave this file unaltered to prevent yourself from losing
	 * any information or code changes.  All customizations should be done by
	 * overriding existing or implementing new methods, properties and variables
	 * in the ClientesInternacional class.
	 *
	 ...
	 * @property-read Guias $_GuiasAsClienteInt the value for the private _objGuiasAsClienteInt (Read-Only) if set due to an expansion on the guias.cliente_int_id reverse relationship
	 * @property-read Guias[] $_GuiasAsClienteIntArray the value for the private _objGuiasAsClienteIntArray (Read-Only) if set due to an ExpandAsArray on the guias.cliente_int_id reverse relationship
	 * @property-read GuiasH $_GuiasHAsClienteInt the value for the private _objGuiasHAsClienteInt (Read-Only) if set due to an expansion on the guias_h.cliente_int_id reverse relationship
	 * @property-read GuiasH[] $_GuiasHAsClienteIntArray the value for the private _objGuiasHAsClienteIntArray (Read-Only) if set due to an ExpandAsArray on the guias_h.cliente_int_id reverse relationship
	 * @property-read boolean $__Restored whether or not this object was restored from the database (as opposed to created new)
	 */
	class ClientesInternacionalGen extends QBaseClass implements IteratorAggregate {
		...
		/**
		 * Protected member variable that maps to the database PK Identity column clientes_internacional.id
		 * @var integer intId
		 */
		protected $intId;
		...
		/**
		 * Protected member variable that maps to the database column clientes_internacional.codigo
		...
		/**
		 * Protected member variable that maps to the database column clientes_internacional.nombre
		...
		/**
		 * Protected member variable that maps to the database column clientes_internacional.sucursal_id
		...
		/**
		 * Protected member variable that maps to the database column clientes_internacional.telefono_movil
		...
		/**
		 * Protected member variable that maps to the database column clientes_internacional.cedula_rif
		...
		/**
		 * Protected member variable that maps to the database column clientes_internacional.sexo
		 * @var string strSexo
		 */
		protected $strSexo;
		...
		/**
		 * Protected member variable that maps to the database column clientes_internacional.email
		 * @var string strEmail
		 */
		protected $strEmail;
		...
		/**
		 * Protected member variable that maps to the database column clientes_internacional.telefono_fijo
		...
		/**
		 * Protected member variable that maps to the database column clientes_internacional.direccion
		...
		/**
		 * Protected member variable that maps to the database column clientes_internacional.fecha_nacimiento
		...
		/**
		 * Protected member variable that maps to the database column clientes_internacional.profesion_id
		...
		/**
		 * Protected member variable that maps to the database column clientes_internacional.created_at
		...
		/**
		 * Protected member variable that maps to the database column clientes_internacional.updated_at
		...
		/**
		 * Protected member variable that maps to the database column clientes_internacional.deleted_at
		...
		/**
		 * Protected member variable that maps to the database column clientes_internacional.created_by
		...
		/**
		 * Protected member variable that maps to the database column clientes_internacional.updated_by
		...
		/**
		 * Protected member variable that maps to the database column clientes_internacional.deleted_by
		...
		/**
		 * Private member variable that stores a reference to a single GuiasAsClienteInt object
		 * (of type Guias), if this ClientesInternacional object was restored with
		 * an expansion on the guias association table.
		 * @var Guias _objGuiasAsClienteInt;
		 */
		private $_objGuiasAsClienteInt;

		/**
		 * Private member variable that stores a reference to an array of GuiasAsClienteInt objects
		 * (of type Guias[]), if this ClientesInternacional object was restored with
		 * an ExpandAsArray on the guias association table.
		 * @var Guias[] _objGuiasAsClienteIntArray;
		 */
		private $_objGuiasAsClienteIntArray = null;

		/**
		 * Private member variable that stores a reference to a single GuiasHAsClienteInt object
		 * (of type GuiasH), if this ClientesInternacional object was restored with
		 * an expansion on the guias_h association table.
		 * @var GuiasH _objGuiasHAsClienteInt;
		 */
		private $_objGuiasHAsClienteInt;

		/**
		 * Private member variable that stores a reference to an array of GuiasHAsClienteInt objects
		 * (of type GuiasH[]), if this ClientesInternacional object was restored with
		 * an ExpandAsArray on the guias_h association table.
		 * @var GuiasH[] _objGuiasHAsClienteIntArray;
		 */
		private $_objGuiasHAsClienteIntArray = null;
		 ...
		 * in the database column clientes_internacional.sucursal_id.
		 *
		...
		/**
		 * Protected member variable that contains the object pointed by the reference
		 * in the database column clientes_internacional.profesion_id.
		 *
		...
		{
			$this->intId = ClientesInternacional::IdDefault;
			$this->intCodigo = ClientesInternacional::CodigoDefault;
			$this->strNombre = ClientesInternacional::NombreDefault;
			$this->intSucursalId = ClientesInternacional::SucursalIdDefault;
			$this->strTelefonoMovil = ClientesInternacional::TelefonoMovilDefault;
			$this->strCedulaRif = ClientesInternacional::CedulaRifDefault;
			$this->strSexo = ClientesInternacional::SexoDefault;
			$this->strEmail = ClientesInternacional::EmailDefault;
			$this->strTelefonoFijo = ClientesInternacional::TelefonoFijoDefault;
			$this->strDireccion = ClientesInternacional::DireccionDefault;
			$this->dttFechaNacimiento = (ClientesInternacional::FechaNacimientoDefault === null)?null:new QDateTime(ClientesInternacional::FechaNacimientoDefault);
			$this->intProfesionId = ClientesInternacional::ProfesionIdDefault;
			$this->strCreatedAt = ClientesInternacional::CreatedAtDefault;
			$this->strUpdatedAt = ClientesInternacional::UpdatedAtDefault;
			$this->strDeletedAt = ClientesInternacional::DeletedAtDefault;
			$this->intCreatedBy = ClientesInternacional::CreatedByDefault;
			$this->intUpdatedBy = ClientesInternacional::UpdatedByDefault;
			$this->intDeletedBy = ClientesInternacional::DeletedByDefault;
		}
		...
		/**
		 * Load a ClientesInternacional from PK Info
		 * @param integer $intId
		...
		public static function Load($intId, $objOptionalClauses = null) {
			...
			if (QApplication::$objCacheProvider && !$objOptionalClauses && QApplication::$Database[1]->Caching) {
				$strCacheKey = QApplication::$objCacheProvider->CreateKey(QApplication::$Database[1]->Database, 'ClientesInternacional', $intId);
			...
			$objToReturn = ClientesInternacional::QuerySingle(
				QQ::AndCondition(
					QQ::Equal(QQN::ClientesInternacional()->Id, $intId)
				),
				$objOptionalClauses
			);
		...
		/**
		 * Load all ClientesInternacionals
		 * @param QQClause[] $objOptionalClauses additional optional QQClause objects for this query
		 * @return ClientesInternacional[]
		 */
		public static function LoadAll($objOptionalClauses = null) {
			...
			// Call ClientesInternacional::QueryArray to perform the LoadAll query
			try {
				return ClientesInternacional::QueryArray(QQ::All(), $objOptionalClauses);
		...
		/**
		 * Count all ClientesInternacionals
		 * @return int
		 */
		public static function CountAll() {
			// Call ClientesInternacional::QueryCount to perform the CountAll query
			return ClientesInternacional::QueryCount(QQ::All());
		}
		...
		protected static function BuildQueryStatement(&$objQueryBuilder, QQCondition $objConditions, $objOptionalClauses, $mixParameterArray, $blnCountOnly) {
			...
			$objDatabase = ClientesInternacional::GetDatabase();

			// Create/Build out the QueryBuilder object with ClientesInternacional-specific SELET and FROM fields
			$objQueryBuilder = new QQueryBuilder($objDatabase, 'clientes_internacional');
			...
			if ($blnAddAllFieldsToSelect) {
				ClientesInternacional::GetSelectFields($objQueryBuilder, null, QQuery::extractSelectClause($objOptionalClauses));
			}
			$objQueryBuilder->AddFromItem('clientes_internacional');
		...
		/**
		 * Static Qcubed Query method to query for a single ClientesInternacional object.
		 * Uses BuildQueryStatment to perform most of the work.
		 * @param QQCondition $objConditions any conditions on the query, itself
		 * @param QQClause[] $objOptionalClausees additional optional QQClause objects for this query
		 * @param mixed[] $mixParameterArray a array of name-value pairs to perform PrepareStatement with
		 * @return ClientesInternacional the queried object
		 */
		public static function QuerySingle(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null) {
			// Get the Query Statement
			try {
				$strQuery = ClientesInternacional::BuildQueryStatement($objQueryBuilder, $objConditions, $objOptionalClauses, $mixParameterArray, false);
			} catch (QCallerException $objExc) {
				$objExc->IncrementOffset();
				throw $objExc;
			}

			// Perform the Query, Get the First Row, and Instantiate a new ClientesInternacional object
			...
			if ($objQueryBuilder->ExpandAsArrayNode) {
				...
				while ($objDbRow = $objDbResult->GetNextRow()) {
					$objItem = ClientesInternacional::InstantiateDbRow($objDbRow, null, $objQueryBuilder->ExpandAsArrayNode, $objPrevItemArray, $objQueryBuilder->ColumnAliasArray);
					if ($objItem) {
						$objToReturn[] = $objItem;
				...
				if(null === $objDbRow)
					return null;
				return ClientesInternacional::InstantiateDbRow($objDbRow, null, null, null, $objQueryBuilder->ColumnAliasArray);
			}
		}

		/**
		 * Static Qcubed Query method to query for an array of ClientesInternacional objects.
		 * Uses BuildQueryStatment to perform most of the work.
		 * @param QQCondition $objConditions any conditions on the query, itself
		 * @param QQClause[] $objOptionalClausees additional optional QQClause objects for this query
		 * @param mixed[] $mixParameterArray a array of name-value pairs to perform PrepareStatement with
		 * @return ClientesInternacional[] the queried objects as an array
		 */
		public static function QueryArray(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null) {
			...
			$objDbResult = $objQueryBuilder->Database->Query($strQuery);
			return ClientesInternacional::InstantiateDbResult($objDbResult, $objQueryBuilder->ExpandAsArrayNode, $objQueryBuilder->ColumnAliasArray);
		}
		...
		/**
		 * Static Qcubed Query method to query for a count of ClientesInternacional objects.
		 * Uses BuildQueryStatment to perform most of the work.
		 * @param QQCondition $objConditions any conditions on the query, itself
		 * @param QQClause[] $objOptionalClausees additional optional QQClause objects for this query
		 * @param mixed[] $mixParameterArray a array of name-value pairs to perform PrepareStatement with
		...
		public static function QueryCount(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null) {
			// Get the Query Statement
			try {
				$strQuery = ClientesInternacional::BuildQueryStatement($objQueryBuilder, $objConditions, $objOptionalClauses, $mixParameterArray, true);
			} catch (QCallerException $objExc) {
				$objExc->IncrementOffset();
				throw $objExc;
			}
		...
		public static function QueryArrayCached(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null, $blnForceUpdate = false) {
			...
			$objCache = new QCache('qquery/clientesinternacional', $strQuery);
			$cacheData = $objCache->GetData();

			if (!$cacheData || $blnForceUpdate) {
				$objDbResult = $objQueryBuilder->Database->Query($strQuery);
				$arrResult = ClientesInternacional::InstantiateDbResult($objDbResult, $objQueryBuilder->ExpandAsArrayNode, $objQueryBuilder->ColumnAliasArray);
		...
		/**
		 * Updates a QQueryBuilder with the SELECT fields for this ClientesInternacional
		...
		public static function GetSelectFields(QQueryBuilder $objBuilder, $strPrefix = null, QQSelect $objSelect = null) {
			if ($strPrefix) {
				...
				$strTableName = 'clientes_internacional';
				$strAliasPrefix = '';
			}
		...
		/**
		 * Instantiate a ClientesInternacional from a Database Row.
		 * Takes in an optional strAliasPrefix, used in case another Object::InstantiateDbRow
		 * is calling this ClientesInternacional::InstantiateDbRow in order to perform
		 ...
		 * @param string[] $strColumnAliasArray
		 * @return mixed Either a ClientesInternacional, or false to indicate the dbrow was used in an expansion, or null to indicate that this leaf is a duplicate.
		*/
		public static function InstantiateDbRow($objDbRow, $strAliasPrefix = null, $objExpandAsArrayNode = null, $objPreviousItemArray = null, $strColumnAliasArray = array()) {
			...
			if ($objExpandAsArrayNode && 
				...
				if (ClientesInternacional::ExpandArray ($objDbRow, $strAliasPrefix, $objExpandAsArrayNode, $objPreviousItemArray, $strColumnAliasArray)) {
					return false; // db row was used but no new object was created
				}
			}

			// Create a new instance of the ClientesInternacional object
			$objToReturn = new ClientesInternacional();
			...
			if (!$strAliasPrefix)
				$strAliasPrefix = 'clientes_internacional__';
			...
			// Check for GuiasAsClienteInt Virtual Binding
			$strAlias = $strAliasPrefix . 'guiasasclienteint__id';
			$strAliasName = !empty($strColumnAliasArray[$strAlias]) ? $strColumnAliasArray[$strAlias] : $strAlias;
			$objExpansionNode = (empty($objExpansionAliasArray['guiasasclienteint']) ? null : $objExpansionAliasArray['guiasasclienteint']);
			$blnExpanded = ($objExpansionNode && $objExpansionNode->ExpandAsArray);
			if ($blnExpanded && null === $objToReturn->_objGuiasAsClienteIntArray)
				$objToReturn->_objGuiasAsClienteIntArray = array();
			if (!is_null($objDbRow->GetColumn($strAliasName))) {
				if ($blnExpanded) {
					$objToReturn->_objGuiasAsClienteIntArray[] = Guias::InstantiateDbRow($objDbRow, $strAliasPrefix . 'guiasasclienteint__', $objExpansionNode, null, $strColumnAliasArray);
				} elseif (is_null($objToReturn->_objGuiasAsClienteInt)) {
					$objToReturn->_objGuiasAsClienteInt = Guias::InstantiateDbRow($objDbRow, $strAliasPrefix . 'guiasasclienteint__', $objExpansionNode, null, $strColumnAliasArray);
				}
			}

			// Check for GuiasHAsClienteInt Virtual Binding
			$strAlias = $strAliasPrefix . 'guiashasclienteint__id';
			$strAliasName = !empty($strColumnAliasArray[$strAlias]) ? $strColumnAliasArray[$strAlias] : $strAlias;
			$objExpansionNode = (empty($objExpansionAliasArray['guiashasclienteint']) ? null : $objExpansionAliasArray['guiashasclienteint']);
			$blnExpanded = ($objExpansionNode && $objExpansionNode->ExpandAsArray);
			if ($blnExpanded && null === $objToReturn->_objGuiasHAsClienteIntArray)
				$objToReturn->_objGuiasHAsClienteIntArray = array();
			if (!is_null($objDbRow->GetColumn($strAliasName))) {
				if ($blnExpanded) {
					$objToReturn->_objGuiasHAsClienteIntArray[] = GuiasH::InstantiateDbRow($objDbRow, $strAliasPrefix . 'guiashasclienteint__', $objExpansionNode, null, $strColumnAliasArray);
				} elseif (is_null($objToReturn->_objGuiasHAsClienteInt)) {
					$objToReturn->_objGuiasHAsClienteInt = GuiasH::InstantiateDbRow($objDbRow, $strAliasPrefix . 'guiashasclienteint__', $objExpansionNode, null, $strColumnAliasArray);
				}
			}
		...
		/**
		 * Instantiate an array of ClientesInternacionals from a Database Result
		...
		public static function InstantiateDbResult(QDatabaseResultBase $objDbResult, $objExpandAsArrayNode = null, $strColumnAliasArray = null) {
			...
			if ($objExpandAsArrayNode) {
				...
				$objPrevItemArray = array();
				while ($objDbRow = $objDbResult->GetNextRow()) {
					$objItem = ClientesInternacional::InstantiateDbRow($objDbRow, null, $objExpandAsArrayNode, $objPrevItemArray, $strColumnAliasArray);
					if ($objItem) {
						$objToReturn[] = $objItem;
						$objPrevItemArray[$objItem->intId][] = $objItem;
				...
				while ($objDbRow = $objDbResult->GetNextRow())
					$objToReturn[] = ClientesInternacional::InstantiateDbRow($objDbRow, null, null, null, $strColumnAliasArray);
			}
		...
		/**
		 * Instantiate a single ClientesInternacional object from a query cursor (e.g. a DB ResultSet).
		 * Cursor is automatically moved to the "next row" of the result set.
		 * Will return NULL if no cursor or if the cursor has no more rows in the resultset.
		 * @param QDatabaseResultBase $objDbResult cursor resource
		 * @return ClientesInternacional next row resulting from the query
		 */
		public static function InstantiateCursor(QDatabaseResultBase $objDbResult) {
			...
			return ClientesInternacional::InstantiateDbRow($objDbRow, null, null, null, $strColumnAliasArray);
		}
		...
		/**
		 * Load a single ClientesInternacional object,
		 * by Id Index(es)
		 * @param integer $intId
		 * @param QQClause[] $objOptionalClauses additional optional QQClause objects for this query
		 * @return ClientesInternacional
		*/
		public static function LoadById($intId, $objOptionalClauses = null) {
			return ClientesInternacional::QuerySingle(
				QQ::AndCondition(
					QQ::Equal(QQN::ClientesInternacional()->Id, $intId)
				),
				$objOptionalClauses
		...
		/**
		 * Load an array of ClientesInternacional objects,
		...
		*/
		public static function LoadArrayBySucursalId($intSucursalId, $objOptionalClauses = null) {
			// Call ClientesInternacional::QueryArray to perform the LoadArrayBySucursalId query
			try {
				return ClientesInternacional::QueryArray(
					QQ::Equal(QQN::ClientesInternacional()->SucursalId, $intSucursalId),
					$objOptionalClauses);
			} catch (QCallerException $objExc) {
				$objExc->IncrementOffset();
				throw $objExc;
		...
		/**
		 * Count ClientesInternacionals
		 * by SucursalId Index(es)
		 * @param integer $intSucursalId
		 * @return int
		*/
		public static function CountBySucursalId($intSucursalId) {
			// Call ClientesInternacional::QueryCount to perform the CountBySucursalId query
			return ClientesInternacional::QueryCount(
				QQ::Equal(QQN::ClientesInternacional()->SucursalId, $intSucursalId)
			);
		}
		...
		*/
		public static function LoadArrayByProfesionId($intProfesionId, $objOptionalClauses = null) {
			// Call ClientesInternacional::QueryArray to perform the LoadArrayByProfesionId query
			try {
				return ClientesInternacional::QueryArray(
					QQ::Equal(QQN::ClientesInternacional()->ProfesionId, $intProfesionId),
					$objOptionalClauses);
			} catch (QCallerException $objExc) {
				$objExc->IncrementOffset();
				throw $objExc;
		...
		*/
		public static function CountByProfesionId($intProfesionId) {
			// Call ClientesInternacional::QueryCount to perform the CountByProfesionId query
			return ClientesInternacional::QueryCount(
				QQ::Equal(QQN::ClientesInternacional()->ProfesionId, $intProfesionId)
			);
		}
		...
		/**
		 * Save this ClientesInternacional
			...
			try {
				if ((!$this->__blnRestored) || ($blnForceInsert)) {
					...
					$objDatabase->NonQuery('
						INSERT INTO `clientes_internacional` (
							`codigo`,
							`nombre`,
							`sucursal_id`,
							`telefono_movil`,
					...
					$mixToReturn = $this->intId = $objDatabase->InsertId('clientes_internacional', 'id');
				} else {
					...
					if (!$blnForceUpdate) {
						...
						if ($objRow[0] != $this->strCreatedAt)
							throw new QOptimisticLockingException('ClientesInternacional');
					}
					if (!$blnForceUpdate) {
						// Perform the Optimistic Locking check
						$objResult = $objDatabase->Query('
		...
		/**
		 * Delete this ClientesInternacional
		 * @return void
		 */
		public function Delete() {
			if ((is_null($this->intId)))
				throw new QUndefinedPrimaryKeyException('Cannot delete this ClientesInternacional with an unset primary key.');
        ...
        /**
 	     * Delete this ClientesInternacional ONLY from the cache
 		 * @return void
		 */
		public function DeleteCache() {
			if (QApplication::$objCacheProvider && QApplication::$Database[1]->Caching) {
				$strCacheKey = QApplication::$objCacheProvider->CreateKey(QApplication::$Database[1]->Database, 'ClientesInternacional', $this->intId);
				QApplication::$objCacheProvider->Delete($strCacheKey);
			}
		}

		/**
		 * Delete all ClientesInternacionals
		 * @return void
		 */
		...
		/**
		 * Truncate clientes_internacional table
		 * @return void
		 */
		public static function Truncate() {
			...
			// Perform the Query
			$objDatabase->NonQuery('
				TRUNCATE `clientes_internacional`');
		...
		/**
		 * Reload this ClientesInternacional from the database.
		 * @return void
		 */
		public function Reload() {
			// Make sure we are actually Restored from the database
			if (!$this->__blnRestored)
				throw new QCallerException('Cannot call Reload() on a new, unsaved ClientesInternacional object.');

			$this->DeleteCache();

			// Reload the Object
			$objReloaded = ClientesInternacional::Load($this->intId);
		...
		public function __get($strName) {
			switch ($strName) {
				...
				case '_GuiasAsClienteInt':
					/**
					 * Gets the value for the private _objGuiasAsClienteInt (Read-Only)
					 * if set due to an expansion on the guias.cliente_int_id reverse relationship
					 * @return Guias
					 */
					return $this->_objGuiasAsClienteInt;

				case '_GuiasAsClienteIntArray':
					/**
					 * Gets the value for the private _objGuiasAsClienteIntArray (Read-Only)
					 * if set due to an ExpandAsArray on the guias.cliente_int_id reverse relationship
					 * @return Guias[]
					 */
					return $this->_objGuiasAsClienteIntArray;

				case '_GuiasHAsClienteInt':
					/**
					 * Gets the value for the private _objGuiasHAsClienteInt (Read-Only)
					 * if set due to an expansion on the guias_h.cliente_int_id reverse relationship
					 * @return GuiasH
					 */
					return $this->_objGuiasHAsClienteInt;

				case '_GuiasHAsClienteIntArray':
					/**
					 * Gets the value for the private _objGuiasHAsClienteIntArray (Read-Only)
					 * if set due to an ExpandAsArray on the guias_h.cliente_int_id reverse relationship
					 * @return GuiasH[]
					 */
					return $this->_objGuiasHAsClienteIntArray;
			...
			switch ($strName) {
				...
				case 'Sucursal':
					...
					if (is_null($mixValue)) {
						...
						if (is_null($mixValue->Id))
							throw new QCallerException('Unable to set an unsaved Sucursal for this ClientesInternacional');
				...
				case 'Profesion':
					...
					if (is_null($mixValue)) {
						...
						if (is_null($mixValue->Id))
							throw new QCallerException('Unable to set an unsaved Profesion for this ClientesInternacional');
		...
		public function TablasRelacionadas() {
			$arrTablRela = array();
			if ($this->CountGuiasesAsClienteInt()) {
				$arrTablRela[] = 'guias';
			}
			if ($this->CountGuiasHsAsClienteInt()) {
				$arrTablRela[] = 'guias_h';
			}
		...
		// Related Objects' Methods for GuiasAsClienteInt
		//-------------------------------------------------------------------

		/**
		 * Gets all associated GuiasesAsClienteInt as an array of Guias objects
		 * @param QQClause[] $objOptionalClauses additional optional QQClause objects for this query
		 * @return Guias[]
		*/
		public function GetGuiasAsClienteIntArray($objOptionalClauses = null) {
			if ((is_null($this->intId)))
				return array();

			try {
				return Guias::LoadArrayByClienteIntId($this->intId, $objOptionalClauses);
			} catch (QCallerException $objExc) {
				$objExc->IncrementOffset();
				throw $objExc;
			}
		...
		/**
		 * Counts all associated GuiasesAsClienteInt
		 * @return int
		*/
		public function CountGuiasesAsClienteInt() {
			if ((is_null($this->intId)))
				return 0;

			return Guias::CountByClienteIntId($this->intId);
		}

		/**
		 * Associates a GuiasAsClienteInt
		 * @param Guias $objGuias
		 * @return void
		*/
		public function AssociateGuiasAsClienteInt(Guias $objGuias) {
			if ((is_null($this->intId)))
				throw new QUndefinedPrimaryKeyException('Unable to call AssociateGuiasAsClienteInt on this unsaved ClientesInternacional.');
			if ((is_null($objGuias->Id)))
				throw new QUndefinedPrimaryKeyException('Unable to call AssociateGuiasAsClienteInt on this ClientesInternacional with an unsaved Guias.');
			...
			$objDatabase->NonQuery('
				UPDATE
					`guias`
				SET
					`cliente_int_id` = ' . $objDatabase->SqlVariable($this->intId) . '
				WHERE
		...
		/**
		 * Unassociates a GuiasAsClienteInt
		 * @param Guias $objGuias
		 * @return void
		*/
		public function UnassociateGuiasAsClienteInt(Guias $objGuias) {
			if ((is_null($this->intId)))
				throw new QUndefinedPrimaryKeyException('Unable to call UnassociateGuiasAsClienteInt on this unsaved ClientesInternacional.');
			if ((is_null($objGuias->Id)))
				throw new QUndefinedPrimaryKeyException('Unable to call UnassociateGuiasAsClienteInt on this ClientesInternacional with an unsaved Guias.');
		...
		/**
		 * Unassociates all GuiasesAsClienteInt
		 * @return void
		*/
		public function UnassociateAllGuiasesAsClienteInt() {
			if ((is_null($this->intId)))
				throw new QUndefinedPrimaryKeyException('Unable to call UnassociateGuiasAsClienteInt on this unsaved ClientesInternacional.');
		...
		/**
		 * Deletes an associated GuiasAsClienteInt
		 * @param Guias $objGuias
		 * @return void
		*/
		public function DeleteAssociatedGuiasAsClienteInt(Guias $objGuias) {
			if ((is_null($this->intId)))
				throw new QUndefinedPrimaryKeyException('Unable to call UnassociateGuiasAsClienteInt on this unsaved ClientesInternacional.');
			if ((is_null($objGuias->Id)))
				throw new QUndefinedPrimaryKeyException('Unable to call UnassociateGuiasAsClienteInt on this ClientesInternacional with an unsaved Guias.');
		...
		/**
		 * Deletes all associated GuiasesAsClienteInt
		 * @return void
		*/
		public function DeleteAllGuiasesAsClienteInt() {
			if ((is_null($this->intId)))
				throw new QUndefinedPrimaryKeyException('Unable to call UnassociateGuiasAsClienteInt on this unsaved ClientesInternacional.');
		...
		// Related Objects' Methods for GuiasHAsClienteInt
		//-------------------------------------------------------------------

		/**
		 * Gets all associated GuiasHsAsClienteInt as an array of GuiasH objects
		 * @param QQClause[] $objOptionalClauses additional optional QQClause objects for this query
		 * @return GuiasH[]
		*/
		public function GetGuiasHAsClienteIntArray($objOptionalClauses = null) {
			if ((is_null($this->intId)))
				return array();

			try {
				return GuiasH::LoadArrayByClienteIntId($this->intId, $objOptionalClauses);
			} catch (QCallerException $objExc) {
				$objExc->IncrementOffset();
				throw $objExc;
			}
		...
		/**
		 * Counts all associated GuiasHsAsClienteInt
		 * @return int
		*/
		public function CountGuiasHsAsClienteInt() {
			if ((is_null($this->intId)))
				return 0;

			return GuiasH::CountByClienteIntId($this->intId);
		}

		/**
		 * Associates a GuiasHAsClienteInt
		 * @param GuiasH $objGuiasH
		 * @return void
		*/
		public function AssociateGuiasHAsClienteInt(GuiasH $objGuiasH) {
			if ((is_null($this->intId)))
				throw new QUndefinedPrimaryKeyException('Unable to call AssociateGuiasHAsClienteInt on this unsaved ClientesInternacional.');
			if ((is_null($objGuiasH->Id)))
				throw new QUndefinedPrimaryKeyException('Unable to call AssociateGuiasHAsClienteInt on this ClientesInternacional with an unsaved GuiasH.');
		...
		/**
		 * Unassociates a GuiasHAsClienteInt
		 * @param GuiasH $objGuiasH
		 * @return void
		*/
		public function UnassociateGuiasHAsClienteInt(GuiasH $objGuiasH) {
			if ((is_null($this->intId)))
				throw new QUndefinedPrimaryKeyException('Unable to call UnassociateGuiasHAsClienteInt on this unsaved ClientesInternacional.');
			if ((is_null($objGuiasH->Id)))
				throw new QUndefinedPrimaryKeyException('Unable to call UnassociateGuiasHAsClienteInt on this ClientesInternacional with an unsaved GuiasH.');
		...
		/**
		 * Unassociates all GuiasHsAsClienteInt
		 * @return void
		*/
		public function UnassociateAllGuiasHsAsClienteInt() {
			if ((is_null($this->intId)))
				throw new QUndefinedPrimaryKeyException('Unable to call UnassociateGuiasHAsClienteInt on this unsaved ClientesInternacional.');
		...
		/**
		 * Deletes an associated GuiasHAsClienteInt
		 * @param GuiasH $objGuiasH
		 * @return void
		*/
		public function DeleteAssociatedGuiasHAsClienteInt(GuiasH $objGuiasH) {
			if ((is_null($this->intId)))
				throw new QUndefinedPrimaryKeyException('Unable to call UnassociateGuiasHAsClienteInt on this unsaved ClientesInternacional.');
			if ((is_null($objGuiasH->Id)))
				throw new QUndefinedPrimaryKeyException('Unable to call UnassociateGuiasHAsClienteInt on this ClientesInternacional with an unsaved GuiasH.');
		...
		/**
		 * Deletes all associated GuiasHsAsClienteInt
		 * @return void
		*/
		public function DeleteAllGuiasHsAsClienteInt() {
			if ((is_null($this->intId)))
				throw new QUndefinedPrimaryKeyException('Unable to call UnassociateGuiasHAsClienteInt on this unsaved ClientesInternacional.');
		...
		public static function GetDatabaseName() {
			return QApplication::$Database[ClientesInternacional::GetDatabaseIndex()]->Database;
		}
		...
		public static function GetSoapComplexTypeXml() {
			$strToReturn = '<complexType name="ClientesInternacional"><sequence>';
		...
		public static function AlterSoapComplexTypeArray(&$strComplexTypeArray) {
			if (!array_key_exists('ClientesInternacional', $strComplexTypeArray)) {
				$strComplexTypeArray['ClientesInternacional'] = ClientesInternacional::GetSoapComplexTypeXml();
		...
		public static function GetArrayFromSoapArray($objSoapArray) {
			...
			foreach ($objSoapArray as $objSoapObject)
				array_push($objArrayToReturn, ClientesInternacional::GetObjectFromSoapObject($objSoapObject));
		...
		public static function GetSoapArrayFromArray($objArray) {
			...
			foreach ($objArray as $objObject)
				array_push($objArrayToReturn, ClientesInternacional::GetSoapObjectFromObject($objObject, true));
     ...
     *
     *
     * @property-read QQReverseReferenceNodeGuias $GuiasAsClienteInt
     * @property-read QQReverseReferenceNodeGuiasH $GuiasHAsClienteInt

     * @property-read QQNode $_PrimaryKeyNode
     **/
	class QQNodeClientesInternacional extends QQNode {
		protected $strTableName = 'clientes_internacional';
		protected $strPrimaryKey = 'id';
		protected $strClassName = 'ClientesInternacional';
		public function __get($strName) {
			switch ($strName) {
				case 'Id':
				...
				case 'GuiasAsClienteInt':
					return new QQReverseReferenceNodeGuias($this, 'guiasasclienteint', 'reverse_reference', 'cliente_int_id', 'GuiasAsClienteInt');
				case 'GuiasHAsClienteInt':
					return new QQReverseReferenceNodeGuiasH($this, 'guiashasclienteint', 'reverse_reference', 'cliente_int_id', 'GuiasHAsClienteInt');
     ...
     * @property-read QQNode $_PrimaryKeyNode
     **/
	class QQReverseReferenceNodeClientesInternacional extends QQReverseReferenceNode {
		protected $strTableName = 'clientes_internacional';
		protected $strPrimaryKey = 'id';
		protected $strClassName = 'ClientesInternacional';
		public function __get($strName) {
