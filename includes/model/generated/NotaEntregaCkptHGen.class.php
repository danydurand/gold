<?php
	/**
	 * The abstract NotaEntregaCkptHGen class defined here is
	 * code-generated and contains all the basic CRUD-type functionality as well as
	 * basic methods to handle relationships and index-based loading.
	 *
	 * To use, you should use the NotaEntregaCkptH subclass which
	 * extends this NotaEntregaCkptHGen class.
	 *
	 * Because subsequent re-code generations will overwrite any changes to this
	 * file, you should leave this file unaltered to prevent yourself from losing
	 * any information or code changes.  All customizations should be done by
	 * overriding existing or implementing new methods, properties and variables
	 * in the NotaEntregaCkptH class.
	 *
	 ...
	 * @property NotaEntregaH $Container the value for the NotaEntregaH object referenced by intContainerId (Not Null)
	 ...
	 */
	class NotaEntregaCkptHGen extends QBaseClass implements IteratorAggregate {
		...
		/**
		 * Protected member variable that maps to the database PK Identity column nota_entrega_ckpt_h.id
		 * @var integer intId
		 */
		protected $intId;
		...
		/**
		 * Protected member variable that maps to the database column nota_entrega_ckpt_h.container_id
		...
		/**
		 * Protected member variable that maps to the database column nota_entrega_ckpt_h.checkpoint_id
		...
		/**
		 * Protected member variable that maps to the database column nota_entrega_ckpt_h.sucursal_id
		...
		/**
		 * Protected member variable that maps to the database column nota_entrega_ckpt_h.fecha
		...
		/**
		 * Protected member variable that maps to the database column nota_entrega_ckpt_h.hora
		 * @var string strHora
		 */
		protected $strHora;
		...
		/**
		 * Protected member variable that maps to the database column nota_entrega_ckpt_h.usuario_id
		...
		/**
		 * Protected member variable that maps to the database column nota_entrega_ckpt_h.observacion
		...
		/**
		 * Protected member variable that maps to the database column nota_entrega_ckpt_h.created_at
		...
		/**
		 * Protected member variable that maps to the database column nota_entrega_ckpt_h.updated_at
		...
		/**
		 * Protected member variable that maps to the database column nota_entrega_ckpt_h.created_by
		...
		/**
		 * Protected member variable that maps to the database column nota_entrega_ckpt_h.updated_by
		 ...
		 * in the database column nota_entrega_ckpt_h.container_id.
		 *
		 * NOTE: Always use the Container property getter to correctly retrieve this NotaEntregaH object.
		 * (Because this class implements late binding, this variable reference MAY be null.)
		 * @var NotaEntregaH objContainer
		 */
		protected $objContainer;

		/**
		 * Protected member variable that contains the object pointed by the reference
		 * in the database column nota_entrega_ckpt_h.checkpoint_id.
		 *
		...
		/**
		 * Protected member variable that contains the object pointed by the reference
		 * in the database column nota_entrega_ckpt_h.sucursal_id.
		 *
		...
		/**
		 * Protected member variable that contains the object pointed by the reference
		 * in the database column nota_entrega_ckpt_h.usuario_id.
		 *
		...
		{
			$this->intId = NotaEntregaCkptH::IdDefault;
			$this->intContainerId = NotaEntregaCkptH::ContainerIdDefault;
			$this->intCheckpointId = NotaEntregaCkptH::CheckpointIdDefault;
			$this->intSucursalId = NotaEntregaCkptH::SucursalIdDefault;
			$this->dttFecha = (NotaEntregaCkptH::FechaDefault === null)?null:new QDateTime(NotaEntregaCkptH::FechaDefault);
			$this->strHora = NotaEntregaCkptH::HoraDefault;
			$this->intUsuarioId = NotaEntregaCkptH::UsuarioIdDefault;
			$this->strObservacion = NotaEntregaCkptH::ObservacionDefault;
			$this->strCreatedAt = NotaEntregaCkptH::CreatedAtDefault;
			$this->strUpdatedAt = NotaEntregaCkptH::UpdatedAtDefault;
			$this->intCreatedBy = NotaEntregaCkptH::CreatedByDefault;
			$this->intUpdatedBy = NotaEntregaCkptH::UpdatedByDefault;
		}
		...
		/**
		 * Load a NotaEntregaCkptH from PK Info
		 * @param integer $intId
		...
		public static function Load($intId, $objOptionalClauses = null) {
			...
			if (QApplication::$objCacheProvider && !$objOptionalClauses && QApplication::$Database[1]->Caching) {
				$strCacheKey = QApplication::$objCacheProvider->CreateKey(QApplication::$Database[1]->Database, 'NotaEntregaCkptH', $intId);
			...
			$objToReturn = NotaEntregaCkptH::QuerySingle(
				QQ::AndCondition(
					QQ::Equal(QQN::NotaEntregaCkptH()->Id, $intId)
				),
				$objOptionalClauses
			);
		...
		public static function LoadAll($objOptionalClauses = null) {
			...
			// Call NotaEntregaCkptH::QueryArray to perform the LoadAll query
			try {
				return NotaEntregaCkptH::QueryArray(QQ::All(), $objOptionalClauses);
		...
		/**
		 * Count all NotaEntregaCkptHs
		 * @return int
		 */
		public static function CountAll() {
			// Call NotaEntregaCkptH::QueryCount to perform the CountAll query
			return NotaEntregaCkptH::QueryCount(QQ::All());
		}
		...
		protected static function BuildQueryStatement(&$objQueryBuilder, QQCondition $objConditions, $objOptionalClauses, $mixParameterArray, $blnCountOnly) {
			...
			// Create/Build out the QueryBuilder object with NotaEntregaCkptH-specific SELET and FROM fields
			$objQueryBuilder = new QQueryBuilder($objDatabase, 'nota_entrega_ckpt_h');
			...
			if ($blnAddAllFieldsToSelect) {
				NotaEntregaCkptH::GetSelectFields($objQueryBuilder, null, QQuery::extractSelectClause($objOptionalClauses));
			}
			$objQueryBuilder->AddFromItem('nota_entrega_ckpt_h');
		...
		/**
		 * Static Qcubed Query method to query for a single NotaEntregaCkptH object.
		 * Uses BuildQueryStatment to perform most of the work.
		 * @param QQCondition $objConditions any conditions on the query, itself
		 * @param QQClause[] $objOptionalClausees additional optional QQClause objects for this query
		 * @param mixed[] $mixParameterArray a array of name-value pairs to perform PrepareStatement with
		 * @return NotaEntregaCkptH the queried object
		 */
		public static function QuerySingle(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null) {
			// Get the Query Statement
			try {
				$strQuery = NotaEntregaCkptH::BuildQueryStatement($objQueryBuilder, $objConditions, $objOptionalClauses, $mixParameterArray, false);
			} catch (QCallerException $objExc) {
				$objExc->IncrementOffset();
				throw $objExc;
			}

			// Perform the Query, Get the First Row, and Instantiate a new NotaEntregaCkptH object
			...
			if ($objQueryBuilder->ExpandAsArrayNode) {
				...
				while ($objDbRow = $objDbResult->GetNextRow()) {
					$objItem = NotaEntregaCkptH::InstantiateDbRow($objDbRow, null, $objQueryBuilder->ExpandAsArrayNode, $objPrevItemArray, $objQueryBuilder->ColumnAliasArray);
					if ($objItem) {
						$objToReturn[] = $objItem;
				...
				if(null === $objDbRow)
					return null;
				return NotaEntregaCkptH::InstantiateDbRow($objDbRow, null, null, null, $objQueryBuilder->ColumnAliasArray);
			}
		}

		/**
		 * Static Qcubed Query method to query for an array of NotaEntregaCkptH objects.
		 * Uses BuildQueryStatment to perform most of the work.
		 * @param QQCondition $objConditions any conditions on the query, itself
		 * @param QQClause[] $objOptionalClausees additional optional QQClause objects for this query
		 * @param mixed[] $mixParameterArray a array of name-value pairs to perform PrepareStatement with
		 * @return NotaEntregaCkptH[] the queried objects as an array
		 */
		public static function QueryArray(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null) {
			...
			$objDbResult = $objQueryBuilder->Database->Query($strQuery);
			return NotaEntregaCkptH::InstantiateDbResult($objDbResult, $objQueryBuilder->ExpandAsArrayNode, $objQueryBuilder->ColumnAliasArray);
		}
		...
		/**
		 * Static Qcubed Query method to query for a count of NotaEntregaCkptH objects.
		 * Uses BuildQueryStatment to perform most of the work.
		 * @param QQCondition $objConditions any conditions on the query, itself
		 * @param QQClause[] $objOptionalClausees additional optional QQClause objects for this query
		 * @param mixed[] $mixParameterArray a array of name-value pairs to perform PrepareStatement with
		...
		public static function QueryCount(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null) {
			// Get the Query Statement
			try {
				$strQuery = NotaEntregaCkptH::BuildQueryStatement($objQueryBuilder, $objConditions, $objOptionalClauses, $mixParameterArray, true);
			} catch (QCallerException $objExc) {
				$objExc->IncrementOffset();
				throw $objExc;
			}
		...
		public static function QueryArrayCached(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null, $blnForceUpdate = false) {
			...
			$objCache = new QCache('qquery/notaentregackpth', $strQuery);
			$cacheData = $objCache->GetData();

			if (!$cacheData || $blnForceUpdate) {
				$objDbResult = $objQueryBuilder->Database->Query($strQuery);
				$arrResult = NotaEntregaCkptH::InstantiateDbResult($objDbResult, $objQueryBuilder->ExpandAsArrayNode, $objQueryBuilder->ColumnAliasArray);
		...
		/**
		 * Updates a QQueryBuilder with the SELECT fields for this NotaEntregaCkptH
		...
		public static function GetSelectFields(QQueryBuilder $objBuilder, $strPrefix = null, QQSelect $objSelect = null) {
			if ($strPrefix) {
				...
				$strTableName = 'nota_entrega_ckpt_h';
				$strAliasPrefix = '';
			}
		...
		/**
		 * Instantiate a NotaEntregaCkptH from a Database Row.
		 * Takes in an optional strAliasPrefix, used in case another Object::InstantiateDbRow
		 * is calling this NotaEntregaCkptH::InstantiateDbRow in order to perform
		 ...
		 * @param string[] $strColumnAliasArray
		 * @return mixed Either a NotaEntregaCkptH, or false to indicate the dbrow was used in an expansion, or null to indicate that this leaf is a duplicate.
		*/
		public static function InstantiateDbRow($objDbRow, $strAliasPrefix = null, $objExpandAsArrayNode = null, $objPreviousItemArray = null, $strColumnAliasArray = array()) {
			...
			if ($objExpandAsArrayNode && 
				...
				if (NotaEntregaCkptH::ExpandArray ($objDbRow, $strAliasPrefix, $objExpandAsArrayNode, $objPreviousItemArray, $strColumnAliasArray)) {
					return false; // db row was used but no new object was created
				}
			}

			// Create a new instance of the NotaEntregaCkptH object
			$objToReturn = new NotaEntregaCkptH();
			...
			if (!$strAliasPrefix)
				$strAliasPrefix = 'nota_entrega_ckpt_h__';
			...
			if (!is_null($objDbRow->GetColumn($strAliasName))) {
				...
				$objToReturn->objContainer = NotaEntregaH::InstantiateDbRow($objDbRow, $strAliasPrefix . 'container_id__', $objExpansionNode, null, $strColumnAliasArray);
			}
		...
		/**
		 * Instantiate an array of NotaEntregaCkptHs from a Database Result
		...
		public static function InstantiateDbResult(QDatabaseResultBase $objDbResult, $objExpandAsArrayNode = null, $strColumnAliasArray = null) {
			...
			if ($objExpandAsArrayNode) {
				...
				$objPrevItemArray = array();
				while ($objDbRow = $objDbResult->GetNextRow()) {
					$objItem = NotaEntregaCkptH::InstantiateDbRow($objDbRow, null, $objExpandAsArrayNode, $objPrevItemArray, $strColumnAliasArray);
					if ($objItem) {
						$objToReturn[] = $objItem;
						$objPrevItemArray[$objItem->intId][] = $objItem;
				...
				while ($objDbRow = $objDbResult->GetNextRow())
					$objToReturn[] = NotaEntregaCkptH::InstantiateDbRow($objDbRow, null, null, null, $strColumnAliasArray);
			}
		...
		/**
		 * Instantiate a single NotaEntregaCkptH object from a query cursor (e.g. a DB ResultSet).
		 * Cursor is automatically moved to the "next row" of the result set.
		 * Will return NULL if no cursor or if the cursor has no more rows in the resultset.
		 * @param QDatabaseResultBase $objDbResult cursor resource
		 * @return NotaEntregaCkptH next row resulting from the query
		 */
		public static function InstantiateCursor(QDatabaseResultBase $objDbResult) {
			...
			return NotaEntregaCkptH::InstantiateDbRow($objDbRow, null, null, null, $strColumnAliasArray);
		}
		...
		/**
		 * Load a single NotaEntregaCkptH object,
		 * by Id Index(es)
		 * @param integer $intId
		 * @param QQClause[] $objOptionalClauses additional optional QQClause objects for this query
		 * @return NotaEntregaCkptH
		*/
		...
		/**
		 * Load an array of NotaEntregaCkptH objects,
		...
		*/
		public static function LoadArrayByContainerId($intContainerId, $objOptionalClauses = null) {
			// Call NotaEntregaCkptH::QueryArray to perform the LoadArrayByContainerId query
			try {
				return NotaEntregaCkptH::QueryArray(
					QQ::Equal(QQN::NotaEntregaCkptH()->ContainerId, $intContainerId),
					$objOptionalClauses);
			} catch (QCallerException $objExc) {
				$objExc->IncrementOffset();
				throw $objExc;
		...
		/**
		 * Count NotaEntregaCkptHs
		 * by ContainerId Index(es)
		 * @param integer $intContainerId
		 * @return int
		*/
		public static function CountByContainerId($intContainerId) {
			// Call NotaEntregaCkptH::QueryCount to perform the CountByContainerId query
		...
		*/
		public static function LoadArrayByCheckpointId($intCheckpointId, $objOptionalClauses = null) {
			// Call NotaEntregaCkptH::QueryArray to perform the LoadArrayByCheckpointId query
			try {
				return NotaEntregaCkptH::QueryArray(
					QQ::Equal(QQN::NotaEntregaCkptH()->CheckpointId, $intCheckpointId),
					$objOptionalClauses);
			} catch (QCallerException $objExc) {
				$objExc->IncrementOffset();
				throw $objExc;
		...
		*/
		public static function CountByCheckpointId($intCheckpointId) {
			// Call NotaEntregaCkptH::QueryCount to perform the CountByCheckpointId query
			return NotaEntregaCkptH::QueryCount(
				QQ::Equal(QQN::NotaEntregaCkptH()->CheckpointId, $intCheckpointId)
			);
		}
		...
		*/
		public static function LoadArrayBySucursalId($intSucursalId, $objOptionalClauses = null) {
			// Call NotaEntregaCkptH::QueryArray to perform the LoadArrayBySucursalId query
			try {
				return NotaEntregaCkptH::QueryArray(
					QQ::Equal(QQN::NotaEntregaCkptH()->SucursalId, $intSucursalId),
					$objOptionalClauses);
			} catch (QCallerException $objExc) {
				$objExc->IncrementOffset();
				throw $objExc;
		...
		*/
		public static function CountBySucursalId($intSucursalId) {
			// Call NotaEntregaCkptH::QueryCount to perform the CountBySucursalId query
			return NotaEntregaCkptH::QueryCount(
				QQ::Equal(QQN::NotaEntregaCkptH()->SucursalId, $intSucursalId)
			);
		}
		...
		*/
		public static function LoadArrayByUsuarioId($intUsuarioId, $objOptionalClauses = null) {
			// Call NotaEntregaCkptH::QueryArray to perform the LoadArrayByUsuarioId query
			try {
				return NotaEntregaCkptH::QueryArray(
					QQ::Equal(QQN::NotaEntregaCkptH()->UsuarioId, $intUsuarioId),
					$objOptionalClauses);
			} catch (QCallerException $objExc) {
				$objExc->IncrementOffset();
				throw $objExc;
		...
		*/
		public static function CountByUsuarioId($intUsuarioId) {
			// Call NotaEntregaCkptH::QueryCount to perform the CountByUsuarioId query
			return NotaEntregaCkptH::QueryCount(
				QQ::Equal(QQN::NotaEntregaCkptH()->UsuarioId, $intUsuarioId)
			);
		}
			...
			try {
				if ((!$this->__blnRestored) || ($blnForceInsert)) {
					...
					$objDatabase->NonQuery('
						INSERT INTO `nota_entrega_ckpt_h` (
							`container_id`,
							`checkpoint_id`,
							`sucursal_id`,
							`fecha`,
					...
					$mixToReturn = $this->intId = $objDatabase->InsertId('nota_entrega_ckpt_h', 'id');
				} else {
					...
					if (!$blnForceUpdate) {
						...
						if ($objRow[0] != $this->strCreatedAt)
							throw new QOptimisticLockingException('NotaEntregaCkptH');
					}
					if (!$blnForceUpdate) {
						// Perform the Optimistic Locking check
						$objResult = $objDatabase->Query('
		...
		/**
		 * Delete this NotaEntregaCkptH
		 * @return void
		 */
		public function Delete() {
			if ((is_null($this->intId)))
				throw new QUndefinedPrimaryKeyException('Cannot delete this NotaEntregaCkptH with an unset primary key.');
        ...
        /**
 	     * Delete this NotaEntregaCkptH ONLY from the cache
 		 * @return void
		 */
		public function DeleteCache() {
			if (QApplication::$objCacheProvider && QApplication::$Database[1]->Caching) {
				$strCacheKey = QApplication::$objCacheProvider->CreateKey(QApplication::$Database[1]->Database, 'NotaEntregaCkptH', $this->intId);
				QApplication::$objCacheProvider->Delete($strCacheKey);
			}
		}

		/**
		 * Delete all NotaEntregaCkptHs
		 * @return void
		 */
		...
		/**
		 * Truncate nota_entrega_ckpt_h table
		 * @return void
		 */
		...
		/**
		 * Reload this NotaEntregaCkptH from the database.
		 * @return void
		 */
		public function Reload() {
			// Make sure we are actually Restored from the database
			if (!$this->__blnRestored)
				throw new QCallerException('Cannot call Reload() on a new, unsaved NotaEntregaCkptH object.');

			$this->DeleteCache();

			// Reload the Object
			$objReloaded = NotaEntregaCkptH::Load($this->intId);
		...
		public function __get($strName) {
			switch ($strName) {
				...
				case 'Container':
					/**
					 * Gets the value for the NotaEntregaH object referenced by intContainerId (Not Null)
					 * @return NotaEntregaH
					 */
					try {
						if ((!$this->objContainer) && (!is_null($this->intContainerId)))
							$this->objContainer = NotaEntregaH::Load($this->intContainerId);
		...
		public function __set($strName, $mixValue) {
			switch ($strName) {
				...
				case 'Container':
					/**
					 * Sets the value for the NotaEntregaH object referenced by intContainerId (Not Null)
					...
					if (is_null($mixValue)) {
						...
						if (is_null($mixValue->Id))
							throw new QCallerException('Unable to set an unsaved Container for this NotaEntregaCkptH');
				...
				case 'Checkpoint':
					...
					if (is_null($mixValue)) {
						...
						if (is_null($mixValue->Id))
							throw new QCallerException('Unable to set an unsaved Checkpoint for this NotaEntregaCkptH');
				...
				case 'Sucursal':
					...
					if (is_null($mixValue)) {
						...
						if (is_null($mixValue->Id))
							throw new QCallerException('Unable to set an unsaved Sucursal for this NotaEntregaCkptH');
				...
				case 'Usuario':
					...
					if (is_null($mixValue)) {
						...
						if (is_null($mixValue->CodiUsua))
							throw new QCallerException('Unable to set an unsaved Usuario for this NotaEntregaCkptH');
		...
		public static function GetDatabaseName() {
			return QApplication::$Database[NotaEntregaCkptH::GetDatabaseIndex()]->Database;
		}
		...
		public static function GetSoapComplexTypeXml() {
			$strToReturn = '<complexType name="NotaEntregaCkptH"><sequence>';
			$strToReturn .= '<element name="Id" type="xsd:int"/>';
			$strToReturn .= '<element name="Container" type="xsd1:NotaEntregaH"/>';
		...
		public static function AlterSoapComplexTypeArray(&$strComplexTypeArray) {
			if (!array_key_exists('NotaEntregaCkptH', $strComplexTypeArray)) {
				$strComplexTypeArray['NotaEntregaCkptH'] = NotaEntregaCkptH::GetSoapComplexTypeXml();
		...
		public static function GetArrayFromSoapArray($objSoapArray) {
			...
			foreach ($objSoapArray as $objSoapObject)
				array_push($objArrayToReturn, NotaEntregaCkptH::GetObjectFromSoapObject($objSoapObject));
		...
		public static function GetObjectFromSoapObject($objSoapObject) {
			...
			if ((property_exists($objSoapObject, 'Container')) &&
				...
				$objToReturn->Container = NotaEntregaH::GetObjectFromSoapObject($objSoapObject->Container);
		...
		public static function GetSoapArrayFromArray($objArray) {
			...
			foreach ($objArray as $objObject)
				array_push($objArrayToReturn, NotaEntregaCkptH::GetSoapObjectFromObject($objObject, true));
		...
		public static function GetSoapObjectFromObject($objObject, $blnBindRelatedObjects) {
			if ($objObject->objContainer)
				$objObject->objContainer = NotaEntregaH::GetSoapObjectFromObject($objObject->objContainer, false);
     ...
     * @property-read QQNodeNotaEntregaH $Container
     ...
     **/
	class QQNodeNotaEntregaCkptH extends QQNode {
		protected $strTableName = 'nota_entrega_ckpt_h';
		protected $strPrimaryKey = 'id';
		protected $strClassName = 'NotaEntregaCkptH';
		public function __get($strName) {
			switch ($strName) {
				case 'Id':
				...
				case 'Container':
					return new QQNodeNotaEntregaH('container_id', 'Container', 'Integer', $this);
				case 'CheckpointId':
     ...
     * @property-read QQNode $_PrimaryKeyNode
     **/
	class QQReverseReferenceNodeNotaEntregaCkptH extends QQReverseReferenceNode {
		protected $strTableName = 'nota_entrega_ckpt_h';
		protected $strPrimaryKey = 'id';
		protected $strClassName = 'NotaEntregaCkptH';
		public function __get($strName) {
