<?php
	/**
	 * The abstract GcoTempTableGen class defined here is
	 * code-generated and contains all the basic CRUD-type functionality as well as
	 * basic methods to handle relationships and index-based loading.
	 *
	 * To use, you should use the GcoTempTable subclass which
	 * extends this GcoTempTableGen class.
	 *
	 * Because subsequent re-code generations will overwrite any changes to this
	 * file, you should leave this file unaltered to prevent yourself from losing
	 * any information or code changes.  All customizations should be done by
	 * overriding existing or implementing new methods, properties and variables
	 * in the GcoTempTable class.
	 *
	 ...
	 */
	class GcoTempTableGen extends QBaseClass implements IteratorAggregate {
		...
		/**
		 * Protected member variable that maps to the database PK Identity column gco_temp_table.id
		 * @var integer intId
		 */
		protected $intId;
		...
		/**
		 * Protected member variable that maps to the database column gco_temp_table.proceso_error_id
		...
		/**
		 * Protected member variable that maps to the database column gco_temp_table.guia_id
		...
		/**
		 * Protected member variable that maps to the database column gco_temp_table.concepto_id
		...
		/**
		 * Protected member variable that maps to the database column gco_temp_table.created_at
		...
		/**
		 * Protected member variable that maps to the database column gco_temp_table.updated_at
		...
		/**
		 * Protected member variable that maps to the database column gco_temp_table.created_by
		...
		/**
		 * Protected member variable that maps to the database column gco_temp_table.updated_by
		 ...
		 * in the database column gco_temp_table.proceso_error_id.
		 *
		...
		/**
		 * Protected member variable that contains the object pointed by the reference
		 * in the database column gco_temp_table.guia_id.
		 *
		...
		/**
		 * Protected member variable that contains the object pointed by the reference
		 * in the database column gco_temp_table.concepto_id.
		 *
		...
		/**
		 * Protected member variable that contains the object pointed by the reference
		 * in the database column gco_temp_table.created_by.
		 *
		...
		/**
		 * Protected member variable that contains the object pointed by the reference
		 * in the database column gco_temp_table.updated_by.
		 *
		...
		{
			$this->intId = GcoTempTable::IdDefault;
			$this->intProcesoErrorId = GcoTempTable::ProcesoErrorIdDefault;
			$this->intGuiaId = GcoTempTable::GuiaIdDefault;
			$this->intConceptoId = GcoTempTable::ConceptoIdDefault;
			$this->dttCreatedAt = (GcoTempTable::CreatedAtDefault === null)?null:new QDateTime(GcoTempTable::CreatedAtDefault);
			$this->dttUpdatedAt = (GcoTempTable::UpdatedAtDefault === null)?null:new QDateTime(GcoTempTable::UpdatedAtDefault);
			$this->intCreatedBy = GcoTempTable::CreatedByDefault;
			$this->intUpdatedBy = GcoTempTable::UpdatedByDefault;
		}
		...
		/**
		 * Load a GcoTempTable from PK Info
		 * @param integer $intId
		...
		public static function Load($intId, $objOptionalClauses = null) {
			...
			if (QApplication::$objCacheProvider && !$objOptionalClauses && QApplication::$Database[1]->Caching) {
				$strCacheKey = QApplication::$objCacheProvider->CreateKey(QApplication::$Database[1]->Database, 'GcoTempTable', $intId);
			...
			$objToReturn = GcoTempTable::QuerySingle(
				QQ::AndCondition(
					QQ::Equal(QQN::GcoTempTable()->Id, $intId)
				),
				$objOptionalClauses
			);
		...
		public static function LoadAll($objOptionalClauses = null) {
			...
			// Call GcoTempTable::QueryArray to perform the LoadAll query
			try {
				return GcoTempTable::QueryArray(QQ::All(), $objOptionalClauses);
		...
		/**
		 * Count all GcoTempTables
		 * @return int
		 */
		public static function CountAll() {
			// Call GcoTempTable::QueryCount to perform the CountAll query
			return GcoTempTable::QueryCount(QQ::All());
		}
		...
		protected static function BuildQueryStatement(&$objQueryBuilder, QQCondition $objConditions, $objOptionalClauses, $mixParameterArray, $blnCountOnly) {
			...
			$objDatabase = GcoTempTable::GetDatabase();

			// Create/Build out the QueryBuilder object with GcoTempTable-specific SELET and FROM fields
			$objQueryBuilder = new QQueryBuilder($objDatabase, 'gco_temp_table');
			...
			if ($blnAddAllFieldsToSelect) {
				GcoTempTable::GetSelectFields($objQueryBuilder, null, QQuery::extractSelectClause($objOptionalClauses));
			}
			$objQueryBuilder->AddFromItem('gco_temp_table');
		...
		/**
		 * Static Qcubed Query method to query for a single GcoTempTable object.
		 * Uses BuildQueryStatment to perform most of the work.
		 * @param QQCondition $objConditions any conditions on the query, itself
		 * @param QQClause[] $objOptionalClausees additional optional QQClause objects for this query
		 * @param mixed[] $mixParameterArray a array of name-value pairs to perform PrepareStatement with
		 * @return GcoTempTable the queried object
		 */
		public static function QuerySingle(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null) {
			// Get the Query Statement
			try {
				$strQuery = GcoTempTable::BuildQueryStatement($objQueryBuilder, $objConditions, $objOptionalClauses, $mixParameterArray, false);
			} catch (QCallerException $objExc) {
				$objExc->IncrementOffset();
				throw $objExc;
			}

			// Perform the Query, Get the First Row, and Instantiate a new GcoTempTable object
			...
			if ($objQueryBuilder->ExpandAsArrayNode) {
				...
				while ($objDbRow = $objDbResult->GetNextRow()) {
					$objItem = GcoTempTable::InstantiateDbRow($objDbRow, null, $objQueryBuilder->ExpandAsArrayNode, $objPrevItemArray, $objQueryBuilder->ColumnAliasArray);
					if ($objItem) {
						$objToReturn[] = $objItem;
				...
				if(null === $objDbRow)
					return null;
				return GcoTempTable::InstantiateDbRow($objDbRow, null, null, null, $objQueryBuilder->ColumnAliasArray);
			}
		}

		/**
		 * Static Qcubed Query method to query for an array of GcoTempTable objects.
		 * Uses BuildQueryStatment to perform most of the work.
		 * @param QQCondition $objConditions any conditions on the query, itself
		 * @param QQClause[] $objOptionalClausees additional optional QQClause objects for this query
		 * @param mixed[] $mixParameterArray a array of name-value pairs to perform PrepareStatement with
		 * @return GcoTempTable[] the queried objects as an array
		 */
		public static function QueryArray(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null) {
			...
			$objDbResult = $objQueryBuilder->Database->Query($strQuery);
			return GcoTempTable::InstantiateDbResult($objDbResult, $objQueryBuilder->ExpandAsArrayNode, $objQueryBuilder->ColumnAliasArray);
		}
		...
		/**
		 * Static Qcubed Query method to query for a count of GcoTempTable objects.
		 * Uses BuildQueryStatment to perform most of the work.
		 * @param QQCondition $objConditions any conditions on the query, itself
		 * @param QQClause[] $objOptionalClausees additional optional QQClause objects for this query
		 * @param mixed[] $mixParameterArray a array of name-value pairs to perform PrepareStatement with
		...
		public static function QueryCount(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null) {
			// Get the Query Statement
			try {
				$strQuery = GcoTempTable::BuildQueryStatement($objQueryBuilder, $objConditions, $objOptionalClauses, $mixParameterArray, true);
			} catch (QCallerException $objExc) {
				$objExc->IncrementOffset();
				throw $objExc;
			}
		...
		public static function QueryArrayCached(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null, $blnForceUpdate = false) {
			...
			$objCache = new QCache('qquery/gcotemptable', $strQuery);
			$cacheData = $objCache->GetData();

			if (!$cacheData || $blnForceUpdate) {
				$objDbResult = $objQueryBuilder->Database->Query($strQuery);
				$arrResult = GcoTempTable::InstantiateDbResult($objDbResult, $objQueryBuilder->ExpandAsArrayNode, $objQueryBuilder->ColumnAliasArray);
		...
		/**
		 * Updates a QQueryBuilder with the SELECT fields for this GcoTempTable
		...
		/**
		 * Instantiate a GcoTempTable from a Database Row.
		 * Takes in an optional strAliasPrefix, used in case another Object::InstantiateDbRow
		 * is calling this GcoTempTable::InstantiateDbRow in order to perform
		 ...
		 * @param string[] $strColumnAliasArray
		 * @return mixed Either a GcoTempTable, or false to indicate the dbrow was used in an expansion, or null to indicate that this leaf is a duplicate.
		*/
		public static function InstantiateDbRow($objDbRow, $strAliasPrefix = null, $objExpandAsArrayNode = null, $objPreviousItemArray = null, $strColumnAliasArray = array()) {
			...
			if ($objExpandAsArrayNode && 
				...
				if (GcoTempTable::ExpandArray ($objDbRow, $strAliasPrefix, $objExpandAsArrayNode, $objPreviousItemArray, $strColumnAliasArray)) {
					return false; // db row was used but no new object was created
				}
			}

			// Create a new instance of the GcoTempTable object
			$objToReturn = new GcoTempTable();
			...
			if (!$strAliasPrefix)
				$strAliasPrefix = 'gco_temp_table__';
		...
		/**
		 * Instantiate an array of GcoTempTables from a Database Result
		...
		public static function InstantiateDbResult(QDatabaseResultBase $objDbResult, $objExpandAsArrayNode = null, $strColumnAliasArray = null) {
			...
			if ($objExpandAsArrayNode) {
				...
				$objPrevItemArray = array();
				while ($objDbRow = $objDbResult->GetNextRow()) {
					$objItem = GcoTempTable::InstantiateDbRow($objDbRow, null, $objExpandAsArrayNode, $objPrevItemArray, $strColumnAliasArray);
					if ($objItem) {
						$objToReturn[] = $objItem;
						$objPrevItemArray[$objItem->intId][] = $objItem;
				...
				while ($objDbRow = $objDbResult->GetNextRow())
					$objToReturn[] = GcoTempTable::InstantiateDbRow($objDbRow, null, null, null, $strColumnAliasArray);
			}
		...
		/**
		 * Instantiate a single GcoTempTable object from a query cursor (e.g. a DB ResultSet).
		 * Cursor is automatically moved to the "next row" of the result set.
		 * Will return NULL if no cursor or if the cursor has no more rows in the resultset.
		 * @param QDatabaseResultBase $objDbResult cursor resource
		 * @return GcoTempTable next row resulting from the query
		 */
		public static function InstantiateCursor(QDatabaseResultBase $objDbResult) {
			...
			return GcoTempTable::InstantiateDbRow($objDbRow, null, null, null, $strColumnAliasArray);
		}
		...
		/**
		 * Load a single GcoTempTable object,
		 * by Id Index(es)
		 * @param integer $intId
		 * @param QQClause[] $objOptionalClauses additional optional QQClause objects for this query
		 * @return GcoTempTable
		*/
		public static function LoadById($intId, $objOptionalClauses = null) {
			return GcoTempTable::QuerySingle(
				QQ::AndCondition(
					QQ::Equal(QQN::GcoTempTable()->Id, $intId)
				),
				$objOptionalClauses
		...
		*/
		public static function LoadByGuiaIdConceptoId($intGuiaId, $intConceptoId, $objOptionalClauses = null) {
			return GcoTempTable::QuerySingle(
				QQ::AndCondition(
					QQ::Equal(QQN::GcoTempTable()->GuiaId, $intGuiaId),
					QQ::Equal(QQN::GcoTempTable()->ConceptoId, $intConceptoId)
				),
				$objOptionalClauses
			);
		}
		...
		/**
		 * Load an array of GcoTempTable objects,
		...
		*/
		public static function LoadArrayByProcesoErrorId($intProcesoErrorId, $objOptionalClauses = null) {
			// Call GcoTempTable::QueryArray to perform the LoadArrayByProcesoErrorId query
			try {
				return GcoTempTable::QueryArray(
					QQ::Equal(QQN::GcoTempTable()->ProcesoErrorId, $intProcesoErrorId),
					$objOptionalClauses);
			} catch (QCallerException $objExc) {
				$objExc->IncrementOffset();
				throw $objExc;
		...
		*/
		public static function CountByProcesoErrorId($intProcesoErrorId) {
			// Call GcoTempTable::QueryCount to perform the CountByProcesoErrorId query
			return GcoTempTable::QueryCount(
				QQ::Equal(QQN::GcoTempTable()->ProcesoErrorId, $intProcesoErrorId)
			);
		}
		...
		*/
		public static function LoadArrayByGuiaId($intGuiaId, $objOptionalClauses = null) {
			// Call GcoTempTable::QueryArray to perform the LoadArrayByGuiaId query
			try {
				return GcoTempTable::QueryArray(
					QQ::Equal(QQN::GcoTempTable()->GuiaId, $intGuiaId),
					$objOptionalClauses);
		...
		*/
		public static function CountByGuiaId($intGuiaId) {
			// Call GcoTempTable::QueryCount to perform the CountByGuiaId query
			return GcoTempTable::QueryCount(
				QQ::Equal(QQN::GcoTempTable()->GuiaId, $intGuiaId)
			);
		}
		...
		*/
		public static function LoadArrayByConceptoId($intConceptoId, $objOptionalClauses = null) {
			// Call GcoTempTable::QueryArray to perform the LoadArrayByConceptoId query
			try {
				return GcoTempTable::QueryArray(
					QQ::Equal(QQN::GcoTempTable()->ConceptoId, $intConceptoId),
					$objOptionalClauses);
		...
		*/
		public static function CountByConceptoId($intConceptoId) {
			// Call GcoTempTable::QueryCount to perform the CountByConceptoId query
			return GcoTempTable::QueryCount(
				QQ::Equal(QQN::GcoTempTable()->ConceptoId, $intConceptoId)
			);
		}
		...
		*/
		public static function LoadArrayByCreatedBy($intCreatedBy, $objOptionalClauses = null) {
			// Call GcoTempTable::QueryArray to perform the LoadArrayByCreatedBy query
			try {
				return GcoTempTable::QueryArray(
					QQ::Equal(QQN::GcoTempTable()->CreatedBy, $intCreatedBy),
					$objOptionalClauses);
			} catch (QCallerException $objExc) {
				$objExc->IncrementOffset();
				throw $objExc;
		...
		*/
		public static function CountByCreatedBy($intCreatedBy) {
			// Call GcoTempTable::QueryCount to perform the CountByCreatedBy query
			return GcoTempTable::QueryCount(
				QQ::Equal(QQN::GcoTempTable()->CreatedBy, $intCreatedBy)
			);
		}
		...
		*/
		public static function LoadArrayByUpdatedBy($intUpdatedBy, $objOptionalClauses = null) {
			// Call GcoTempTable::QueryArray to perform the LoadArrayByUpdatedBy query
			try {
				return GcoTempTable::QueryArray(
					QQ::Equal(QQN::GcoTempTable()->UpdatedBy, $intUpdatedBy),
					$objOptionalClauses);
			} catch (QCallerException $objExc) {
				$objExc->IncrementOffset();
				throw $objExc;
		...
		*/
		public static function CountByUpdatedBy($intUpdatedBy) {
			// Call GcoTempTable::QueryCount to perform the CountByUpdatedBy query
			return GcoTempTable::QueryCount(
				QQ::Equal(QQN::GcoTempTable()->UpdatedBy, $intUpdatedBy)
			);
		}
		...
		public function Save($blnForceInsert = false, $blnForceUpdate = false) {
			...
			try {
				if ((!$this->__blnRestored) || ($blnForceInsert)) {
					...
					$mixToReturn = $this->intId = $objDatabase->InsertId('gco_temp_table', 'id');
				} else {
		...
		/**
		 * Delete this GcoTempTable
		 * @return void
		 */
		public function Delete() {
			if ((is_null($this->intId)))
				throw new QUndefinedPrimaryKeyException('Cannot delete this GcoTempTable with an unset primary key.');
        ...
        /**
 	     * Delete this GcoTempTable ONLY from the cache
 		 * @return void
		 */
		public function DeleteCache() {
			if (QApplication::$objCacheProvider && QApplication::$Database[1]->Caching) {
				$strCacheKey = QApplication::$objCacheProvider->CreateKey(QApplication::$Database[1]->Database, 'GcoTempTable', $this->intId);
				QApplication::$objCacheProvider->Delete($strCacheKey);
			}
		}

		/**
		 * Delete all GcoTempTables
		 * @return void
		 */
		...
		/**
		 * Reload this GcoTempTable from the database.
		 * @return void
		 */
		public function Reload() {
			// Make sure we are actually Restored from the database
			if (!$this->__blnRestored)
				throw new QCallerException('Cannot call Reload() on a new, unsaved GcoTempTable object.');

			$this->DeleteCache();

			// Reload the Object
			$objReloaded = GcoTempTable::Load($this->intId);
			...
			switch ($strName) {
				...
				case 'ProcesoError':
					...
					if (is_null($mixValue)) {
						...
						if (is_null($mixValue->Id))
							throw new QCallerException('Unable to set an unsaved ProcesoError for this GcoTempTable');
				...
				case 'Guia':
					...
					if (is_null($mixValue)) {
						...
						if (is_null($mixValue->Id))
							throw new QCallerException('Unable to set an unsaved Guia for this GcoTempTable');
				...
				case 'Concepto':
					...
					if (is_null($mixValue)) {
						...
						if (is_null($mixValue->Id))
							throw new QCallerException('Unable to set an unsaved Concepto for this GcoTempTable');
				...
				case 'CreatedByObject':
					...
					if (is_null($mixValue)) {
						...
						if (is_null($mixValue->CodiUsua))
							throw new QCallerException('Unable to set an unsaved CreatedByObject for this GcoTempTable');
				...
				case 'UpdatedByObject':
					...
					if (is_null($mixValue)) {
						...
						// Make sure $mixValue is a SAVED Usuario object
						if (is_null($mixValue->CodiUsua))
							throw new QCallerException('Unable to set an unsaved UpdatedByObject for this GcoTempTable');
		...
		public static function GetDatabaseName() {
			return QApplication::$Database[GcoTempTable::GetDatabaseIndex()]->Database;
		}
		...
		public static function GetSoapComplexTypeXml() {
			$strToReturn = '<complexType name="GcoTempTable"><sequence>';
		...
		public static function AlterSoapComplexTypeArray(&$strComplexTypeArray) {
			if (!array_key_exists('GcoTempTable', $strComplexTypeArray)) {
				$strComplexTypeArray['GcoTempTable'] = GcoTempTable::GetSoapComplexTypeXml();
		...
		public static function GetArrayFromSoapArray($objSoapArray) {
			...
			foreach ($objSoapArray as $objSoapObject)
				array_push($objArrayToReturn, GcoTempTable::GetObjectFromSoapObject($objSoapObject));
		...
		public static function GetSoapArrayFromArray($objArray) {
			...
			foreach ($objArray as $objObject)
				array_push($objArrayToReturn, GcoTempTable::GetSoapObjectFromObject($objObject, true));
     ...
     **/
	class QQNodeGcoTempTable extends QQNode {
		protected $strTableName = 'gco_temp_table';
		protected $strPrimaryKey = 'id';
		protected $strClassName = 'GcoTempTable';
		public function __get($strName) {
			switch ($strName) {
				case 'Id':
     ...
     * @property-read QQNode $_PrimaryKeyNode
     **/
	class QQReverseReferenceNodeGcoTempTable extends QQReverseReferenceNode {
		protected $strTableName = 'gco_temp_table';
		protected $strPrimaryKey = 'id';
		protected $strClassName = 'GcoTempTable';
		public function __get($strName) {
