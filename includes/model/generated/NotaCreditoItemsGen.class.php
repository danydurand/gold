<?php
	/**
	 * The abstract NotaCreditoItemsGen class defined here is
	 * code-generated and contains all the basic CRUD-type functionality as well as
	 * basic methods to handle relationships and index-based loading.
	 *
	 * To use, you should use the NotaCreditoItems subclass which
	 * extends this NotaCreditoItemsGen class.
	 *
	 * Because subsequent re-code generations will overwrite any changes to this
	 * file, you should leave this file unaltered to prevent yourself from losing
	 * any information or code changes.  All customizations should be done by
	 * overriding existing or implementing new methods, properties and variables
	 * in the NotaCreditoItems class.
	 *
	 ...
	 */
	class NotaCreditoItemsGen extends QBaseClass implements IteratorAggregate {
		...
		/**
		 * Protected member variable that maps to the database PK Identity column nota_credito_items.id
		 * @var integer intId
		 */
		protected $intId;
		...
		/**
		 * Protected member variable that maps to the database column nota_credito_items.nota_credito_id
		...
		/**
		 * Protected member variable that maps to the database column nota_credito_items.concepto_id
		...
		/**
		 * Protected member variable that maps to the database column nota_credito_items.mostrar_como
		...
		/**
		 * Protected member variable that maps to the database column nota_credito_items.monto
		 * @var double fltMonto
		 */
		protected $fltMonto;
		...
		/**
		 * Protected member variable that maps to the database column nota_credito_items.created_at
		...
		/**
		 * Protected member variable that maps to the database column nota_credito_items.updated_at
		 ...
		 * in the database column nota_credito_items.nota_credito_id.
		 *
		...
		/**
		 * Protected member variable that contains the object pointed by the reference
		 * in the database column nota_credito_items.concepto_id.
		 *
		...
		{
			$this->intId = NotaCreditoItems::IdDefault;
			$this->intNotaCreditoId = NotaCreditoItems::NotaCreditoIdDefault;
			$this->intConceptoId = NotaCreditoItems::ConceptoIdDefault;
			$this->strMostrarComo = NotaCreditoItems::MostrarComoDefault;
			$this->fltMonto = NotaCreditoItems::MontoDefault;
			$this->dttCreatedAt = (NotaCreditoItems::CreatedAtDefault === null)?null:new QDateTime(NotaCreditoItems::CreatedAtDefault);
			$this->dttUpdatedAt = (NotaCreditoItems::UpdatedAtDefault === null)?null:new QDateTime(NotaCreditoItems::UpdatedAtDefault);
		}
		...
		/**
		 * Load a NotaCreditoItems from PK Info
		 * @param integer $intId
		...
		public static function Load($intId, $objOptionalClauses = null) {
			...
			if (QApplication::$objCacheProvider && !$objOptionalClauses && QApplication::$Database[1]->Caching) {
				$strCacheKey = QApplication::$objCacheProvider->CreateKey(QApplication::$Database[1]->Database, 'NotaCreditoItems', $intId);
			...
			$objToReturn = NotaCreditoItems::QuerySingle(
				QQ::AndCondition(
					QQ::Equal(QQN::NotaCreditoItems()->Id, $intId)
				),
				$objOptionalClauses
			);
		...
		public static function LoadAll($objOptionalClauses = null) {
			...
			// Call NotaCreditoItems::QueryArray to perform the LoadAll query
			try {
				return NotaCreditoItems::QueryArray(QQ::All(), $objOptionalClauses);
		...
		/**
		 * Count all NotaCreditoItemses
		 * @return int
		 */
		public static function CountAll() {
			// Call NotaCreditoItems::QueryCount to perform the CountAll query
			return NotaCreditoItems::QueryCount(QQ::All());
		}
		...
		protected static function BuildQueryStatement(&$objQueryBuilder, QQCondition $objConditions, $objOptionalClauses, $mixParameterArray, $blnCountOnly) {
			...
			$objDatabase = NotaCreditoItems::GetDatabase();

			// Create/Build out the QueryBuilder object with NotaCreditoItems-specific SELET and FROM fields
			$objQueryBuilder = new QQueryBuilder($objDatabase, 'nota_credito_items');
			...
			if ($blnAddAllFieldsToSelect) {
				NotaCreditoItems::GetSelectFields($objQueryBuilder, null, QQuery::extractSelectClause($objOptionalClauses));
			}
			$objQueryBuilder->AddFromItem('nota_credito_items');
		...
		/**
		 * Static Qcubed Query method to query for a single NotaCreditoItems object.
		 * Uses BuildQueryStatment to perform most of the work.
		 * @param QQCondition $objConditions any conditions on the query, itself
		 * @param QQClause[] $objOptionalClausees additional optional QQClause objects for this query
		 * @param mixed[] $mixParameterArray a array of name-value pairs to perform PrepareStatement with
		 * @return NotaCreditoItems the queried object
		 */
		public static function QuerySingle(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null) {
			// Get the Query Statement
			try {
				$strQuery = NotaCreditoItems::BuildQueryStatement($objQueryBuilder, $objConditions, $objOptionalClauses, $mixParameterArray, false);
			} catch (QCallerException $objExc) {
				$objExc->IncrementOffset();
				throw $objExc;
			}

			// Perform the Query, Get the First Row, and Instantiate a new NotaCreditoItems object
			...
			if ($objQueryBuilder->ExpandAsArrayNode) {
				...
				while ($objDbRow = $objDbResult->GetNextRow()) {
					$objItem = NotaCreditoItems::InstantiateDbRow($objDbRow, null, $objQueryBuilder->ExpandAsArrayNode, $objPrevItemArray, $objQueryBuilder->ColumnAliasArray);
					if ($objItem) {
						$objToReturn[] = $objItem;
				...
				if(null === $objDbRow)
					return null;
				return NotaCreditoItems::InstantiateDbRow($objDbRow, null, null, null, $objQueryBuilder->ColumnAliasArray);
			}
		}

		/**
		 * Static Qcubed Query method to query for an array of NotaCreditoItems objects.
		 * Uses BuildQueryStatment to perform most of the work.
		 * @param QQCondition $objConditions any conditions on the query, itself
		 * @param QQClause[] $objOptionalClausees additional optional QQClause objects for this query
		 * @param mixed[] $mixParameterArray a array of name-value pairs to perform PrepareStatement with
		 * @return NotaCreditoItems[] the queried objects as an array
		 */
		public static function QueryArray(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null) {
			...
			$objDbResult = $objQueryBuilder->Database->Query($strQuery);
			return NotaCreditoItems::InstantiateDbResult($objDbResult, $objQueryBuilder->ExpandAsArrayNode, $objQueryBuilder->ColumnAliasArray);
		}
		...
		/**
		 * Static Qcubed Query method to query for a count of NotaCreditoItems objects.
		 * Uses BuildQueryStatment to perform most of the work.
		 * @param QQCondition $objConditions any conditions on the query, itself
		 * @param QQClause[] $objOptionalClausees additional optional QQClause objects for this query
		 * @param mixed[] $mixParameterArray a array of name-value pairs to perform PrepareStatement with
		...
		public static function QueryCount(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null) {
			// Get the Query Statement
			try {
				$strQuery = NotaCreditoItems::BuildQueryStatement($objQueryBuilder, $objConditions, $objOptionalClauses, $mixParameterArray, true);
			} catch (QCallerException $objExc) {
				$objExc->IncrementOffset();
				throw $objExc;
			}
		...
		public static function QueryArrayCached(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null, $blnForceUpdate = false) {
			...
			$objCache = new QCache('qquery/notacreditoitems', $strQuery);
			$cacheData = $objCache->GetData();

			if (!$cacheData || $blnForceUpdate) {
				$objDbResult = $objQueryBuilder->Database->Query($strQuery);
				$arrResult = NotaCreditoItems::InstantiateDbResult($objDbResult, $objQueryBuilder->ExpandAsArrayNode, $objQueryBuilder->ColumnAliasArray);
		...
		/**
		 * Updates a QQueryBuilder with the SELECT fields for this NotaCreditoItems
		...
		public static function GetSelectFields(QQueryBuilder $objBuilder, $strPrefix = null, QQSelect $objSelect = null) {
			if ($strPrefix) {
				...
				$strTableName = 'nota_credito_items';
				$strAliasPrefix = '';
			}
		...
		/**
		 * Instantiate a NotaCreditoItems from a Database Row.
		 * Takes in an optional strAliasPrefix, used in case another Object::InstantiateDbRow
		 * is calling this NotaCreditoItems::InstantiateDbRow in order to perform
		 ...
		 * @param string[] $strColumnAliasArray
		 * @return mixed Either a NotaCreditoItems, or false to indicate the dbrow was used in an expansion, or null to indicate that this leaf is a duplicate.
		*/
		public static function InstantiateDbRow($objDbRow, $strAliasPrefix = null, $objExpandAsArrayNode = null, $objPreviousItemArray = null, $strColumnAliasArray = array()) {
			...
			if ($objExpandAsArrayNode && 
				...
				if (NotaCreditoItems::ExpandArray ($objDbRow, $strAliasPrefix, $objExpandAsArrayNode, $objPreviousItemArray, $strColumnAliasArray)) {
					return false; // db row was used but no new object was created
				}
			}

			// Create a new instance of the NotaCreditoItems object
			$objToReturn = new NotaCreditoItems();
			...
			if (!$strAliasPrefix)
				$strAliasPrefix = 'nota_credito_items__';
		...
		/**
		 * Instantiate an array of NotaCreditoItemses from a Database Result
		...
		public static function InstantiateDbResult(QDatabaseResultBase $objDbResult, $objExpandAsArrayNode = null, $strColumnAliasArray = null) {
			...
			if ($objExpandAsArrayNode) {
				...
				$objPrevItemArray = array();
				while ($objDbRow = $objDbResult->GetNextRow()) {
					$objItem = NotaCreditoItems::InstantiateDbRow($objDbRow, null, $objExpandAsArrayNode, $objPrevItemArray, $strColumnAliasArray);
					if ($objItem) {
						$objToReturn[] = $objItem;
						$objPrevItemArray[$objItem->intId][] = $objItem;
				...
				while ($objDbRow = $objDbResult->GetNextRow())
					$objToReturn[] = NotaCreditoItems::InstantiateDbRow($objDbRow, null, null, null, $strColumnAliasArray);
			}
		...
		/**
		 * Instantiate a single NotaCreditoItems object from a query cursor (e.g. a DB ResultSet).
		 * Cursor is automatically moved to the "next row" of the result set.
		 * Will return NULL if no cursor or if the cursor has no more rows in the resultset.
		 * @param QDatabaseResultBase $objDbResult cursor resource
		 * @return NotaCreditoItems next row resulting from the query
		 */
		public static function InstantiateCursor(QDatabaseResultBase $objDbResult) {
			...
			return NotaCreditoItems::InstantiateDbRow($objDbRow, null, null, null, $strColumnAliasArray);
		}
		...
		/**
		 * Load a single NotaCreditoItems object,
		 * by Id Index(es)
		 * @param integer $intId
		 * @param QQClause[] $objOptionalClauses additional optional QQClause objects for this query
		 * @return NotaCreditoItems
		*/
		public static function LoadById($intId, $objOptionalClauses = null) {
			return NotaCreditoItems::QuerySingle(
				QQ::AndCondition(
					QQ::Equal(QQN::NotaCreditoItems()->Id, $intId)
				),
				$objOptionalClauses
		...
		/**
		 * Load a single NotaCreditoItems object,
		 * by NotaCreditoId, ConceptoId Index(es)
		 * @param integer $intNotaCreditoId
		 * @param integer $intConceptoId
		 * @param QQClause[] $objOptionalClauses additional optional QQClause objects for this query
		 * @return NotaCreditoItems
		*/
		public static function LoadByNotaCreditoIdConceptoId($intNotaCreditoId, $intConceptoId, $objOptionalClauses = null) {
			return NotaCreditoItems::QuerySingle(
				QQ::AndCondition(
					QQ::Equal(QQN::NotaCreditoItems()->NotaCreditoId, $intNotaCreditoId),
					QQ::Equal(QQN::NotaCreditoItems()->ConceptoId, $intConceptoId)
				),
				$objOptionalClauses
			);
		}
		...
		/**
		 * Load an array of NotaCreditoItems objects,
		...
		*/
		public static function LoadArrayByConceptoId($intConceptoId, $objOptionalClauses = null) {
			// Call NotaCreditoItems::QueryArray to perform the LoadArrayByConceptoId query
			try {
				return NotaCreditoItems::QueryArray(
					QQ::Equal(QQN::NotaCreditoItems()->ConceptoId, $intConceptoId),
					$objOptionalClauses);
			} catch (QCallerException $objExc) {
				$objExc->IncrementOffset();
		...
		/**
		 * Count NotaCreditoItemses
		 * by ConceptoId Index(es)
		 * @param integer $intConceptoId
		 * @return int
		*/
		public static function CountByConceptoId($intConceptoId) {
			// Call NotaCreditoItems::QueryCount to perform the CountByConceptoId query
			return NotaCreditoItems::QueryCount(
				QQ::Equal(QQN::NotaCreditoItems()->ConceptoId, $intConceptoId)
			);
		}
		...
		*/
		public static function LoadArrayByNotaCreditoId($intNotaCreditoId, $objOptionalClauses = null) {
			// Call NotaCreditoItems::QueryArray to perform the LoadArrayByNotaCreditoId query
			try {
				return NotaCreditoItems::QueryArray(
					QQ::Equal(QQN::NotaCreditoItems()->NotaCreditoId, $intNotaCreditoId),
					$objOptionalClauses);
		...
		*/
		public static function CountByNotaCreditoId($intNotaCreditoId) {
			// Call NotaCreditoItems::QueryCount to perform the CountByNotaCreditoId query
			return NotaCreditoItems::QueryCount(
				QQ::Equal(QQN::NotaCreditoItems()->NotaCreditoId, $intNotaCreditoId)
			);
		}
		...
		public function Save($blnForceInsert = false, $blnForceUpdate = false) {
			...
			try {
				if ((!$this->__blnRestored) || ($blnForceInsert)) {
					...
					$mixToReturn = $this->intId = $objDatabase->InsertId('nota_credito_items', 'id');
				} else {
		...
		/**
		 * Delete this NotaCreditoItems
		 * @return void
		 */
		public function Delete() {
			if ((is_null($this->intId)))
				throw new QUndefinedPrimaryKeyException('Cannot delete this NotaCreditoItems with an unset primary key.');
        ...
        /**
 	     * Delete this NotaCreditoItems ONLY from the cache
 		 * @return void
		 */
		public function DeleteCache() {
			if (QApplication::$objCacheProvider && QApplication::$Database[1]->Caching) {
				$strCacheKey = QApplication::$objCacheProvider->CreateKey(QApplication::$Database[1]->Database, 'NotaCreditoItems', $this->intId);
				QApplication::$objCacheProvider->Delete($strCacheKey);
			}
		}

		/**
		 * Delete all NotaCreditoItemses
		 * @return void
		 */
		...
		/**
		 * Truncate nota_credito_items table
		 * @return void
		 */
		...
		/**
		 * Reload this NotaCreditoItems from the database.
		 * @return void
		 */
		public function Reload() {
			// Make sure we are actually Restored from the database
			if (!$this->__blnRestored)
				throw new QCallerException('Cannot call Reload() on a new, unsaved NotaCreditoItems object.');

			$this->DeleteCache();

			// Reload the Object
			$objReloaded = NotaCreditoItems::Load($this->intId);
			...
			switch ($strName) {
				...
				case 'NotaCredito':
					...
					if (is_null($mixValue)) {
						...
						if (is_null($mixValue->Id))
							throw new QCallerException('Unable to set an unsaved NotaCredito for this NotaCreditoItems');
				...
				case 'Concepto':
					...
					if (is_null($mixValue)) {
						...
						if (is_null($mixValue->Id))
							throw new QCallerException('Unable to set an unsaved Concepto for this NotaCreditoItems');
		...
		public static function GetDatabaseName() {
			return QApplication::$Database[NotaCreditoItems::GetDatabaseIndex()]->Database;
		}
		...
		public static function GetSoapComplexTypeXml() {
			$strToReturn = '<complexType name="NotaCreditoItems"><sequence>';
		...
		public static function AlterSoapComplexTypeArray(&$strComplexTypeArray) {
			if (!array_key_exists('NotaCreditoItems', $strComplexTypeArray)) {
				$strComplexTypeArray['NotaCreditoItems'] = NotaCreditoItems::GetSoapComplexTypeXml();
		...
		public static function GetArrayFromSoapArray($objSoapArray) {
			...
			foreach ($objSoapArray as $objSoapObject)
				array_push($objArrayToReturn, NotaCreditoItems::GetObjectFromSoapObject($objSoapObject));
		...
		public static function GetSoapArrayFromArray($objArray) {
			...
			foreach ($objArray as $objObject)
				array_push($objArrayToReturn, NotaCreditoItems::GetSoapObjectFromObject($objObject, true));
     ...
     **/
	class QQNodeNotaCreditoItems extends QQNode {
		protected $strTableName = 'nota_credito_items';
		protected $strPrimaryKey = 'id';
		protected $strClassName = 'NotaCreditoItems';
		public function __get($strName) {
			switch ($strName) {
				case 'Id':
     ...
     * @property-read QQNode $_PrimaryKeyNode
     **/
	class QQReverseReferenceNodeNotaCreditoItems extends QQReverseReferenceNode {
		protected $strTableName = 'nota_credito_items';
		protected $strPrimaryKey = 'id';
		protected $strClassName = 'NotaCreditoItems';
		public function __get($strName) {
