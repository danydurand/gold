<?php
	...
	class NotaCreditoItemsGen extends QBaseClass implements IteratorAggregate {
		...
		public function Initialize()
		{
			...
			$this->strCreatedAt = NotaCreditoItems::CreatedAtDefault;
			$this->strUpdatedAt = NotaCreditoItems::UpdatedAtDefault;
		}
				...
				if ((!$this->__blnRestored) || ($blnForceInsert)) {
					...
					if (!$blnForceUpdate) {
						...
						if ($objRow[0] != $this->strCreatedAt)
							throw new QOptimisticLockingException('NotaCreditoItems');
					}
					if (!$blnForceUpdate) {
						// Perform the Optimistic Locking check
						$objResult = $objDatabase->Query('
