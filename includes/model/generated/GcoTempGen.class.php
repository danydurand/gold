<?php
	/**
	 * The abstract GcoTempGen class defined here is
	 * code-generated and contains all the basic CRUD-type functionality as well as
	 * basic methods to handle relationships and index-based loading.
	 *
	 * To use, you should use the GcoTemp subclass which
	 * extends this GcoTempGen class.
	 *
	 * Because subsequent re-code generations will overwrite any changes to this
	 * file, you should leave this file unaltered to prevent yourself from losing
	 * any information or code changes.  All customizations should be done by
	 * overriding existing or implementing new methods, properties and variables
	 * in the GcoTemp class.
	 *
	 ...
	 */
	class GcoTempGen extends QBaseClass implements IteratorAggregate {
		...
		/**
		 * Protected member variable that maps to the database PK Identity column gco_temp.id
		 * @var integer intId
		 */
		protected $intId;
		...
		/**
		 * Protected member variable that maps to the database column gco_temp.proceso_error_id
		...
		/**
		 * Protected member variable that maps to the database column gco_temp.concepto_id
		...
		/**
		 * Protected member variable that maps to the database column gco_temp.created_at
		...
		/**
		 * Protected member variable that maps to the database column gco_temp.updated_at
		...
		/**
		 * Protected member variable that maps to the database column gco_temp.created_by
		...
		/**
		 * Protected member variable that maps to the database column gco_temp.updated_by
		 ...
		 * in the database column gco_temp.proceso_error_id.
		 *
		...
		/**
		 * Protected member variable that contains the object pointed by the reference
		 * in the database column gco_temp.concepto_id.
		 *
		...
		/**
		 * Protected member variable that contains the object pointed by the reference
		 * in the database column gco_temp.created_by.
		 *
		...
		/**
		 * Protected member variable that contains the object pointed by the reference
		 * in the database column gco_temp.updated_by.
		 *
		...
		{
			$this->intId = GcoTemp::IdDefault;
			$this->intProcesoErrorId = GcoTemp::ProcesoErrorIdDefault;
			$this->intConceptoId = GcoTemp::ConceptoIdDefault;
			$this->dttCreatedAt = (GcoTemp::CreatedAtDefault === null)?null:new QDateTime(GcoTemp::CreatedAtDefault);
			$this->dttUpdatedAt = (GcoTemp::UpdatedAtDefault === null)?null:new QDateTime(GcoTemp::UpdatedAtDefault);
			$this->intCreatedBy = GcoTemp::CreatedByDefault;
			$this->intUpdatedBy = GcoTemp::UpdatedByDefault;
		}
		...
		public static function Load($intId, $objOptionalClauses = null) {
			...
			if (QApplication::$objCacheProvider && !$objOptionalClauses && QApplication::$Database[1]->Caching) {
				$strCacheKey = QApplication::$objCacheProvider->CreateKey(QApplication::$Database[1]->Database, 'GcoTemp', $intId);
			...
			$objToReturn = GcoTemp::QuerySingle(
				QQ::AndCondition(
					QQ::Equal(QQN::GcoTemp()->Id, $intId)
				),
				$objOptionalClauses
			);
		...
		public static function LoadAll($objOptionalClauses = null) {
			...
			// Call GcoTemp::QueryArray to perform the LoadAll query
			try {
				return GcoTemp::QueryArray(QQ::All(), $objOptionalClauses);
		...
		public static function CountAll() {
			// Call GcoTemp::QueryCount to perform the CountAll query
			return GcoTemp::QueryCount(QQ::All());
		}
		...
		protected static function BuildQueryStatement(&$objQueryBuilder, QQCondition $objConditions, $objOptionalClauses, $mixParameterArray, $blnCountOnly) {
			...
			// Create/Build out the QueryBuilder object with GcoTemp-specific SELET and FROM fields
			$objQueryBuilder = new QQueryBuilder($objDatabase, 'gco_temp');
			...
			if ($blnAddAllFieldsToSelect) {
				GcoTemp::GetSelectFields($objQueryBuilder, null, QQuery::extractSelectClause($objOptionalClauses));
			}
			$objQueryBuilder->AddFromItem('gco_temp');
		...
		/**
		 * Static Qcubed Query method to query for a single GcoTemp object.
		 * Uses BuildQueryStatment to perform most of the work.
		 * @param QQCondition $objConditions any conditions on the query, itself
		 * @param QQClause[] $objOptionalClausees additional optional QQClause objects for this query
		 * @param mixed[] $mixParameterArray a array of name-value pairs to perform PrepareStatement with
		 * @return GcoTemp the queried object
		 */
		public static function QuerySingle(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null) {
			// Get the Query Statement
			try {
				$strQuery = GcoTemp::BuildQueryStatement($objQueryBuilder, $objConditions, $objOptionalClauses, $mixParameterArray, false);
			} catch (QCallerException $objExc) {
				$objExc->IncrementOffset();
				throw $objExc;
			}

			// Perform the Query, Get the First Row, and Instantiate a new GcoTemp object
			...
			if ($objQueryBuilder->ExpandAsArrayNode) {
				...
				while ($objDbRow = $objDbResult->GetNextRow()) {
					$objItem = GcoTemp::InstantiateDbRow($objDbRow, null, $objQueryBuilder->ExpandAsArrayNode, $objPrevItemArray, $objQueryBuilder->ColumnAliasArray);
					if ($objItem) {
						$objToReturn[] = $objItem;
				...
				if(null === $objDbRow)
					return null;
				return GcoTemp::InstantiateDbRow($objDbRow, null, null, null, $objQueryBuilder->ColumnAliasArray);
			}
		}

		/**
		 * Static Qcubed Query method to query for an array of GcoTemp objects.
		 * Uses BuildQueryStatment to perform most of the work.
		 * @param QQCondition $objConditions any conditions on the query, itself
		 * @param QQClause[] $objOptionalClausees additional optional QQClause objects for this query
		 * @param mixed[] $mixParameterArray a array of name-value pairs to perform PrepareStatement with
		 * @return GcoTemp[] the queried objects as an array
		 */
		public static function QueryArray(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null) {
			...
			$objDbResult = $objQueryBuilder->Database->Query($strQuery);
			return GcoTemp::InstantiateDbResult($objDbResult, $objQueryBuilder->ExpandAsArrayNode, $objQueryBuilder->ColumnAliasArray);
		}
		...
		/**
		 * Static Qcubed Query method to query for a count of GcoTemp objects.
		 * Uses BuildQueryStatment to perform most of the work.
		 * @param QQCondition $objConditions any conditions on the query, itself
		 * @param QQClause[] $objOptionalClausees additional optional QQClause objects for this query
		 * @param mixed[] $mixParameterArray a array of name-value pairs to perform PrepareStatement with
		...
		public static function QueryCount(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null) {
			// Get the Query Statement
			try {
				$strQuery = GcoTemp::BuildQueryStatement($objQueryBuilder, $objConditions, $objOptionalClauses, $mixParameterArray, true);
			} catch (QCallerException $objExc) {
				$objExc->IncrementOffset();
				throw $objExc;
			}
		...
		public static function QueryArrayCached(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null, $blnForceUpdate = false) {
			...
			$objCache = new QCache('qquery/gcotemp', $strQuery);
			$cacheData = $objCache->GetData();

			if (!$cacheData || $blnForceUpdate) {
				$objDbResult = $objQueryBuilder->Database->Query($strQuery);
				$arrResult = GcoTemp::InstantiateDbResult($objDbResult, $objQueryBuilder->ExpandAsArrayNode, $objQueryBuilder->ColumnAliasArray);
		...
		/**
		 * Updates a QQueryBuilder with the SELECT fields for this GcoTemp
		...
		/**
		 * Instantiate a GcoTemp from a Database Row.
		 * Takes in an optional strAliasPrefix, used in case another Object::InstantiateDbRow
		 * is calling this GcoTemp::InstantiateDbRow in order to perform
		 ...
		 * @param string[] $strColumnAliasArray
		 * @return mixed Either a GcoTemp, or false to indicate the dbrow was used in an expansion, or null to indicate that this leaf is a duplicate.
		*/
		public static function InstantiateDbRow($objDbRow, $strAliasPrefix = null, $objExpandAsArrayNode = null, $objPreviousItemArray = null, $strColumnAliasArray = array()) {
			...
			if ($objExpandAsArrayNode && 
				...
				if (GcoTemp::ExpandArray ($objDbRow, $strAliasPrefix, $objExpandAsArrayNode, $objPreviousItemArray, $strColumnAliasArray)) {
					return false; // db row was used but no new object was created
				}
			}

			// Create a new instance of the GcoTemp object
			$objToReturn = new GcoTemp();
		...
		/**
		 * Instantiate an array of GcoTemps from a Database Result
		...
		public static function InstantiateDbResult(QDatabaseResultBase $objDbResult, $objExpandAsArrayNode = null, $strColumnAliasArray = null) {
			...
			if ($objExpandAsArrayNode) {
				...
				$objPrevItemArray = array();
				while ($objDbRow = $objDbResult->GetNextRow()) {
					$objItem = GcoTemp::InstantiateDbRow($objDbRow, null, $objExpandAsArrayNode, $objPrevItemArray, $strColumnAliasArray);
					if ($objItem) {
						$objToReturn[] = $objItem;
						$objPrevItemArray[$objItem->intId][] = $objItem;
				...
				while ($objDbRow = $objDbResult->GetNextRow())
					$objToReturn[] = GcoTemp::InstantiateDbRow($objDbRow, null, null, null, $strColumnAliasArray);
			}
		...
		/**
		 * Instantiate a single GcoTemp object from a query cursor (e.g. a DB ResultSet).
		 * Cursor is automatically moved to the "next row" of the result set.
		 * Will return NULL if no cursor or if the cursor has no more rows in the resultset.
		 * @param QDatabaseResultBase $objDbResult cursor resource
		 * @return GcoTemp next row resulting from the query
		 */
		public static function InstantiateCursor(QDatabaseResultBase $objDbResult) {
			...
			return GcoTemp::InstantiateDbRow($objDbRow, null, null, null, $strColumnAliasArray);
		}
		...
		*/
		...
		/**
		 * Load a single GcoTemp object,
		 * by ProcesoErrorId, ConceptoId Index(es)
		 * @param integer $intProcesoErrorId
		 * @param integer $intConceptoId
		 * @param QQClause[] $objOptionalClauses additional optional QQClause objects for this query
		 * @return GcoTemp
		*/
		public static function LoadByProcesoErrorIdConceptoId($intProcesoErrorId, $intConceptoId, $objOptionalClauses = null) {
			return GcoTemp::QuerySingle(
				QQ::AndCondition(
					QQ::Equal(QQN::GcoTemp()->ProcesoErrorId, $intProcesoErrorId),
					QQ::Equal(QQN::GcoTemp()->ConceptoId, $intConceptoId)
				),
				$objOptionalClauses
			);
		}
		...
		/**
		 * Load an array of GcoTemp objects,
		...
		*/
		public static function LoadArrayByProcesoErrorId($intProcesoErrorId, $objOptionalClauses = null) {
			// Call GcoTemp::QueryArray to perform the LoadArrayByProcesoErrorId query
			try {
		...
		*/
		public static function CountByProcesoErrorId($intProcesoErrorId) {
			// Call GcoTemp::QueryCount to perform the CountByProcesoErrorId query
		...
		*/
		public static function LoadArrayByConceptoId($intConceptoId, $objOptionalClauses = null) {
			// Call GcoTemp::QueryArray to perform the LoadArrayByConceptoId query
			try {
				return GcoTemp::QueryArray(
					QQ::Equal(QQN::GcoTemp()->ConceptoId, $intConceptoId),
					$objOptionalClauses);
		...
		*/
		public static function CountByConceptoId($intConceptoId) {
			// Call GcoTemp::QueryCount to perform the CountByConceptoId query
			return GcoTemp::QueryCount(
				QQ::Equal(QQN::GcoTemp()->ConceptoId, $intConceptoId)
			);
		}
		...
		*/
		public static function LoadArrayByCreatedBy($intCreatedBy, $objOptionalClauses = null) {
			// Call GcoTemp::QueryArray to perform the LoadArrayByCreatedBy query
			try {
				return GcoTemp::QueryArray(
					QQ::Equal(QQN::GcoTemp()->CreatedBy, $intCreatedBy),
					$objOptionalClauses);
			} catch (QCallerException $objExc) {
				$objExc->IncrementOffset();
				throw $objExc;
		...
		*/
		public static function CountByCreatedBy($intCreatedBy) {
			// Call GcoTemp::QueryCount to perform the CountByCreatedBy query
			return GcoTemp::QueryCount(
				QQ::Equal(QQN::GcoTemp()->CreatedBy, $intCreatedBy)
			);
		}
		...
		*/
		public static function LoadArrayByUpdatedBy($intUpdatedBy, $objOptionalClauses = null) {
			// Call GcoTemp::QueryArray to perform the LoadArrayByUpdatedBy query
			try {
				return GcoTemp::QueryArray(
					QQ::Equal(QQN::GcoTemp()->UpdatedBy, $intUpdatedBy),
					$objOptionalClauses);
			} catch (QCallerException $objExc) {
				$objExc->IncrementOffset();
				throw $objExc;
		...
		*/
		public static function CountByUpdatedBy($intUpdatedBy) {
			// Call GcoTemp::QueryCount to perform the CountByUpdatedBy query
			return GcoTemp::QueryCount(
				QQ::Equal(QQN::GcoTemp()->UpdatedBy, $intUpdatedBy)
			);
		}
		...
		public function Save($blnForceInsert = false, $blnForceUpdate = false) {
			...
			try {
				if ((!$this->__blnRestored) || ($blnForceInsert)) {
					...
					$mixToReturn = $this->intId = $objDatabase->InsertId('gco_temp', 'id');
				} else {
		...
		public function Delete() {
			if ((is_null($this->intId)))
				throw new QUndefinedPrimaryKeyException('Cannot delete this GcoTemp with an unset primary key.');
        ...
        /**
 	     * Delete this GcoTemp ONLY from the cache
 		 * @return void
		 */
		public function DeleteCache() {
			if (QApplication::$objCacheProvider && QApplication::$Database[1]->Caching) {
				$strCacheKey = QApplication::$objCacheProvider->CreateKey(QApplication::$Database[1]->Database, 'GcoTemp', $this->intId);
		...
		/**
		 * Reload this GcoTemp from the database.
		 * @return void
		 */
		public function Reload() {
			// Make sure we are actually Restored from the database
			if (!$this->__blnRestored)
				throw new QCallerException('Cannot call Reload() on a new, unsaved GcoTemp object.');

			$this->DeleteCache();

			// Reload the Object
			$objReloaded = GcoTemp::Load($this->intId);
			...
			switch ($strName) {
				...
				case 'ProcesoError':
					...
					if (is_null($mixValue)) {
						...
						if (is_null($mixValue->Id))
							throw new QCallerException('Unable to set an unsaved ProcesoError for this GcoTemp');
				...
				case 'Concepto':
					...
					if (is_null($mixValue)) {
						...
						if (is_null($mixValue->Id))
							throw new QCallerException('Unable to set an unsaved Concepto for this GcoTemp');
				...
				case 'CreatedByObject':
					...
					if (is_null($mixValue)) {
						...
						if (is_null($mixValue->CodiUsua))
							throw new QCallerException('Unable to set an unsaved CreatedByObject for this GcoTemp');
				...
				case 'UpdatedByObject':
					...
					if (is_null($mixValue)) {
						...
						// Make sure $mixValue is a SAVED Usuario object
						if (is_null($mixValue->CodiUsua))
							throw new QCallerException('Unable to set an unsaved UpdatedByObject for this GcoTemp');
		...
		public static function GetDatabaseName() {
			return QApplication::$Database[GcoTemp::GetDatabaseIndex()]->Database;
		}
		...
		public static function GetSoapComplexTypeXml() {
			$strToReturn = '<complexType name="GcoTemp"><sequence>';
		...
		public static function AlterSoapComplexTypeArray(&$strComplexTypeArray) {
			if (!array_key_exists('GcoTemp', $strComplexTypeArray)) {
				$strComplexTypeArray['GcoTemp'] = GcoTemp::GetSoapComplexTypeXml();
		...
		public static function GetArrayFromSoapArray($objSoapArray) {
			...
			foreach ($objSoapArray as $objSoapObject)
				array_push($objArrayToReturn, GcoTemp::GetObjectFromSoapObject($objSoapObject));
		...
		public static function GetSoapArrayFromArray($objArray) {
			...
			foreach ($objArray as $objObject)
				array_push($objArrayToReturn, GcoTemp::GetSoapObjectFromObject($objObject, true));
     ...
     **/
	class QQNodeGcoTemp extends QQNode {
		protected $strTableName = 'gco_temp';
		protected $strPrimaryKey = 'id';
		protected $strClassName = 'GcoTemp';
		public function __get($strName) {
			switch ($strName) {
				case 'Id':
     ...
     * @property-read QQNode $_PrimaryKeyNode
     **/
	class QQReverseReferenceNodeGcoTemp extends QQReverseReferenceNode {
		protected $strTableName = 'gco_temp';
		protected $strPrimaryKey = 'id';
		protected $strClassName = 'GcoTemp';
		public function __get($strName) {
