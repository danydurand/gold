<?php
	/**
	 * The abstract EstadisticasGen class defined here is
	 * code-generated and contains all the basic CRUD-type functionality as well as
	 * basic methods to handle relationships and index-based loading.
	 *
	 * To use, you should use the Estadisticas subclass which
	 * extends this EstadisticasGen class.
	 *
	 * Because subsequent re-code generations will overwrite any changes to this
	 * file, you should leave this file unaltered to prevent yourself from losing
	 * any information or code changes.  All customizations should be done by
	 * overriding existing or implementing new methods, properties and variables
	 * in the Estadisticas class.
	 *
	 ...
	 * @property string $Medicion the value for strMedicion (Not Null)
	 ...
	 */
	class EstadisticasGen extends QBaseClass implements IteratorAggregate {
		...
		/**
		 * Protected member variable that maps to the database PK Identity column estadisticas.id
		 * @var integer intId
		 */
		protected $intId;
		...
		/**
		 * Protected member variable that maps to the database column estadisticas.sucursal_id
		...
		/**
		 * Protected member variable that maps to the database column estadisticas.fecha
		...
		/**
		 * Protected member variable that maps to the database column estadisticas.medicion
		...
		/**
		 * Protected member variable that maps to the database column estadisticas.cifra
		 * @var double fltCifra
		 */
		protected $fltCifra;
		...
		/**
		 * Protected member variable that maps to the database column estadisticas.created_at
		...
		/**
		 * Protected member variable that maps to the database column estadisticas.updated_at
		 ...
		 * in the database column estadisticas.sucursal_id.
		 *
		...
		{
			$this->intId = Estadisticas::IdDefault;
			$this->intSucursalId = Estadisticas::SucursalIdDefault;
			$this->dttFecha = (Estadisticas::FechaDefault === null)?null:new QDateTime(Estadisticas::FechaDefault);
			$this->strMedicion = Estadisticas::MedicionDefault;
			$this->fltCifra = Estadisticas::CifraDefault;
			$this->dttCreatedAt = (Estadisticas::CreatedAtDefault === null)?null:new QDateTime(Estadisticas::CreatedAtDefault);
			$this->dttUpdatedAt = (Estadisticas::UpdatedAtDefault === null)?null:new QDateTime(Estadisticas::UpdatedAtDefault);
		}
		...
		/**
		 * Load a Estadisticas from PK Info
		 * @param integer $intId
		...
		public static function Load($intId, $objOptionalClauses = null) {
			...
			if (QApplication::$objCacheProvider && !$objOptionalClauses && QApplication::$Database[1]->Caching) {
				$strCacheKey = QApplication::$objCacheProvider->CreateKey(QApplication::$Database[1]->Database, 'Estadisticas', $intId);
			...
			$objToReturn = Estadisticas::QuerySingle(
				QQ::AndCondition(
					QQ::Equal(QQN::Estadisticas()->Id, $intId)
				),
				$objOptionalClauses
			);
		...
		public static function LoadAll($objOptionalClauses = null) {
			...
			// Call Estadisticas::QueryArray to perform the LoadAll query
			try {
				return Estadisticas::QueryArray(QQ::All(), $objOptionalClauses);
		...
		/**
		 * Count all Estadisticases
		 * @return int
		 */
		public static function CountAll() {
			// Call Estadisticas::QueryCount to perform the CountAll query
			return Estadisticas::QueryCount(QQ::All());
		}
		...
		protected static function BuildQueryStatement(&$objQueryBuilder, QQCondition $objConditions, $objOptionalClauses, $mixParameterArray, $blnCountOnly) {
			...
			// Create/Build out the QueryBuilder object with Estadisticas-specific SELET and FROM fields
			$objQueryBuilder = new QQueryBuilder($objDatabase, 'estadisticas');
			...
			if ($blnAddAllFieldsToSelect) {
				Estadisticas::GetSelectFields($objQueryBuilder, null, QQuery::extractSelectClause($objOptionalClauses));
			}
			$objQueryBuilder->AddFromItem('estadisticas');
		...
		/**
		 * Static Qcubed Query method to query for a single Estadisticas object.
		 * Uses BuildQueryStatment to perform most of the work.
		 * @param QQCondition $objConditions any conditions on the query, itself
		 * @param QQClause[] $objOptionalClausees additional optional QQClause objects for this query
		 * @param mixed[] $mixParameterArray a array of name-value pairs to perform PrepareStatement with
		 * @return Estadisticas the queried object
		 */
		public static function QuerySingle(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null) {
			// Get the Query Statement
			try {
				$strQuery = Estadisticas::BuildQueryStatement($objQueryBuilder, $objConditions, $objOptionalClauses, $mixParameterArray, false);
			} catch (QCallerException $objExc) {
				$objExc->IncrementOffset();
				throw $objExc;
			}

			// Perform the Query, Get the First Row, and Instantiate a new Estadisticas object
			...
			if ($objQueryBuilder->ExpandAsArrayNode) {
				...
				while ($objDbRow = $objDbResult->GetNextRow()) {
					$objItem = Estadisticas::InstantiateDbRow($objDbRow, null, $objQueryBuilder->ExpandAsArrayNode, $objPrevItemArray, $objQueryBuilder->ColumnAliasArray);
					if ($objItem) {
						$objToReturn[] = $objItem;
				...
				if(null === $objDbRow)
					return null;
				return Estadisticas::InstantiateDbRow($objDbRow, null, null, null, $objQueryBuilder->ColumnAliasArray);
			}
		}

		/**
		 * Static Qcubed Query method to query for an array of Estadisticas objects.
		 * Uses BuildQueryStatment to perform most of the work.
		 * @param QQCondition $objConditions any conditions on the query, itself
		 * @param QQClause[] $objOptionalClausees additional optional QQClause objects for this query
		 * @param mixed[] $mixParameterArray a array of name-value pairs to perform PrepareStatement with
		 * @return Estadisticas[] the queried objects as an array
		 */
		public static function QueryArray(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null) {
			...
			$objDbResult = $objQueryBuilder->Database->Query($strQuery);
			return Estadisticas::InstantiateDbResult($objDbResult, $objQueryBuilder->ExpandAsArrayNode, $objQueryBuilder->ColumnAliasArray);
		}
		...
		/**
		 * Static Qcubed Query method to query for a count of Estadisticas objects.
		 * Uses BuildQueryStatment to perform most of the work.
		 * @param QQCondition $objConditions any conditions on the query, itself
		 * @param QQClause[] $objOptionalClausees additional optional QQClause objects for this query
		 * @param mixed[] $mixParameterArray a array of name-value pairs to perform PrepareStatement with
		...
		public static function QueryCount(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null) {
			// Get the Query Statement
			try {
				$strQuery = Estadisticas::BuildQueryStatement($objQueryBuilder, $objConditions, $objOptionalClauses, $mixParameterArray, true);
			} catch (QCallerException $objExc) {
				$objExc->IncrementOffset();
				throw $objExc;
			}
		...
		public static function QueryArrayCached(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null, $blnForceUpdate = false) {
			...
			$objCache = new QCache('qquery/estadisticas', $strQuery);
			$cacheData = $objCache->GetData();

			if (!$cacheData || $blnForceUpdate) {
				$objDbResult = $objQueryBuilder->Database->Query($strQuery);
				$arrResult = Estadisticas::InstantiateDbResult($objDbResult, $objQueryBuilder->ExpandAsArrayNode, $objQueryBuilder->ColumnAliasArray);
		...
		/**
		 * Updates a QQueryBuilder with the SELECT fields for this Estadisticas
		...
		/**
		 * Instantiate a Estadisticas from a Database Row.
		 * Takes in an optional strAliasPrefix, used in case another Object::InstantiateDbRow
		 * is calling this Estadisticas::InstantiateDbRow in order to perform
		 ...
		 * @param string[] $strColumnAliasArray
		 * @return mixed Either a Estadisticas, or false to indicate the dbrow was used in an expansion, or null to indicate that this leaf is a duplicate.
		*/
		public static function InstantiateDbRow($objDbRow, $strAliasPrefix = null, $objExpandAsArrayNode = null, $objPreviousItemArray = null, $strColumnAliasArray = array()) {
			...
			if ($objExpandAsArrayNode && 
				...
				if (Estadisticas::ExpandArray ($objDbRow, $strAliasPrefix, $objExpandAsArrayNode, $objPreviousItemArray, $strColumnAliasArray)) {
					return false; // db row was used but no new object was created
				}
			}

			// Create a new instance of the Estadisticas object
			$objToReturn = new Estadisticas();
		...
		/**
		 * Instantiate an array of Estadisticases from a Database Result
		...
		public static function InstantiateDbResult(QDatabaseResultBase $objDbResult, $objExpandAsArrayNode = null, $strColumnAliasArray = null) {
			...
			if ($objExpandAsArrayNode) {
				...
				$objPrevItemArray = array();
				while ($objDbRow = $objDbResult->GetNextRow()) {
					$objItem = Estadisticas::InstantiateDbRow($objDbRow, null, $objExpandAsArrayNode, $objPrevItemArray, $strColumnAliasArray);
					if ($objItem) {
						$objToReturn[] = $objItem;
						$objPrevItemArray[$objItem->intId][] = $objItem;
				...
				while ($objDbRow = $objDbResult->GetNextRow())
					$objToReturn[] = Estadisticas::InstantiateDbRow($objDbRow, null, null, null, $strColumnAliasArray);
			}
		...
		/**
		 * Instantiate a single Estadisticas object from a query cursor (e.g. a DB ResultSet).
		 * Cursor is automatically moved to the "next row" of the result set.
		 * Will return NULL if no cursor or if the cursor has no more rows in the resultset.
		 * @param QDatabaseResultBase $objDbResult cursor resource
		 * @return Estadisticas next row resulting from the query
		 */
		public static function InstantiateCursor(QDatabaseResultBase $objDbResult) {
			...
			return Estadisticas::InstantiateDbRow($objDbRow, null, null, null, $strColumnAliasArray);
		}
		...
		/**
		 * Load a single Estadisticas object,
		 * by Id Index(es)
		 * @param integer $intId
		 * @param QQClause[] $objOptionalClauses additional optional QQClause objects for this query
		 * @return Estadisticas
		...
		*/
		public static function LoadBySucursalIdFechaMedicion($intSucursalId, $dttFecha, $strMedicion, $objOptionalClauses = null) {
			return Estadisticas::QuerySingle(
				QQ::AndCondition(
					QQ::Equal(QQN::Estadisticas()->SucursalId, $intSucursalId),
					QQ::Equal(QQN::Estadisticas()->Fecha, $dttFecha),
					QQ::Equal(QQN::Estadisticas()->Medicion, $strMedicion)
				),
				$objOptionalClauses
			);
		}
		...
		/**
		 * Load an array of Estadisticas objects,
		...
		*/
		public static function LoadArrayBySucursalId($intSucursalId, $objOptionalClauses = null) {
			// Call Estadisticas::QueryArray to perform the LoadArrayBySucursalId query
			try {
		...
		/**
		 * Count Estadisticases
		 * by SucursalId Index(es)
		 * @param integer $intSucursalId
		 * @return int
		*/
		public static function CountBySucursalId($intSucursalId) {
			// Call Estadisticas::QueryCount to perform the CountBySucursalId query
		...
		*/
		public static function LoadArrayByFecha($dttFecha, $objOptionalClauses = null) {
			// Call Estadisticas::QueryArray to perform the LoadArrayByFecha query
			try {
				return Estadisticas::QueryArray(
					QQ::Equal(QQN::Estadisticas()->Fecha, $dttFecha),
					$objOptionalClauses);
		...
		*/
		public static function CountByFecha($dttFecha) {
			// Call Estadisticas::QueryCount to perform the CountByFecha query
			return Estadisticas::QueryCount(
				QQ::Equal(QQN::Estadisticas()->Fecha, $dttFecha)
			);
		}
		...
		public function Save($blnForceInsert = false, $blnForceUpdate = false) {
			...
			try {
				if ((!$this->__blnRestored) || ($blnForceInsert)) {
					...
					$mixToReturn = $this->intId = $objDatabase->InsertId('estadisticas', 'id');
				} else {
		...
		/**
		 * Delete this Estadisticas
		 * @return void
		 */
		public function Delete() {
			if ((is_null($this->intId)))
				throw new QUndefinedPrimaryKeyException('Cannot delete this Estadisticas with an unset primary key.');
        ...
        /**
 	     * Delete this Estadisticas ONLY from the cache
 		 * @return void
		 */
		public function DeleteCache() {
			if (QApplication::$objCacheProvider && QApplication::$Database[1]->Caching) {
				$strCacheKey = QApplication::$objCacheProvider->CreateKey(QApplication::$Database[1]->Database, 'Estadisticas', $this->intId);
				QApplication::$objCacheProvider->Delete($strCacheKey);
			}
		}

		/**
		 * Delete all Estadisticases
		 * @return void
		 */
		...
		/**
		 * Reload this Estadisticas from the database.
		 * @return void
		 */
		public function Reload() {
			// Make sure we are actually Restored from the database
			if (!$this->__blnRestored)
				throw new QCallerException('Cannot call Reload() on a new, unsaved Estadisticas object.');

			$this->DeleteCache();

			// Reload the Object
			$objReloaded = Estadisticas::Load($this->intId);
		...
		public function __get($strName) {
			switch ($strName) {
				...
				case 'Medicion':
					/**
					 * Gets the value for strMedicion (Not Null)
					 * @return string
					 */
		...
		public function __set($strName, $mixValue) {
			switch ($strName) {
				...
				case 'Medicion':
					/**
					 * Sets the value for strMedicion (Not Null)
				...
				case 'Sucursal':
					...
					if (is_null($mixValue)) {
						...
						if (is_null($mixValue->Id))
							throw new QCallerException('Unable to set an unsaved Sucursal for this Estadisticas');
		...
		public static function GetDatabaseName() {
			return QApplication::$Database[Estadisticas::GetDatabaseIndex()]->Database;
		}
		...
		public static function GetSoapComplexTypeXml() {
			$strToReturn = '<complexType name="Estadisticas"><sequence>';
		...
		public static function AlterSoapComplexTypeArray(&$strComplexTypeArray) {
			if (!array_key_exists('Estadisticas', $strComplexTypeArray)) {
				$strComplexTypeArray['Estadisticas'] = Estadisticas::GetSoapComplexTypeXml();
		...
		public static function GetArrayFromSoapArray($objSoapArray) {
			...
			foreach ($objSoapArray as $objSoapObject)
				array_push($objArrayToReturn, Estadisticas::GetObjectFromSoapObject($objSoapObject));
		...
		public static function GetSoapArrayFromArray($objArray) {
			...
			foreach ($objArray as $objObject)
				array_push($objArrayToReturn, Estadisticas::GetSoapObjectFromObject($objObject, true));
     ...
     **/
	class QQNodeEstadisticas extends QQNode {
		protected $strTableName = 'estadisticas';
		protected $strPrimaryKey = 'id';
		protected $strClassName = 'Estadisticas';
		public function __get($strName) {
			switch ($strName) {
				case 'Id':
     ...
     * @property-read QQNode $_PrimaryKeyNode
     **/
	class QQReverseReferenceNodeEstadisticas extends QQReverseReferenceNode {
		protected $strTableName = 'estadisticas';
		protected $strPrimaryKey = 'id';
		protected $strClassName = 'Estadisticas';
		public function __get($strName) {
