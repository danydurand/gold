<?php
	/**
	 * The abstract NotaConceptosGen class defined here is
	 * code-generated and contains all the basic CRUD-type functionality as well as
	 * basic methods to handle relationships and index-based loading.
	 *
	 * To use, you should use the NotaConceptos subclass which
	 * extends this NotaConceptosGen class.
	 *
	 * Because subsequent re-code generations will overwrite any changes to this
	 * file, you should leave this file unaltered to prevent yourself from losing
	 * any information or code changes.  All customizations should be done by
	 * overriding existing or implementing new methods, properties and variables
	 * in the NotaConceptos class.
	 *
	 ...
	 */
	class NotaConceptosGen extends QBaseClass implements IteratorAggregate {
		...
		/**
		 * Protected member variable that maps to the database PK Identity column nota_conceptos.id
		 * @var integer intId
		 */
		protected $intId;
		...
		/**
		 * Protected member variable that maps to the database column nota_conceptos.nota_entrega_id
		...
		/**
		 * Protected member variable that maps to the database column nota_conceptos.concepto_id
		...
		/**
		 * Protected member variable that maps to the database column nota_conceptos.tipo
		 * @var string strTipo
		 */
		protected $strTipo;
		...
		/**
		 * Protected member variable that maps to the database column nota_conceptos.valor
		 * @var double fltValor
		 */
		protected $fltValor;
		...
		/**
		 * Protected member variable that maps to the database column nota_conceptos.monto
		 * @var double fltMonto
		 */
		protected $fltMonto;
		...
		/**
		 * Protected member variable that maps to the database column nota_conceptos.mostrar_como
		...
		/**
		 * Protected member variable that maps to the database column nota_conceptos.explicacion
		...
		/**
		 * Protected member variable that maps to the database column nota_conceptos.created_at
		...
		/**
		 * Protected member variable that maps to the database column nota_conceptos.updated_at
		...
		/**
		 * Protected member variable that maps to the database column nota_conceptos.deleted_at
		...
		/**
		 * Protected member variable that maps to the database column nota_conceptos.created_by
		...
		/**
		 * Protected member variable that maps to the database column nota_conceptos.updated_by
		...
		/**
		 * Protected member variable that maps to the database column nota_conceptos.deleted_by
		 ...
		 * in the database column nota_conceptos.nota_entrega_id.
		 *
		...
		/**
		 * Protected member variable that contains the object pointed by the reference
		 * in the database column nota_conceptos.concepto_id.
		 *
		...
		{
			$this->intId = NotaConceptos::IdDefault;
			$this->intNotaEntregaId = NotaConceptos::NotaEntregaIdDefault;
			$this->intConceptoId = NotaConceptos::ConceptoIdDefault;
			$this->strTipo = NotaConceptos::TipoDefault;
			$this->fltValor = NotaConceptos::ValorDefault;
			$this->fltMonto = NotaConceptos::MontoDefault;
			$this->strMostrarComo = NotaConceptos::MostrarComoDefault;
			$this->strExplicacion = NotaConceptos::ExplicacionDefault;
			$this->dttCreatedAt = (NotaConceptos::CreatedAtDefault === null)?null:new QDateTime(NotaConceptos::CreatedAtDefault);
			$this->dttUpdatedAt = (NotaConceptos::UpdatedAtDefault === null)?null:new QDateTime(NotaConceptos::UpdatedAtDefault);
			$this->strDeletedAt = NotaConceptos::DeletedAtDefault;
			$this->intCreatedBy = NotaConceptos::CreatedByDefault;
			$this->intUpdatedBy = NotaConceptos::UpdatedByDefault;
			$this->intDeletedBy = NotaConceptos::DeletedByDefault;
		}
		...
		/**
		 * Load a NotaConceptos from PK Info
		 * @param integer $intId
		...
		public static function Load($intId, $objOptionalClauses = null) {
			...
			if (QApplication::$objCacheProvider && !$objOptionalClauses && QApplication::$Database[1]->Caching) {
				$strCacheKey = QApplication::$objCacheProvider->CreateKey(QApplication::$Database[1]->Database, 'NotaConceptos', $intId);
			...
			$objToReturn = NotaConceptos::QuerySingle(
				QQ::AndCondition(
					QQ::Equal(QQN::NotaConceptos()->Id, $intId)
				),
				$objOptionalClauses
			);
		...
		public static function LoadAll($objOptionalClauses = null) {
			...
			// Call NotaConceptos::QueryArray to perform the LoadAll query
			try {
				return NotaConceptos::QueryArray(QQ::All(), $objOptionalClauses);
		...
		/**
		 * Count all NotaConceptoses
		 * @return int
		 */
		public static function CountAll() {
			// Call NotaConceptos::QueryCount to perform the CountAll query
			return NotaConceptos::QueryCount(QQ::All());
		}
		...
		protected static function BuildQueryStatement(&$objQueryBuilder, QQCondition $objConditions, $objOptionalClauses, $mixParameterArray, $blnCountOnly) {
			...
			$objDatabase = NotaConceptos::GetDatabase();

			// Create/Build out the QueryBuilder object with NotaConceptos-specific SELET and FROM fields
			$objQueryBuilder = new QQueryBuilder($objDatabase, 'nota_conceptos');
			...
			if ($blnAddAllFieldsToSelect) {
				NotaConceptos::GetSelectFields($objQueryBuilder, null, QQuery::extractSelectClause($objOptionalClauses));
			}
			$objQueryBuilder->AddFromItem('nota_conceptos');
		...
		/**
		 * Static Qcubed Query method to query for a single NotaConceptos object.
		 * Uses BuildQueryStatment to perform most of the work.
		 * @param QQCondition $objConditions any conditions on the query, itself
		 * @param QQClause[] $objOptionalClausees additional optional QQClause objects for this query
		 * @param mixed[] $mixParameterArray a array of name-value pairs to perform PrepareStatement with
		 * @return NotaConceptos the queried object
		 */
		public static function QuerySingle(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null) {
			// Get the Query Statement
			try {
				$strQuery = NotaConceptos::BuildQueryStatement($objQueryBuilder, $objConditions, $objOptionalClauses, $mixParameterArray, false);
			} catch (QCallerException $objExc) {
				$objExc->IncrementOffset();
				throw $objExc;
			}

			// Perform the Query, Get the First Row, and Instantiate a new NotaConceptos object
			...
			if ($objQueryBuilder->ExpandAsArrayNode) {
				...
				while ($objDbRow = $objDbResult->GetNextRow()) {
					$objItem = NotaConceptos::InstantiateDbRow($objDbRow, null, $objQueryBuilder->ExpandAsArrayNode, $objPrevItemArray, $objQueryBuilder->ColumnAliasArray);
					if ($objItem) {
						$objToReturn[] = $objItem;
				...
				if(null === $objDbRow)
					return null;
				return NotaConceptos::InstantiateDbRow($objDbRow, null, null, null, $objQueryBuilder->ColumnAliasArray);
			}
		}

		/**
		 * Static Qcubed Query method to query for an array of NotaConceptos objects.
		 * Uses BuildQueryStatment to perform most of the work.
		 * @param QQCondition $objConditions any conditions on the query, itself
		 * @param QQClause[] $objOptionalClausees additional optional QQClause objects for this query
		 * @param mixed[] $mixParameterArray a array of name-value pairs to perform PrepareStatement with
		 * @return NotaConceptos[] the queried objects as an array
		 */
		public static function QueryArray(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null) {
			...
			$objDbResult = $objQueryBuilder->Database->Query($strQuery);
			return NotaConceptos::InstantiateDbResult($objDbResult, $objQueryBuilder->ExpandAsArrayNode, $objQueryBuilder->ColumnAliasArray);
		}
		...
		/**
		 * Static Qcubed Query method to query for a count of NotaConceptos objects.
		 * Uses BuildQueryStatment to perform most of the work.
		 * @param QQCondition $objConditions any conditions on the query, itself
		 * @param QQClause[] $objOptionalClausees additional optional QQClause objects for this query
		 * @param mixed[] $mixParameterArray a array of name-value pairs to perform PrepareStatement with
		...
		public static function QueryCount(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null) {
			// Get the Query Statement
			try {
				$strQuery = NotaConceptos::BuildQueryStatement($objQueryBuilder, $objConditions, $objOptionalClauses, $mixParameterArray, true);
			} catch (QCallerException $objExc) {
				$objExc->IncrementOffset();
				throw $objExc;
			}
		...
		public static function QueryArrayCached(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null, $blnForceUpdate = false) {
			...
			$objCache = new QCache('qquery/notaconceptos', $strQuery);
			$cacheData = $objCache->GetData();

			if (!$cacheData || $blnForceUpdate) {
				$objDbResult = $objQueryBuilder->Database->Query($strQuery);
				$arrResult = NotaConceptos::InstantiateDbResult($objDbResult, $objQueryBuilder->ExpandAsArrayNode, $objQueryBuilder->ColumnAliasArray);
		...
		/**
		 * Updates a QQueryBuilder with the SELECT fields for this NotaConceptos
		...
		/**
		 * Instantiate a NotaConceptos from a Database Row.
		 * Takes in an optional strAliasPrefix, used in case another Object::InstantiateDbRow
		 * is calling this NotaConceptos::InstantiateDbRow in order to perform
		 ...
		 * @param string[] $strColumnAliasArray
		 * @return mixed Either a NotaConceptos, or false to indicate the dbrow was used in an expansion, or null to indicate that this leaf is a duplicate.
		*/
		public static function InstantiateDbRow($objDbRow, $strAliasPrefix = null, $objExpandAsArrayNode = null, $objPreviousItemArray = null, $strColumnAliasArray = array()) {
			...
			if ($objExpandAsArrayNode && 
				...
				if (NotaConceptos::ExpandArray ($objDbRow, $strAliasPrefix, $objExpandAsArrayNode, $objPreviousItemArray, $strColumnAliasArray)) {
					return false; // db row was used but no new object was created
				}
			}

			// Create a new instance of the NotaConceptos object
			$objToReturn = new NotaConceptos();
			...
			if (!$strAliasPrefix)
				$strAliasPrefix = 'nota_conceptos__';
		...
		/**
		 * Instantiate an array of NotaConceptoses from a Database Result
		...
		public static function InstantiateDbResult(QDatabaseResultBase $objDbResult, $objExpandAsArrayNode = null, $strColumnAliasArray = null) {
			...
			if ($objExpandAsArrayNode) {
				...
				$objPrevItemArray = array();
				while ($objDbRow = $objDbResult->GetNextRow()) {
					$objItem = NotaConceptos::InstantiateDbRow($objDbRow, null, $objExpandAsArrayNode, $objPrevItemArray, $strColumnAliasArray);
					if ($objItem) {
						$objToReturn[] = $objItem;
						$objPrevItemArray[$objItem->intId][] = $objItem;
				...
				while ($objDbRow = $objDbResult->GetNextRow())
					$objToReturn[] = NotaConceptos::InstantiateDbRow($objDbRow, null, null, null, $strColumnAliasArray);
			}
		...
		/**
		 * Instantiate a single NotaConceptos object from a query cursor (e.g. a DB ResultSet).
		 * Cursor is automatically moved to the "next row" of the result set.
		 * Will return NULL if no cursor or if the cursor has no more rows in the resultset.
		 * @param QDatabaseResultBase $objDbResult cursor resource
		 * @return NotaConceptos next row resulting from the query
		 */
		public static function InstantiateCursor(QDatabaseResultBase $objDbResult) {
			...
			return NotaConceptos::InstantiateDbRow($objDbRow, null, null, null, $strColumnAliasArray);
		}
		...
		/**
		 * Load a single NotaConceptos object,
		 * by Id Index(es)
		 * @param integer $intId
		 * @param QQClause[] $objOptionalClauses additional optional QQClause objects for this query
		 * @return NotaConceptos
		*/
		public static function LoadById($intId, $objOptionalClauses = null) {
			return NotaConceptos::QuerySingle(
				QQ::AndCondition(
					QQ::Equal(QQN::NotaConceptos()->Id, $intId)
				),
				$objOptionalClauses
		...
		/**
		 * Load a single NotaConceptos object,
		 * by NotaEntregaId, ConceptoId Index(es)
		 * @param integer $intNotaEntregaId
		 * @param integer $intConceptoId
		 * @param QQClause[] $objOptionalClauses additional optional QQClause objects for this query
		 * @return NotaConceptos
		*/
		public static function LoadByNotaEntregaIdConceptoId($intNotaEntregaId, $intConceptoId, $objOptionalClauses = null) {
			return NotaConceptos::QuerySingle(
				QQ::AndCondition(
					QQ::Equal(QQN::NotaConceptos()->NotaEntregaId, $intNotaEntregaId),
					QQ::Equal(QQN::NotaConceptos()->ConceptoId, $intConceptoId)
				),
				$objOptionalClauses
			);
		}
		...
		/**
		 * Load an array of NotaConceptos objects,
		...
		*/
		public static function LoadArrayByConceptoId($intConceptoId, $objOptionalClauses = null) {
			// Call NotaConceptos::QueryArray to perform the LoadArrayByConceptoId query
			try {
				return NotaConceptos::QueryArray(
					QQ::Equal(QQN::NotaConceptos()->ConceptoId, $intConceptoId),
					$objOptionalClauses);
			} catch (QCallerException $objExc) {
				$objExc->IncrementOffset();
		...
		/**
		 * Count NotaConceptoses
		 * by ConceptoId Index(es)
		 * @param integer $intConceptoId
		 * @return int
		*/
		public static function CountByConceptoId($intConceptoId) {
			// Call NotaConceptos::QueryCount to perform the CountByConceptoId query
			return NotaConceptos::QueryCount(
				QQ::Equal(QQN::NotaConceptos()->ConceptoId, $intConceptoId)
			);
		}
		...
		*/
		public static function LoadArrayByNotaEntregaId($intNotaEntregaId, $objOptionalClauses = null) {
			// Call NotaConceptos::QueryArray to perform the LoadArrayByNotaEntregaId query
			try {
				return NotaConceptos::QueryArray(
					QQ::Equal(QQN::NotaConceptos()->NotaEntregaId, $intNotaEntregaId),
					$objOptionalClauses);
		...
		*/
		public static function CountByNotaEntregaId($intNotaEntregaId) {
			// Call NotaConceptos::QueryCount to perform the CountByNotaEntregaId query
			return NotaConceptos::QueryCount(
				QQ::Equal(QQN::NotaConceptos()->NotaEntregaId, $intNotaEntregaId)
			);
		}
		...
		public function Save($blnForceInsert = false, $blnForceUpdate = false) {
			...
			try {
				if ((!$this->__blnRestored) || ($blnForceInsert)) {
					...
					$mixToReturn = $this->intId = $objDatabase->InsertId('nota_conceptos', 'id');
				} else {
					...
					if (!$blnForceUpdate) {
						...
						if ($objRow[0] != $this->strDeletedAt)
							throw new QOptimisticLockingException('NotaConceptos');
					}
		...
		/**
		 * Delete this NotaConceptos
		 * @return void
		 */
		public function Delete() {
			if ((is_null($this->intId)))
				throw new QUndefinedPrimaryKeyException('Cannot delete this NotaConceptos with an unset primary key.');
        ...
        /**
 	     * Delete this NotaConceptos ONLY from the cache
 		 * @return void
		 */
		public function DeleteCache() {
			if (QApplication::$objCacheProvider && QApplication::$Database[1]->Caching) {
				$strCacheKey = QApplication::$objCacheProvider->CreateKey(QApplication::$Database[1]->Database, 'NotaConceptos', $this->intId);
				QApplication::$objCacheProvider->Delete($strCacheKey);
			}
		}

		/**
		 * Delete all NotaConceptoses
		 * @return void
		 */
		...
		/**
		 * Reload this NotaConceptos from the database.
		 * @return void
		 */
		public function Reload() {
			// Make sure we are actually Restored from the database
			if (!$this->__blnRestored)
				throw new QCallerException('Cannot call Reload() on a new, unsaved NotaConceptos object.');

			$this->DeleteCache();

			// Reload the Object
			$objReloaded = NotaConceptos::Load($this->intId);
			...
			switch ($strName) {
				...
				case 'NotaEntrega':
					...
					if (is_null($mixValue)) {
						...
						if (is_null($mixValue->Id))
							throw new QCallerException('Unable to set an unsaved NotaEntrega for this NotaConceptos');
				...
				case 'Concepto':
					...
					if (is_null($mixValue)) {
						...
						if (is_null($mixValue->Id))
							throw new QCallerException('Unable to set an unsaved Concepto for this NotaConceptos');
		...
		public static function GetDatabaseName() {
			return QApplication::$Database[NotaConceptos::GetDatabaseIndex()]->Database;
		}
		...
		public static function GetSoapComplexTypeXml() {
			$strToReturn = '<complexType name="NotaConceptos"><sequence>';
		...
		public static function AlterSoapComplexTypeArray(&$strComplexTypeArray) {
			if (!array_key_exists('NotaConceptos', $strComplexTypeArray)) {
				$strComplexTypeArray['NotaConceptos'] = NotaConceptos::GetSoapComplexTypeXml();
		...
		public static function GetArrayFromSoapArray($objSoapArray) {
			...
			foreach ($objSoapArray as $objSoapObject)
				array_push($objArrayToReturn, NotaConceptos::GetObjectFromSoapObject($objSoapObject));
		...
		public static function GetSoapArrayFromArray($objArray) {
			...
			foreach ($objArray as $objObject)
				array_push($objArrayToReturn, NotaConceptos::GetSoapObjectFromObject($objObject, true));
     ...
     **/
	class QQNodeNotaConceptos extends QQNode {
		protected $strTableName = 'nota_conceptos';
		protected $strPrimaryKey = 'id';
		protected $strClassName = 'NotaConceptos';
		public function __get($strName) {
			switch ($strName) {
				case 'Id':
     ...
     * @property-read QQNode $_PrimaryKeyNode
     **/
	class QQReverseReferenceNodeNotaConceptos extends QQReverseReferenceNode {
		protected $strTableName = 'nota_conceptos';
		protected $strPrimaryKey = 'id';
		protected $strClassName = 'NotaConceptos';
		public function __get($strName) {
