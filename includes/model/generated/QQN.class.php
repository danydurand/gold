<?php
	class QQN {
		...
		/**
		 * @return QQNodeCheckpoints
		 */
		static public function Checkpoints() {
			return new QQNodeCheckpoints('checkpoints', null, null);
		}
		/**
		 * @return QQNodeChofer
		 */
		...
		/**
		 * @return QQNodeClientesInternacional
		 */
		static public function ClientesInternacional() {
			return new QQNodeClientesInternacional('clientes_internacional', null, null);
		}
		/**
		 * @return QQNodeClientesRetail
		 */
		static public function ClientesRetail() {
			return new QQNodeClientesRetail('clientes_retail', null, null);
		}
		/**
		...
		/**
		 * @return QQNodeConceptoRangos
		 */
		static public function ConceptoRangos() {
			return new QQNodeConceptoRangos('concepto_rangos', null, null);
		}
		/**
		 * @return QQNodeConceptos
		 */
		static public function Conceptos() {
			return new QQNodeConceptos('conceptos', null, null);
		}
		/**
		...
		/**
		 * @return QQNodeContainerCkpt
		 */
		static public function ContainerCkpt() {
		...
		static public function Containers() {
			return new QQNodeContainers('containers', null, null);
		}
		/**
		...
		/**
		 * @return QQNodeDivisas
		 */
		static public function Divisas() {
			return new QQNodeDivisas('divisas', null, null);
		}
		/**
		...
		static public function FacturaGuias() {
			return new QQNodeFacturaGuias('factura_guias', null, null);
		}
		/**
		 * @return QQNodeFacturaItems
		 */
		static public function FacturaItems() {
			return new QQNodeFacturaItems('factura_items', null, null);
		}
		/**
		 * @return QQNodeFacturaNotas
		 */
		static public function FacturaNotas() {
			return new QQNodeFacturaNotas('factura_notas', null, null);
		}
		/**
		 * @return QQNodeFacturaPagos
		 */
		static public function FacturaPagos() {
			return new QQNodeFacturaPagos('factura_pagos', null, null);
		}
		/**
		...
		/**
		 * @return QQNodeFacturas
		 */
		static public function Facturas() {
			return new QQNodeFacturas('facturas', null, null);
		}
		/**
		...
		/**
		 * @return QQNodeLineaAerea
		 */
		static public function LineaAerea() {
			return new QQNodeLineaAerea('linea_aerea', null, null);
		}
		/**
		 * @return QQNodeLog
		 */
		...
		/**
		 * @return QQNodeNotaConceptos
		 */
		static public function NotaConceptos() {
			return new QQNodeNotaConceptos('nota_conceptos', null, null);
		}
		/**
		...
		static public function NotaCreditoItems() {
			return new QQNodeNotaCreditoItems('nota_credito_items', null, null);
		}
		/**
		 * @return QQNodeNotaEntrega
		 */
		static public function NotaEntrega() {
		...
		/**
		 * @return QQNodePagosCorp
		 */
		static public function PagosCorp() {
		...
		/**
		 * @return QQNodeProductos
		 */
		static public function Productos() {
			return new QQNodeProductos('productos', null, null);
		}
		/**
		 * @return QQNodeProfesiones
		 */
		static public function Profesiones() {
			return new QQNodeProfesiones('profesiones', null, null);
		}
		/**
		...
		static public function Rutas() {
			return new QQNodeRutas('rutas', null, null);
		}
		/**
		...
		/**
		 * @return QQNodeSucursales
		 */
		static public function Sucursales() {
			return new QQNodeSucursales('sucursales', null, null);
		}
		/**
		 * @return QQNodeT500
		 */
		...
		/**
		 * @return QQNodeTarifaAgentes
		 */
		static public function TarifaAgentes() {
			return new QQNodeTarifaAgentes('tarifa_agentes', null, null);
		}
		/**
		 * @return QQNodeTarifaAgentesZonas
		 */
		static public function TarifaAgentesZonas() {
		...
		static public function Tasas() {
			return new QQNodeTasas('tasas', null, null);
		}
		/**
		 * @return QQNodeTempSubcuentas
		 */
		static public function TempSubcuentas() {
			return new QQNodeTempSubcuentas('temp_subcuentas', null, null);
		}
		/**
