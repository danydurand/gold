<?php
	/**
	 * The abstract RutasGen class defined here is
	 * code-generated and contains all the basic CRUD-type functionality as well as
	 * basic methods to handle relationships and index-based loading.
	 *
	 * To use, you should use the Rutas subclass which
	 * extends this RutasGen class.
	 *
	 ...
	 * @property-read Counter $_CounterAsRuta the value for the private _objCounterAsRuta (Read-Only) if set due to an expansion on the counter.ruta_id reverse relationship
	 ...
	 */
	class RutasGen extends QBaseClass implements IteratorAggregate {
		...
		/**
		 * Protected member variable that maps to the database PK Identity column rutas.id
		 * @var integer intId
		 */
		protected $intId;
		...
		/**
		 * Protected member variable that maps to the database column rutas.codigo
		...
		/**
		 * Protected member variable that maps to the database column rutas.descripcion
		...
		/**
		 * Protected member variable that maps to the database column rutas.sucursal_id
		...
		/**
		 * Protected member variable that maps to the database column rutas.tipo_id
		...
		/**
		 * Protected member variable that maps to the database column rutas.observacion
		...
		/**
		 * Protected member variable that maps to the database column rutas.created_at
		...
		/**
		 * Protected member variable that maps to the database column rutas.updated_at
		...
		/**
		 * Protected member variable that maps to the database column rutas.deleted_at
		...
		/**
		 * Protected member variable that maps to the database column rutas.created_by
		...
		/**
		 * Protected member variable that maps to the database column rutas.updated_by
		...
		/**
		 * Protected member variable that maps to the database column rutas.deleted_by
		...
		/**
		 * Private member variable that stores a reference to a single CounterAsRuta object
		 * (of type Counter), if this Rutas object was restored with
		 * an expansion on the counter association table.
		 * @var Counter _objCounterAsRuta;
		 */
		private $_objCounterAsRuta;

		/**
		 * Private member variable that stores a reference to an array of CounterAsRuta objects
		 * (of type Counter[]), if this Rutas object was restored with
		 * an ExpandAsArray on the counter association table.
		 * @var Counter[] _objCounterAsRutaArray;
		 */
		private $_objCounterAsRutaArray = null;

		/**
		 * Private member variable that stores a reference to a single PiezaCheckpointsAsRuta object
		 * (of type PiezaCheckpoints), if this Rutas object was restored with
		 * an expansion on the pieza_checkpoints association table.
		 * @var PiezaCheckpoints _objPiezaCheckpointsAsRuta;
		 */
		private $_objPiezaCheckpointsAsRuta;

		/**
		 * Private member variable that stores a reference to an array of PiezaCheckpointsAsRuta objects
		 * (of type PiezaCheckpoints[]), if this Rutas object was restored with
		 ...
		 * (of type SdeOperacion), if this Rutas object was restored with
		 * an expansion on the sde_operacion association table.
		 * @var SdeOperacion _objSdeOperacionAsRuta;
		 */
		private $_objSdeOperacionAsRuta;

		/**
		 * Private member variable that stores a reference to an array of SdeOperacionAsRuta objects
		 * (of type SdeOperacion[]), if this Rutas object was restored with
		 * an ExpandAsArray on the sde_operacion association table.
		 * @var SdeOperacion[] _objSdeOperacionAsRutaArray;
		 */
		private $_objSdeOperacionAsRutaArray = null;
		 ...
		 * in the database column rutas.sucursal_id.
		 *
		...
		{
			$this->intId = Rutas::IdDefault;
			$this->strCodigo = Rutas::CodigoDefault;
			$this->strDescripcion = Rutas::DescripcionDefault;
			$this->intSucursalId = Rutas::SucursalIdDefault;
			$this->intTipoId = Rutas::TipoIdDefault;
			$this->strObservacion = Rutas::ObservacionDefault;
			$this->strCreatedAt = Rutas::CreatedAtDefault;
			$this->strUpdatedAt = Rutas::UpdatedAtDefault;
			$this->strDeletedAt = Rutas::DeletedAtDefault;
			$this->intCreatedBy = Rutas::CreatedByDefault;
			$this->intUpdatedBy = Rutas::UpdatedByDefault;
			$this->intDeletedBy = Rutas::DeletedByDefault;
		}
		...
		public static function Load($intId, $objOptionalClauses = null) {
			...
			if (QApplication::$objCacheProvider && !$objOptionalClauses && QApplication::$Database[1]->Caching) {
				$strCacheKey = QApplication::$objCacheProvider->CreateKey(QApplication::$Database[1]->Database, 'Rutas', $intId);
			...
			$objToReturn = Rutas::QuerySingle(
				QQ::AndCondition(
					QQ::Equal(QQN::Rutas()->Id, $intId)
				),
				$objOptionalClauses
			);
		...
		public static function LoadAll($objOptionalClauses = null) {
			...
			// Call Rutas::QueryArray to perform the LoadAll query
			try {
				return Rutas::QueryArray(QQ::All(), $objOptionalClauses);
		...
		public static function CountAll() {
			// Call Rutas::QueryCount to perform the CountAll query
			return Rutas::QueryCount(QQ::All());
		}
		...
		protected static function BuildQueryStatement(&$objQueryBuilder, QQCondition $objConditions, $objOptionalClauses, $mixParameterArray, $blnCountOnly) {
			...
			// Create/Build out the QueryBuilder object with Rutas-specific SELET and FROM fields
			$objQueryBuilder = new QQueryBuilder($objDatabase, 'rutas');
			...
			if ($blnAddAllFieldsToSelect) {
				Rutas::GetSelectFields($objQueryBuilder, null, QQuery::extractSelectClause($objOptionalClauses));
			}
			$objQueryBuilder->AddFromItem('rutas');
		...
		/**
		 * Static Qcubed Query method to query for a single Rutas object.
		 * Uses BuildQueryStatment to perform most of the work.
		 * @param QQCondition $objConditions any conditions on the query, itself
		 * @param QQClause[] $objOptionalClausees additional optional QQClause objects for this query
		 * @param mixed[] $mixParameterArray a array of name-value pairs to perform PrepareStatement with
		 * @return Rutas the queried object
		 */
		public static function QuerySingle(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null) {
			// Get the Query Statement
			try {
				$strQuery = Rutas::BuildQueryStatement($objQueryBuilder, $objConditions, $objOptionalClauses, $mixParameterArray, false);
			} catch (QCallerException $objExc) {
				$objExc->IncrementOffset();
				throw $objExc;
			}

			// Perform the Query, Get the First Row, and Instantiate a new Rutas object
			...
			if ($objQueryBuilder->ExpandAsArrayNode) {
				...
				while ($objDbRow = $objDbResult->GetNextRow()) {
					$objItem = Rutas::InstantiateDbRow($objDbRow, null, $objQueryBuilder->ExpandAsArrayNode, $objPrevItemArray, $objQueryBuilder->ColumnAliasArray);
					if ($objItem) {
						$objToReturn[] = $objItem;
				...
				if(null === $objDbRow)
					return null;
				return Rutas::InstantiateDbRow($objDbRow, null, null, null, $objQueryBuilder->ColumnAliasArray);
			}
		}

		/**
		 * Static Qcubed Query method to query for an array of Rutas objects.
		 * Uses BuildQueryStatment to perform most of the work.
		 * @param QQCondition $objConditions any conditions on the query, itself
		 * @param QQClause[] $objOptionalClausees additional optional QQClause objects for this query
		 * @param mixed[] $mixParameterArray a array of name-value pairs to perform PrepareStatement with
		 * @return Rutas[] the queried objects as an array
		 */
		public static function QueryArray(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null) {
			...
			$objDbResult = $objQueryBuilder->Database->Query($strQuery);
			return Rutas::InstantiateDbResult($objDbResult, $objQueryBuilder->ExpandAsArrayNode, $objQueryBuilder->ColumnAliasArray);
		}
		...
		/**
		 * Static Qcubed Query method to query for a count of Rutas objects.
		 * Uses BuildQueryStatment to perform most of the work.
		 * @param QQCondition $objConditions any conditions on the query, itself
		 * @param QQClause[] $objOptionalClausees additional optional QQClause objects for this query
		 * @param mixed[] $mixParameterArray a array of name-value pairs to perform PrepareStatement with
		...
		public static function QueryCount(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null) {
			// Get the Query Statement
			try {
				$strQuery = Rutas::BuildQueryStatement($objQueryBuilder, $objConditions, $objOptionalClauses, $mixParameterArray, true);
			} catch (QCallerException $objExc) {
				$objExc->IncrementOffset();
				throw $objExc;
			}
		...
		public static function QueryArrayCached(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null, $blnForceUpdate = false) {
			...
			$objCache = new QCache('qquery/rutas', $strQuery);
			$cacheData = $objCache->GetData();

			if (!$cacheData || $blnForceUpdate) {
				$objDbResult = $objQueryBuilder->Database->Query($strQuery);
				$arrResult = Rutas::InstantiateDbResult($objDbResult, $objQueryBuilder->ExpandAsArrayNode, $objQueryBuilder->ColumnAliasArray);
		...
		/**
		 * Updates a QQueryBuilder with the SELECT fields for this Rutas
		...
		/**
		 * Instantiate a Rutas from a Database Row.
		 * Takes in an optional strAliasPrefix, used in case another Object::InstantiateDbRow
		 * is calling this Rutas::InstantiateDbRow in order to perform
		 ...
		 * @param string[] $strColumnAliasArray
		 * @return mixed Either a Rutas, or false to indicate the dbrow was used in an expansion, or null to indicate that this leaf is a duplicate.
		*/
		public static function InstantiateDbRow($objDbRow, $strAliasPrefix = null, $objExpandAsArrayNode = null, $objPreviousItemArray = null, $strColumnAliasArray = array()) {
			...
			if ($objExpandAsArrayNode && 
				...
				if (Rutas::ExpandArray ($objDbRow, $strAliasPrefix, $objExpandAsArrayNode, $objPreviousItemArray, $strColumnAliasArray)) {
					return false; // db row was used but no new object was created
				}
			}

			// Create a new instance of the Rutas object
			$objToReturn = new Rutas();
			...
			// Check for CounterAsRuta Virtual Binding
			$strAlias = $strAliasPrefix . 'counterasruta__id';
			$strAliasName = !empty($strColumnAliasArray[$strAlias]) ? $strColumnAliasArray[$strAlias] : $strAlias;
			$objExpansionNode = (empty($objExpansionAliasArray['counterasruta']) ? null : $objExpansionAliasArray['counterasruta']);
			$blnExpanded = ($objExpansionNode && $objExpansionNode->ExpandAsArray);
			if ($blnExpanded && null === $objToReturn->_objCounterAsRutaArray)
				$objToReturn->_objCounterAsRutaArray = array();
			if (!is_null($objDbRow->GetColumn($strAliasName))) {
				if ($blnExpanded) {
					$objToReturn->_objCounterAsRutaArray[] = Counter::InstantiateDbRow($objDbRow, $strAliasPrefix . 'counterasruta__', $objExpansionNode, null, $strColumnAliasArray);
				} elseif (is_null($objToReturn->_objCounterAsRuta)) {
					$objToReturn->_objCounterAsRuta = Counter::InstantiateDbRow($objDbRow, $strAliasPrefix . 'counterasruta__', $objExpansionNode, null, $strColumnAliasArray);
				}
			}

			// Check for PiezaCheckpointsAsRuta Virtual Binding
			$strAlias = $strAliasPrefix . 'piezacheckpointsasruta__id';
			$strAliasName = !empty($strColumnAliasArray[$strAlias]) ? $strColumnAliasArray[$strAlias] : $strAlias;
			$objExpansionNode = (empty($objExpansionAliasArray['piezacheckpointsasruta']) ? null : $objExpansionAliasArray['piezacheckpointsasruta']);
			$blnExpanded = ($objExpansionNode && $objExpansionNode->ExpandAsArray);
			if ($blnExpanded && null === $objToReturn->_objPiezaCheckpointsAsRutaArray)
				$objToReturn->_objPiezaCheckpointsAsRutaArray = array();
			if (!is_null($objDbRow->GetColumn($strAliasName))) {
				if ($blnExpanded) {
					$objToReturn->_objPiezaCheckpointsAsRutaArray[] = PiezaCheckpoints::InstantiateDbRow($objDbRow, $strAliasPrefix . 'piezacheckpointsasruta__', $objExpansionNode, null, $strColumnAliasArray);
				} elseif (is_null($objToReturn->_objPiezaCheckpointsAsRuta)) {
					$objToReturn->_objPiezaCheckpointsAsRuta = PiezaCheckpoints::InstantiateDbRow($objDbRow, $strAliasPrefix . 'piezacheckpointsasruta__', $objExpansionNode, null, $strColumnAliasArray);
				}
			}
			...
			$strAliasName = !empty($strColumnAliasArray[$strAlias]) ? $strColumnAliasArray[$strAlias] : $strAlias;
			$objExpansionNode = (empty($objExpansionAliasArray['sdeoperacionasruta']) ? null : $objExpansionAliasArray['sdeoperacionasruta']);
			$blnExpanded = ($objExpansionNode && $objExpansionNode->ExpandAsArray);
			if ($blnExpanded && null === $objToReturn->_objSdeOperacionAsRutaArray)
				$objToReturn->_objSdeOperacionAsRutaArray = array();
			if (!is_null($objDbRow->GetColumn($strAliasName))) {
				if ($blnExpanded) {
					$objToReturn->_objSdeOperacionAsRutaArray[] = SdeOperacion::InstantiateDbRow($objDbRow, $strAliasPrefix . 'sdeoperacionasruta__', $objExpansionNode, null, $strColumnAliasArray);
				} elseif (is_null($objToReturn->_objSdeOperacionAsRuta)) {
					$objToReturn->_objSdeOperacionAsRuta = SdeOperacion::InstantiateDbRow($objDbRow, $strAliasPrefix . 'sdeoperacionasruta__', $objExpansionNode, null, $strColumnAliasArray);
				}
			}
		...
		/**
		 * Instantiate an array of Rutases from a Database Result
		...
		public static function InstantiateDbResult(QDatabaseResultBase $objDbResult, $objExpandAsArrayNode = null, $strColumnAliasArray = null) {
			...
			if ($objExpandAsArrayNode) {
				...
				$objPrevItemArray = array();
				while ($objDbRow = $objDbResult->GetNextRow()) {
					$objItem = Rutas::InstantiateDbRow($objDbRow, null, $objExpandAsArrayNode, $objPrevItemArray, $strColumnAliasArray);
					if ($objItem) {
						$objToReturn[] = $objItem;
						$objPrevItemArray[$objItem->intId][] = $objItem;
				...
				while ($objDbRow = $objDbResult->GetNextRow())
					$objToReturn[] = Rutas::InstantiateDbRow($objDbRow, null, null, null, $strColumnAliasArray);
			}
		...
		/**
		 * Instantiate a single Rutas object from a query cursor (e.g. a DB ResultSet).
		 * Cursor is automatically moved to the "next row" of the result set.
		 * Will return NULL if no cursor or if the cursor has no more rows in the resultset.
		 * @param QDatabaseResultBase $objDbResult cursor resource
		 * @return Rutas next row resulting from the query
		 */
		public static function InstantiateCursor(QDatabaseResultBase $objDbResult) {
			...
			return Rutas::InstantiateDbRow($objDbRow, null, null, null, $strColumnAliasArray);
		}
		...
		*/
		public static function LoadByCodigo($strCodigo, $objOptionalClauses = null) {
			return Rutas::QuerySingle(
				QQ::AndCondition(
					QQ::Equal(QQN::Rutas()->Codigo, $strCodigo)
				),
				$objOptionalClauses
			);
		}
		...
		/**
		 * Load an array of Rutas objects,
		...
		*/
		public static function LoadArrayBySucursalId($intSucursalId, $objOptionalClauses = null) {
			// Call Rutas::QueryArray to perform the LoadArrayBySucursalId query
			try {
				return Rutas::QueryArray(
					QQ::Equal(QQN::Rutas()->SucursalId, $intSucursalId),
					$objOptionalClauses);
			} catch (QCallerException $objExc) {
				$objExc->IncrementOffset();
				throw $objExc;
		...
		*/
		public static function CountBySucursalId($intSucursalId) {
			// Call Rutas::QueryCount to perform the CountBySucursalId query
			return Rutas::QueryCount(
				QQ::Equal(QQN::Rutas()->SucursalId, $intSucursalId)
			);
		}
		...
		*/
		public static function LoadArrayByTipoId($intTipoId, $objOptionalClauses = null) {
			// Call Rutas::QueryArray to perform the LoadArrayByTipoId query
			try {
				return Rutas::QueryArray(
					QQ::Equal(QQN::Rutas()->TipoId, $intTipoId),
					$objOptionalClauses);
			} catch (QCallerException $objExc) {
				$objExc->IncrementOffset();
				throw $objExc;
		...
		*/
		public static function CountByTipoId($intTipoId) {
			// Call Rutas::QueryCount to perform the CountByTipoId query
			return Rutas::QueryCount(
				QQ::Equal(QQN::Rutas()->TipoId, $intTipoId)
			);
		}
		...
		public function Save($blnForceInsert = false, $blnForceUpdate = false) {
			...
			try {
				if ((!$this->__blnRestored) || ($blnForceInsert)) {
					...
					$mixToReturn = $this->intId = $objDatabase->InsertId('rutas', 'id');
				} else {
					...
					if (!$blnForceUpdate) {
						...
						if ($objRow[0] != $this->strCreatedAt)
							throw new QOptimisticLockingException('Rutas');
					}
					if (!$blnForceUpdate) {
						// Perform the Optimistic Locking check
						$objResult = $objDatabase->Query('
		...
		public function Delete() {
			if ((is_null($this->intId)))
				throw new QUndefinedPrimaryKeyException('Cannot delete this Rutas with an unset primary key.');
        ...
        /**
 	     * Delete this Rutas ONLY from the cache
 		 * @return void
		 */
		public function DeleteCache() {
			if (QApplication::$objCacheProvider && QApplication::$Database[1]->Caching) {
				$strCacheKey = QApplication::$objCacheProvider->CreateKey(QApplication::$Database[1]->Database, 'Rutas', $this->intId);
		...
		/**
		 * Reload this Rutas from the database.
		 * @return void
		 */
		public function Reload() {
			// Make sure we are actually Restored from the database
			if (!$this->__blnRestored)
				throw new QCallerException('Cannot call Reload() on a new, unsaved Rutas object.');

			$this->DeleteCache();

			// Reload the Object
			$objReloaded = Rutas::Load($this->intId);
		...
		public function __get($strName) {
			switch ($strName) {
				...
				case '_CounterAsRuta':
					/**
					 * Gets the value for the private _objCounterAsRuta (Read-Only)
					 * if set due to an expansion on the counter.ruta_id reverse relationship
					 * @return Counter
					 */
					return $this->_objCounterAsRuta;

				case '_CounterAsRutaArray':
					/**
					 * Gets the value for the private _objCounterAsRutaArray (Read-Only)
					 * if set due to an ExpandAsArray on the counter.ruta_id reverse relationship
					 * @return Counter[]
					 */
					return $this->_objCounterAsRutaArray;

				case '_PiezaCheckpointsAsRuta':
					/**
					 * Gets the value for the private _objPiezaCheckpointsAsRuta (Read-Only)
					 * if set due to an expansion on the pieza_checkpoints.ruta_id reverse relationship
					 * @return PiezaCheckpoints
					 */
					return $this->_objPiezaCheckpointsAsRuta;

				case '_PiezaCheckpointsAsRutaArray':
					/**
					 * Gets the value for the private _objPiezaCheckpointsAsRutaArray (Read-Only)
					 * if set due to an ExpandAsArray on the pieza_checkpoints.ruta_id reverse relationship
					 * @return PiezaCheckpoints[]
					 */
				...
				case '_SdeOperacionAsRuta':
					 ...
					 * if set due to an expansion on the sde_operacion.ruta_id reverse relationship
					 * @return SdeOperacion
					 */
					return $this->_objSdeOperacionAsRuta;

				case '_SdeOperacionAsRutaArray':
					/**
					 * Gets the value for the private _objSdeOperacionAsRutaArray (Read-Only)
					 * if set due to an ExpandAsArray on the sde_operacion.ruta_id reverse relationship
					 * @return SdeOperacion[]
					 */
					return $this->_objSdeOperacionAsRutaArray;
				...
				case 'Sucursal':
					...
					if (is_null($mixValue)) {
						...
						if (is_null($mixValue->Id))
							throw new QCallerException('Unable to set an unsaved Sucursal for this Rutas');
		...
		// Related Objects' Methods for CounterAsRuta
		//-------------------------------------------------------------------

		/**
		 * Gets all associated CountersAsRuta as an array of Counter objects
		 * @param QQClause[] $objOptionalClauses additional optional QQClause objects for this query
		 * @return Counter[]
		*/
		public function GetCounterAsRutaArray($objOptionalClauses = null) {
			if ((is_null($this->intId)))
				return array();

			try {
				return Counter::LoadArrayByRutaId($this->intId, $objOptionalClauses);
			} catch (QCallerException $objExc) {
				$objExc->IncrementOffset();
				throw $objExc;
			}
		...
		/**
		 * Counts all associated CountersAsRuta
		 * @return int
		*/
		public function CountCountersAsRuta() {
			if ((is_null($this->intId)))
				return 0;

			return Counter::CountByRutaId($this->intId);
		}

		/**
		 * Associates a CounterAsRuta
		 * @param Counter $objCounter
		 * @return void
		*/
		public function AssociateCounterAsRuta(Counter $objCounter) {
			if ((is_null($this->intId)))
				throw new QUndefinedPrimaryKeyException('Unable to call AssociateCounterAsRuta on this unsaved Rutas.');
			if ((is_null($objCounter->Id)))
				throw new QUndefinedPrimaryKeyException('Unable to call AssociateCounterAsRuta on this Rutas with an unsaved Counter.');
		...
		/**
		 * Unassociates a CounterAsRuta
		 * @param Counter $objCounter
		 * @return void
		*/
		public function UnassociateCounterAsRuta(Counter $objCounter) {
			if ((is_null($this->intId)))
				throw new QUndefinedPrimaryKeyException('Unable to call UnassociateCounterAsRuta on this unsaved Rutas.');
			if ((is_null($objCounter->Id)))
				throw new QUndefinedPrimaryKeyException('Unable to call UnassociateCounterAsRuta on this Rutas with an unsaved Counter.');
		...
		/**
		 * Unassociates all CountersAsRuta
		 * @return void
		*/
		public function UnassociateAllCountersAsRuta() {
			if ((is_null($this->intId)))
				throw new QUndefinedPrimaryKeyException('Unable to call UnassociateCounterAsRuta on this unsaved Rutas.');
		...
		/**
		 * Deletes an associated CounterAsRuta
		 * @param Counter $objCounter
		 * @return void
		*/
		public function DeleteAssociatedCounterAsRuta(Counter $objCounter) {
			if ((is_null($this->intId)))
				throw new QUndefinedPrimaryKeyException('Unable to call UnassociateCounterAsRuta on this unsaved Rutas.');
			if ((is_null($objCounter->Id)))
				throw new QUndefinedPrimaryKeyException('Unable to call UnassociateCounterAsRuta on this Rutas with an unsaved Counter.');
		...
		/**
		 * Deletes all associated CountersAsRuta
		 * @return void
		*/
		public function DeleteAllCountersAsRuta() {
			if ((is_null($this->intId)))
				throw new QUndefinedPrimaryKeyException('Unable to call UnassociateCounterAsRuta on this unsaved Rutas.');
		...
		// Related Objects' Methods for PiezaCheckpointsAsRuta
		//-------------------------------------------------------------------

		/**
		 * Gets all associated PiezaCheckpointsesAsRuta as an array of PiezaCheckpoints objects
		 * @param QQClause[] $objOptionalClauses additional optional QQClause objects for this query
		 * @return PiezaCheckpoints[]
		*/
		public function GetPiezaCheckpointsAsRutaArray($objOptionalClauses = null) {
			if ((is_null($this->intId)))
				return array();

			try {
				return PiezaCheckpoints::LoadArrayByRutaId($this->intId, $objOptionalClauses);
			} catch (QCallerException $objExc) {
				$objExc->IncrementOffset();
				throw $objExc;
			}
		...
		/**
		 * Counts all associated PiezaCheckpointsesAsRuta
		 * @return int
		*/
		public function CountPiezaCheckpointsesAsRuta() {
			if ((is_null($this->intId)))
				return 0;

			return PiezaCheckpoints::CountByRutaId($this->intId);
		}

		/**
		 * Associates a PiezaCheckpointsAsRuta
		 * @param PiezaCheckpoints $objPiezaCheckpoints
		 * @return void
		*/
		public function AssociatePiezaCheckpointsAsRuta(PiezaCheckpoints $objPiezaCheckpoints) {
			if ((is_null($this->intId)))
				throw new QUndefinedPrimaryKeyException('Unable to call AssociatePiezaCheckpointsAsRuta on this unsaved Rutas.');
			if ((is_null($objPiezaCheckpoints->Id)))
				throw new QUndefinedPrimaryKeyException('Unable to call AssociatePiezaCheckpointsAsRuta on this Rutas with an unsaved PiezaCheckpoints.');
		...
		/**
		 * Unassociates a PiezaCheckpointsAsRuta
		 * @param PiezaCheckpoints $objPiezaCheckpoints
		 * @return void
		*/
		public function UnassociatePiezaCheckpointsAsRuta(PiezaCheckpoints $objPiezaCheckpoints) {
			if ((is_null($this->intId)))
				throw new QUndefinedPrimaryKeyException('Unable to call UnassociatePiezaCheckpointsAsRuta on this unsaved Rutas.');
			if ((is_null($objPiezaCheckpoints->Id)))
				throw new QUndefinedPrimaryKeyException('Unable to call UnassociatePiezaCheckpointsAsRuta on this Rutas with an unsaved PiezaCheckpoints.');
		...
		/**
		 * Unassociates all PiezaCheckpointsesAsRuta
		 * @return void
		*/
		public function UnassociateAllPiezaCheckpointsesAsRuta() {
			if ((is_null($this->intId)))
				throw new QUndefinedPrimaryKeyException('Unable to call UnassociatePiezaCheckpointsAsRuta on this unsaved Rutas.');
		...
		/**
		 * Deletes an associated PiezaCheckpointsAsRuta
		 * @param PiezaCheckpoints $objPiezaCheckpoints
		 * @return void
		*/
		public function DeleteAssociatedPiezaCheckpointsAsRuta(PiezaCheckpoints $objPiezaCheckpoints) {
			if ((is_null($this->intId)))
				throw new QUndefinedPrimaryKeyException('Unable to call UnassociatePiezaCheckpointsAsRuta on this unsaved Rutas.');
			if ((is_null($objPiezaCheckpoints->Id)))
				throw new QUndefinedPrimaryKeyException('Unable to call UnassociatePiezaCheckpointsAsRuta on this Rutas with an unsaved PiezaCheckpoints.');
		...
		/**
		 * Deletes all associated PiezaCheckpointsesAsRuta
		 * @return void
		*/
		public function DeleteAllPiezaCheckpointsesAsRuta() {
			if ((is_null($this->intId)))
				throw new QUndefinedPrimaryKeyException('Unable to call UnassociatePiezaCheckpointsAsRuta on this unsaved Rutas.');
		...
		*/
		...
		// Related Objects' Methods for SdeOperacionAsRuta
		//-------------------------------------------------------------------

		/**
		 * Gets all associated SdeOperacionsAsRuta as an array of SdeOperacion objects
		 * @param QQClause[] $objOptionalClauses additional optional QQClause objects for this query
		 * @return SdeOperacion[]
		*/
		public function GetSdeOperacionAsRutaArray($objOptionalClauses = null) {
			if ((is_null($this->intId)))
				return array();

			try {
				return SdeOperacion::LoadArrayByRutaId($this->intId, $objOptionalClauses);
			} catch (QCallerException $objExc) {
				$objExc->IncrementOffset();
				throw $objExc;
			}
		...
		/**
		 * Counts all associated SdeOperacionsAsRuta
		 * @return int
		*/
		public function CountSdeOperacionsAsRuta() {
			if ((is_null($this->intId)))
				return 0;

			return SdeOperacion::CountByRutaId($this->intId);
		}

		/**
		 * Associates a SdeOperacionAsRuta
		 * @param SdeOperacion $objSdeOperacion
		 * @return void
		*/
		public function AssociateSdeOperacionAsRuta(SdeOperacion $objSdeOperacion) {
			if ((is_null($this->intId)))
				throw new QUndefinedPrimaryKeyException('Unable to call AssociateSdeOperacionAsRuta on this unsaved Rutas.');
			if ((is_null($objSdeOperacion->CodiOper)))
				throw new QUndefinedPrimaryKeyException('Unable to call AssociateSdeOperacionAsRuta on this Rutas with an unsaved SdeOperacion.');
		...
		/**
		 * Unassociates a SdeOperacionAsRuta
		 * @param SdeOperacion $objSdeOperacion
		 * @return void
		*/
		public function UnassociateSdeOperacionAsRuta(SdeOperacion $objSdeOperacion) {
			if ((is_null($this->intId)))
				throw new QUndefinedPrimaryKeyException('Unable to call UnassociateSdeOperacionAsRuta on this unsaved Rutas.');
			if ((is_null($objSdeOperacion->CodiOper)))
				throw new QUndefinedPrimaryKeyException('Unable to call UnassociateSdeOperacionAsRuta on this Rutas with an unsaved SdeOperacion.');
		...
		/**
		 * Unassociates all SdeOperacionsAsRuta
		 * @return void
		*/
		public function UnassociateAllSdeOperacionsAsRuta() {
			if ((is_null($this->intId)))
				throw new QUndefinedPrimaryKeyException('Unable to call UnassociateSdeOperacionAsRuta on this unsaved Rutas.');
		...
		/**
		 * Deletes an associated SdeOperacionAsRuta
		 * @param SdeOperacion $objSdeOperacion
		 * @return void
		*/
		public function DeleteAssociatedSdeOperacionAsRuta(SdeOperacion $objSdeOperacion) {
			if ((is_null($this->intId)))
				throw new QUndefinedPrimaryKeyException('Unable to call UnassociateSdeOperacionAsRuta on this unsaved Rutas.');
			if ((is_null($objSdeOperacion->CodiOper)))
				throw new QUndefinedPrimaryKeyException('Unable to call UnassociateSdeOperacionAsRuta on this Rutas with an unsaved SdeOperacion.');
		...
		/**
		 * Deletes all associated SdeOperacionsAsRuta
		 * @return void
		*/
		public function DeleteAllSdeOperacionsAsRuta() {
			if ((is_null($this->intId)))
				throw new QUndefinedPrimaryKeyException('Unable to call UnassociateSdeOperacionAsRuta on this unsaved Rutas.');
		...
		public static function GetDatabaseName() {
			return QApplication::$Database[Rutas::GetDatabaseIndex()]->Database;
		}
		...
		public static function GetSoapComplexTypeXml() {
			$strToReturn = '<complexType name="Rutas"><sequence>';
		...
		public static function AlterSoapComplexTypeArray(&$strComplexTypeArray) {
			if (!array_key_exists('Rutas', $strComplexTypeArray)) {
				$strComplexTypeArray['Rutas'] = Rutas::GetSoapComplexTypeXml();
		...
		public static function GetArrayFromSoapArray($objSoapArray) {
			...
			foreach ($objSoapArray as $objSoapObject)
				array_push($objArrayToReturn, Rutas::GetObjectFromSoapObject($objSoapObject));
		...
		public static function GetSoapArrayFromArray($objArray) {
			...
			foreach ($objArray as $objObject)
				array_push($objArrayToReturn, Rutas::GetSoapObjectFromObject($objObject, true));
     ...
     **/
	class QQNodeRutas extends QQNode {
		protected $strTableName = 'rutas';
		protected $strPrimaryKey = 'id';
		protected $strClassName = 'Rutas';
		public function __get($strName) {
			switch ($strName) {
				case 'Id':
     ...
     * @property-read QQNode $_PrimaryKeyNode
     **/
	class QQReverseReferenceNodeRutas extends QQReverseReferenceNode {
		protected $strTableName = 'rutas';
		protected $strPrimaryKey = 'id';
		protected $strClassName = 'Rutas';
		public function __get($strName) {
