<?php
	...
	class ContainersGen extends QBaseClass implements IteratorAggregate {
		...
		public function Initialize()
		{
			...
			$this->dttCreatedAt = (Containers::CreatedAtDefault === null)?null:new QDateTime(Containers::CreatedAtDefault);
			$this->dttUpdatedAt = (Containers::UpdatedAtDefault === null)?null:new QDateTime(Containers::UpdatedAtDefault);
