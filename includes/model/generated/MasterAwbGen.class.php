<?php
	/**
	 * The abstract MasterAwbGen class defined here is
	 * code-generated and contains all the basic CRUD-type functionality as well as
	 * basic methods to handle relationships and index-based loading.
	 *
	 * To use, you should use the MasterAwb subclass which
	 * extends this MasterAwbGen class.
	 *
	 * Because subsequent re-code generations will overwrite any changes to this
	 * file, you should leave this file unaltered to prevent yourself from losing
	 * any information or code changes.  All customizations should be done by
	 * overriding existing or implementing new methods, properties and variables
	 * in the MasterAwb class.
	 *
	 ...
	 * @property boolean $Usada the value for blnUsada (Not Null)
	 * @property integer $ProcesoId the value for intProcesoId 
	...
	class MasterAwbGen extends QBaseClass implements IteratorAggregate {
		...
		/**
		 * Protected member variable that maps to the database PK Identity column master_awb.id
		 * @var integer intId
		 */
		protected $intId;
		...
		/**
		 * Protected member variable that maps to the database column master_awb.linea_aerea_id
		...
		/**
		 * Protected member variable that maps to the database column master_awb.numero
		...
		/**
		 * Protected member variable that maps to the database column master_awb.usada
		 * @var boolean blnUsada
		 */
		protected $blnUsada;
		const UsadaDefault = 0;


		/**
		 * Protected member variable that maps to the database column master_awb.proceso_id
		...
		/**
		 * Protected member variable that maps to the database column master_awb.created_at
		...
		/**
		 * Protected member variable that maps to the database column master_awb.updated_at
		...
		/**
		 * Protected member variable that maps to the database column master_awb.created_by
		...
		/**
		 * Protected member variable that maps to the database column master_awb.updated_by
		 ...
		 * in the database column master_awb.linea_aerea_id.
		 *
		...
		{
			$this->intId = MasterAwb::IdDefault;
			$this->intLineaAereaId = MasterAwb::LineaAereaIdDefault;
			$this->strNumero = MasterAwb::NumeroDefault;
			$this->blnUsada = MasterAwb::UsadaDefault;
			$this->intProcesoId = MasterAwb::ProcesoIdDefault;
			$this->strCreatedAt = MasterAwb::CreatedAtDefault;
			$this->strUpdatedAt = MasterAwb::UpdatedAtDefault;
			$this->intCreatedBy = MasterAwb::CreatedByDefault;
			$this->intUpdatedBy = MasterAwb::UpdatedByDefault;
		}
		...
		public static function Load($intId, $objOptionalClauses = null) {
			...
			if (QApplication::$objCacheProvider && !$objOptionalClauses && QApplication::$Database[1]->Caching) {
				$strCacheKey = QApplication::$objCacheProvider->CreateKey(QApplication::$Database[1]->Database, 'MasterAwb', $intId);
			...
			$objToReturn = MasterAwb::QuerySingle(
				QQ::AndCondition(
					QQ::Equal(QQN::MasterAwb()->Id, $intId)
				),
				$objOptionalClauses
			);
		...
		public static function LoadAll($objOptionalClauses = null) {
			...
			// Call MasterAwb::QueryArray to perform the LoadAll query
			try {
				return MasterAwb::QueryArray(QQ::All(), $objOptionalClauses);
		...
		/**
		 * Count all MasterAwbs
		 * @return int
		 */
		public static function CountAll() {
			// Call MasterAwb::QueryCount to perform the CountAll query
			return MasterAwb::QueryCount(QQ::All());
		}
		...
		protected static function BuildQueryStatement(&$objQueryBuilder, QQCondition $objConditions, $objOptionalClauses, $mixParameterArray, $blnCountOnly) {
			...
			// Create/Build out the QueryBuilder object with MasterAwb-specific SELET and FROM fields
			$objQueryBuilder = new QQueryBuilder($objDatabase, 'master_awb');
			...
			if ($blnAddAllFieldsToSelect) {
				MasterAwb::GetSelectFields($objQueryBuilder, null, QQuery::extractSelectClause($objOptionalClauses));
			}
			$objQueryBuilder->AddFromItem('master_awb');
		...
		/**
		 * Static Qcubed Query method to query for a single MasterAwb object.
		 * Uses BuildQueryStatment to perform most of the work.
		 * @param QQCondition $objConditions any conditions on the query, itself
		 * @param QQClause[] $objOptionalClausees additional optional QQClause objects for this query
		 * @param mixed[] $mixParameterArray a array of name-value pairs to perform PrepareStatement with
		 * @return MasterAwb the queried object
		 */
		public static function QuerySingle(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null) {
			// Get the Query Statement
			try {
				$strQuery = MasterAwb::BuildQueryStatement($objQueryBuilder, $objConditions, $objOptionalClauses, $mixParameterArray, false);
			} catch (QCallerException $objExc) {
				$objExc->IncrementOffset();
				throw $objExc;
			}

			// Perform the Query, Get the First Row, and Instantiate a new MasterAwb object
			...
			if ($objQueryBuilder->ExpandAsArrayNode) {
				...
				while ($objDbRow = $objDbResult->GetNextRow()) {
					$objItem = MasterAwb::InstantiateDbRow($objDbRow, null, $objQueryBuilder->ExpandAsArrayNode, $objPrevItemArray, $objQueryBuilder->ColumnAliasArray);
					if ($objItem) {
						$objToReturn[] = $objItem;
				...
				if(null === $objDbRow)
					return null;
				return MasterAwb::InstantiateDbRow($objDbRow, null, null, null, $objQueryBuilder->ColumnAliasArray);
			}
		}

		/**
		 * Static Qcubed Query method to query for an array of MasterAwb objects.
		 * Uses BuildQueryStatment to perform most of the work.
		 * @param QQCondition $objConditions any conditions on the query, itself
		 * @param QQClause[] $objOptionalClausees additional optional QQClause objects for this query
		 * @param mixed[] $mixParameterArray a array of name-value pairs to perform PrepareStatement with
		 * @return MasterAwb[] the queried objects as an array
		 */
		public static function QueryArray(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null) {
			...
			$objDbResult = $objQueryBuilder->Database->Query($strQuery);
			return MasterAwb::InstantiateDbResult($objDbResult, $objQueryBuilder->ExpandAsArrayNode, $objQueryBuilder->ColumnAliasArray);
		}
		...
		/**
		 * Static Qcubed Query method to query for a count of MasterAwb objects.
		 * Uses BuildQueryStatment to perform most of the work.
		 * @param QQCondition $objConditions any conditions on the query, itself
		 * @param QQClause[] $objOptionalClausees additional optional QQClause objects for this query
		 * @param mixed[] $mixParameterArray a array of name-value pairs to perform PrepareStatement with
		...
		public static function QueryCount(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null) {
			// Get the Query Statement
			try {
				$strQuery = MasterAwb::BuildQueryStatement($objQueryBuilder, $objConditions, $objOptionalClauses, $mixParameterArray, true);
			} catch (QCallerException $objExc) {
				$objExc->IncrementOffset();
				throw $objExc;
			}
		...
		public static function QueryArrayCached(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null, $blnForceUpdate = false) {
			...
			$objCache = new QCache('qquery/masterawb', $strQuery);
			$cacheData = $objCache->GetData();

			if (!$cacheData || $blnForceUpdate) {
				$objDbResult = $objQueryBuilder->Database->Query($strQuery);
				$arrResult = MasterAwb::InstantiateDbResult($objDbResult, $objQueryBuilder->ExpandAsArrayNode, $objQueryBuilder->ColumnAliasArray);
		...
		/**
		 * Updates a QQueryBuilder with the SELECT fields for this MasterAwb
		...
		public static function GetSelectFields(QQueryBuilder $objBuilder, $strPrefix = null, QQSelect $objSelect = null) {
            ...
            if ($objSelect) {
			    ...
			    $objBuilder->AddSelectItem($strTableName, 'usada', $strAliasPrefix . 'usada');
		...
		/**
		 * Instantiate a MasterAwb from a Database Row.
		 * Takes in an optional strAliasPrefix, used in case another Object::InstantiateDbRow
		 * is calling this MasterAwb::InstantiateDbRow in order to perform
		 ...
		 * @param string[] $strColumnAliasArray
		 * @return mixed Either a MasterAwb, or false to indicate the dbrow was used in an expansion, or null to indicate that this leaf is a duplicate.
		*/
		public static function InstantiateDbRow($objDbRow, $strAliasPrefix = null, $objExpandAsArrayNode = null, $objPreviousItemArray = null, $strColumnAliasArray = array()) {
			...
			if ($objExpandAsArrayNode && 
				...
				if (MasterAwb::ExpandArray ($objDbRow, $strAliasPrefix, $objExpandAsArrayNode, $objPreviousItemArray, $strColumnAliasArray)) {
					return false; // db row was used but no new object was created
				}
			}

			// Create a new instance of the MasterAwb object
			$objToReturn = new MasterAwb();
			...
			$strAlias = $strAliasPrefix . 'usada';
			$strAliasName = !empty($strColumnAliasArray[$strAlias]) ? $strColumnAliasArray[$strAlias] : $strAlias;
			$objToReturn->blnUsada = $objDbRow->GetColumn($strAliasName, 'Bit');
		...
		/**
		 * Instantiate an array of MasterAwbs from a Database Result
		...
		public static function InstantiateDbResult(QDatabaseResultBase $objDbResult, $objExpandAsArrayNode = null, $strColumnAliasArray = null) {
			...
			if ($objExpandAsArrayNode) {
				...
				$objPrevItemArray = array();
				while ($objDbRow = $objDbResult->GetNextRow()) {
					$objItem = MasterAwb::InstantiateDbRow($objDbRow, null, $objExpandAsArrayNode, $objPrevItemArray, $strColumnAliasArray);
					if ($objItem) {
						$objToReturn[] = $objItem;
						$objPrevItemArray[$objItem->intId][] = $objItem;
				...
				while ($objDbRow = $objDbResult->GetNextRow())
					$objToReturn[] = MasterAwb::InstantiateDbRow($objDbRow, null, null, null, $strColumnAliasArray);
			}
		...
		/**
		 * Instantiate a single MasterAwb object from a query cursor (e.g. a DB ResultSet).
		 * Cursor is automatically moved to the "next row" of the result set.
		 * Will return NULL if no cursor or if the cursor has no more rows in the resultset.
		 * @param QDatabaseResultBase $objDbResult cursor resource
		 * @return MasterAwb next row resulting from the query
		 */
		public static function InstantiateCursor(QDatabaseResultBase $objDbResult) {
			...
			return MasterAwb::InstantiateDbRow($objDbRow, null, null, null, $strColumnAliasArray);
		}
		...
		/**
		 * Load a single MasterAwb object,
		 * by Id Index(es)
		 * @param integer $intId
		 * @param QQClause[] $objOptionalClauses additional optional QQClause objects for this query
		 * @return MasterAwb
		...
		*/
		public static function LoadByNumero($strNumero, $objOptionalClauses = null) {
			return MasterAwb::QuerySingle(
				QQ::AndCondition(
					QQ::Equal(QQN::MasterAwb()->Numero, $strNumero)
				),
				$objOptionalClauses
			);
		}
		...
		/**
		 * Load an array of MasterAwb objects,
		...
		*/
		public static function LoadArrayByLineaAereaId($intLineaAereaId, $objOptionalClauses = null) {
			// Call MasterAwb::QueryArray to perform the LoadArrayByLineaAereaId query
			try {
				return MasterAwb::QueryArray(
					QQ::Equal(QQN::MasterAwb()->LineaAereaId, $intLineaAereaId),
					$objOptionalClauses);
			} catch (QCallerException $objExc) {
				$objExc->IncrementOffset();
				throw $objExc;
		...
		*/
		public static function CountByLineaAereaId($intLineaAereaId) {
			// Call MasterAwb::QueryCount to perform the CountByLineaAereaId query
			return MasterAwb::QueryCount(
				QQ::Equal(QQN::MasterAwb()->LineaAereaId, $intLineaAereaId)
			);
		}
				...
				if ((!$this->__blnRestored) || ($blnForceInsert)) {
					...
					$objDatabase->NonQuery('
						INSERT INTO `master_awb` (
							...
							' . $objDatabase->SqlVariable($this->blnUsada) . ',
					...
					$mixToReturn = $this->intId = $objDatabase->InsertId('master_awb', 'id');
				} else {
					...
					if (!$blnForceUpdate) {
						...
						if ($objRow[0] != $this->strCreatedAt)
							throw new QOptimisticLockingException('MasterAwb');
					}
					if (!$blnForceUpdate) {
						// Perform the Optimistic Locking check
						$objResult = $objDatabase->Query('
					...
					$objDatabase->NonQuery('
						...
						SET
							...
							`usada` = ' . $objDatabase->SqlVariable($this->blnUsada) . ',
		...
		/**
		 * Delete this MasterAwb
		 * @return void
		 */
		public function Delete() {
			if ((is_null($this->intId)))
				throw new QUndefinedPrimaryKeyException('Cannot delete this MasterAwb with an unset primary key.');
        ...
        /**
 	     * Delete this MasterAwb ONLY from the cache
 		 * @return void
		 */
		public function DeleteCache() {
			if (QApplication::$objCacheProvider && QApplication::$Database[1]->Caching) {
				$strCacheKey = QApplication::$objCacheProvider->CreateKey(QApplication::$Database[1]->Database, 'MasterAwb', $this->intId);
				QApplication::$objCacheProvider->Delete($strCacheKey);
			}
		}

		/**
		 * Delete all MasterAwbs
		 * @return void
		 */
		...
		/**
		 * Reload this MasterAwb from the database.
		 * @return void
		 */
		public function Reload() {
			// Make sure we are actually Restored from the database
			if (!$this->__blnRestored)
				throw new QCallerException('Cannot call Reload() on a new, unsaved MasterAwb object.');

			$this->DeleteCache();

			// Reload the Object
			$objReloaded = MasterAwb::Load($this->intId);

			// Update $this's local variables to match
			$this->LineaAereaId = $objReloaded->LineaAereaId;
			$this->strNumero = $objReloaded->strNumero;
			$this->blnUsada = $objReloaded->blnUsada;
		...
		public function __get($strName) {
			switch ($strName) {
				...
				case 'Usada':
					/**
					 * Gets the value for blnUsada (Not Null)
					 * @return boolean
					 */
					return $this->blnUsada;

				case 'ProcesoId':
					/**
					 * Gets the value for intProcesoId 
					 * @return integer
					 */
		...
		public function __set($strName, $mixValue) {
			switch ($strName) {
				...
				case 'Usada':
					/**
					 * Sets the value for blnUsada (Not Null)
					 * @param boolean $mixValue
					 * @return boolean
					 */
					try {
						return ($this->blnUsada = QType::Cast($mixValue, QType::Boolean));
					} catch (QCallerException $objExc) {
						$objExc->IncrementOffset();
						throw $objExc;
					}
				...
				case 'ProcesoId':
					/**
					 * Sets the value for intProcesoId 
					 * @param integer $mixValue
					 * @return integer
					 */
					try {
				...
				case 'LineaAerea':
					...
					if (is_null($mixValue)) {
						...
						if (is_null($mixValue->Id))
							throw new QCallerException('Unable to set an unsaved LineaAerea for this MasterAwb');
		...
		public static function GetDatabaseName() {
			return QApplication::$Database[MasterAwb::GetDatabaseIndex()]->Database;
		}
		...
		public static function AlterSoapComplexTypeArray(&$strComplexTypeArray) {
			if (!array_key_exists('MasterAwb', $strComplexTypeArray)) {
				$strComplexTypeArray['MasterAwb'] = MasterAwb::GetSoapComplexTypeXml();
		...
		public static function GetArrayFromSoapArray($objSoapArray) {
			...
			foreach ($objSoapArray as $objSoapObject)
				array_push($objArrayToReturn, MasterAwb::GetObjectFromSoapObject($objSoapObject));
		...
		public static function GetObjectFromSoapObject($objSoapObject) {
			...
			if (property_exists($objSoapObject, 'Usada'))
				$objToReturn->blnUsada = $objSoapObject->Usada;
		...
		public static function GetSoapArrayFromArray($objArray) {
			...
			foreach ($objArray as $objObject)
				array_push($objArrayToReturn, MasterAwb::GetSoapObjectFromObject($objObject, true));
     ...
     **/
	class QQNodeMasterAwb extends QQNode {
		protected $strTableName = 'master_awb';
		protected $strPrimaryKey = 'id';
		protected $strClassName = 'MasterAwb';
		public function __get($strName) {
			switch ($strName) {
				case 'Id':
				...
				case 'Usada':
					return new QQNode('usada', 'Usada', 'Bit', $this);
				case 'ProcesoId':
     ...
     * @property-read QQNode $_PrimaryKeyNode
     **/
	class QQReverseReferenceNodeMasterAwb extends QQReverseReferenceNode {
		protected $strTableName = 'master_awb';
		protected $strPrimaryKey = 'id';
		protected $strClassName = 'MasterAwb';
		public function __get($strName) {
			switch ($strName) {
				...
				case 'Usada':
					return new QQNode('usada', 'Usada', 'boolean', $this);
				case 'ProcesoId':
					return new QQNode('proceso_id', 'ProcesoId', 'integer', $this);
				case 'CreatedAt':
