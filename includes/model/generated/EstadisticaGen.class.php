<?php
	 ...
	 * @property integer $SucursalId the value for intSucursalId (PK)
	 ...
	 * @property Sucursales $Sucursal the value for the Sucursales object referenced by intSucursalId (PK)
	...
	class EstadisticaGen extends QBaseClass implements IteratorAggregate {
		 ...
		 * @var integer __intSucursalId;
		 */
		protected $__intSucursalId;
		...
		{
			$this->intSucursalId = Estadistica::SucursalIdDefault;
		 ...
		 * @param integer $intSucursalId		 * @param QDateTime $dttFecha		 * @param string $strMedicion
		 * @param QQClause[] $objOptionalClauses additional optional QQClause objects for this query
		 * @return Estadistica
		 */
		public static function Load($intSucursalId, $dttFecha, $strMedicion, $objOptionalClauses = null) {
			$strCacheKey = false;
			if (QApplication::$objCacheProvider && !$objOptionalClauses && QApplication::$Database[1]->Caching) {
				$strCacheKey = QApplication::$objCacheProvider->CreateKey(QApplication::$Database[1]->Database, 'Estadistica', $intSucursalId, $dttFecha, $strMedicion);
			...
			$objToReturn = Estadistica::QuerySingle(
				QQ::AndCondition(
					QQ::Equal(QQN::Estadistica()->SucursalId, $intSucursalId),
		...
		public static function QuerySingle(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null) {
			...
			if ($objQueryBuilder->ExpandAsArrayNode) {
				...
				while ($objDbRow = $objDbResult->GetNextRow()) {
					...
					if ($objItem) {
						$objToReturn[] = $objItem;
						$objPrevItemArray[$objItem->intSucursalId][] = $objItem;
		...
		public static function ExpandArray ($objDbRow, $strAliasPrefix, $objNode, $objPreviousItemArray, $strColumnAliasArray) {
			...
			foreach ($objPreviousItemArray as $objPreviousItem) {
				if ($objPreviousItem->intSucursalId != $objDbRow->GetColumn($strColumnAlias, 'Integer')) {
					continue;
				}
		...
		*/
		public static function InstantiateDbRow($objDbRow, $strAliasPrefix = null, $objExpandAsArrayNode = null, $objPreviousItemArray = null, $strColumnAliasArray = array()) {
			...
			$objToReturn->__intSucursalId = $objDbRow->GetColumn($strAliasName, 'Integer');
		 ...
		 * @return Estadistica
		*/
		public static function LoadBySucursalIdFechaMedicion($intSucursalId, $dttFecha, $strMedicion, $objOptionalClauses = null) {
		...
		*/
		...
		public function Save($blnForceInsert = false, $blnForceUpdate = false) {
			...
			try {
				if ((!$this->__blnRestored) || ($blnForceInsert)) {
					...
					$objDatabase->NonQuery('
						...
						WHERE
							`sucursal_id` = ' . $objDatabase->SqlVariable($this->__intSucursalId) . ' AND 
			...
			$this->__intSucursalId = $this->intSucursalId;
		...
		public function Delete() {
			if ((is_null($this->intSucursalId)) || (is_null($this->dttFecha)) || (is_null($this->strMedicion)))
			...
			$objDatabase->NonQuery('
				DELETE FROM
					`estadistica`
				WHERE
					`sucursal_id` = ' . $objDatabase->SqlVariable($this->intSucursalId) . ' AND
		...
		public function DeleteCache() {
			if (QApplication::$objCacheProvider && QApplication::$Database[1]->Caching) {
				$strCacheKey = QApplication::$objCacheProvider->CreateKey(QApplication::$Database[1]->Database, 'Estadistica', $this->intSucursalId, $this->dttFecha, $this->strMedicion);
		...
		public function Reload() {
			...
			// Reload the Object
			$objReloaded = Estadistica::Load($this->intSucursalId, $this->dttFecha, $this->strMedicion);
		...
		public function __get($strName) {
			switch ($strName) {
				...
				case 'SucursalId':
					/**
					 * Gets the value for intSucursalId (PK)
					 * @return integer
					 */
				...
				case 'Sucursal':
					/**
					 * Gets the value for the Sucursales object referenced by intSucursalId (PK)
					 * @return Sucursales
					 */
					try {
		...
		public function __set($strName, $mixValue) {
			switch ($strName) {
				...
				case 'SucursalId':
					/**
					 * Sets the value for intSucursalId (PK)
				...
				case 'Sucursal':
					/**
					 * Sets the value for the Sucursales object referenced by intSucursalId (PK)
		...
		public function toJsObject () {
			return JavaScriptHelper::toJsObject(array('value' => $this->__toString(), 'id' =>  array( $this->intSucursalId,  $this->dttFecha,  $this->strMedicion) ));
		}
     ...
     * @property-read QQNodeSucursales $_PrimaryKeyNode
     **/
		...
		public function __get($strName) {
			switch ($strName) {
				...
				case '_PrimaryKeyNode':
					return new QQNodeSucursales('sucursal_id', 'SucursalId', 'Integer', $this);
				default:
					try {
						return parent::__get($strName);
					} catch (QCallerException $objExc) {
