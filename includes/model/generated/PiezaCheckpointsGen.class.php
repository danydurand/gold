<?php
	/**
	 * The abstract PiezaCheckpointsGen class defined here is
	 * code-generated and contains all the basic CRUD-type functionality as well as
	 * basic methods to handle relationships and index-based loading.
	 *
	 * To use, you should use the PiezaCheckpoints subclass which
	 * extends this PiezaCheckpointsGen class.
	 *
	 * Because subsequent re-code generations will overwrite any changes to this
	 * file, you should leave this file unaltered to prevent yourself from losing
	 * any information or code changes.  All customizations should be done by
	 * overriding existing or implementing new methods, properties and variables
	 * in the PiezaCheckpoints class.
	 *
	 ...
	 * @property GuiaPiezas $Pieza the value for the GuiaPiezas object referenced by intPiezaId (Not Null)
	...
	class PiezaCheckpointsGen extends QBaseClass implements IteratorAggregate {
		...
		/**
		 * Protected member variable that maps to the database PK Identity column pieza_checkpoints.id
		 * @var integer intId
		 */
		protected $intId;
		...
		/**
		 * Protected member variable that maps to the database column pieza_checkpoints.pieza_id
		...
		/**
		 * Protected member variable that maps to the database column pieza_checkpoints.checkpoint_id
		...
		/**
		 * Protected member variable that maps to the database column pieza_checkpoints.sucursal_id
		...
		/**
		 * Protected member variable that maps to the database column pieza_checkpoints.fecha
		...
		/**
		 * Protected member variable that maps to the database column pieza_checkpoints.hora
		 * @var string strHora
		 */
		protected $strHora;
		...
		/**
		 * Protected member variable that maps to the database column pieza_checkpoints.comentario
		...
		/**
		 * Protected member variable that maps to the database column pieza_checkpoints.ruta_id
		...
		/**
		 * Protected member variable that maps to the database column pieza_checkpoints.created_at
		...
		/**
		 * Protected member variable that maps to the database column pieza_checkpoints.updated_at
		...
		/**
		 * Protected member variable that maps to the database column pieza_checkpoints.created_by
		...
		/**
		 * Protected member variable that maps to the database column pieza_checkpoints.updated_by
		 ...
		 * in the database column pieza_checkpoints.pieza_id.
		 *
		...
		/**
		 * Protected member variable that contains the object pointed by the reference
		 * in the database column pieza_checkpoints.checkpoint_id.
		 *
		...
		/**
		 * Protected member variable that contains the object pointed by the reference
		 * in the database column pieza_checkpoints.sucursal_id.
		 *
		...
		/**
		 * Protected member variable that contains the object pointed by the reference
		 * in the database column pieza_checkpoints.ruta_id.
		 *
		...
		{
			$this->intId = PiezaCheckpoints::IdDefault;
			$this->intPiezaId = PiezaCheckpoints::PiezaIdDefault;
			$this->intCheckpointId = PiezaCheckpoints::CheckpointIdDefault;
			$this->intSucursalId = PiezaCheckpoints::SucursalIdDefault;
			$this->dttFecha = (PiezaCheckpoints::FechaDefault === null)?null:new QDateTime(PiezaCheckpoints::FechaDefault);
			$this->strHora = PiezaCheckpoints::HoraDefault;
			$this->strComentario = PiezaCheckpoints::ComentarioDefault;
			$this->intRutaId = PiezaCheckpoints::RutaIdDefault;
			$this->dttCreatedAt = (PiezaCheckpoints::CreatedAtDefault === null)?null:new QDateTime(PiezaCheckpoints::CreatedAtDefault);
			$this->dttUpdatedAt = (PiezaCheckpoints::UpdatedAtDefault === null)?null:new QDateTime(PiezaCheckpoints::UpdatedAtDefault);
			$this->intCreatedBy = PiezaCheckpoints::CreatedByDefault;
			$this->intUpdatedBy = PiezaCheckpoints::UpdatedByDefault;
		}
		...
		/**
		 * Load a PiezaCheckpoints from PK Info
		 * @param integer $intId
		...
		public static function Load($intId, $objOptionalClauses = null) {
			...
			if (QApplication::$objCacheProvider && !$objOptionalClauses && QApplication::$Database[1]->Caching) {
				$strCacheKey = QApplication::$objCacheProvider->CreateKey(QApplication::$Database[1]->Database, 'PiezaCheckpoints', $intId);
			...
			$objToReturn = PiezaCheckpoints::QuerySingle(
				QQ::AndCondition(
					QQ::Equal(QQN::PiezaCheckpoints()->Id, $intId)
				),
				$objOptionalClauses
			);
		...
		public static function LoadAll($objOptionalClauses = null) {
			...
			// Call PiezaCheckpoints::QueryArray to perform the LoadAll query
			try {
				return PiezaCheckpoints::QueryArray(QQ::All(), $objOptionalClauses);
		...
		/**
		 * Count all PiezaCheckpointses
		 * @return int
		 */
		public static function CountAll() {
			// Call PiezaCheckpoints::QueryCount to perform the CountAll query
			return PiezaCheckpoints::QueryCount(QQ::All());
		}
		...
		protected static function BuildQueryStatement(&$objQueryBuilder, QQCondition $objConditions, $objOptionalClauses, $mixParameterArray, $blnCountOnly) {
			...
			// Create/Build out the QueryBuilder object with PiezaCheckpoints-specific SELET and FROM fields
			$objQueryBuilder = new QQueryBuilder($objDatabase, 'pieza_checkpoints');
			...
			if ($blnAddAllFieldsToSelect) {
				PiezaCheckpoints::GetSelectFields($objQueryBuilder, null, QQuery::extractSelectClause($objOptionalClauses));
			}
			$objQueryBuilder->AddFromItem('pieza_checkpoints');
		...
		/**
		 * Static Qcubed Query method to query for a single PiezaCheckpoints object.
		 * Uses BuildQueryStatment to perform most of the work.
		 * @param QQCondition $objConditions any conditions on the query, itself
		 * @param QQClause[] $objOptionalClausees additional optional QQClause objects for this query
		 * @param mixed[] $mixParameterArray a array of name-value pairs to perform PrepareStatement with
		 * @return PiezaCheckpoints the queried object
		 */
		public static function QuerySingle(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null) {
			// Get the Query Statement
			try {
				$strQuery = PiezaCheckpoints::BuildQueryStatement($objQueryBuilder, $objConditions, $objOptionalClauses, $mixParameterArray, false);
			} catch (QCallerException $objExc) {
				$objExc->IncrementOffset();
				throw $objExc;
			}

			// Perform the Query, Get the First Row, and Instantiate a new PiezaCheckpoints object
			...
			if ($objQueryBuilder->ExpandAsArrayNode) {
				...
				while ($objDbRow = $objDbResult->GetNextRow()) {
					$objItem = PiezaCheckpoints::InstantiateDbRow($objDbRow, null, $objQueryBuilder->ExpandAsArrayNode, $objPrevItemArray, $objQueryBuilder->ColumnAliasArray);
					if ($objItem) {
						$objToReturn[] = $objItem;
				...
				if(null === $objDbRow)
					return null;
				return PiezaCheckpoints::InstantiateDbRow($objDbRow, null, null, null, $objQueryBuilder->ColumnAliasArray);
			}
		}

		/**
		 * Static Qcubed Query method to query for an array of PiezaCheckpoints objects.
		 * Uses BuildQueryStatment to perform most of the work.
		 * @param QQCondition $objConditions any conditions on the query, itself
		 * @param QQClause[] $objOptionalClausees additional optional QQClause objects for this query
		 * @param mixed[] $mixParameterArray a array of name-value pairs to perform PrepareStatement with
		 * @return PiezaCheckpoints[] the queried objects as an array
		 */
		public static function QueryArray(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null) {
			...
			$objDbResult = $objQueryBuilder->Database->Query($strQuery);
			return PiezaCheckpoints::InstantiateDbResult($objDbResult, $objQueryBuilder->ExpandAsArrayNode, $objQueryBuilder->ColumnAliasArray);
		}
		...
		/**
		 * Static Qcubed Query method to query for a count of PiezaCheckpoints objects.
		 * Uses BuildQueryStatment to perform most of the work.
		 * @param QQCondition $objConditions any conditions on the query, itself
		 * @param QQClause[] $objOptionalClausees additional optional QQClause objects for this query
		 * @param mixed[] $mixParameterArray a array of name-value pairs to perform PrepareStatement with
		...
		public static function QueryCount(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null) {
			// Get the Query Statement
			try {
				$strQuery = PiezaCheckpoints::BuildQueryStatement($objQueryBuilder, $objConditions, $objOptionalClauses, $mixParameterArray, true);
			} catch (QCallerException $objExc) {
				$objExc->IncrementOffset();
				throw $objExc;
			}
		...
		public static function QueryArrayCached(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null, $blnForceUpdate = false) {
			...
			$objCache = new QCache('qquery/piezacheckpoints', $strQuery);
			$cacheData = $objCache->GetData();

			if (!$cacheData || $blnForceUpdate) {
				$objDbResult = $objQueryBuilder->Database->Query($strQuery);
				$arrResult = PiezaCheckpoints::InstantiateDbResult($objDbResult, $objQueryBuilder->ExpandAsArrayNode, $objQueryBuilder->ColumnAliasArray);
		...
		/**
		 * Updates a QQueryBuilder with the SELECT fields for this PiezaCheckpoints
		...
		public static function GetSelectFields(QQueryBuilder $objBuilder, $strPrefix = null, QQSelect $objSelect = null) {
			if ($strPrefix) {
				...
				$strTableName = 'pieza_checkpoints';
				$strAliasPrefix = '';
			}
		...
		/**
		 * Instantiate a PiezaCheckpoints from a Database Row.
		 * Takes in an optional strAliasPrefix, used in case another Object::InstantiateDbRow
		 * is calling this PiezaCheckpoints::InstantiateDbRow in order to perform
		 ...
		 * @param string[] $strColumnAliasArray
		 * @return mixed Either a PiezaCheckpoints, or false to indicate the dbrow was used in an expansion, or null to indicate that this leaf is a duplicate.
		*/
		public static function InstantiateDbRow($objDbRow, $strAliasPrefix = null, $objExpandAsArrayNode = null, $objPreviousItemArray = null, $strColumnAliasArray = array()) {
			...
			if ($objExpandAsArrayNode && 
				...
				if (PiezaCheckpoints::ExpandArray ($objDbRow, $strAliasPrefix, $objExpandAsArrayNode, $objPreviousItemArray, $strColumnAliasArray)) {
					return false; // db row was used but no new object was created
				}
			}

			// Create a new instance of the PiezaCheckpoints object
			$objToReturn = new PiezaCheckpoints();
			...
			if (!$strAliasPrefix)
				$strAliasPrefix = 'pieza_checkpoints__';
		...
		/**
		 * Instantiate an array of PiezaCheckpointses from a Database Result
		...
		public static function InstantiateDbResult(QDatabaseResultBase $objDbResult, $objExpandAsArrayNode = null, $strColumnAliasArray = null) {
			...
			if ($objExpandAsArrayNode) {
				...
				$objPrevItemArray = array();
				while ($objDbRow = $objDbResult->GetNextRow()) {
					$objItem = PiezaCheckpoints::InstantiateDbRow($objDbRow, null, $objExpandAsArrayNode, $objPrevItemArray, $strColumnAliasArray);
					if ($objItem) {
						$objToReturn[] = $objItem;
						$objPrevItemArray[$objItem->intId][] = $objItem;
				...
				while ($objDbRow = $objDbResult->GetNextRow())
					$objToReturn[] = PiezaCheckpoints::InstantiateDbRow($objDbRow, null, null, null, $strColumnAliasArray);
			}
		...
		/**
		 * Instantiate a single PiezaCheckpoints object from a query cursor (e.g. a DB ResultSet).
		 * Cursor is automatically moved to the "next row" of the result set.
		 * Will return NULL if no cursor or if the cursor has no more rows in the resultset.
		 * @param QDatabaseResultBase $objDbResult cursor resource
		 * @return PiezaCheckpoints next row resulting from the query
		 */
		public static function InstantiateCursor(QDatabaseResultBase $objDbResult) {
			...
			return PiezaCheckpoints::InstantiateDbRow($objDbRow, null, null, null, $strColumnAliasArray);
		}
		...
		/**
		 * Load a single PiezaCheckpoints object,
		 * by Id Index(es)
		 * @param integer $intId
		 * @param QQClause[] $objOptionalClauses additional optional QQClause objects for this query
		 * @return PiezaCheckpoints
		*/
		...
		/**
		 * Load an array of PiezaCheckpoints objects,
		 * by PiezaId Index(es)
		...
		*/
		public static function LoadArrayByPiezaId($intPiezaId, $objOptionalClauses = null) {
			// Call PiezaCheckpoints::QueryArray to perform the LoadArrayByPiezaId query
			try {
				return PiezaCheckpoints::QueryArray(
					QQ::Equal(QQN::PiezaCheckpoints()->PiezaId, $intPiezaId),
					$objOptionalClauses);
			} catch (QCallerException $objExc) {
				$objExc->IncrementOffset();
				throw $objExc;
		...
		/**
		 * Count PiezaCheckpointses
		 * by PiezaId Index(es)
		 * @param integer $intPiezaId
		 * @return int
		*/
		public static function CountByPiezaId($intPiezaId) {
			// Call PiezaCheckpoints::QueryCount to perform the CountByPiezaId query
		...
		*/
		public static function LoadArrayByCheckpointId($intCheckpointId, $objOptionalClauses = null) {
			// Call PiezaCheckpoints::QueryArray to perform the LoadArrayByCheckpointId query
			try {
				return PiezaCheckpoints::QueryArray(
					QQ::Equal(QQN::PiezaCheckpoints()->CheckpointId, $intCheckpointId),
					$objOptionalClauses);
			} catch (QCallerException $objExc) {
				$objExc->IncrementOffset();
				throw $objExc;
		...
		*/
		public static function CountByCheckpointId($intCheckpointId) {
			// Call PiezaCheckpoints::QueryCount to perform the CountByCheckpointId query
			return PiezaCheckpoints::QueryCount(
				QQ::Equal(QQN::PiezaCheckpoints()->CheckpointId, $intCheckpointId)
			);
		}
		...
		*/
		public static function LoadArrayBySucursalId($intSucursalId, $objOptionalClauses = null) {
			// Call PiezaCheckpoints::QueryArray to perform the LoadArrayBySucursalId query
			try {
				return PiezaCheckpoints::QueryArray(
					QQ::Equal(QQN::PiezaCheckpoints()->SucursalId, $intSucursalId),
					$objOptionalClauses);
			} catch (QCallerException $objExc) {
				$objExc->IncrementOffset();
				throw $objExc;
		...
		*/
		public static function CountBySucursalId($intSucursalId) {
			// Call PiezaCheckpoints::QueryCount to perform the CountBySucursalId query
			return PiezaCheckpoints::QueryCount(
				QQ::Equal(QQN::PiezaCheckpoints()->SucursalId, $intSucursalId)
			);
		}
		...
		*/
		public static function LoadArrayByRutaId($intRutaId, $objOptionalClauses = null) {
			// Call PiezaCheckpoints::QueryArray to perform the LoadArrayByRutaId query
			try {
				return PiezaCheckpoints::QueryArray(
					QQ::Equal(QQN::PiezaCheckpoints()->RutaId, $intRutaId),
					$objOptionalClauses);
			} catch (QCallerException $objExc) {
				$objExc->IncrementOffset();
				throw $objExc;
		...
		*/
		public static function CountByRutaId($intRutaId) {
			// Call PiezaCheckpoints::QueryCount to perform the CountByRutaId query
			return PiezaCheckpoints::QueryCount(
				QQ::Equal(QQN::PiezaCheckpoints()->RutaId, $intRutaId)
			);
		}
		...
		public function Save($blnForceInsert = false, $blnForceUpdate = false) {
			...
			try {
				if ((!$this->__blnRestored) || ($blnForceInsert)) {
					...
					$mixToReturn = $this->intId = $objDatabase->InsertId('pieza_checkpoints', 'id');
				} else {
		...
		/**
		 * Delete this PiezaCheckpoints
		 * @return void
		 */
		public function Delete() {
			if ((is_null($this->intId)))
				throw new QUndefinedPrimaryKeyException('Cannot delete this PiezaCheckpoints with an unset primary key.');
        ...
        /**
 	     * Delete this PiezaCheckpoints ONLY from the cache
 		 * @return void
		 */
		public function DeleteCache() {
			if (QApplication::$objCacheProvider && QApplication::$Database[1]->Caching) {
				$strCacheKey = QApplication::$objCacheProvider->CreateKey(QApplication::$Database[1]->Database, 'PiezaCheckpoints', $this->intId);
				QApplication::$objCacheProvider->Delete($strCacheKey);
			}
		}

		/**
		 * Delete all PiezaCheckpointses
		 * @return void
		 */
		...
		/**
		 * Truncate pieza_checkpoints table
		 * @return void
		 */
		...
		/**
		 * Reload this PiezaCheckpoints from the database.
		 * @return void
		 */
		public function Reload() {
			// Make sure we are actually Restored from the database
			if (!$this->__blnRestored)
				throw new QCallerException('Cannot call Reload() on a new, unsaved PiezaCheckpoints object.');

			$this->DeleteCache();

			// Reload the Object
			$objReloaded = PiezaCheckpoints::Load($this->intId);
		...
		public function __get($strName) {
			switch ($strName) {
				...
				case 'Pieza':
					/**
					 * Gets the value for the GuiaPiezas object referenced by intPiezaId (Not Null)
					 * @return GuiaPiezas
					 */
					try {
		...
		public function __set($strName, $mixValue) {
			switch ($strName) {
				...
				case 'Pieza':
					/**
					 * Sets the value for the GuiaPiezas object referenced by intPiezaId (Not Null)
					...
					if (is_null($mixValue)) {
						...
						if (is_null($mixValue->Id))
							throw new QCallerException('Unable to set an unsaved Pieza for this PiezaCheckpoints');
				...
				case 'Checkpoint':
					...
					if (is_null($mixValue)) {
						...
						if (is_null($mixValue->Id))
							throw new QCallerException('Unable to set an unsaved Checkpoint for this PiezaCheckpoints');
				...
				case 'Sucursal':
					...
					if (is_null($mixValue)) {
						...
						if (is_null($mixValue->Id))
							throw new QCallerException('Unable to set an unsaved Sucursal for this PiezaCheckpoints');
				...
				case 'Ruta':
					...
					if (is_null($mixValue)) {
						...
						if (is_null($mixValue->Id))
							throw new QCallerException('Unable to set an unsaved Ruta for this PiezaCheckpoints');
		...
		*/
		...
		public static function GetDatabaseName() {
			return QApplication::$Database[PiezaCheckpoints::GetDatabaseIndex()]->Database;
		}
		...
		public static function GetSoapComplexTypeXml() {
			$strToReturn = '<complexType name="PiezaCheckpoints"><sequence>';
		...
		public static function AlterSoapComplexTypeArray(&$strComplexTypeArray) {
			if (!array_key_exists('PiezaCheckpoints', $strComplexTypeArray)) {
				$strComplexTypeArray['PiezaCheckpoints'] = PiezaCheckpoints::GetSoapComplexTypeXml();
		...
		public static function GetArrayFromSoapArray($objSoapArray) {
			...
			foreach ($objSoapArray as $objSoapObject)
				array_push($objArrayToReturn, PiezaCheckpoints::GetObjectFromSoapObject($objSoapObject));
		...
		public static function GetSoapArrayFromArray($objArray) {
			...
			foreach ($objArray as $objObject)
				array_push($objArrayToReturn, PiezaCheckpoints::GetSoapObjectFromObject($objObject, true));
     ...
     **/
	class QQNodePiezaCheckpoints extends QQNode {
		protected $strTableName = 'pieza_checkpoints';
		protected $strPrimaryKey = 'id';
		protected $strClassName = 'PiezaCheckpoints';
		public function __get($strName) {
			switch ($strName) {
				case 'Id':
     ...
     * @property-read QQNode $_PrimaryKeyNode
     **/
	class QQReverseReferenceNodePiezaCheckpoints extends QQReverseReferenceNode {
		protected $strTableName = 'pieza_checkpoints';
		protected $strPrimaryKey = 'id';
		protected $strClassName = 'PiezaCheckpoints';
		public function __get($strName) {
