<?php
	...
	class RegistroTrabajoGen extends QBaseClass implements IteratorAggregate {
		...
		/**
		 * Protected member variable that contains the object pointed by the reference
		 * in the database column registro_trabajo.checkpoint_id.
		 *
		...
		public function Initialize()
		{
			...
			$this->intGuiaId = RegistroTrabajo::GuiaIdDefault;
			...
			$this->intSucursalId = RegistroTrabajo::SucursalIdDefault;
			$this->intCheckpointId = RegistroTrabajo::CheckpointIdDefault;
		}
		...
		public static function LoadArrayByGuiaId($intGuiaId, $objOptionalClauses = null) {
			...
			try {
				return RegistroTrabajo::QueryArray(
					QQ::Equal(QQN::RegistroTrabajo()->GuiaId, $intGuiaId),
					$objOptionalClauses);
			} catch (QCallerException $objExc) {
				$objExc->IncrementOffset();
				throw $objExc;
		...
		*/
		public static function LoadArrayBySucursalId($intSucursalId, $objOptionalClauses = null) {
			...
			try {
				return RegistroTrabajo::QueryArray(
					QQ::Equal(QQN::RegistroTrabajo()->SucursalId, $intSucursalId),
					$objOptionalClauses);
			} catch (QCallerException $objExc) {
				$objExc->IncrementOffset();
				throw $objExc;
		...
		*/
		public static function LoadArrayByCheckpointId($intCheckpointId, $objOptionalClauses = null) {
			...
			try {
				return RegistroTrabajo::QueryArray(
					QQ::Equal(QQN::RegistroTrabajo()->CheckpointId, $intCheckpointId),
					$objOptionalClauses);
			} catch (QCallerException $objExc) {
				$objExc->IncrementOffset();
				throw $objExc;
			...
			switch ($strName) {
				...
				case 'Checkpoint':
					...
					if (is_null($mixValue)) {
						...
						if (is_null($mixValue->Id))
							throw new QCallerException('Unable to set an unsaved Checkpoint for this RegistroTrabajo');
