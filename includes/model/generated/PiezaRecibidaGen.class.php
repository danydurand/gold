<?php
	/**
	 * The abstract PiezaRecibidaGen class defined here is
	 * code-generated and contains all the basic CRUD-type functionality as well as
	 * basic methods to handle relationships and index-based loading.
	 *
	 * To use, you should use the PiezaRecibida subclass which
	 * extends this PiezaRecibidaGen class.
	 *
	 * Because subsequent re-code generations will overwrite any changes to this
	 * file, you should leave this file unaltered to prevent yourself from losing
	 * any information or code changes.  All customizations should be done by
	 * overriding existing or implementing new methods, properties and variables
	 * in the PiezaRecibida class.
	 *
	 ...
	 */
	class PiezaRecibidaGen extends QBaseClass implements IteratorAggregate {
		...
		/**
		 * Protected member variable that maps to the database PK Identity column pieza_recibida.id
		 * @var integer intId
		 */
		protected $intId;
		...
		/**
		 * Protected member variable that maps to the database column pieza_recibida.proceso_error_id
		...
		/**
		 * Protected member variable that maps to the database column pieza_recibida.id_pieza
		...
		/**
		 * Protected member variable that maps to the database column pieza_recibida.is_recibida
		 * @var boolean blnIsRecibida
		 */
		protected $blnIsRecibida;
		const IsRecibidaDefault = 0;


		/**
		 * Protected member variable that maps to the database column pieza_recibida.created_at
		...
		/**
		 * Protected member variable that maps to the database column pieza_recibida.updated_at
		...
		/**
		 * Protected member variable that maps to the database column pieza_recibida.created_by
		...
		/**
		 * Protected member variable that maps to the database column pieza_recibida.updated_by
		 ...
		 * in the database column pieza_recibida.proceso_error_id.
		 *
		...
		/**
		 * Protected member variable that contains the object pointed by the reference
		 * in the database column pieza_recibida.created_by.
		 *
		...
		/**
		 * Protected member variable that contains the object pointed by the reference
		 * in the database column pieza_recibida.updated_by.
		 *
		...
		{
			$this->intId = PiezaRecibida::IdDefault;
			$this->intProcesoErrorId = PiezaRecibida::ProcesoErrorIdDefault;
			$this->strIdPieza = PiezaRecibida::IdPiezaDefault;
			$this->blnIsRecibida = PiezaRecibida::IsRecibidaDefault;
			$this->dttCreatedAt = (PiezaRecibida::CreatedAtDefault === null)?null:new QDateTime(PiezaRecibida::CreatedAtDefault);
			$this->dttUpdatedAt = (PiezaRecibida::UpdatedAtDefault === null)?null:new QDateTime(PiezaRecibida::UpdatedAtDefault);
			$this->intCreatedBy = PiezaRecibida::CreatedByDefault;
			$this->intUpdatedBy = PiezaRecibida::UpdatedByDefault;
		}
		...
		/**
		 * Load a PiezaRecibida from PK Info
		 * @param integer $intId
		...
		public static function Load($intId, $objOptionalClauses = null) {
			...
			if (QApplication::$objCacheProvider && !$objOptionalClauses && QApplication::$Database[1]->Caching) {
				$strCacheKey = QApplication::$objCacheProvider->CreateKey(QApplication::$Database[1]->Database, 'PiezaRecibida', $intId);
			...
			$objToReturn = PiezaRecibida::QuerySingle(
				QQ::AndCondition(
					QQ::Equal(QQN::PiezaRecibida()->Id, $intId)
				),
				$objOptionalClauses
			);
		...
		public static function LoadAll($objOptionalClauses = null) {
			...
			// Call PiezaRecibida::QueryArray to perform the LoadAll query
			try {
				return PiezaRecibida::QueryArray(QQ::All(), $objOptionalClauses);
		...
		/**
		 * Count all PiezaRecibidas
		 * @return int
		 */
		public static function CountAll() {
			// Call PiezaRecibida::QueryCount to perform the CountAll query
			return PiezaRecibida::QueryCount(QQ::All());
		}
		...
		protected static function BuildQueryStatement(&$objQueryBuilder, QQCondition $objConditions, $objOptionalClauses, $mixParameterArray, $blnCountOnly) {
			...
			$objDatabase = PiezaRecibida::GetDatabase();

			// Create/Build out the QueryBuilder object with PiezaRecibida-specific SELET and FROM fields
			$objQueryBuilder = new QQueryBuilder($objDatabase, 'pieza_recibida');
			...
			if ($blnAddAllFieldsToSelect) {
				PiezaRecibida::GetSelectFields($objQueryBuilder, null, QQuery::extractSelectClause($objOptionalClauses));
			}
			$objQueryBuilder->AddFromItem('pieza_recibida');
		...
		/**
		 * Static Qcubed Query method to query for a single PiezaRecibida object.
		 * Uses BuildQueryStatment to perform most of the work.
		 * @param QQCondition $objConditions any conditions on the query, itself
		 * @param QQClause[] $objOptionalClausees additional optional QQClause objects for this query
		 * @param mixed[] $mixParameterArray a array of name-value pairs to perform PrepareStatement with
		 * @return PiezaRecibida the queried object
		 */
		public static function QuerySingle(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null) {
			// Get the Query Statement
			try {
				$strQuery = PiezaRecibida::BuildQueryStatement($objQueryBuilder, $objConditions, $objOptionalClauses, $mixParameterArray, false);
			} catch (QCallerException $objExc) {
				$objExc->IncrementOffset();
				throw $objExc;
			}

			// Perform the Query, Get the First Row, and Instantiate a new PiezaRecibida object
			...
			if ($objQueryBuilder->ExpandAsArrayNode) {
				...
				while ($objDbRow = $objDbResult->GetNextRow()) {
					$objItem = PiezaRecibida::InstantiateDbRow($objDbRow, null, $objQueryBuilder->ExpandAsArrayNode, $objPrevItemArray, $objQueryBuilder->ColumnAliasArray);
					if ($objItem) {
						$objToReturn[] = $objItem;
				...
				if(null === $objDbRow)
					return null;
				return PiezaRecibida::InstantiateDbRow($objDbRow, null, null, null, $objQueryBuilder->ColumnAliasArray);
			}
		}

		/**
		 * Static Qcubed Query method to query for an array of PiezaRecibida objects.
		 * Uses BuildQueryStatment to perform most of the work.
		 * @param QQCondition $objConditions any conditions on the query, itself
		 * @param QQClause[] $objOptionalClausees additional optional QQClause objects for this query
		 * @param mixed[] $mixParameterArray a array of name-value pairs to perform PrepareStatement with
		 * @return PiezaRecibida[] the queried objects as an array
		 */
		public static function QueryArray(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null) {
			...
			$objDbResult = $objQueryBuilder->Database->Query($strQuery);
			return PiezaRecibida::InstantiateDbResult($objDbResult, $objQueryBuilder->ExpandAsArrayNode, $objQueryBuilder->ColumnAliasArray);
		}
		...
		/**
		 * Static Qcubed Query method to query for a count of PiezaRecibida objects.
		 * Uses BuildQueryStatment to perform most of the work.
		 * @param QQCondition $objConditions any conditions on the query, itself
		 * @param QQClause[] $objOptionalClausees additional optional QQClause objects for this query
		 * @param mixed[] $mixParameterArray a array of name-value pairs to perform PrepareStatement with
		...
		public static function QueryCount(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null) {
			// Get the Query Statement
			try {
				$strQuery = PiezaRecibida::BuildQueryStatement($objQueryBuilder, $objConditions, $objOptionalClauses, $mixParameterArray, true);
			} catch (QCallerException $objExc) {
				$objExc->IncrementOffset();
				throw $objExc;
			}
		...
		public static function QueryArrayCached(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null, $blnForceUpdate = false) {
			...
			$objCache = new QCache('qquery/piezarecibida', $strQuery);
			$cacheData = $objCache->GetData();

			if (!$cacheData || $blnForceUpdate) {
				$objDbResult = $objQueryBuilder->Database->Query($strQuery);
				$arrResult = PiezaRecibida::InstantiateDbResult($objDbResult, $objQueryBuilder->ExpandAsArrayNode, $objQueryBuilder->ColumnAliasArray);
		...
		/**
		 * Updates a QQueryBuilder with the SELECT fields for this PiezaRecibida
		...
		/**
		 * Instantiate a PiezaRecibida from a Database Row.
		 * Takes in an optional strAliasPrefix, used in case another Object::InstantiateDbRow
		 * is calling this PiezaRecibida::InstantiateDbRow in order to perform
		 ...
		 * @param string[] $strColumnAliasArray
		 * @return mixed Either a PiezaRecibida, or false to indicate the dbrow was used in an expansion, or null to indicate that this leaf is a duplicate.
		*/
		public static function InstantiateDbRow($objDbRow, $strAliasPrefix = null, $objExpandAsArrayNode = null, $objPreviousItemArray = null, $strColumnAliasArray = array()) {
			...
			if ($objExpandAsArrayNode && 
				...
				if (PiezaRecibida::ExpandArray ($objDbRow, $strAliasPrefix, $objExpandAsArrayNode, $objPreviousItemArray, $strColumnAliasArray)) {
					return false; // db row was used but no new object was created
				}
			}

			// Create a new instance of the PiezaRecibida object
			$objToReturn = new PiezaRecibida();
			...
			if (!$strAliasPrefix)
				$strAliasPrefix = 'pieza_recibida__';
		...
		/**
		 * Instantiate an array of PiezaRecibidas from a Database Result
		...
		public static function InstantiateDbResult(QDatabaseResultBase $objDbResult, $objExpandAsArrayNode = null, $strColumnAliasArray = null) {
			...
			if ($objExpandAsArrayNode) {
				...
				$objPrevItemArray = array();
				while ($objDbRow = $objDbResult->GetNextRow()) {
					$objItem = PiezaRecibida::InstantiateDbRow($objDbRow, null, $objExpandAsArrayNode, $objPrevItemArray, $strColumnAliasArray);
					if ($objItem) {
						$objToReturn[] = $objItem;
						$objPrevItemArray[$objItem->intId][] = $objItem;
				...
				while ($objDbRow = $objDbResult->GetNextRow())
					$objToReturn[] = PiezaRecibida::InstantiateDbRow($objDbRow, null, null, null, $strColumnAliasArray);
			}
		...
		/**
		 * Instantiate a single PiezaRecibida object from a query cursor (e.g. a DB ResultSet).
		 * Cursor is automatically moved to the "next row" of the result set.
		 * Will return NULL if no cursor or if the cursor has no more rows in the resultset.
		 * @param QDatabaseResultBase $objDbResult cursor resource
		 * @return PiezaRecibida next row resulting from the query
		 */
		public static function InstantiateCursor(QDatabaseResultBase $objDbResult) {
			...
			return PiezaRecibida::InstantiateDbRow($objDbRow, null, null, null, $strColumnAliasArray);
		}
		...
		/**
		 * Load a single PiezaRecibida object,
		 * by Id Index(es)
		 * @param integer $intId
		 * @param QQClause[] $objOptionalClauses additional optional QQClause objects for this query
		 * @return PiezaRecibida
		*/
		public static function LoadById($intId, $objOptionalClauses = null) {
			return PiezaRecibida::QuerySingle(
				QQ::AndCondition(
					QQ::Equal(QQN::PiezaRecibida()->Id, $intId)
				),
				$objOptionalClauses
		...
		*/
		public static function LoadByIdPieza($strIdPieza, $objOptionalClauses = null) {
			return PiezaRecibida::QuerySingle(
				QQ::AndCondition(
					QQ::Equal(QQN::PiezaRecibida()->IdPieza, $strIdPieza)
				),
				$objOptionalClauses
			);
		}
		...
		/**
		 * Load an array of PiezaRecibida objects,
		...
		*/
		public static function LoadArrayByProcesoErrorId($intProcesoErrorId, $objOptionalClauses = null) {
			// Call PiezaRecibida::QueryArray to perform the LoadArrayByProcesoErrorId query
			try {
				return PiezaRecibida::QueryArray(
					QQ::Equal(QQN::PiezaRecibida()->ProcesoErrorId, $intProcesoErrorId),
					$objOptionalClauses);
			} catch (QCallerException $objExc) {
				$objExc->IncrementOffset();
				throw $objExc;
		...
		/**
		 * Count PiezaRecibidas
		 * by ProcesoErrorId Index(es)
		 * @param integer $intProcesoErrorId
		 * @return int
		*/
		public static function CountByProcesoErrorId($intProcesoErrorId) {
			// Call PiezaRecibida::QueryCount to perform the CountByProcesoErrorId query
			return PiezaRecibida::QueryCount(
				QQ::Equal(QQN::PiezaRecibida()->ProcesoErrorId, $intProcesoErrorId)
			);
		}
		...
		*/
		public static function LoadArrayByUpdatedBy($intUpdatedBy, $objOptionalClauses = null) {
			// Call PiezaRecibida::QueryArray to perform the LoadArrayByUpdatedBy query
			try {
				return PiezaRecibida::QueryArray(
					QQ::Equal(QQN::PiezaRecibida()->UpdatedBy, $intUpdatedBy),
					$objOptionalClauses);
			} catch (QCallerException $objExc) {
				$objExc->IncrementOffset();
				throw $objExc;
		...
		*/
		public static function CountByUpdatedBy($intUpdatedBy) {
			// Call PiezaRecibida::QueryCount to perform the CountByUpdatedBy query
			return PiezaRecibida::QueryCount(
				QQ::Equal(QQN::PiezaRecibida()->UpdatedBy, $intUpdatedBy)
			);
		}
		...
		*/
		public static function LoadArrayByCreatedBy($intCreatedBy, $objOptionalClauses = null) {
			// Call PiezaRecibida::QueryArray to perform the LoadArrayByCreatedBy query
			try {
				return PiezaRecibida::QueryArray(
					QQ::Equal(QQN::PiezaRecibida()->CreatedBy, $intCreatedBy),
					$objOptionalClauses);
			} catch (QCallerException $objExc) {
				$objExc->IncrementOffset();
				throw $objExc;
		...
		*/
		public static function CountByCreatedBy($intCreatedBy) {
			// Call PiezaRecibida::QueryCount to perform the CountByCreatedBy query
			return PiezaRecibida::QueryCount(
				QQ::Equal(QQN::PiezaRecibida()->CreatedBy, $intCreatedBy)
			);
		}
		...
		public function Save($blnForceInsert = false, $blnForceUpdate = false) {
			...
			try {
				if ((!$this->__blnRestored) || ($blnForceInsert)) {
					...
					$mixToReturn = $this->intId = $objDatabase->InsertId('pieza_recibida', 'id');
				} else {
		...
		/**
		 * Delete this PiezaRecibida
		 * @return void
		 */
		public function Delete() {
			if ((is_null($this->intId)))
				throw new QUndefinedPrimaryKeyException('Cannot delete this PiezaRecibida with an unset primary key.');
        ...
        /**
 	     * Delete this PiezaRecibida ONLY from the cache
 		 * @return void
		 */
		public function DeleteCache() {
			if (QApplication::$objCacheProvider && QApplication::$Database[1]->Caching) {
				$strCacheKey = QApplication::$objCacheProvider->CreateKey(QApplication::$Database[1]->Database, 'PiezaRecibida', $this->intId);
				QApplication::$objCacheProvider->Delete($strCacheKey);
			}
		}

		/**
		 * Delete all PiezaRecibidas
		 * @return void
		 */
		...
		/**
		 * Reload this PiezaRecibida from the database.
		 * @return void
		 */
		public function Reload() {
			// Make sure we are actually Restored from the database
			if (!$this->__blnRestored)
				throw new QCallerException('Cannot call Reload() on a new, unsaved PiezaRecibida object.');

			$this->DeleteCache();

			// Reload the Object
			$objReloaded = PiezaRecibida::Load($this->intId);
			...
			switch ($strName) {
				...
				case 'ProcesoError':
					...
					if (is_null($mixValue)) {
						...
						if (is_null($mixValue->Id))
							throw new QCallerException('Unable to set an unsaved ProcesoError for this PiezaRecibida');
				...
				case 'CreatedByObject':
					...
					if (is_null($mixValue)) {
						...
						if (is_null($mixValue->CodiUsua))
							throw new QCallerException('Unable to set an unsaved CreatedByObject for this PiezaRecibida');
				...
				case 'UpdatedByObject':
					...
					if (is_null($mixValue)) {
						...
						// Make sure $mixValue is a SAVED Usuario object
						if (is_null($mixValue->CodiUsua))
							throw new QCallerException('Unable to set an unsaved UpdatedByObject for this PiezaRecibida');
		...
		public static function GetDatabaseName() {
			return QApplication::$Database[PiezaRecibida::GetDatabaseIndex()]->Database;
		}
		...
		public static function GetSoapComplexTypeXml() {
			$strToReturn = '<complexType name="PiezaRecibida"><sequence>';
		...
		public static function AlterSoapComplexTypeArray(&$strComplexTypeArray) {
			if (!array_key_exists('PiezaRecibida', $strComplexTypeArray)) {
				$strComplexTypeArray['PiezaRecibida'] = PiezaRecibida::GetSoapComplexTypeXml();
		...
		public static function GetArrayFromSoapArray($objSoapArray) {
			...
			foreach ($objSoapArray as $objSoapObject)
				array_push($objArrayToReturn, PiezaRecibida::GetObjectFromSoapObject($objSoapObject));
		...
		public static function GetSoapArrayFromArray($objArray) {
			...
			foreach ($objArray as $objObject)
				array_push($objArrayToReturn, PiezaRecibida::GetSoapObjectFromObject($objObject, true));
     ...
     **/
	class QQNodePiezaRecibida extends QQNode {
		protected $strTableName = 'pieza_recibida';
		protected $strPrimaryKey = 'id';
		protected $strClassName = 'PiezaRecibida';
		public function __get($strName) {
			switch ($strName) {
				case 'Id':
     ...
     * @property-read QQNode $_PrimaryKeyNode
     **/
	class QQReverseReferenceNodePiezaRecibida extends QQReverseReferenceNode {
		protected $strTableName = 'pieza_recibida';
		protected $strPrimaryKey = 'id';
		protected $strClassName = 'PiezaRecibida';
		public function __get($strName) {
