<?php
	require(__MODEL_GEN__ . '/UsersGen.class.php');

	/**
	 * The Users class defined here contains any
	 * customized code for the Users class in the
	 * Object Relational Model.  It represents the "users" table
	 * in the database, and extends from the code generated abstract UsersGen
	...
	class Users extends UsersGen {
		 ...
		 *
		 * Can also be called directly via $objUsers->__toString().
		 *
		 * @return string a nicely formatted string representation of this object
		 */
		public function __toString() {
			return sprintf('Users Object %s',  $this->intId);
		}
