...
<div class="row">
    <div class="col-md-12">
        ...
        <div style="margin-bottom: .3em">
            <div class="row">
                <div class="col-sm-2 text-center" style="font-weight: bold; text-align: center"><?php $this->lblAltoPiez->Render(); ?></div>
                <div class="col-sm-2 text-center" style="font-weight: bold; text-align: center"><?php $this->lblAnchPiez->Render(); ?></div>
                <div class="col-sm-2 text-center" style="font-weight: bold; text-align: center"><?php $this->lblLargPiez->Render(); ?></div>
                <div class="col-sm-2 text-center" style="font-weight: bold; text-align: center"><?php $this->lblKiloPiez->Render(); ?></div>
            ...
            <div class="row">
                <div class="col-sm-2 text-left" style="text-align: center"><?php $this->txtAltoPiez->Render(); ?></div>
                <div class="col-sm-2 text-left" style="text-align: center"><?php $this->txtAnchPiez->Render(); ?></div>
                <div class="col-sm-2 text-left" style="text-align: center"><?php $this->txtLargPiez->Render(); ?></div>
