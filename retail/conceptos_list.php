...
//		protected function Form_Load() {}
	...
	protected function Form_Create() {
		...
		$colOrdeConc = $this->dtgConceptoses->MetaAddColumn('Orden','Name=ORD');
		...
		$this->dtgConceptoses->MetaAddColumn('EsFijo','Name=FIJO?');
		$this->dtgConceptoses->MetaAddColumn('FechaInicial','Name=F.Inic');
		$this->dtgConceptoses->MetaAddColumn('FechaFinal','Name=F.Final');
		$colOperConc = $this->dtgConceptoses->MetaAddColumn('Operacion','Name=OPER');
		$colOperConc->FilterBoxSize = 4;
		$colApliComo = $this->dtgConceptoses->MetaAddColumn('AplicaComo','Name=APL.COMO');
