    ...
    <div data-role="page" id="acerca">
        ...
        <div data-role="content">
        	<div class="" style="text-align: center; padding-top: 0">
	            <h2><span style="color:#666;">LS-Mobile <small>ver 1.0 </span></small><small style="color:crimson">beta!</small></h2>
	            <span>by <a href="http://www.lufemansoftware.com" style="text-decoration:none;">Lufeman Software</a></span>
	            <hr>
	        </div>
	        <p align="justify">LS-Mobile es una extensión móvil de la Plaforma SISPAQ, que permite
