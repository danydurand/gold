...
class CambiarClave extends FormularioBaseKaizen {
    ...
    protected function btnSave_Click() {
        ...
        $objMessage->From = 'GoldCoast - Connect <locahost@goldcoast.com>';
        ...
        $strBody .= 'El Sistema Connect, ha registrado un cambio de Clave de Acceso, para su Usuario.<br>';
        ...
        $strBody .= 'soporte@goldcoast.com<br>';
        $objMessage->HtmlBody = $strBody;

        // Add random/custom email headers
        $objMessage->SetHeader('x-application', 'Sistema Connect');
