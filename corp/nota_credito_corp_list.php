...
//		protected function Form_Load() {}
	...
	protected function Form_Create() {
        ...
        $objClauWher[] = QQ::Equal(QQN::NotaCreditoCorp()->ClienteCorpId,$objUser->ClienteId);
        $this->dtgNotaCreditoCorps->AdditionalConditions = QQ::AndCondition($objClauWher);

        $objClauOrde   = QQ::Clause();
        $objClauOrde[] = QQ::OrderBy(QQN::NotaCreditoCorp()->Id,false);
        $this->dtgNotaCreditoCorps->AdditionalClauses = $objClauOrde;
